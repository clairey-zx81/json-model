...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_map_0_tab[0] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "b" } }, _jm_obj_1 };
        _jm_map_0_tab[1] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "c" } }, _jm_obj_1 };
        _jm_map_0_tab[2] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "d" } }, json_model_2 };
