...
static bool json_model_2(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (likely(jm_str_eq_2(prop, 0x00000075)))
        {
...
static bool json_model_3(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (likely(jm_str_eq_4(prop, 0x00676665)))
        {
...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_map_0_tab[1] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "e" } }, json_model_3 };
        _jm_map_0_tab[2] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "f" } }, json_model_3 };
        _jm_map_0_tab[3] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "g" } }, json_model_3 };
        jm_sort_constmap(_jm_map_0_tab, 4);
        _jm_map_1_tab[0] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "b" } }, _jm_obj_1 };
        _jm_map_1_tab[1] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "c" } }, _jm_obj_1 };
        _jm_map_1_tab[2] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "d" } }, json_model_2 };
