...
public class alter_1 extends ModelChecker
{
    ...
    public Map<String, Checker> alter_1_map_pmap;

    // check $g (.'$g')
    public boolean json_model_2(Object val, Path path, Report rep)
    {
        // .'$g'
        return json.isString(val) && json.asString(val).compareTo("g") == 0;
    }
    ...
    public boolean _jm_obj_2(Object val, Path path, Report rep)
    {
        ...
        if (! ((pval = json.objectValue(val, "g")) != null))
        {
            return false;
        }
        // .'$alternative'.'|'.2.g
    ...
    public boolean _jm_obj_3(Object val, Path path, Report rep)
    {
        ...
        if (! ((pval = json.objectValue(val, "hi")) != null))
        {
            return false;
        }
        // .'$alternative'.'|'.3.hi
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            _jm_cst_0_set.add(json.safeJSON("\"h\""));
            _jm_cst_0_set.add(json.safeJSON("\"i\""));
    ...
    public void free()
    {
        if (initialized)
        {
            ...
            _jm_cst_2_set = null;
            _jm_map_0_cmap = null;
            alter_1_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return alter_1_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return alter_1_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new alter_1();
        Main.main("alter_1", checker, VERSION, args);
    }
}
