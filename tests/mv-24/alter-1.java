...
public class alter_1 extends ModelChecker
{
    ...
    public boolean json_model_2(Object val, Path path, Report rep)
    {
        boolean res;
        // .'$g'
        res = json.isString(val) && json.asString(val).compareTo("g") == 0;
        return res;
    }
    ...
    public boolean _jm_obj_4(Object val, Path path, Report rep)
    {
        ...
        if (! json.objectHasProp(val, "g"))
        {
            return false;
        }
        pval = json.objectValue(val, "g");
        // .'$alternative'.'|'.2.g
        res = json.isString(pval);
        if (! res)
        {
    ...
    public boolean _jm_obj_5(Object val, Path path, Report rep)
    {
        ...
        if (! json.objectHasProp(val, "hi"))
        {
            return false;
        }
        pval = json.objectValue(val, "hi");
        // .'$alternative'.'|'.3.hi
        res = json.isString(pval);
        if (! res)
        {
