...
bool json_model_3(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    if (! val.containsKey("efg"))
    {
        return false;
    }
    lpath = (path != null ? [...?path, "efg"] : null);
    pval = val["efg"];
    // .'$efg'.efg
    return (pval is String);
}
...
void check_model_init() {
  if (!GlobalState.initializer){
    GlobalState.initializer = true;
        ...
        _jm_map_0["e"] = json_model_3;
        _jm_map_0["f"] = json_model_3;
        _jm_map_0["g"] = json_model_3;
        _jm_map_1["b"] = _jm_obj_1;
        _jm_map_1["c"] = _jm_obj_1;
        _jm_map_1["d"] = json_model_2;
        check_model_map[""] = json_model_4;
        check_model_map["d"] = json_model_2;
        check_model_map["efg"] = json_model_3;
        check_model_map["alternative"] = json_model_4;
}
