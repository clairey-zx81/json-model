...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_map_0_tab[3] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "d" } }, json_model_2 };
        _jm_map_0_tab[4] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "e" } }, json_model_3 };
        _jm_map_0_tab[5] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "f" } }, json_model_3 };
