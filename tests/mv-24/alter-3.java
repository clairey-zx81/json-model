...
public class alter_3 extends ModelChecker
{
    static public final String VERSION = "2";

    Set<Object> _jm_cst_0_set;
    Map<Object, Checker> _jm_map_0_cmap;
    public Map<String, Checker> alter_3_map_pmap;
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            _jm_map_0_cmap.put(json.safeJSON("\"b\""), new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_2(o, p, r);} });
    ...
    public void free()
    {
        if (initialized)
        {
            ...
            _jm_cst_0_set = null;
            _jm_map_0_cmap = null;
            alter_3_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return alter_3_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return alter_3_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new alter_3();
        Main.main("alter_3", checker, VERSION, args);
    }
}
