...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Foo\" [.'$over']", path))
    return res
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = json_model_4(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$over#Foo\" [.]", path))
    return res
...
def json_model_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "foo":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_rewritten foo\" [.'$over#Foo'.foo]", lpath_0 if path is not None else None))
