...
sub json_model_27($$$)
{
    ...
    # .'$Link'.'|'.0
    # .'$Link'.'|'.1
    return jm_is_object($val) && (_jm_obj_17($val, undef, undef) || _jm_obj_16($val, undef, undef));
}
...
sub json_model_36($$$)
{
    ...
    return 0 unless $res;
    return 0 unless exists $$val{"scheme"};
    $pval = $$val{"scheme"};
    # .'$SS-http'.scheme
...
sub json_model_38($$$)
{
    ...
    return 0 unless $res;
    return 0 unless exists $$val{"flows"};
    $pval = $$val{"flows"};
    # .'$SS-oauth2'.flows
...
sub json_model_39($$$)
{
    ...
    return 0 unless $res;
    return 0 unless exists $$val{"openIdConnectUrl"};
