...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$PathItem\" [.'$OpenAPI'.webhooks.'']", lpath_1 if path is not None else None))
            return False
    return True
...
def json_model_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "openapi":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"/^3\\\\.1\\\\.\\\\d+(-.+)?$/\" [.'$OpenAPI'.openapi]", lpath_0 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Info\" [.'$OpenAPI'.info]", lpath_0 if path is not None else None))
        ...
        if prop == "jsonSchemaDialect":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$OpenAPI'.jsonSchemaDialect]", lpath_0 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$OpenAPI'.jsonSchemaDialect]", lpath_0 if path is not None else None))
                return False
            continue
        elif prop == "servers":
            ...
            if res:
                for arr_0_idx, arr_0_item in enumerate(pval):
                    ...
                    # .'$OpenAPI'.servers.0
                    res = json_model_6(arr_0_item, arr_0_lpath if (lpath_0 if path is not None else None) is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$Server\" [.'$OpenAPI'.servers.0]", arr_0_lpath if (lpath_0 if path is not None else None) is not None else None))
                        break
            if not res:
                rep is None or rep.append(("not array or unexpected array [.'$OpenAPI'.servers]", lpath_0 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$OpenAPI'.servers]", lpath_0 if path is not None else None))
                return False
            continue
        elif prop == "paths":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Paths\" [.'$OpenAPI'.paths]", lpath_0 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$OpenAPI'.paths]", lpath_0 if path is not None else None))
                return False
            continue
        elif prop == "webhooks":
            ...
            if not res:
                rep is None or rep.append(("unexpected element [.'$OpenAPI'.webhooks]", lpath_0 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$OpenAPI'.webhooks]", lpath_0 if path is not None else None))
                return False
            continue
        elif prop == "components":
            # handle may components property
            # .'$OpenAPI'.components
            res = json_model_8(pval, lpath_0 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Components\" [.'$OpenAPI'.components]", lpath_0 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$OpenAPI'.components]", lpath_0 if path is not None else None))
                return False
            continue
        elif prop == "security":
            ...
            if res:
                for arr_1_idx, arr_1_item in enumerate(pval):
                    arr_1_lpath: Path = ((lpath_0 if path is not None else None) + [ arr_1_idx ]) if (lpath_0 if path is not None else None) is not None else None
                    # .'$OpenAPI'.security.0
                    res = json_model_43(arr_1_item, arr_1_lpath if (lpath_0 if path is not None else None) is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$SecurityRequirement\" [.'$OpenAPI'.security.0]", arr_1_lpath if (lpath_0 if path is not None else None) is not None else None))
                        break
            if not res:
                rep is None or rep.append(("not array or unexpected array [.'$OpenAPI'.security]", lpath_0 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$OpenAPI'.security]", lpath_0 if path is not None else None))
                return False
            continue
        elif prop == "tags":
            ...
            if res:
                for arr_2_idx, arr_2_item in enumerate(pval):
                    arr_2_lpath: Path = ((lpath_0 if path is not None else None) + [ arr_2_idx ]) if (lpath_0 if path is not None else None) is not None else None
                    # .'$OpenAPI'.tags.0
                    res = json_model_29(arr_2_item, arr_2_lpath if (lpath_0 if path is not None else None) is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$Tag\" [.'$OpenAPI'.tags.0]", arr_2_lpath if (lpath_0 if path is not None else None) is not None else None))
                        break
            if not res:
                rep is None or rep.append(("not array or unexpected array [.'$OpenAPI'.tags]", lpath_0 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$OpenAPI'.tags]", lpath_0 if path is not None else None))
                return False
            continue
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$ExternalDocumentation\" [.'$OpenAPI'.externalDocs]", lpath_0 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$OpenAPI'.externalDocs]", lpath_0 if path is not None else None))
                return False
            continue
...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "title":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Info'.title]", lpath_2 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Info'.version]", lpath_2 if path is not None else None))
        ...
        if prop == "summary":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Info'.summary]", lpath_2 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Info'.description]", lpath_2 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Info'.termsOfService]", lpath_2 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Contact\" [.'$Info'.contact]", lpath_2 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$License\" [.'$Info'.license]", lpath_2 if path is not None else None))
...
def json_model_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Contact'.name]", lpath_3 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$Contact'.url]", lpath_3 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Contact'.email]", lpath_3 if path is not None else None))
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$License'.'|'.1.name]", lpath_4 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$License'.'|'.1.url]", lpath_4 if path is not None else None))
...
def _jm_obj_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$License'.'|'.0.name]", lpath_5 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$License'.'|'.0.identifier]", lpath_5 if path is not None else None))
...
def _jm_obj_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$ServerVariable\" [.'$Server'.variables.'']", lpath_7 if path is not None else None))
            return False
    return True
...
def json_model_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "url":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$Server'.url]", lpath_6 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Server'.description]", lpath_6 if path is not None else None))
...
def json_model_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "default":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$ServerVariable'.default]", lpath_8 if path is not None else None))
        ...
        if prop == "enum":
            ...
            if res:
                for arr_3_idx, arr_3_item in enumerate(pval):
                    ...
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"\" [.'$ServerVariable'.enum.0]", arr_3_lpath if (lpath_8 if path is not None else None) is not None else None))
                        break
            if not res:
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$ServerVariable'.description]", lpath_8 if path is not None else None))
...
def _jm_obj_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$Components'.schemas.'']", lpath_10 if path is not None else None))
            return False
    return True
...
def _jm_obj_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_23(pval, lpath_11 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Response\" [.'$Components'.responses.''.'|'.0]", lpath_11 if path is not None else None))
            # .'$Components'.responses.''.'|'.1
            res = json_model_30(pval, lpath_11 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Components'.responses.''.'|'.1]", lpath_11 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$Components'.responses.''.'|']", lpath_11 if path is not None else None))
            return False
    return True
...
def _jm_obj_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_18(pval, lpath_12 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Parameter\" [.'$Components'.parameters.''.'|'.0]", lpath_12 if path is not None else None))
            # .'$Components'.parameters.''.'|'.1
            res = json_model_30(pval, lpath_12 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Components'.parameters.''.'|'.1]", lpath_12 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$Components'.parameters.''.'|']", lpath_12 if path is not None else None))
            return False
    return True
...
def _jm_obj_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Example\" [.'$Components'.examples.''.'|'.0]", lpath_13 if path is not None else None))
            # .'$Components'.examples.''.'|'.1
            res = json_model_30(pval, lpath_13 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Components'.examples.''.'|'.1]", lpath_13 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$Components'.examples.''.'|']", lpath_13 if path is not None else None))
            return False
    return True
...
def _jm_obj_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$RequestBody\" [.'$Components'.requestBodies.''.'|'.0]", lpath_14 if path is not None else None))
            # .'$Components'.requestBodies.''.'|'.1
            res = json_model_30(pval, lpath_14 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Components'.requestBodies.''.'|'.1]", lpath_14 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$Components'.requestBodies.''.'|']", lpath_14 if path is not None else None))
            return False
    return True
...
def _jm_obj_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_28(pval, lpath_15 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Header\" [.'$Components'.headers.''.'|'.0]", lpath_15 if path is not None else None))
            # .'$Components'.headers.''.'|'.1
            res = json_model_30(pval, lpath_15 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Components'.headers.''.'|'.1]", lpath_15 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$Components'.headers.''.'|']", lpath_15 if path is not None else None))
            return False
    return True
...
def _jm_obj_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_40(pval, lpath_16 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$SecurityScheme\" [.'$Components'.securitySchemes.''.'|'.0]", lpath_16 if path is not None else None))
            # .'$Components'.securitySchemes.''.'|'.1
            res = json_model_30(pval, lpath_16 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Components'.securitySchemes.''.'|'.1]", lpath_16 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$Components'.securitySchemes.''.'|']", lpath_16 if path is not None else None))
            return False
    return True
...
def _jm_obj_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        # .'$Components'.links.''
        # .'$Components'.links.''.'|'.0
        res = json_model_27(pval, lpath_17 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Link\" [.'$Components'.links.''.'|'.0]", lpath_17 if path is not None else None))
            # .'$Components'.links.''.'|'.1
            res = json_model_30(pval, lpath_17 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Components'.links.''.'|'.1]", lpath_17 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Callback\" [.'$Components'.callbacks.''.'|'.0]", lpath_18 if path is not None else None))
            # .'$Components'.callbacks.''.'|'.1
            res = json_model_30(pval, lpath_18 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Components'.callbacks.''.'|'.1]", lpath_18 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$Components'.callbacks.''.'|']", lpath_18 if path is not None else None))
            return False
    return True
...
def _jm_obj_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_10(pval, lpath_19 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$PathItem\" [.'$Components'.pathItems.''.'|'.0]", lpath_19 if path is not None else None))
            # .'$Components'.pathItems.''.'|'.1
            res = json_model_30(pval, lpath_19 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Components'.pathItems.''.'|'.1]", lpath_19 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$Components'.pathItems.''.'|']", lpath_19 if path is not None else None))
            return False
    return True
...
def json_model_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "schemas":
            ...
            # .'$Components'.schemas
            res = _jm_obj_4(pval, lpath_9 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected element [.'$Components'.schemas]", lpath_9 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Components'.schemas]", lpath_9 if path is not None else None))
                return False
            continue
        elif prop == "responses":
            # handle may responses property
            # .'$Components'.responses
            res = _jm_obj_5(pval, lpath_9 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected element [.'$Components'.responses]", lpath_9 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Components'.responses]", lpath_9 if path is not None else None))
                return False
            continue
            ...
            if not res:
                rep is None or rep.append(("unexpected element [.'$Components'.parameters]", lpath_9 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Components'.parameters]", lpath_9 if path is not None else None))
                return False
            continue
        elif prop == "examples":
            # handle may examples property
            # .'$Components'.examples
            res = _jm_obj_7(pval, lpath_9 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected element [.'$Components'.examples]", lpath_9 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Components'.examples]", lpath_9 if path is not None else None))
                return False
            continue
            ...
            if not res:
                rep is None or rep.append(("unexpected element [.'$Components'.requestBodies]", lpath_9 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Components'.requestBodies]", lpath_9 if path is not None else None))
                return False
            continue
        elif prop == "headers":
            ...
            if not res:
                rep is None or rep.append(("unexpected element [.'$Components'.headers]", lpath_9 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Components'.headers]", lpath_9 if path is not None else None))
                return False
            continue
            ...
            if not res:
                rep is None or rep.append(("unexpected element [.'$Components'.securitySchemes]", lpath_9 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Components'.securitySchemes]", lpath_9 if path is not None else None))
                return False
            continue
        elif prop == "links":
            ...
            if not res:
                rep is None or rep.append(("unexpected element [.'$Components'.links]", lpath_9 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Components'.links]", lpath_9 if path is not None else None))
                return False
            continue
        elif prop == "callbacks":
            # handle may callbacks property
            # .'$Components'.callbacks
            res = _jm_obj_12(pval, lpath_9 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected element [.'$Components'.callbacks]", lpath_9 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Components'.callbacks]", lpath_9 if path is not None else None))
                return False
            continue
        elif prop == "pathItems":
            ...
            if not res:
                rep is None or rep.append(("unexpected element [.'$Components'.pathItems]", lpath_9 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Components'.pathItems]", lpath_9 if path is not None else None))
                return False
            continue
        if prop.startswith("x-"):
            # handle 1 re props
...
def json_model_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop.startswith("/"):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$PathItem\" [.'$Paths'.'/^//']", lpath_20 if path is not None else None))
                return False
...
def _jm_f_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$URI\" [.'$PathItem'.'$ref']", path))
    return res
...
def _jm_f_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$PathItem'.description]", path))
    return res
...
def _jm_f_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_4_idx, arr_4_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Parameter\" [.'$PathItem'.parameters.0.'|'.0]", arr_4_lpath if path is not None else None))
                # .'$PathItem'.parameters.0.'|'.1
                res = json_model_30(arr_4_item, arr_4_lpath if path is not None else None, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$PathItem'.parameters.0.'|'.1]", arr_4_lpath if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
...
def _jm_f_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_5_idx, arr_5_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Operation\" [.'$PathItem'.servers.0]", arr_5_lpath if path is not None else None))
                break
    if not res:
...
def _jm_f_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$PathItem'.summary]", path))
    return res
...
def _jm_f_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Callback\" [.'$Operation'.callbacks.''.'|'.0]", lpath_23 if path is not None else None))
            # .'$Operation'.callbacks.''.'|'.1
            res = json_model_30(pval, lpath_23 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Operation'.callbacks.''.'|'.1]", lpath_23 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_f_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Operation'.description]", path))
    return res
...
def _jm_f_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Operation'.operationId]", path))
    return res
...
def _jm_f_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_6_idx, arr_6_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Parameter\" [.'$Operation'.parameters.0.'|'.0]", arr_6_lpath if path is not None else None))
                # .'$Operation'.parameters.0.'|'.1
                res = json_model_30(arr_6_item, arr_6_lpath if path is not None else None, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Operation'.parameters.0.'|'.1]", arr_6_lpath if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
...
def _jm_f_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = json_model_19(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$RequestBody\" [.'$Operation'.requestBody.'|'.0]", path))
        # .'$Operation'.requestBody.'|'.1
        res = json_model_30(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Operation'.requestBody.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def _jm_f_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_7_idx, arr_7_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$SecurityRequirement\" [.'$Operation'.security.0]", arr_7_lpath if path is not None else None))
                break
    if not res:
...
def _jm_f_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_8_idx, arr_8_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Server\" [.'$Operation'.servers.0]", arr_8_lpath if path is not None else None))
                break
    if not res:
...
def _jm_f_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Operation'.summary]", path))
    return res
...
def _jm_f_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_9_idx, arr_9_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Operation'.tags.0]", arr_9_lpath if path is not None else None))
                break
    if not res:
...
def json_model_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "url":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$ExternalDocumentation'.url]", lpath_24 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$ExternalDocumentation'.description]", lpath_24 if path is not None else None))
...
def json_model_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$parameterShare'.description]", lpath_25 if path is not None else None))
...
def json_model_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$commonParameter'.name]", lpath_26 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$commonParameter'.description]", lpath_26 if path is not None else None))
...
def _jm_obj_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Example\" [.'$parameterSchemaOnly'.examples.''.'|'.0]", lpath_28 if path is not None else None))
            # .'$parameterSchemaOnly'.examples.''.'|'.1
            res = json_model_30(pval, lpath_28 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$parameterSchemaOnly'.examples.''.'|'.1]", lpath_28 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def json_model_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "style":
            ...
            res = json_model_15(pval, lpath_27 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Style\" [.'$parameterSchemaOnly'.style]", lpath_27 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$parameterSchemaOnly'.style]", lpath_27 if path is not None else None))
                return False
            continue
        elif prop == "explode":
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$parameterSchemaOnly'.explode]", lpath_27 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$parameterSchemaOnly'.explode]", lpath_27 if path is not None else None))
                return False
            continue
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$parameterSchemaOnly'.allowReserved]", lpath_27 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$parameterSchemaOnly'.allowReserved]", lpath_27 if path is not None else None))
                return False
            continue
        elif prop == "schema":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$parameterSchemaOnly'.schema]", lpath_27 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$parameterSchemaOnly'.schema]", lpath_27 if path is not None else None))
                return False
            continue
        elif prop == "example":
            ...
            # handle may examples property
            # .'$parameterSchemaOnly'.examples
            res = _jm_obj_14(pval, lpath_27 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected element [.'$parameterSchemaOnly'.examples]", lpath_27 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$parameterSchemaOnly'.examples]", lpath_27 if path is not None else None))
                return False
            continue
...
def _jm_obj_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$MediaType\" [.'$parameterContentOnly'.content.'']", lpath_30 if path is not None else None))
            return False
    return True
...
def json_model_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "content":
            ...
            # .'$parameterContentOnly'.content
            res = _jm_obj_15(pval, lpath_29 if path is not None else None, rep)
            if not res:
...
def _jm_obj_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$MediaType\" [.'$Parameter'.'|'.1.content.'']", lpath_32 if path is not None else None))
            return False
    return True
...
def _jm_obj_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Parameter'.'|'.1.name]", lpath_31 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Parameter'.'|'.1.description]", lpath_31 if path is not None else None))
            ...
            # handle may content property
            # .'$Parameter'.'|'.1.content
            res = _jm_obj_17(pval, lpath_31 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected element [.'$Parameter'.'|'.1.content]", lpath_31 if path is not None else None))
...
def _jm_obj_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Example\" [.'$Parameter'.'|'.0.examples.''.'|'.0]", lpath_34 if path is not None else None))
            # .'$Parameter'.'|'.0.examples.''.'|'.1
            res = json_model_30(pval, lpath_34 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Parameter'.'|'.0.examples.''.'|'.1]", lpath_34 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Parameter'.'|'.0.name]", lpath_33 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Parameter'.'|'.0.description]", lpath_33 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Parameter'.'|'.0.description]", lpath_33 if path is not None else None))
                return False
            continue
        elif prop == "required":
            # handle may required property
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$Parameter'.'|'.0.required]", lpath_33 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Parameter'.'|'.0.required]", lpath_33 if path is not None else None))
                return False
            continue
        elif prop == "deprecated":
            # handle may deprecated property
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$Parameter'.'|'.0.deprecated]", lpath_33 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Parameter'.'|'.0.deprecated]", lpath_33 if path is not None else None))
                return False
            continue
        elif prop == "allowEmptyValue":
            # handle may allowEmptyValue property
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$Parameter'.'|'.0.allowEmptyValue]", lpath_33 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Parameter'.'|'.0.allowEmptyValue]", lpath_33 if path is not None else None))
                return False
            continue
        elif prop == "style":
            # handle may style property
            # .'$Parameter'.'|'.0.style
            res = json_model_15(pval, lpath_33 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Style\" [.'$Parameter'.'|'.0.style]", lpath_33 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Parameter'.'|'.0.style]", lpath_33 if path is not None else None))
                return False
            continue
        elif prop == "explode":
            # handle may explode property
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$Parameter'.'|'.0.explode]", lpath_33 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Parameter'.'|'.0.explode]", lpath_33 if path is not None else None))
                return False
            continue
        elif prop == "allowReserved":
            # handle may allowReserved property
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$Parameter'.'|'.0.allowReserved]", lpath_33 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Parameter'.'|'.0.allowReserved]", lpath_33 if path is not None else None))
                return False
            continue
        elif prop == "schema":
            # handle may schema property
            # .'$Parameter'.'|'.0.schema
            res = json_model_32(pval, lpath_33 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$Parameter'.'|'.0.schema]", lpath_33 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Parameter'.'|'.0.schema]", lpath_33 if path is not None else None))
                return False
            continue
        elif prop == "example":
            # handle may example property
            ...
            # handle may examples property
            # .'$Parameter'.'|'.0.examples
            res = _jm_obj_19(pval, lpath_33 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected element [.'$Parameter'.'|'.0.examples]", lpath_33 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Parameter'.'|'.0.examples]", lpath_33 if path is not None else None))
                return False
            continue
        if prop.startswith("x-"):
            # handle 1 re props
...
def _jm_obj_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$MediaType\" [.'$RequestBody'.content.'']", lpath_36 if path is not None else None))
            return False
    return True
...
def json_model_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$RequestBody'.description]", lpath_35 if path is not None else None))
            ...
            # handle may content property
            # .'$RequestBody'.content
            res = _jm_obj_20(pval, lpath_35 if path is not None else None, rep)
            if not res:
...
def _jm_obj_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Example\" [.'$MediaType'.examples.''.'|'.0]", lpath_38 if path is not None else None))
            # .'$MediaType'.examples.''.'|'.1
            res = json_model_30(pval, lpath_38 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$MediaType'.examples.''.'|'.1]", lpath_38 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Encoding\" [.'$MediaType'.encoding.'']", lpath_39 if path is not None else None))
            return False
    return True
...
def json_model_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "schema":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$MediaType'.schema]", lpath_37 if path is not None else None))
            ...
            # handle may examples property
            # .'$MediaType'.examples
            res = _jm_obj_21(pval, lpath_37 if path is not None else None, rep)
            if not res:
            ...
            # .'$MediaType'.encoding
            res = _jm_obj_22(pval, lpath_37 if path is not None else None, rep)
            if not res:
...
def _jm_obj_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Header\" [.'$Encoding'.headers.''.'|'.0]", lpath_41 if path is not None else None))
            # .'$Encoding'.headers.''.'|'.1
            res = json_model_30(pval, lpath_41 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Encoding'.headers.''.'|'.1]", lpath_41 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def json_model_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "contentType":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Encoding'.contentType]", lpath_40 if path is not None else None))
            ...
            # handle may headers property
            # .'$Encoding'.headers
            res = _jm_obj_23(pval, lpath_40 if path is not None else None, rep)
            if not res:
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Style\" [.'$Encoding'.style]", lpath_40 if path is not None else None))
...
def json_model_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "default":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Response\" [.'$Responses'.default.'|'.0]", lpath_42 if path is not None else None))
                # .'$Responses'.default.'|'.1
                res = json_model_30(pval, lpath_42 if path is not None else None, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Responses'.default.'|'.1]", lpath_42 if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
        ...
        if _jm_re_2(prop, path, rep):
            ...
            res = json_model_23(pval, lpath_42 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Response\" [.'$Responses'.'/^[1-5](\\\\d\\\\d|XX)$/'.'|'.0]", lpath_42 if path is not None else None))
                # .'$Responses'.'/^[1-5](\\d\\d|XX)$/'.'|'.1
                res = json_model_30(pval, lpath_42 if path is not None else None, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Responses'.'/^[1-5](\\\\d\\\\d|XX)$/'.'|'.1]", lpath_42 if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
...
def _jm_obj_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Header\" [.'$Response'.headers.''.'|'.0]", lpath_44 if path is not None else None))
            # .'$Response'.headers.''.'|'.1
            res = json_model_30(pval, lpath_44 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Response'.headers.''.'|'.1]", lpath_44 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$MediaType\" [.'$Response'.content.'']", lpath_45 if path is not None else None))
            return False
    return True
...
def _jm_obj_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Link\" [.'$Response'.links.''.'|'.0]", lpath_46 if path is not None else None))
            # .'$Response'.links.''.'|'.1
            res = json_model_30(pval, lpath_46 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Response'.links.''.'|'.1]", lpath_46 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def json_model_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Response'.description]", lpath_43 if path is not None else None))
            ...
            # handle may headers property
            # .'$Response'.headers
            res = _jm_obj_24(pval, lpath_43 if path is not None else None, rep)
            if not res:
            ...
            # handle may content property
            # .'$Response'.content
            res = _jm_obj_25(pval, lpath_43 if path is not None else None, rep)
            if not res:
            ...
            # handle may links property
            # .'$Response'.links
            res = _jm_obj_26(pval, lpath_43 if path is not None else None, rep)
            if not res:
...
def json_model_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if json_model_26(prop, lpath_47 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$PathItem\" [.'$Callback'.'$Expression'.'|'.0]", lpath_47 if path is not None else None))
                # .'$Callback'.'$Expression'.'|'.1
                res = json_model_30(pval, lpath_47 if path is not None else None, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Callback'.'$Expression'.'|'.1]", lpath_47 if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
...
def json_model_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "summary":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Example'.summary]", lpath_48 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Example'.description]", lpath_48 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Example'.externalValue]", lpath_48 if path is not None else None))
...
def json_model_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Expression']", path))
    return res
...
def _jm_obj_27(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "operationId":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Link'.'|'.1.operationId]", lpath_49 if path is not None else None))
        ...
        if prop == "parameters":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Link'.'|'.1.description]", lpath_49 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Server\" [.'$Link'.'|'.1.server]", lpath_49 if path is not None else None))
...
def _jm_obj_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "operationRef":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Link'.'|'.0.operationRef]", lpath_50 if path is not None else None))
        ...
        if prop == "parameters":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Link'.'|'.0.description]", lpath_50 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Server\" [.'$Link'.'|'.0.server]", lpath_50 if path is not None else None))
...
def _jm_obj_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$MediaType\" [.'$Header'.'|'.1.content.'']", lpath_52 if path is not None else None))
            return False
    return True
...
def _jm_obj_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Header'.'|'.1.description]", lpath_51 if path is not None else None))
            ...
            # handle may content property
            # .'$Header'.'|'.1.content
            res = _jm_obj_30(pval, lpath_51 if path is not None else None, rep)
            if not res:
...
def _jm_obj_32(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Example\" [.'$Header'.'|'.0.examples.''.'|'.0]", lpath_54 if path is not None else None))
            # .'$Header'.'|'.0.examples.''.'|'.1
            res = json_model_30(pval, lpath_54 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$Header'.'|'.0.examples.''.'|'.1]", lpath_54 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_31(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Header'.'|'.0.description]", lpath_53 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Header'.'|'.0.description]", lpath_53 if path is not None else None))
                return False
            continue
        elif prop == "required":
            # handle may required property
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$Header'.'|'.0.required]", lpath_53 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Header'.'|'.0.required]", lpath_53 if path is not None else None))
                return False
            continue
        elif prop == "deprecated":
            # handle may deprecated property
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$Header'.'|'.0.deprecated]", lpath_53 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Header'.'|'.0.deprecated]", lpath_53 if path is not None else None))
                return False
            continue
        elif prop == "allowEmptyValue":
            # handle may allowEmptyValue property
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$Header'.'|'.0.allowEmptyValue]", lpath_53 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Header'.'|'.0.allowEmptyValue]", lpath_53 if path is not None else None))
                return False
            continue
        elif prop == "style":
            # handle may style property
            # .'$Header'.'|'.0.style
            res = json_model_15(pval, lpath_53 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Style\" [.'$Header'.'|'.0.style]", lpath_53 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Header'.'|'.0.style]", lpath_53 if path is not None else None))
                return False
            continue
        elif prop == "explode":
            # handle may explode property
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$Header'.'|'.0.explode]", lpath_53 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Header'.'|'.0.explode]", lpath_53 if path is not None else None))
                return False
            continue
        elif prop == "allowReserved":
            # handle may allowReserved property
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [.'$Header'.'|'.0.allowReserved]", lpath_53 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Header'.'|'.0.allowReserved]", lpath_53 if path is not None else None))
                return False
            continue
        elif prop == "schema":
            # handle may schema property
            # .'$Header'.'|'.0.schema
            res = json_model_32(pval, lpath_53 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$Header'.'|'.0.schema]", lpath_53 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Header'.'|'.0.schema]", lpath_53 if path is not None else None))
                return False
            continue
        elif prop == "example":
            # handle may example property
            ...
            # handle may examples property
            # .'$Header'.'|'.0.examples
            res = _jm_obj_32(pval, lpath_53 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected element [.'$Header'.'|'.0.examples]", lpath_53 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$Header'.'|'.0.examples]", lpath_53 if path is not None else None))
                return False
            continue
        if prop.startswith("x-"):
            # handle 1 re props
...
def json_model_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Tag'.name]", lpath_55 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Tag'.description]", lpath_55 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$ExternalDocumentation\" [.'$Tag'.externalDocs]", lpath_55 if path is not None else None))
...
def json_model_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "$ref":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Reference'.'$ref']", lpath_56 if path is not None else None))
        ...
        if prop == "summary":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Reference'.summary]", lpath_56 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Reference'.description]", lpath_56 if path is not None else None))
...
def _jm_f_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Schema'.'$comment']", path))
    return res
...
def _jm_f_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$schema#Schema\" [.'$Schema'.'$defs'.'']", lpath_58 if path is not None else None))
            return False
    return True
...
def _jm_f_17(val: Jsonable, path: Path, rep: Report) -> bool:
    # .'$Schema'.'$schema'
    res: bool = isinstance(val, str) and (val == "https://json-schema.org/draft/2020-12/schema")
    if not res:
        rep is None or rep.append(("unexpected value for model \"_https://json-schema.org/draft/2020-12/schema\" [.'$Schema'.'$schema']", path))
    return res
...
def _jm_f_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Schema'.contentMediaType]", path))
    return res
...
def _jm_f_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$schema#stringArray\" [.'$Schema'.dependentRequired.'']", lpath_60 if path is not None else None))
            return False
    return True
...
def _jm_f_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$schema#Schema\" [.'$Schema'.dependentSchemas.'']", lpath_61 if path is not None else None))
            return False
    return True
...
def _jm_f_37(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_62 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$schema#Schema\" [.'$Schema'.patternProperties.'$REGEX']", lpath_62 if path is not None else None))
                return False
        else:
...
def _jm_f_38(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$schema#Schema\" [.'$Schema'.properties.'']", lpath_63 if path is not None else None))
            return False
    return True
...
def _jm_f_41(val: Jsonable, path: Path, rep: Report) -> bool:
    # .'$Schema'.type
    # .'$Schema'.type.'|'.0
    res: bool = json_model_52(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$schema#simpleTypes\" [.'$Schema'.type.'|'.0]", path))
        # .'$Schema'.type.'|'.1
        res = json_model_53(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$schema#simpleTypesArray\" [.'$Schema'.type.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def _jm_obj_33(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = isinstance(pval, str)
        if not res:
            rep is None or rep.append(("unexpected value for model \"\" [.'$Discriminator'.mapping.'']", lpath_65 if path is not None else None))
            return False
    return True
...
def json_model_33(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "propertyName":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Discriminator'.propertyName]", lpath_64 if path is not None else None))
        ...
        if prop == "mapping":
            ...
            # .'$Discriminator'.mapping
            res = _jm_obj_33(pval, lpath_64 if path is not None else None, rep)
            if not res:
...
def json_model_34(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$xml'.name]", lpath_66 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$xml'.namespace]", lpath_66 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$xml'.prefix]", lpath_66 if path is not None else None))
...
def json_model_35(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    # .'$SS-apikey'.type
    res: bool = isinstance(pval, str) and pval == "apiKey"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_apiKey\" [.'$SS-apikey'.type]", lpath if path is not None else None))
    ...
    res = isinstance(pval, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$SS-apikey'.name]", lpath if path is not None else None))
...
def json_model_36(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    lpath = (path + [ "type" ]) if path is not None else None
    # .'$SS-http'.type
    res: bool = isinstance(pval, str) and pval == "http"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_http\" [.'$SS-http'.type]", lpath if path is not None else None))
    ...
    res = isinstance(pval, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$SS-http'.scheme]", lpath if path is not None else None))
...
def json_model_37(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_http\" [.'$SS-http-bearer'.type]", lpath_67 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"/bearer/i\" [.'$SS-http-bearer'.scheme]", lpath_67 if path is not None else None))
        ...
        if prop == "bearerFormat":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$SS-http-bearer'.bearerFormat]", lpath_67 if path is not None else None))
...
def json_model_38(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    lpath = (path + [ "type" ]) if path is not None else None
    # .'$SS-oauth2'.type
    res: bool = isinstance(pval, str) and pval == "oauth2"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_oauth2\" [.'$SS-oauth2'.type]", lpath if path is not None else None))
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$OAuthFlows\" [.'$SS-oauth2'.flows]", lpath if path is not None else None))
...
def json_model_39(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    lpath = (path + [ "type" ]) if path is not None else None
    # .'$SS-oic'.type
    res: bool = isinstance(pval, str) and pval == "openIdConnect"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_openIdConnect\" [.'$SS-oic'.type]", lpath if path is not None else None))
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$URL\" [.'$SS-oic'.openIdConnectUrl]", lpath if path is not None else None))
...
def _jm_obj_34(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_apiKey\" [.'$SecurityScheme'.'|'.0.type]", lpath_68 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$SecurityScheme'.'|'.0.name]", lpath_68 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$SecurityScheme'.'|'.0.description]", lpath_68 if path is not None else None))
...
def _jm_obj_35(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            res = isinstance(pval, str) and pval == "http"
            if not res:
                rep is None or rep.append(("unexpected value for model \"_http\" [.'$SecurityScheme'.'|'.1.type]", lpath_69 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"/bearer/i\" [.'$SecurityScheme'.'|'.1.scheme]", lpath_69 if path is not None else None))
        ...
        if prop == "bearerFormat":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$SecurityScheme'.'|'.1.bearerFormat]", lpath_69 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$SecurityScheme'.'|'.1.description]", lpath_69 if path is not None else None))
...
def _jm_obj_36(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            res = isinstance(pval, str) and pval == "http"
            if not res:
                rep is None or rep.append(("unexpected value for model \"_http\" [.'$SecurityScheme'.'|'.2.type]", lpath_70 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$SecurityScheme'.'|'.2.scheme]", lpath_70 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$SecurityScheme'.'|'.2.description]", lpath_70 if path is not None else None))
...
def _jm_obj_37(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_oauth2\" [.'$SecurityScheme'.'|'.3.type]", lpath_71 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$OAuthFlows\" [.'$SecurityScheme'.'|'.3.flows]", lpath_71 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$SecurityScheme'.'|'.3.description]", lpath_71 if path is not None else None))
...
def _jm_obj_38(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_openIdConnect\" [.'$SecurityScheme'.'|'.4.type]", lpath_72 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$SecurityScheme'.'|'.4.openIdConnectUrl]", lpath_72 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$SecurityScheme'.'|'.4.description]", lpath_72 if path is not None else None))
...
def _jm_obj_39(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$SecurityScheme'.'|'.5.description]", lpath_73 if path is not None else None))
...
def json_model_41(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "implicit":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$OAuthFlow\" [.'$OAuthFlows'.implicit]", lpath_74 if path is not None else None))
            ...
            res = json_model_42(pval, lpath_74 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$OAuthFlow\" [.'$OAuthFlows'.password]", lpath_74 if path is not None else None))
            ...
            res = json_model_42(pval, lpath_74 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$OAuthFlow\" [.'$OAuthFlows'.clientCredentials]", lpath_74 if path is not None else None))
            ...
            res = json_model_42(pval, lpath_74 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$OAuthFlow\" [.'$OAuthFlows'.authorizationCode]", lpath_74 if path is not None else None))
...
def _jm_obj_40(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = isinstance(pval, str)
        if not res:
            rep is None or rep.append(("unexpected value for model \"\" [.'$OAuthFlow'.scopes.'']", lpath_76 if path is not None else None))
            return False
    return True
...
def json_model_42(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "authorizationUrl":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$OAuthFlow'.authorizationUrl]", lpath_75 if path is not None else None))
            ...
            res = is_valid_url(pval, lpath_75 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$OAuthFlow'.tokenUrl]", lpath_75 if path is not None else None))
            ...
            must_count += 1
            # .'$OAuthFlow'.scopes
            res = _jm_obj_40(pval, lpath_75 if path is not None else None, rep)
            if not res:
        ...
        if prop == "refreshUrl":
            ...
            res = is_valid_url(pval, lpath_75 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$OAuthFlow'.refreshUrl]", lpath_75 if path is not None else None))
    ...
    for prop, pval in val.items():
        ...
        if res:
            for arr_10_idx, arr_10_item in enumerate(pval):
                ...
                if not res:
                    rep is None or rep.append(("unexpected value for model \"\" [.'$SecurityRequirement'.''.0]", arr_10_lpath if (lpath_77 if path is not None else None) is not None else None))
                    break
        if not res:
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$OpenAPI\" [.]", path))
    return res
...
def json_model_52(val: Jsonable, path: Path, rep: Report) -> bool:
    # .'$schema#simpleTypes'
    res: bool = ((val is None or isinstance(val, (bool, int, float, str)))) and val in _jm_cst_6
    if not res:
...
def json_model_53(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_11_idx, arr_11_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$simpleTypes\" [.'$schema#simpleTypesArray'.'@'.0]", arr_11_lpath if path is not None else None))
                break
    if res:
        ival_0: int = len(val)
...
def json_model_54(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_12_idx, arr_12_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$schema#stringArray'.'@'.0]", arr_12_lpath if path is not None else None))
                break
    if res:
...
def json_model_57(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_13_idx, arr_13_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$schema#schemaArray'.'@'.0]", arr_13_lpath if path is not None else None))
                break
    if res:
        ival_1: int = len(val)
        res = ival_1 >= 1
...
def _jm_f_45(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$schema#ObjectSchema'.'$defs'.'']", lpath_80 if path is not None else None))
            return False
    return True
...
def _jm_f_46(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str) and (val == "https://json-schema.org/draft/2020-12/schema")
    if not res:
        rep is None or rep.append(("unexpected value for model \"_https://json-schema.org/draft/2020-12/schema\" [.'$schema#ObjectSchema'.'$schema']", path))
    return res
...
def _jm_f_52(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$stringArray\" [.'$schema#ObjectSchema'.dependentRequired.'']", lpath_82 if path is not None else None))
            return False
    return True
...
def _jm_f_53(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$schema#ObjectSchema'.dependentSchemas.'']", lpath_83 if path is not None else None))
            return False
    return True
...
def _jm_f_64(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = is_valid_regex(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$REGEX\" [.'$schema#ObjectSchema'.pattern]", path))
    return res
...
def _jm_f_65(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_84 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$schema#ObjectSchema'.patternProperties.'$REGEX']", lpath_84 if path is not None else None))
                return False
        else:
...
def _jm_f_66(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$schema#ObjectSchema'.properties.'']", lpath_85 if path is not None else None))
            return False
    return True
...
def check_model_init():
    ...
    if not initialized:
        ...
        json_model_32_map = {
            ...
            "contentMediaType": _jm_f_21,
            "contentSchema": json_model_60,
            "default": _jm_f_22,
            "dependentRequired": _jm_f_23,
            "dependentSchemas": _jm_f_24,
            "deprecated": _jm_f_25,
        ...
        json_model_59_map = {
            ...
            "const": _jm_f_48,
            "contains": json_model_60,
            "contentEncoding": _jm_f_49,
            "contentMediaType": _jm_f_50,
            "contentSchema": json_model_60,
            "default": _jm_f_51,
            "dependentRequired": _jm_f_52,
            "dependentSchemas": _jm_f_53,
            "deprecated": _jm_f_54,
            "description": _jm_f_55,
            "else": json_model_60,
            "enum": _jm_f_56,
            "examples": _jm_f_57,
            "exclusiveMaximum": _jm_f_58,
            "exclusiveMinimum": _jm_f_59,
            "format": _jm_f_60,
            "if": json_model_60,
            "items": json_model_60,
            "maxContains": json_model_55,
