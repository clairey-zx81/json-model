...
def _jm_f_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_0_idx, arr_0_item in enumerate(val):
            ...
            # .'$OpenAPI'.security.0
            res = _jm_obj_83(arr_0_item, arr_0_lpath if path is not None else None, rep)
            if not res:
...
def _jm_f_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_1_idx, arr_1_item in enumerate(val):
            ...
            # .'$OpenAPI'.servers.0
            res = _jm_obj_6(arr_1_item, arr_1_lpath if path is not None else None, rep)
            if not res:
...
def _jm_f_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_2_idx, arr_2_item in enumerate(val):
            ...
            # .'$OpenAPI'.tags.0
            res = _jm_obj_57(arr_2_item, arr_2_lpath if path is not None else None, rep)
            if not res:
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        # handle other props
        # .'$OpenAPI'.webhooks.''
        res = _jm_obj_21(pval, lpath_1 if path is not None else None, rep)
        if not res:
...
def _jm_obj_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = _jm_obj_47(pval, lpath_10 if path is not None else None, rep)
        if not res:
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_10 if path is not None else None, rep)
            if not res:
...
def _jm_obj_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = _jm_obj_48(pval, lpath_11 if path is not None else None, rep)
        if not res:
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_11 if path is not None else None, rep)
            if not res:
...
def _jm_obj_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_12 if path is not None else None, rep)
            if not res:
...
def _jm_obj_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            # .'$Components'.links.''.'|'.1
            res = _jm_obj_58(pval, lpath_13 if path is not None else None, rep)
            if not res:
...
def _jm_obj_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_14 if path is not None else None, rep)
            if not res:
...
def _jm_obj_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = _jm_obj_21(pval, lpath_15 if path is not None else None, rep)
        if not res:
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_15 if path is not None else None, rep)
            if not res:
...
def _jm_obj_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = _jm_obj_35(pval, lpath_16 if path is not None else None, rep)
        if not res:
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_16 if path is not None else None, rep)
            if not res:
...
def _jm_obj_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = _jm_obj_43(pval, lpath_17 if path is not None else None, rep)
        if not res:
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_17 if path is not None else None, rep)
            if not res:
...
def _jm_obj_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        # handle other props
        # .'$Components'.schemas.''
        res = _jm_obj_59(pval, lpath_18 if path is not None else None, rep)
        if not res:
...
def _jm_obj_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_19 if path is not None else None, rep)
            if not res:
    ...
    if res:
        for arr_4_idx, arr_4_item in enumerate(val):
            ...
            if not res:
                ...
                res = _jm_obj_58(arr_4_item, arr_4_lpath if path is not None else None, rep)
                if not res:
...
def _jm_f_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_5_idx, arr_5_item in enumerate(val):
            ...
            # .'$PathItem'.servers.0
            res = _jm_obj_22(arr_5_item, arr_5_lpath if path is not None else None, rep)
            if not res:
...
def _jm_obj_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_23 if path is not None else None, rep)
            if not res:
    ...
    if res:
        for arr_6_idx, arr_6_item in enumerate(val):
            ...
            if not res:
                ...
                res = _jm_obj_58(arr_6_item, arr_6_lpath if path is not None else None, rep)
                if not res:
...
def _jm_f_39(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_7_idx, arr_7_item in enumerate(val):
            ...
            res = _jm_obj_83(arr_7_item, arr_7_lpath if path is not None else None, rep)
            if not res:
...
def _jm_f_40(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_8_idx, arr_8_item in enumerate(val):
            ...
            # .'$Operation'.servers.0
            res = _jm_obj_6(arr_8_item, arr_8_lpath if path is not None else None, rep)
            if not res:
...
def _jm_obj_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = _jm_obj_48(pval, lpath_28 if path is not None else None, rep)
        if not res:
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_28 if path is not None else None, rep)
            if not res:
...
def _jm_obj_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = _jm_obj_37(pval, lpath_30 if path is not None else None, rep)
        if not res:
...
def _jm_obj_32(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = _jm_obj_48(pval, lpath_32 if path is not None else None, rep)
        if not res:
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_32 if path is not None else None, rep)
            if not res:
...
def _jm_obj_34(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        # handle other props
        # .'$Parameter'.'|'.1.content.''
        res = _jm_obj_37(pval, lpath_34 if path is not None else None, rep)
        if not res:
...
def _jm_obj_36(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        # handle other props
        # .'$RequestBody'.content.''
        res = _jm_obj_37(pval, lpath_36 if path is not None else None, rep)
        if not res:
...
def _jm_obj_38(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = _jm_obj_48(pval, lpath_38 if path is not None else None, rep)
        if not res:
        ...
        if not res:
            ...
            res = _jm_obj_58(pval, lpath_38 if path is not None else None, rep)
            if not res:
...
def _jm_obj_37(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "schema":
            ...
            # .'$MediaType'.schema
            res = _jm_obj_59(pval, lpath_37 if path is not None else None, rep)
            if not res:
...
def _jm_obj_41(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            # .'$Encoding'.headers.''.'|'.1
            res = _jm_obj_58(pval, lpath_41 if path is not None else None, rep)
            if not res:
...
def _jm_obj_42(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "default":
            ...
            if not res:
                # .'$Responses'.default.'|'.1
                res = _jm_obj_58(pval, lpath_42 if path is not None else None, rep)
                if not res:
...
def _jm_obj_44(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            # .'$Response'.headers.''.'|'.1
            res = _jm_obj_58(pval, lpath_44 if path is not None else None, rep)
            if not res:
...
def _jm_obj_45(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        # handle other props
        # .'$Response'.content.''
        res = _jm_obj_37(pval, lpath_45 if path is not None else None, rep)
        if not res:
...
def _jm_obj_46(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            # .'$Response'.links.''.'|'.1
            res = _jm_obj_58(pval, lpath_46 if path is not None else None, rep)
            if not res:
    ...
    for prop, pval in val.items():
        ...
        if json_model_26(prop, lpath_47 if path is not None else None, rep):
            ...
            if not res:
                ...
                res = _jm_obj_58(pval, lpath_47 if path is not None else None, rep)
                if not res:
...
def _jm_obj_49(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "operationId":
            ...
            # .'$Link'.'|'.1.server
            res = _jm_obj_6(pval, lpath_49 if path is not None else None, rep)
            if not res:
...
def _jm_obj_51(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "operationRef":
            ...
            # handle may server property
            # .'$Link'.'|'.0.server
            res = _jm_obj_6(pval, lpath_50 if path is not None else None, rep)
            if not res:
...
def _jm_obj_54(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        # handle other props
        # .'$Header'.'|'.1.content.''
        res = _jm_obj_37(pval, lpath_52 if path is not None else None, rep)
        if not res:
...
def _jm_obj_56(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        # .'$Header'.'|'.0.examples.''
        # .'$Header'.'|'.0.examples.''.'|'.0
        res = _jm_obj_48(pval, lpath_54 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected $Example [.'$Header'.'|'.0.examples.''.'|'.0]", lpath_54 if path is not None else None))
        if not res:
            # .'$Header'.'|'.0.examples.''.'|'.1
            res = _jm_obj_58(pval, lpath_54 if path is not None else None, rep)
            if not res:
...
def _jm_obj_57(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            # .'$Tag'.externalDocs
            res = _jm_obj_24(pval, lpath_55 if path is not None else None, rep)
            if not res:
...
def _jm_obj_72(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            must_count += 1
            # .'$SS-oauth2'.flows
            res = _jm_obj_80(pval, lpath_70 if path is not None else None, rep)
            if not res:
...
def _jm_obj_74(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            res = isinstance(pval, str) and pval == "apiKey"
            if not res:
                rep is None or rep.append(("unexpected _apiKey [.'$SecurityScheme'.'|'.0.type]", lpath_72 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.0.type]", lpath_72 if path is not None else None))
                return False
        elif prop == "name":
            # handle must name property
            must_count += 1
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected string [.'$SecurityScheme'.'|'.0.name]", lpath_72 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.0.name]", lpath_72 if path is not None else None))
                return False
        elif prop == "in":
            # handle must in property
            must_count += 1
            ...
            if not res:
                rep is None or rep.append(("value not in enum [.'$SecurityScheme'.'|'.0.in.'|']", lpath_72 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.0.in]", lpath_72 if path is not None else None))
                return False
        elif prop == "description":
            # handle may description property
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected string [.'$SecurityScheme'.'|'.0.description]", lpath_72 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$SecurityScheme'.'|'.0.description]", lpath_72 if path is not None else None))
                return False
        else:
            rep is None or rep.append(("unexpected prop [.'$SecurityScheme'.'|'.0]", lpath_72 if path is not None else None))
            return False
    if must_count != 3:
        if rep is not None:
            if not "in" in val:
...
def _jm_obj_75(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            res = isinstance(pval, str) and pval == "http"
            if not res:
                rep is None or rep.append(("unexpected _http [.'$SecurityScheme'.'|'.1.type]", lpath_73 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.1.type]", lpath_73 if path is not None else None))
                return False
        elif prop == "scheme":
            # handle must scheme property
            must_count += 1
            ...
            # "/bearer/i"
            res = isinstance(pval, str) and _jm_re_3(pval, lpath_73 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected /bearer/i [.'$SecurityScheme'.'|'.1.scheme]", lpath_73 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.1.scheme]", lpath_73 if path is not None else None))
                return False
        elif prop == "bearerFormat":
            # handle may bearerFormat property
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected string [.'$SecurityScheme'.'|'.1.bearerFormat]", lpath_73 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$SecurityScheme'.'|'.1.bearerFormat]", lpath_73 if path is not None else None))
                return False
        elif prop == "description":
            # handle may description property
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected string [.'$SecurityScheme'.'|'.1.description]", lpath_73 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$SecurityScheme'.'|'.1.description]", lpath_73 if path is not None else None))
                return False
        else:
            rep is None or rep.append(("unexpected prop [.'$SecurityScheme'.'|'.1]", lpath_73 if path is not None else None))
            return False
    if must_count != 2:
        if rep is not None:
            if not "scheme" in val:
...
def _jm_obj_76(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            res = isinstance(pval, str) and pval == "http"
            if not res:
                rep is None or rep.append(("unexpected _http [.'$SecurityScheme'.'|'.2.type]", lpath_74 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.2.type]", lpath_74 if path is not None else None))
                return False
        elif prop == "scheme":
            # handle must scheme property
            must_count += 1
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected string [.'$SecurityScheme'.'|'.2.scheme]", lpath_74 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.2.scheme]", lpath_74 if path is not None else None))
                return False
        elif prop == "description":
            # handle may description property
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected string [.'$SecurityScheme'.'|'.2.description]", lpath_74 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$SecurityScheme'.'|'.2.description]", lpath_74 if path is not None else None))
                return False
        else:
            rep is None or rep.append(("unexpected prop [.'$SecurityScheme'.'|'.2]", lpath_74 if path is not None else None))
            return False
    if must_count != 2:
        if rep is not None:
            if not "scheme" in val:
...
def _jm_obj_77(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            res = isinstance(pval, str) and pval == "oauth2"
            if not res:
                rep is None or rep.append(("unexpected _oauth2 [.'$SecurityScheme'.'|'.3.type]", lpath_75 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.3.type]", lpath_75 if path is not None else None))
                return False
        elif prop == "flows":
            # handle must flows property
            must_count += 1
            # .'$SecurityScheme'.'|'.3.flows
            res = _jm_obj_80(pval, lpath_75 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected $OAuthFlows [.'$SecurityScheme'.'|'.3.flows]", lpath_75 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.3.flows]", lpath_75 if path is not None else None))
                return False
        elif prop == "description":
            # handle may description property
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected string [.'$SecurityScheme'.'|'.3.description]", lpath_75 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$SecurityScheme'.'|'.3.description]", lpath_75 if path is not None else None))
                return False
        else:
            rep is None or rep.append(("unexpected prop [.'$SecurityScheme'.'|'.3]", lpath_75 if path is not None else None))
            return False
    if must_count != 2:
        if rep is not None:
            if not "flows" in val:
...
def _jm_obj_78(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            res = isinstance(pval, str) and pval == "openIdConnect"
            if not res:
                rep is None or rep.append(("unexpected _openIdConnect [.'$SecurityScheme'.'|'.4.type]", lpath_76 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.4.type]", lpath_76 if path is not None else None))
                return False
        elif prop == "openIdConnectUrl":
            # handle must openIdConnectUrl property
            must_count += 1
            ...
            if not res:
                rep is None or rep.append(("unexpected $URL [.'$SecurityScheme'.'|'.4.openIdConnectUrl]", lpath_76 if path is not None else None))
                rep is None or rep.append(("invalid mandatory prop value [.'$SecurityScheme'.'|'.4.openIdConnectUrl]", lpath_76 if path is not None else None))
                return False
        elif prop == "description":
            # handle may description property
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected string [.'$SecurityScheme'.'|'.4.description]", lpath_76 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$SecurityScheme'.'|'.4.description]", lpath_76 if path is not None else None))
                return False
        else:
            rep is None or rep.append(("unexpected prop [.'$SecurityScheme'.'|'.4]", lpath_76 if path is not None else None))
            return False
    if must_count != 2:
        if rep is not None:
            if not "openIdConnectUrl" in val:
...
def _jm_obj_79(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected string [.'$SecurityScheme'.'|'.5.description]", lpath_77 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$SecurityScheme'.'|'.5.description]", lpath_77 if path is not None else None))
                return False
        elif prop.startswith("x-"):
            # handle 1 re props
            # .'$SecurityScheme'.'|'.5.'/^x-/'
            res = True
            if not res:
                rep is None or rep.append(("unexpected $ANY [.'$SecurityScheme'.'|'.5.'/^x-/']", lpath_77 if path is not None else None))
                return False
        else:
            rep is None or rep.append(("unexpected prop [.'$SecurityScheme'.'|'.5]", lpath_77 if path is not None else None))
            return False
    return True
...
def _jm_obj_81(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "authorizationUrl":
            ...
            if not res:
                rep is None or rep.append(("unexpected element [.'$OAuthFlow'.scopes]", lpath_79 if path is not None else None))
