...
def _jm_f_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$OpenAPI'.webhooks]", path))
    return res
...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "openapi":
            ...
            if not res:
                rep is None or rep.append(("unexpected REGEX [.'$OpenAPI'.openapi]", lpath_0 if path is not None else None))
            if not res:
...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$OpenAPI']", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if prop == "title":
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_2 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$Info']", lpath_2 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$Info'.'/^x\\-.*$/'
...
def json_model_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Info']", path))
    return res
...
def json_model_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Contact']", path))
    return res
...
def json_model_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if not res:
            rep is None or rep.append(("not an expected object [.'$License'.'|'.0]", path))
        if not res:
            # .'$License'.'|'.1
            res = _jm_obj_4(val, path, rep)
            if not res:
                rep is None or rep.append(("not an expected object [.'$License'.'|'.1]", path))
        if res:
...
def _jm_obj_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "url":
            ...
            if not res:
                rep is None or rep.append(("not an expected object [.'$Server'.variables]", lpath_6 if path is not None else None))
            if not res:
...
def json_model_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Server']", path))
    return res
...
def json_model_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$ServerVariable']", path))
    return res
...
def _jm_f_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components'.callbacks]", path))
    return res
...
def _jm_f_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components'.examples]", path))
    return res
...
def _jm_f_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components'.headers]", path))
    return res
...
def _jm_f_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components'.links]", path))
    return res
...
def _jm_f_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components'.parameters]", path))
    return res
...
def _jm_f_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components'.pathItems]", path))
    return res
...
def _jm_f_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components'.requestBodies]", path))
    return res
...
def _jm_f_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components'.responses]", path))
    return res
...
def _jm_f_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components'.schemas]", path))
    return res
...
def _jm_f_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components'.securitySchemes]", path))
    return res
...
def json_model_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Components']", path))
    return res
...
def json_model_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Paths']", path))
    return res
...
def json_model_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$PathItem']", path))
    return res
...
def _jm_f_36(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Operation'.callbacks]", path))
    return res
...
def json_model_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Operation']", path))
    return res
...
def json_model_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$ExternalDocumentation']", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_25_map.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_25 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$parameterShare']", lpath_25 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$parameterShare'.'/^x\\-.*$/'
...
def json_model_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$parameterShare']", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_26 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$commonParameter']", lpath_26 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$commonParameter'.'/^x\\-.*$/'
...
def json_model_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$commonParameter']", path))
    return res
...
def _jm_f_58(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$parameterSchemaOnly'.examples]", path))
    return res
...
def json_model_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$parameterSchemaOnly']", path))
    return res
...
def _jm_obj_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "content":
            ...
            if not res:
                rep is None or rep.append(("not an expected object [.'$parameterContentOnly'.content]", lpath_29 if path is not None else None))
            if not res:
...
def json_model_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$parameterContentOnly']", path))
    return res
...
def _jm_f_63(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Parameter'.'|'.1.content]", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_31 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$Parameter'.'|'.1]", lpath_31 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$Parameter'.'|'.1.'/^x\\-.*$/'
...
def _jm_f_72(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Parameter'.'|'.0.examples]", path))
    return res
...
def json_model_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if not res:
            rep is None or rep.append(("not an expected object [.'$Parameter'.'|'.0]", path))
        if not res:
            # .'$Parameter'.'|'.1
            res = _jm_obj_31(val, path, rep)
            if not res:
                rep is None or rep.append(("not an expected object [.'$Parameter'.'|'.1]", path))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_35(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            if not res:
                rep is None or rep.append(("not an expected object [.'$RequestBody'.content]", lpath_35 if path is not None else None))
            if not res:
...
def json_model_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$RequestBody']", path))
    return res
...
def _jm_f_77(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$MediaType'.encoding]", path))
    return res
...
def _jm_f_79(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$MediaType'.examples]", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_37_map.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_37 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$MediaType']", lpath_37 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$MediaType'.'/^x\\-.*$/'
...
def json_model_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$MediaType']", path))
    return res
...
def _jm_f_84(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Encoding'.headers]", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_40_map.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_40 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$Encoding']", lpath_40 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$Encoding'.'/^x\\-.*$/'
...
def json_model_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Encoding']", path))
    return res
...
def json_model_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Responses']", path))
    return res
...
def _jm_f_86(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Response'.content]", path))
    return res
...
def _jm_f_88(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Response'.headers]", path))
    return res
...
def _jm_f_89(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Response'.links]", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_43_map.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_43 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$Response']", lpath_43 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$Response'.'/^x\\-.*$/'
...
def json_model_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Response']", path))
    return res
...
def json_model_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Callback']", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_48_map.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_48 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$Example']", lpath_48 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$Example'.'/^x\\-.*$/'
...
def json_model_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Example']", path))
    return res
...
def _jm_f_95(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Link'.'|'.1.parameters]", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if prop == "operationId":
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_49 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$Link'.'|'.1]", lpath_49 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$Link'.'|'.1.'/^x\\-.*$/'
...
def _jm_f_99(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Link'.'|'.0.parameters]", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if prop == "operationRef":
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_50 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$Link'.'|'.0]", lpath_50 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$Link'.'|'.0.'/^x\\-.*$/'
...
def json_model_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if not res:
            rep is None or rep.append(("not an expected object [.'$Link'.'|'.0]", path))
        if not res:
            # .'$Link'.'|'.1
            res = _jm_obj_49(val, path, rep)
            if not res:
                rep is None or rep.append(("not an expected object [.'$Link'.'|'.1]", path))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_f_103(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Header'.'|'.1.content]", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_53_map.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_51 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$Header'.'|'.1]", lpath_51 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$Header'.'|'.1.'/^x\\-.*$/'
...
def _jm_f_112(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Header'.'|'.0.examples]", path))
    return res
...
def json_model_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if not res:
            rep is None or rep.append(("not an expected object [.'$Header'.'|'.0]", path))
        if not res:
            # .'$Header'.'|'.1
            res = _jm_obj_53(val, path, rep)
            if not res:
                rep is None or rep.append(("not an expected object [.'$Header'.'|'.1]", path))
        if res:
            rep is None or rep.clear()
        else:
...
def json_model_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Tag']", path))
    return res
...
def json_model_31(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Reference']", path))
    return res
...
def _jm_f_119(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Schema'.'$defs']", path))
    return res
...
def _jm_f_125(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Schema'.'$vocabulary']", path))
    return res
...
def _jm_f_135(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Schema'.dependentRequired]", path))
    return res
...
def _jm_f_136(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Schema'.dependentSchemas]", path))
    return res
...
def _jm_f_164(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Schema'.patternProperties]", path))
    return res
...
def _jm_obj_66(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "propertyName":
            ...
            if not res:
                rep is None or rep.append(("not an expected object [.'$Discriminator'.mapping]", lpath_64 if path is not None else None))
            if not res:
...
def json_model_34(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Discriminator']", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_68_map.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_66 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$XML']", lpath_66 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$XML'.'/^x\\-.*$/'
...
def json_model_35(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$XML']", path))
    return res
...
def json_model_36(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$SecurityScheme']", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_70_map.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_68 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$OAuthFlows']", lpath_68 if path is not None else None))
                return False
        elif _jm_re_1(prop):
            # handle 1 re props
            # .'$OAuthFlows'.'/^x\\-.*$/'
...
def json_model_37(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$OAuthFlows']", path))
    return res
...
def _jm_obj_71(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "authorizationUrl":
            ...
            if not res:
                rep is None or rep.append(("not an expected object [.'$OAuthFlow'.scopes]", lpath_69 if path is not None else None))
            if not res:
...
def json_model_38(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$OAuthFlow']", path))
    return res
...
def json_model_39(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$SecurityRequirement']", path))
    return res
...
def json_model_40(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$Extension']", path))
    return res
...
def _jm_f_195(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$schema#ObjectSchema'.'$defs']", path))
    return res
...
def _jm_f_201(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$schema#ObjectSchema'.'$vocabulary']", path))
    return res
...
def _jm_f_211(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$schema#ObjectSchema'.dependentRequired]", path))
    return res
...
def _jm_f_212(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$schema#ObjectSchema'.dependentSchemas]", path))
    return res
