...
static bool _jm_obj_26(const json_t* val, Path* path, Report* rep)
{
    ...
    if (must_count != 2)
    {
        if (rep) jm_report_add_entry(rep, "missing must prop [$.'$commonParameter']", path);
        return false;
    }
    return true;
}
...
static bool _jm_obj_31(const json_t* val, Path* path, Report* rep)
{
    ...
    if (must_count != 2)
    {
        if (rep) jm_report_add_entry(rep, "missing must prop [$.'$Parameter'.'|'.1]", path);
        return false;
    }
    return true;
}
...
static bool _jm_obj_33(const json_t* val, Path* path, Report* rep)
{
    ...
    if (must_count != 2)
    {
        if (rep) jm_report_add_entry(rep, "missing must prop [$.'$Parameter'.'|'.0]", path);
        return false;
    }
    return true;
}
