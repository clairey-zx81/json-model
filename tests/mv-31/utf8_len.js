...
function json_model_1(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "2")
        {
            ...
            // .'2'
            res = typeof pval == 'string' && pval == "Àß"
            if (! res)
            {
        ...
        else if (prop == "3")
        {
            ...
            // .'3'
            res = typeof pval == 'string' && pval == "Àßç"
            if (! res)
            {
        ...
        else if (prop == "4")
        {
            ...
            // .'4'
            res = typeof pval == 'string' && pval == "ÀßçΔ"
            if (! res)
            {
        ...
        else if (prop == "6")
        {
            ...
            // .'6'
            res = typeof pval == 'string' && pval == "ÀßçΔ€ᵳ"
            if (! res)
            {
        ...
        else if (prop == "7")
        {
            ...
            // .'7'
            res = typeof pval == 'string' && pval == "ÀßçΔ€ᵳǧ"
            if (! res)
            {
        ...
        else if (prop == "8")
        {
            ...
            // .'8'
            res = typeof pval == 'string' && pval == "ÀßçΔ€ᵳǧℏ"
            if (! res)
            {
        ...
        else if (prop == "9")
        {
            ...
            // .'9'
            res = typeof pval == 'string' && pval == "ÀßçΔ€ᵳǧℏı"
            if (! res)
            {
