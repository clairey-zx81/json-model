...
sub json_model_1($$$)
{
    ...
    {
        push @$rep, ["missing mandatory prop <li> [.]", $path] if defined $rep;
        return 0;
    }
    ...
    unless ($res)
    {
        push @$rep, ["not a 0 loose int [.li]", defined $path ? $lpath : undef] if defined $rep;
        push @$rep, ["unexpected value for mandatory prop <li> [.]", defined $path ? $lpath : undef] if defined $rep;
        return 0;
    }
    return 1;
}
