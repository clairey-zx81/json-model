...
bool json_model_1(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    {
        rep?.add(["missing mandatory prop <si> [.]", path]);
        return false;
    }
    ...
    if (! res)
    {
        rep?.add(["not a 0 strict int [.si]", (path != null ? lpath : null)]);
        rep?.add(["unexpected value for mandatory prop <si> [.]", (path != null ? lpath : null)]);
        return false;
    }
    return true;
}
