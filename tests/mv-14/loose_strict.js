...
function json_model_5(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$loose']", path])
    }
    return res;
}
...
function json_model_6(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$strict']", path])
    }
    return res;
}
...
function json_model_4(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$combined']", path])
    }
    return res;
}
