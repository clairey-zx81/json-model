...
public class and_00 extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> and_00_map_pmap;
    ...
    public boolean json_model_1(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.startsWith("d"))
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected value for model \"\" [.'/^d/']", (path != null ? lpath_0 : null));
                    return false;
                }
            }
            else if (prop.startsWith("e"))
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not a 1 strict int [.'/^e/']", (path != null ? lpath_0 : null));
                    return false;
                }
            }
            else
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            and_00_map_pmap = new HashMap<String, Checker>();
            and_00_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        ...
        {
            super.free();
            and_00_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return and_00_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return and_00_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new and_00();
        Main.main("and_00", checker, VERSION, args);
    }
}
