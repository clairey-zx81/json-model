...
sub json_model_1($$$)
{
    ...
    if ($res)
    {
        ...
        if ($res)
        {
            ...
            {
                push @$rep, ["not a 1 strict int [.'&'.1.'\@']", $path] if defined $rep;
            }
            if ($res)
            {
                # .'&'.2
                ...
                if ($res)
                {
                    my $ival_0 = $val;
                    $res = ($ival_0 % 5) == 0;
                    push @$rep, ["constraints failed [.'&'.2]", $path] if defined $rep and not $res;
                }
                else
                {
                    push @$rep, ["not a 1 strict int [.'&'.2.'\@']", $path] if defined $rep;
                }
            }
        }
    }
