...
char *CHECK_init(void)
{
    if (!initialized)
    {
        ...
        _jm_cst_0[0] = (constant_t) { cst_is_integer, { .i = 200 } };
        _jm_cst_0[1] = (constant_t) { cst_is_string, { .s = "Susie" } };
        _jm_cst_0[2] = (constant_t) { cst_is_null, { .s = NULL } };
        _jm_cst_0[3] = (constant_t) { cst_is_float, { .f = 3.1415927 } };
