...
public class uniq_3 extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> uniq_3_map_pmap;
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            uniq_3_map_pmap = new HashMap<String, Checker>();
            uniq_3_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        ...
        {
            super.free();
            uniq_3_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return uniq_3_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return uniq_3_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new uniq_3();
        Main.main("uniq_3", checker, VERSION, args);
    }
}
