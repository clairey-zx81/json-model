...
public class enum_02 extends ModelChecker
{
    static public final String VERSION = "2";

    Set<Object> _jm_cst_0_set;
    Set<Object> _jm_cst_1_set;
    public Map<String, Checker> enum_02_map_pmap;
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            enum_02_map_pmap = new HashMap<String, Checker>();
            enum_02_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
            enum_02_map_pmap.put("p1", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_2(o, p, r);} });
            enum_02_map_pmap.put("p2", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_3(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        if (initialized)
        {
            ...
            _jm_cst_0_set = null;
            _jm_cst_1_set = null;
            enum_02_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return enum_02_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return enum_02_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new enum_02();
        Main.main("enum_02", checker, VERSION, args);
    }
}
