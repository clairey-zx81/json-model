...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "a":
            ...
            # .'|'.1.a
            res = False
            rep is None or rep.append(("unexpected value for model \"$NONE\" [.'|'.1.a]", lpath_0 if path is not None else None))
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "b":
            ...
            # .'|'.0.b
            res = False
            rep is None or rep.append(("unexpected value for model \"$NONE\" [.'|'.0.b]", lpath_1 if path is not None else None))
