        ...
        else if (unlikely(jm_str_eq_8(prop, 0x697274656d6f6567LL) && jm_str_eq_3(prop + 8, 0x00007365)))
        {
            ...
            if (likely(res))
            {
                ...
                json_array_foreach(pval, arr_13_idx, arr_13_item)
                {
                    ...
                    res = json_model_11(arr_13_item, ((path ? &lpath_6 : NULL) ? &arr_13_lpath : NULL), rep);
                    if (unlikely(! res))
                    {
                        if (rep) jm_report_add_entry(rep, "unexpected value for model \"$geometry\" [.'$GeometryCollection'.geometries.0]", ((path ? &lpath_6 : NULL) ? &arr_13_lpath : NULL));
                        break;
                    }
                }
            }
        ...
        if (unlikely(jm_str_eq_5(prop, 0x00000000786f6262LL)))
        {
            ...
            if (likely(res))
            {
                ...
                json_array_foreach(pval, arr_14_idx, arr_14_item)
                {
                    ...
                    if (unlikely(! res))
                    {
                        if (rep) jm_report_add_entry(rep, "not a -1.0 loose float [.'$GeometryCollection'.bbox.0]", ((path ? &lpath_6 : NULL) ? &arr_14_lpath : NULL));
                        break;
                    }
                }
            }
...
static bool json_model_13(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (unlikely(jm_str_eq_5(prop, 0x0000000065707974LL)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"Feature\" [.'$Feature'.type]", (path ? &lpath_7 : NULL));
        ...
        else if (unlikely(jm_str_eq_8(prop, 0x797274656d6f6567LL) && jm_str_eq_0(prop + 8)))
        {
            ...
            if (unlikely(! res))
            {
                ...
                if (unlikely(! res))
                {
                    if (rep) jm_report_add_entry(rep, "unexpected value for model \"$geometry\" [.'$Feature'.geometry.'|'.1]", (path ? &lpath_7 : NULL));
                    // .'$Feature'.geometry.'|'.2
                    res = json_model_12(pval, (path ? &lpath_7 : NULL), rep);
                    if (unlikely(! res))
                    {
                        if (rep) jm_report_add_entry(rep, "unexpected value for model \"$GeometryCollection\" [.'$Feature'.geometry.'|'.2]", (path ? &lpath_7 : NULL));
                    }
                }
            }
            if (likely(res))
        ...
        if (unlikely(jm_str_eq_3(prop, 0x00006469)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"\" [.'$Feature'.id.'|'.0]", (path ? &lpath_7 : NULL));
                // .'$Feature'.id.'|'.1
        ...
        else if (unlikely(jm_str_eq_5(prop, 0x00000000786f6262LL)))
        {
            ...
            if (likely(res))
            {
                ...
                json_array_foreach(pval, arr_15_idx, arr_15_item)
                {
                    ...
                    if (unlikely(! res))
                    {
                        if (rep) jm_report_add_entry(rep, "not a -1.0 loose float [.'$Feature'.bbox.0]", ((path ? &lpath_7 : NULL) ? &arr_15_lpath : NULL));
                        break;
                    }
                }
            }
        ...
        else if (unlikely(jm_str_eq_8(prop, 0x7365727574616566LL) && jm_str_eq_0(prop + 8)))
        {
            ...
            if (likely(res))
            {
                ...
                json_array_foreach(pval, arr_16_idx, arr_16_item)
                {
                    ...
                    res = json_model_13(arr_16_item, ((path ? &lpath_8 : NULL) ? &arr_16_lpath : NULL), rep);
                    if (unlikely(! res))
                    {
                        if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Feature\" [.'$FeatureCollection'.features.0]", ((path ? &lpath_8 : NULL) ? &arr_16_lpath : NULL));
                        break;
                    }
                }
            }
        ...
        if (unlikely(jm_str_eq_5(prop, 0x00000000786f6262LL)))
        {
            ...
            if (likely(res))
            {
                ...
                json_array_foreach(pval, arr_17_idx, arr_17_item)
                {
                    ...
                    if (unlikely(! res))
                    {
                        if (rep) jm_report_add_entry(rep, "not a -1.0 loose float [.'$FeatureCollection'.bbox.0]", ((path ? &lpath_8 : NULL) ? &arr_17_lpath : NULL));
                        break;
                    }
                }
            }
...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_map_0_tab[0] = (jm_constmap_t) { (jm_constant_t) { 6, { .s = "Point" } }, json_model_5 };
        _jm_map_0_tab[1] = (jm_constmap_t) { (jm_constant_t) { 11, { .s = "MultiPoint" } }, json_model_6 };
        _jm_map_0_tab[2] = (jm_constmap_t) { (jm_constant_t) { 11, { .s = "LineString" } }, json_model_7 };
        _jm_map_0_tab[3] = (jm_constmap_t) { (jm_constant_t) { 16, { .s = "MultiLineString" } }, json_model_8 };
        _jm_map_0_tab[4] = (jm_constmap_t) { (jm_constant_t) { 8, { .s = "Polygon" } }, json_model_9 };
        _jm_map_0_tab[5] = (jm_constmap_t) { (jm_constant_t) { 13, { .s = "MultiPolygon" } }, json_model_10 };
