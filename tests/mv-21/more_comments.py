...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_0_idx, arr_0_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Pp\" [.'$Qq'.0]", arr_0_lpath if path is not None else None))
                break
    if not res:
...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "p":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Pp\" [.o.p]", lpath_1 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Qq\" [.o.q]", lpath_1 if path is not None else None))
