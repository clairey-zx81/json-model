...
bool json_model_1(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    if (res)
    {
        ...
        if (res)
        {
            ...
            if (res)
            {
                ...
                if (res)
                {
                    ...
                    if (! res)
                    {
                        rep?.add(["unexpected string [.3]", (path != null ? lpath_0 : null)]);
                    }
                }
                else
                {
                    rep?.add(["not a 0.0 strict float [.2]", (path != null ? lpath_0 : null)]);
                }
            }
            else
            {
        ...
        {
            rep?.add(["not a bool [.0]", (path != null ? lpath_0 : null)]);
        }
    }
    if (! res)
    {
