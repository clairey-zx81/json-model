...
def json_model_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"_a\" [.'$oA'.t]", lpath if path is not None else None))
...
def json_model_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"_d\" [.'$oL'.t]", lpath if path is not None else None))
