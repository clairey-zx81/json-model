...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected string [.'|'.5.f]", path))
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(pval, str)
    if not res:
        rep is None or rep.append(("unexpected string [.'|'.4.e]", path))
...
def _jm_obj_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(pval, str)
    if not res:
        rep is None or rep.append(("unexpected string [.'|'.3.d]", path))
...
def _jm_obj_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(pval, str)
    if not res:
        rep is None or rep.append(("unexpected string [.'|'.2.f]", path))
...
def _jm_obj_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(pval, str)
    if not res:
        rep is None or rep.append(("unexpected string [.'|'.1.e]", path))
...
def _jm_obj_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(pval, str)
    if not res:
        rep is None or rep.append(("unexpected string [.'|'.0.d]", path))
