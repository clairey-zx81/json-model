...
bool json_model_1(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    if (res)
    {
        for (var arr_0_idx = 0; arr_0_idx < val.length; arr_0_idx++)
        {
            ...
            // .0
            res = (arr_0_item is List);
            if (res)
            {
                for (var arr_1_idx = 0; arr_1_idx < arr_0_item.length; arr_1_idx++)
                {
                    var arr_1_item = arr_0_item[arr_1_idx];
                    List<dynamic>? arr_1_lpath = ((path != null ? arr_0_lpath : null) != null ? [...?(path != null ? arr_0_lpath : null), arr_1_idx] : null);
                    // .0.0
                    res = (arr_1_item is String);
                    if (! res)
                    {
                        rep?.add(["unexpected string [.0.0]", ((path != null ? arr_0_lpath : null) != null ? arr_1_lpath : null)]);
                        break;
                    }
                }
            }
            if (! res)
            {
                rep?.add(["not array or unexpected array [.0]", (path != null ? arr_0_lpath : null)]);
                break;
            }
        }
    }
