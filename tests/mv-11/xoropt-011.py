...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"=10\" [.'|'.0.a]", lpath if path is not None else None))
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"=1\" [.'|'.1.a]", lpath if path is not None else None))
...
def _jm_obj_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"=0\" [.'|'.2.a]", lpath if path is not None else None))
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        tag_0: Jsonable
        if (tag_0 := val.get("a", UNDEFINED)) != UNDEFINED:
