...
static bool json_model_1(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (likely(jm_str_eq_6(prop, 0x0000006569766f6dLL)))
        {
            ...
            {
                json_t * tag_0;
                if (likely((tag_0 = json_object_get(pval, "t")) != NULL))
                {
...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_map_0_tab[0] = (jm_constmap_t) { (jm_constant_t) { 3, { .s = "fr" } }, _jm_obj_0 };
        _jm_map_0_tab[1] = (jm_constmap_t) { (jm_constant_t) { 3, { .s = "en" } }, _jm_obj_1 };
        _jm_map_0_tab[2] = (jm_constmap_t) { (jm_constant_t) { 3, { .s = "de" } }, _jm_obj_2 };
        _jm_map_0_tab[3] = (jm_constmap_t) { (jm_constant_t) { 3, { .s = "ru" } }, _jm_obj_3 };
