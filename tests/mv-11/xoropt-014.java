...
public class xoropt_014 extends ModelChecker
{
    ...
    public boolean _jm_obj_3(Object val, Path path, Report rep)
    {
        ...
        if (! res)
        {
            if (rep != null) rep.addEntry("unexpected de [.movie.'|'.2.t]", path);
        ...
        if (! res)
        {
            if (rep != null) rep.addEntry("unexpected string [.movie.'|'.2.Title]", path);
            if (rep != null) rep.addEntry("unexpected value for mandatory prop <Title> [.movie.'|'.2]", path);
            return false;
        }
        return true;
    }
    ...
    public boolean _jm_obj_4(Object val, Path path, Report rep)
    {
        ...
        if (! res)
        {
            if (rep != null) rep.addEntry("unexpected ru [.movie.'|'.3.t]", path);
            if (rep != null) rep.addEntry("unexpected value for mandatory prop <t> [.movie.'|'.3]", path);
            return false;
        }
        ...
        if (! res)
        {
            if (rep != null) rep.addEntry("unexpected string [.movie.'|'.3.suti]", path);
            if (rep != null) rep.addEntry("unexpected value for mandatory prop <suti> [.movie.'|'.3]", path);
            return false;
        }
        return true;
    }
