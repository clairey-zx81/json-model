...
function json_model_3(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$X']", path])
    }
    return res;
}
...
function json_model_4(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$Y']", path])
    }
    return res;
}
...
function json_model_5(val, path, rep)
{
    ...
    if (res)
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["not an expected object [.'$E'.'|'.0]", path])
        }
        if (! res)
        {
            // .'$E'.'|'.1
            ...
            if (! res)
            {
                rep !== null && rep.push(["not an expected object [.'$E'.'|'.1]", path])
            }
        }
        if (res)
        {
