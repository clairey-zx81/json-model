...
static bool _jm_f_0(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected =10 [$.'|'.0.a]", path);
    }
    return res;
}
...
static bool _jm_f_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected =1 [$.'|'.1.a]", path);
    }
    return res;
}
...
static bool _jm_f_2(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected =0 [$.'|'.2.a]", path);
    }
    return res;
}
...
static bool json_model_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        json_t * tag_0 = json_object_get(val, "a");
        if (tag_0 != NULL)
        {
            ...
            {
                res = false;
                if (rep) jm_report_add_entry(rep, "tag a value not found [$.'|']", path);
            }
        }
        else
        {
            res = false;
            if (rep) jm_report_add_entry(rep, "tag prop a is missing [$.'|']", path);
        }
    }
    else
    {
...
char *CHECK_init(void)
{
    if (!initialized)
    {
        ...
        _jm_map_0_tab[0] = (constmap_t) { (constant_t) { cst_is_integer, { .i = 10 } }, _jm_obj_0 };
        _jm_map_0_tab[1] = (constmap_t) { (constant_t) { cst_is_integer, { .i = 1 } }, _jm_obj_1 };
        _jm_map_0_tab[2] = (constmap_t) { (constant_t) { cst_is_integer, { .i = 0 } }, _jm_obj_2 };
