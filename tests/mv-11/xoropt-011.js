...
function _jm_obj_0(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["unexpected =10 [.'|'.0.a]", (path ? lpath : null)])
...
function _jm_obj_1(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["unexpected =1 [.'|'.1.a]", (path ? lpath : null)])
...
function _jm_obj_2(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["unexpected =0 [.'|'.2.a]", (path ? lpath : null)])
