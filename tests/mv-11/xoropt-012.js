...
function _jm_obj_0(val, path, rep)
{
    ...
    for(const [prop, pval] of Object.entries(val))
    {
        ...
        {
            rep !== null && rep.push(["unexpected prop [.'|'.4]", (path ? lpath_0 : null)])
            return false;
        }
    }
    if (must_count != 1)
...
function _jm_obj_1(val, path, rep)
{
    ...
    for(const [prop, pval] of Object.entries(val))
    {
        ...
        {
            rep !== null && rep.push(["unexpected prop [.'|'.3]", (path ? lpath_1 : null)])
            return false;
        }
    }
    if (must_count != 1)
...
function _jm_obj_4(val, path, rep)
{
    ...
    for(const [prop, pval] of Object.entries(val))
    {
        ...
        {
            rep !== null && rep.push(["unexpected prop [.'|'.0]", (path ? lpath_4 : null)])
            return false;
        }
    }
    if (must_count != 1)
