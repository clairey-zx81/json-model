...
public class json_schema_draft_next_fuzzy extends ModelChecker
{
    ...
    public boolean _jm_obj_10(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (! res)
            {
                if (rep != null) rep.addEntry("not a bool [.'$schema#ObjectSchema'.dependencies.''.'|'.0]", (path != null ? lpath_9 : null));
            }
            if (! res)
            {
                // .'$schema#ObjectSchema'.dependencies.''.'|'.1
                res = json_model_17(pval, (path != null ? lpath_9 : null), rep);
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected $ObjectSchema [.'$schema#ObjectSchema'.dependencies.''.'|'.1]", (path != null ? lpath_9 : null));
                }
                if (! res)
                {
                    ...
                    if (! res)
                    {
                        if (rep != null) rep.addEntry("unexpected $stringArray [.'$schema#ObjectSchema'.dependencies.''.'|'.2]", (path != null ? lpath_9 : null));
                    }
                }
            }
            if (res)
