...
RETURNS TEXT STRICT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  map JSONB := JSONB '{"":"json_model_1","URI-REFERENCE":"json_model_2","core":"_jm_obj_0","meta":"_jm_obj_3","content":"_jm_obj_4","unevaluated":"_jm_obj_5","format":"_jm_obj_6","simpleTypes":"json_model_8","simpleTypesArray":"json_model_9","stringArray":"json_model_10","nonNegativeInteger":"json_model_11","validation":"_jm_obj_7","schemaArray":"json_model_13","applicator":"_jm_obj_9","ObjectSchema":"_jm_obj_15","Schema":"json_model_16"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
