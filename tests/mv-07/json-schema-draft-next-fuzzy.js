...
function _jm_obj_9(val, path, rep)
{
    ...
    for(const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected object [.'$schema#ObjectSchema'.propertyDependencies.'']", (path ? lpath_9 : null)])
        }
        if (! res)
        {
            return false;
...
function _jm_f_49(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["unexpected object [.'$schema#ObjectSchema'.propertyDependencies]", path])
    }
    return res;
}
