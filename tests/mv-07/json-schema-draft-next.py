...
def json_model_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$unevaluated']", path))
    return res
...
def _jm_obj_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("not an expected object [.'$applicator'.propertyDependencies.'']", lpath_13 if path is not None else None))
        if not res:
            return False
    return True
...
def _jm_f_49(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$applicator'.propertyDependencies]", path))
    return res
...
def _jm_obj_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("not an expected object [.'$ObjectSchema'.propertyDependencies.'']", lpath_22 if path is not None else None))
        if not res:
            return False
    return True
...
def _jm_f_99(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$ObjectSchema'.propertyDependencies]", path))
    return res
