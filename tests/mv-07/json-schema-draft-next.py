...
def _jm_f_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$REGEX\" [.'$validation'.pattern]", path))
    return res
...
def _jm_f_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_11 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$applicator'.patternProperties.'$REGEX']", lpath_11 if path is not None else None))
                return False
        else:
...
def _jm_obj_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$applicator'.propertyDependencies.''.'']", lpath_14 if path is not None else None))
            return False
    return True
...
def _jm_f_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        # handle other props
        # .'$applicator'.propertyDependencies.''
        res = _jm_obj_2(pval, lpath_13 if path is not None else None, rep)
        if not res:
...
def _jm_f_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.'$defs'.'']", lpath_16 if path is not None else None))
            return False
    return True
...
def _jm_f_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$URI\" [.'$ObjectSchema'.'$schema']", path))
    return res
...
def _jm_f_35(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = is_valid_regex(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$REGEX\" [.'$ObjectSchema'.pattern]", path))
    return res
...
def _jm_f_36(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_20 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.patternProperties.'$REGEX']", lpath_20 if path is not None else None))
                return False
        else:
...
def _jm_obj_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.propertyDependencies.''.'']", lpath_23 if path is not None else None))
            return False
    return True
...
def check_model_init():
    ...
    if not initialized:
        ...
        json_model_15_map = {
            ...
            "enum": _jm_f_27,
            "examples": _jm_f_28,
            "exclusiveMaximum": _jm_f_29,
            "exclusiveMinimum": _jm_f_30,
            "format": _jm_f_31,
            "if": json_model_16,
            "items": json_model_16,
            "maxContains": json_model_11,
