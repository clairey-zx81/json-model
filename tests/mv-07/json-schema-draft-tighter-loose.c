...
static bool _jm_f_34(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "unexpected $Null [.'$tight#Array'.items.'|'.1]", path);
        }
        if (! res)
        {
            // .'$tight#Array'.items.'|'.2
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Bool [.'$tight#Array'.items.'|'.2]", path);
            }
            if (! res)
            {
                // .'$tight#Array'.items.'|'.3
                ...
                if (! res)
                {
                    if (rep) jm_report_add_entry(rep, "unexpected $Const [.'$tight#Array'.items.'|'.3]", path);
                }
                if (! res)
                {
                    // .'$tight#Array'.items.'|'.4
                    ...
                    if (! res)
                    {
                        if (rep) jm_report_add_entry(rep, "unexpected $Enum [.'$tight#Array'.items.'|'.4]", path);
                    }
                    if (! res)
                    {
                        // .'$tight#Array'.items.'|'.5
                        ...
                        if (! res)
                        {
                            if (rep) jm_report_add_entry(rep, "unexpected $Integer [.'$tight#Array'.items.'|'.5]", path);
                        }
                        if (! res)
                        {
                            // .'$tight#Array'.items.'|'.6
                            ...
                            if (! res)
                            {
                                if (rep) jm_report_add_entry(rep, "unexpected $Number [.'$tight#Array'.items.'|'.6]", path);
                            }
                            if (! res)
                            {
                                // .'$tight#Array'.items.'|'.7
                                ...
                                if (! res)
                                {
                                    if (rep) jm_report_add_entry(rep, "unexpected $String [.'$tight#Array'.items.'|'.7]", path);
                                }
                                if (! res)
                                {
                                    // .'$tight#Array'.items.'|'.8
                                    ...
                                    if (! res)
                                    {
                                        if (rep) jm_report_add_entry(rep, "unexpected $Array [.'$tight#Array'.items.'|'.8]", path);
                                    }
                                    if (! res)
                                    {
                                        // .'$tight#Array'.items.'|'.9
                                        ...
                                        if (! res)
                                        {
                                            if (rep) jm_report_add_entry(rep, "unexpected $Object [.'$tight#Array'.items.'|'.9]", path);
                                        }
                                        if (! res)
                                        {
                                            ...
                                            if (! res)
                                            {
                                                if (rep) jm_report_add_entry(rep, "unexpected $AllOf [.'$tight#Array'.items.'|'.10]", path);
                                            }
                                            if (! res)
                                            {
                                                ...
                                                if (! res)
                                                {
                                                    if (rep) jm_report_add_entry(rep, "unexpected $AnyOf [.'$tight#Array'.items.'|'.11]", path);
                                                }
                                                if (! res)
                                                {
                                                    ...
                                                    if (! res)
                                                    {
                                                        if (rep) jm_report_add_entry(rep, "unexpected $OneOf [.'$tight#Array'.items.'|'.12]", path);
                                                    }
                                                    if (! res)
                                                    {
                                                        ...
                                                        if (! res)
                                                        {
                                                            if (rep) jm_report_add_entry(rep, "unexpected $Ref [.'$tight#Array'.items.'|'.13]", path);
                                                        }
                                                        if (! res)
                                                        {
                                                            ...
                                                            if (! res)
                                                            {
                                                                if (rep) jm_report_add_entry(rep, "unexpected $metas [.'$tight#Array'.items.'|'.14]", path);
                                                            }
                                                            if (! res)
                                                            {
                                                                ...
                                                                if (! res)
                                                                {
                                                                    if (rep) jm_report_add_entry(rep, "unexpected $EnumString [.'$tight#Array'.items.'|'.15]", path);
                                                                }
                                                                if (! res)
                                                                {
                                                                    ...
                                                                    if (! res)
                                                                    {
                                                                        if (rep) jm_report_add_entry(rep, "unexpected $EnumNum [.'$tight#Array'.items.'|'.16]", path);
                                                                    }
                                                                    if (! res)
                                                                    {
                                                                        ...
                                                                        if (! res)
                                                                        {
                                                                            if (rep) jm_report_add_entry(rep, "unexpected $EnumInt [.'$tight#Array'.items.'|'.17]", path);
                                                                        }
                                                                        if (! res)
                                                                        {
                                                                            ...
                                                                            if (! res)
                                                                            {
                                                                                if (rep) jm_report_add_entry(rep, "unexpected $ConstString [.'$tight#Array'.items.'|'.18]", path);
                                                                            }
                                                                            if (! res)
                                                                            {
                                                                                ...
                                                                                if (! res)
                                                                                {
                                                                                    if (rep) jm_report_add_entry(rep, "unexpected $ConstNum [.'$tight#Array'.items.'|'.19]", path);
                                                                                }
                                                                                if (! res)
                                                                                {
                                                                                    ...
                                                                                    if (! res)
                                                                                    {
                                                                                        if (rep) jm_report_add_entry(rep, "unexpected $ConstInt [.'$tight#Array'.items.'|'.20]", path);
                                                                                    }
                                                                                    if (! res)
                                                                                    {
                                                                                        ...
                                                                                        if (! res)
                                                                                        {
                                                                                            if (rep) jm_report_add_entry(rep, "unexpected $ConstBool [.'$tight#Array'.items.'|'.21]", path);
                                                                                        }
                                                                                        if (! res)
                                                                                        {
                                                                                            ...
                                                                                            if (! res)
                                                                                            {
                                                                                                if (rep) jm_report_add_entry(rep, "unexpected $schemaArray [.'$tight#Array'.items.'|'.22]", path);
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
...
static bool json_model_26(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "unexpected $Null [.'$tight#Schema'.'|'.1]", path);
        }
        if (! res)
        {
            // .'$tight#Schema'.'|'.2
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Bool [.'$tight#Schema'.'|'.2]", path);
            }
            if (! res)
            {
                // .'$tight#Schema'.'|'.3
                ...
                if (! res)
                {
                    if (rep) jm_report_add_entry(rep, "unexpected $Const [.'$tight#Schema'.'|'.3]", path);
                }
                if (! res)
                {
                    // .'$tight#Schema'.'|'.4
                    ...
                    if (! res)
                    {
                        if (rep) jm_report_add_entry(rep, "unexpected $Enum [.'$tight#Schema'.'|'.4]", path);
                    }
                    if (! res)
                    {
                        // .'$tight#Schema'.'|'.5
                        ...
                        if (! res)
                        {
                            if (rep) jm_report_add_entry(rep, "unexpected $Integer [.'$tight#Schema'.'|'.5]", path);
                        }
                        if (! res)
                        {
                            // .'$tight#Schema'.'|'.6
                            ...
                            if (! res)
                            {
                                if (rep) jm_report_add_entry(rep, "unexpected $Number [.'$tight#Schema'.'|'.6]", path);
                            }
                            if (! res)
                            {
                                // .'$tight#Schema'.'|'.7
                                ...
                                if (! res)
                                {
                                    if (rep) jm_report_add_entry(rep, "unexpected $String [.'$tight#Schema'.'|'.7]", path);
                                }
                                if (! res)
                                {
                                    // .'$tight#Schema'.'|'.8
                                    ...
                                    if (! res)
                                    {
                                        if (rep) jm_report_add_entry(rep, "unexpected $Array [.'$tight#Schema'.'|'.8]", path);
                                    }
                                    if (! res)
                                    {
                                        // .'$tight#Schema'.'|'.9
                                        ...
                                        if (! res)
                                        {
                                            if (rep) jm_report_add_entry(rep, "unexpected $Object [.'$tight#Schema'.'|'.9]", path);
                                        }
                                        if (! res)
                                        {
                                            // .'$tight#Schema'.'|'.10
                                            ...
                                            if (! res)
                                            {
                                                if (rep) jm_report_add_entry(rep, "unexpected $AllOf [.'$tight#Schema'.'|'.10]", path);
                                            }
                                            if (! res)
                                            {
                                                // .'$tight#Schema'.'|'.11
                                                ...
                                                if (! res)
                                                {
                                                    if (rep) jm_report_add_entry(rep, "unexpected $AnyOf [.'$tight#Schema'.'|'.11]", path);
                                                }
                                                if (! res)
                                                {
                                                    // .'$tight#Schema'.'|'.12
                                                    ...
                                                    if (! res)
                                                    {
                                                        if (rep) jm_report_add_entry(rep, "unexpected $OneOf [.'$tight#Schema'.'|'.12]", path);
                                                    }
                                                    if (! res)
                                                    {
                                                        // .'$tight#Schema'.'|'.13
                                                        ...
                                                        if (! res)
                                                        {
                                                            if (rep) jm_report_add_entry(rep, "unexpected $Ref [.'$tight#Schema'.'|'.13]", path);
                                                        }
                                                        if (! res)
                                                        {
                                                            // .'$tight#Schema'.'|'.14
                                                            ...
                                                            if (! res)
                                                            {
                                                                if (rep) jm_report_add_entry(rep, "unexpected $metas [.'$tight#Schema'.'|'.14]", path);
                                                            }
                                                            if (! res)
                                                            {
                                                                // .'$tight#Schema'.'|'.15
                                                                ...
                                                                if (! res)
                                                                {
                                                                    if (rep) jm_report_add_entry(rep, "unexpected $EnumString [.'$tight#Schema'.'|'.15]", path);
                                                                }
                                                                if (! res)
                                                                {
                                                                    // .'$tight#Schema'.'|'.16
                                                                    ...
                                                                    if (! res)
                                                                    {
                                                                        if (rep) jm_report_add_entry(rep, "unexpected $EnumNum [.'$tight#Schema'.'|'.16]", path);
                                                                    }
                                                                    if (! res)
                                                                    {
                                                                        // .'$tight#Schema'.'|'.17
                                                                        ...
                                                                        if (! res)
                                                                        {
                                                                            if (rep) jm_report_add_entry(rep, "unexpected $EnumInt [.'$tight#Schema'.'|'.17]", path);
                                                                        }
                                                                        if (! res)
                                                                        {
                                                                            // .'$tight#Schema'.'|'.18
                                                                            ...
                                                                            if (! res)
                                                                            {
                                                                                if (rep) jm_report_add_entry(rep, "unexpected $ConstString [.'$tight#Schema'.'|'.18]", path);
                                                                            }
                                                                            if (! res)
                                                                            {
                                                                                // .'$tight#Schema'.'|'.19
                                                                                ...
                                                                                if (! res)
                                                                                {
                                                                                    if (rep) jm_report_add_entry(rep, "unexpected $ConstNum [.'$tight#Schema'.'|'.19]", path);
                                                                                }
                                                                                if (! res)
                                                                                {
                                                                                    // .'$tight#Schema'.'|'.20
                                                                                    ...
                                                                                    if (! res)
                                                                                    {
                                                                                        if (rep) jm_report_add_entry(rep, "unexpected $ConstInt [.'$tight#Schema'.'|'.20]", path);
                                                                                    }
                                                                                    if (! res)
                                                                                    {
                                                                                        // .'$tight#Schema'.'|'.21
                                                                                        ...
                                                                                        if (! res)
                                                                                        {
                                                                                            if (rep) jm_report_add_entry(rep, "unexpected $ConstBool [.'$tight#Schema'.'|'.21]", path);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
