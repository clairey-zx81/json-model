...
static bool json_model_27(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (res)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#RootSchema'.'&'.0]", path);
        }
        if (res)
        {
            // .'$tight#RootSchema'.'&'.1
...
static bool _jm_f_1(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#metas'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_5(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#metas'.definitions]", path);
    }
    return res;
}
...
static bool json_model_11(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#metas']", path);
    }
    return res;
}
...
static bool _jm_f_11(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#String'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_15(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#String'.definitions]", path);
    }
    return res;
}
...
static bool json_model_12(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#String']", path);
    }
    return res;
}
...
static bool _jm_f_25(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Array'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_30(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Array'.definitions]", path);
    }
    return res;
}
...
static bool json_model_13(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Array']", path);
    }
    return res;
}
...
static bool _jm_f_41(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Object'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_46(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Object'.definitions]", path);
    }
    return res;
}
...
static bool _jm_obj_13(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        {
            if (rep) jm_report_add_entry(rep, "unexpected prop [.'$tight#Object'.patternProperties]", (path ? &lpath_13 : NULL));
            return false;
        }
    }
    return true;
...
static bool _jm_f_50(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Object'.patternProperties]", path);
    }
    return res;
}
...
static bool _jm_f_51(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Object'.properties]", path);
    }
    return res;
}
...
static bool json_model_14(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Object']", path);
    }
    return res;
}
...
static bool _jm_f_55(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Integer'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_59(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Integer'.definitions]", path);
    }
    return res;
}
...
static bool json_model_15(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Integer']", path);
    }
    return res;
}
...
static bool _jm_f_67(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Number'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_71(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Number'.definitions]", path);
    }
    return res;
}
...
static bool json_model_16(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Number']", path);
    }
    return res;
}
...
static bool _jm_f_79(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Bool'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_83(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Bool'.definitions]", path);
    }
    return res;
}
...
static bool json_model_17(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Bool']", path);
    }
    return res;
}
...
static bool _jm_f_89(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Null'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_93(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Null'.definitions]", path);
    }
    return res;
}
...
static bool json_model_18(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Null']", path);
    }
    return res;
}
...
static bool _jm_f_99(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#AllOf'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_103(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#AllOf'.definitions]", path);
    }
    return res;
}
...
static bool json_model_19(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#AllOf']", path);
    }
    return res;
}
...
static bool _jm_f_109(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#AnyOf'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_113(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#AnyOf'.definitions]", path);
    }
    return res;
}
...
static bool json_model_20(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#AnyOf']", path);
    }
    return res;
}
...
static bool _jm_f_119(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#OneOf'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_123(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#OneOf'.definitions]", path);
    }
    return res;
}
...
static bool json_model_21(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#OneOf']", path);
    }
    return res;
}
...
static bool _jm_f_129(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Enum'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_133(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Enum'.definitions]", path);
    }
    return res;
}
...
static bool json_model_22(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Enum']", path);
    }
    return res;
}
...
static bool _jm_f_139(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Const'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_143(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Const'.definitions]", path);
    }
    return res;
}
...
static bool json_model_23(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Const']", path);
    }
    return res;
}
...
static bool _jm_f_149(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Ref'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_153(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Ref'.definitions]", path);
    }
    return res;
}
...
static bool json_model_24(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#Ref']", path);
    }
    return res;
}
...
static bool _jm_f_159(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#EnumString'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_163(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#EnumString'.definitions]", path);
    }
    return res;
}
...
static bool json_model_28(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#EnumString']", path);
    }
    return res;
}
...
static bool _jm_f_169(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#EnumNum'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_173(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#EnumNum'.definitions]", path);
    }
    return res;
}
...
static bool json_model_29(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#EnumNum']", path);
    }
    return res;
}
...
static bool _jm_f_179(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#EnumInt'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_183(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#EnumInt'.definitions]", path);
    }
    return res;
}
...
static bool json_model_30(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#EnumInt']", path);
    }
    return res;
}
...
static bool _jm_f_189(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstString'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_193(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstString'.definitions]", path);
    }
    return res;
}
...
static bool json_model_31(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstString']", path);
    }
    return res;
}
...
static bool _jm_f_199(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstNum'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_203(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstNum'.definitions]", path);
    }
    return res;
}
...
static bool json_model_32(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstNum']", path);
    }
    return res;
}
...
static bool _jm_f_209(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstInt'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_213(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstInt'.definitions]", path);
    }
    return res;
}
...
static bool json_model_33(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstInt']", path);
    }
    return res;
}
...
static bool _jm_f_219(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstBool'.'$defs']", path);
    }
    return res;
}
...
static bool _jm_f_223(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstBool'.definitions]", path);
    }
    return res;
}
...
static bool json_model_34(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$tight#ConstBool']", path);
    }
    return res;
}
