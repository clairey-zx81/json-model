...
static jm_propmap_t _jm_obj_9_map_tab[16];
...
static jm_propmap_t _jm_obj_15_map_tab[58];
...
static bool json_model_7(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$unevaluated']", path);
    }
    return res;
}
...
static bool _jm_obj_13(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "not an expected object [.'$applicator'.propertyDependencies.'']", (path ? &lpath_13 : NULL));
        }
        if (! res)
        {
            return false;
...
static bool _jm_f_49(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$applicator'.propertyDependencies]", path);
    }
    return res;
}
...
static bool _jm_obj_22(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "not an expected object [.'$ObjectSchema'.propertyDependencies.'']", (path ? &lpath_22 : NULL));
        }
        if (! res)
        {
            return false;
...
static bool _jm_f_99(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$ObjectSchema'.propertyDependencies]", path);
    }
    return res;
}
...
char *CHECK_init(void)
{
    if (!initialized)
    {
        ...
        _jm_obj_9_map_tab[13] = (jm_propmap_t) { "propertyDependencies", _jm_f_49 };
        _jm_obj_9_map_tab[14] = (jm_propmap_t) { "propertyNames", _jm_f_50 };
        _jm_obj_9_map_tab[15] = (jm_propmap_t) { "then", _jm_f_51 };
        jm_sort_propmap(_jm_obj_9_map_tab, 16);
        _jm_obj_15_map_tab[0] = (jm_propmap_t) { "$anchor", _jm_f_52 };
        _jm_obj_15_map_tab[1] = (jm_propmap_t) { "$comment", _jm_f_53 };
        _jm_obj_15_map_tab[2] = (jm_propmap_t) { "$defs", _jm_f_54 };
        _jm_obj_15_map_tab[3] = (jm_propmap_t) { "$dynamicAnchor", _jm_f_55 };
        _jm_obj_15_map_tab[4] = (jm_propmap_t) { "$dynamicRef", _jm_f_56 };
        _jm_obj_15_map_tab[5] = (jm_propmap_t) { "$id", _jm_f_57 };
        _jm_obj_15_map_tab[6] = (jm_propmap_t) { "$ref", _jm_f_58 };
        _jm_obj_15_map_tab[7] = (jm_propmap_t) { "$schema", _jm_f_59 };
        _jm_obj_15_map_tab[8] = (jm_propmap_t) { "$vocabulary", _jm_f_60 };
        _jm_obj_15_map_tab[9] = (jm_propmap_t) { "additionalProperties", _jm_f_61 };
        _jm_obj_15_map_tab[10] = (jm_propmap_t) { "allOf", _jm_f_62 };
        _jm_obj_15_map_tab[11] = (jm_propmap_t) { "anyOf", _jm_f_63 };
        _jm_obj_15_map_tab[12] = (jm_propmap_t) { "const", _jm_f_64 };
        _jm_obj_15_map_tab[13] = (jm_propmap_t) { "contains", _jm_f_65 };
        _jm_obj_15_map_tab[14] = (jm_propmap_t) { "contentEncoding", _jm_f_66 };
        _jm_obj_15_map_tab[15] = (jm_propmap_t) { "contentMediaType", _jm_f_67 };
        _jm_obj_15_map_tab[16] = (jm_propmap_t) { "contentSchema", _jm_f_68 };
        _jm_obj_15_map_tab[17] = (jm_propmap_t) { "default", _jm_f_69 };
        _jm_obj_15_map_tab[18] = (jm_propmap_t) { "dependentRequired", _jm_f_70 };
        _jm_obj_15_map_tab[19] = (jm_propmap_t) { "dependentSchemas", _jm_f_71 };
        _jm_obj_15_map_tab[20] = (jm_propmap_t) { "deprecated", _jm_f_72 };
        _jm_obj_15_map_tab[21] = (jm_propmap_t) { "description", _jm_f_73 };
        _jm_obj_15_map_tab[22] = (jm_propmap_t) { "else", _jm_f_74 };
        _jm_obj_15_map_tab[23] = (jm_propmap_t) { "enum", _jm_f_75 };
        _jm_obj_15_map_tab[24] = (jm_propmap_t) { "examples", _jm_f_76 };
        _jm_obj_15_map_tab[25] = (jm_propmap_t) { "exclusiveMaximum", _jm_f_77 };
        _jm_obj_15_map_tab[26] = (jm_propmap_t) { "exclusiveMinimum", _jm_f_78 };
        _jm_obj_15_map_tab[27] = (jm_propmap_t) { "format", _jm_f_79 };
        _jm_obj_15_map_tab[28] = (jm_propmap_t) { "if", _jm_f_80 };
        _jm_obj_15_map_tab[29] = (jm_propmap_t) { "items", _jm_f_81 };
        _jm_obj_15_map_tab[30] = (jm_propmap_t) { "maxContains", _jm_f_82 };
        _jm_obj_15_map_tab[31] = (jm_propmap_t) { "maxItems", _jm_f_83 };
        _jm_obj_15_map_tab[32] = (jm_propmap_t) { "maxLength", _jm_f_84 };
        _jm_obj_15_map_tab[33] = (jm_propmap_t) { "maxProperties", _jm_f_85 };
        _jm_obj_15_map_tab[34] = (jm_propmap_t) { "maximum", _jm_f_86 };
        _jm_obj_15_map_tab[35] = (jm_propmap_t) { "minContains", _jm_f_87 };
        _jm_obj_15_map_tab[36] = (jm_propmap_t) { "minItems", _jm_f_88 };
        _jm_obj_15_map_tab[37] = (jm_propmap_t) { "minLength", _jm_f_89 };
        _jm_obj_15_map_tab[38] = (jm_propmap_t) { "minProperties", _jm_f_90 };
        _jm_obj_15_map_tab[39] = (jm_propmap_t) { "minimum", _jm_f_91 };
        _jm_obj_15_map_tab[40] = (jm_propmap_t) { "multipleOf", _jm_f_92 };
        _jm_obj_15_map_tab[41] = (jm_propmap_t) { "not", _jm_f_93 };
        _jm_obj_15_map_tab[42] = (jm_propmap_t) { "oneOf", _jm_f_94 };
        _jm_obj_15_map_tab[43] = (jm_propmap_t) { "pattern", _jm_f_95 };
        _jm_obj_15_map_tab[44] = (jm_propmap_t) { "patternProperties", _jm_f_96 };
        _jm_obj_15_map_tab[45] = (jm_propmap_t) { "prefixItems", _jm_f_97 };
        _jm_obj_15_map_tab[46] = (jm_propmap_t) { "properties", _jm_f_98 };
        _jm_obj_15_map_tab[47] = (jm_propmap_t) { "propertyDependencies", _jm_f_99 };
        _jm_obj_15_map_tab[48] = (jm_propmap_t) { "propertyNames", _jm_f_100 };
        _jm_obj_15_map_tab[49] = (jm_propmap_t) { "readOnly", _jm_f_101 };
        _jm_obj_15_map_tab[50] = (jm_propmap_t) { "required", _jm_f_102 };
        _jm_obj_15_map_tab[51] = (jm_propmap_t) { "then", _jm_f_103 };
        _jm_obj_15_map_tab[52] = (jm_propmap_t) { "title", _jm_f_104 };
        _jm_obj_15_map_tab[53] = (jm_propmap_t) { "type", _jm_f_105 };
        _jm_obj_15_map_tab[54] = (jm_propmap_t) { "unevaluatedItems", _jm_f_106 };
        _jm_obj_15_map_tab[55] = (jm_propmap_t) { "unevaluatedProperties", _jm_f_107 };
        _jm_obj_15_map_tab[56] = (jm_propmap_t) { "uniqueItems", _jm_f_108 };
        _jm_obj_15_map_tab[57] = (jm_propmap_t) { "writeOnly", _jm_f_109 };
        ...
        check_model_map_tab[6] = (jm_propmap_t) { "unevaluated", json_model_7 };
