...
export function check_model_init()
{
    if (! initialized)
    {
        ...
        _jm_map_0.set("null", _jm_obj_29)
        _jm_map_0.set("boolean", _jm_obj_26)
        _jm_map_0.set("integer", _jm_obj_20)
        _jm_map_0.set("number", _jm_obj_23)
        _jm_map_0.set("string", _jm_obj_9)
        _jm_map_0.set("array", _jm_obj_12)
        _jm_map_0.set("object", _jm_obj_15)
        ...
        check_model_map.set("String", _jm_obj_9)
        check_model_map.set("Array", _jm_obj_12)
        check_model_map.set("Object", _jm_obj_15)
        check_model_map.set("Integer", _jm_obj_20)
        check_model_map.set("Number", _jm_obj_23)
        check_model_map.set("Bool", _jm_obj_26)
        check_model_map.set("Null", _jm_obj_29)
        check_model_map.set("AllOf", _jm_obj_32)
        check_model_map.set("AnyOf", _jm_obj_35)
        check_model_map.set("OneOf", _jm_obj_38)
        check_model_map.set("Enum", _jm_obj_41)
        check_model_map.set("Const", _jm_obj_44)
        check_model_map.set("Ref", _jm_obj_47)
