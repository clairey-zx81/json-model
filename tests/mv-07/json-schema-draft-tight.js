                                                ...
                                                if (! res)
                                                {
                                                    ...
                                                    if (! res)
                                                    {
                                                        ...
                                                        if (! res)
                                                        {
                                                            ...
                                                            if (! res)
                                                            {
                                                                rep !== null && rep.push(["unexpected $DynRef [.'$arrayKeywords'.items.'|'.14]", path])
                                                            }
                                                            if (! res)
                                                            {
                                                                ...
                                                                if (! res)
                                                                {
                                                                    rep !== null && rep.push(["unexpected $metas [.'$arrayKeywords'.items.'|'.15]", path])
                                                                }
                                                                if (! res)
                                                                {
                                                                    ...
                                                                    if (! res)
                                                                    {
                                                                        rep !== null && rep.push(["unexpected $schemaArray [.'$arrayKeywords'.items.'|'.16]", path])
                                                                    }
                                                                }
                                                            }
                                                        }
                                                ...
                                                if (! res)
                                                {
                                                    ...
                                                    if (! res)
                                                    {
                                                        ...
                                                        if (! res)
                                                        {
                                                            ...
                                                            if (! res)
                                                            {
                                                                rep !== null && rep.push(["unexpected $DynRef [.'$Array'.items.'|'.14]", path])
                                                            }
                                                            if (! res)
                                                            {
                                                                // .'$Array'.items.'|'.15
                                                                ...
                                                                if (! res)
                                                                {
                                                                    rep !== null && rep.push(["unexpected $metas [.'$Array'.items.'|'.15]", path])
                                                                }
                                                                if (! res)
                                                                {
                                                                    // .'$Array'.items.'|'.16
                                                                    ...
                                                                    if (! res)
                                                                    {
                                                                        rep !== null && rep.push(["unexpected $schemaArray [.'$Array'.items.'|'.16]", path])
                                                                    }
                                                                }
                                                            }
                                                        }
                                                ...
                                                if (! res)
                                                {
                                                    ...
                                                    if (! res)
                                                    {
                                                        ...
                                                        if (! res)
                                                        {
                                                            ...
                                                            if (! res)
                                                            {
                                                                rep !== null && rep.push(["unexpected $DynRef [.'$Schema'.'|'.14]", path])
                                                            }
                                                            if (! res)
                                                            {
                                                                // .'$Schema'.'|'.15
                                                                ...
                                                                if (! res)
                                                                {
                                                                    rep !== null && rep.push(["unexpected $metas [.'$Schema'.'|'.15]", path])
                                                                }
                                                            }
                                                        }
                                                    }
