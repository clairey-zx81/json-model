...
static bool _jm_f_18(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$schema#ObjectSchema'.definitions]", path);
    }
    return res;
}
...
static bool _jm_f_19(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$schema#ObjectSchema'.dependencies]", path);
    }
    return res;
}
...
static bool _jm_obj_9(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "not an expected object [.'$schema#ObjectSchema'.propertyDependencies.'']", (path ? &lpath_9 : NULL));
        }
        if (! res)
        {
            return false;
...
static bool _jm_f_49(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$schema#ObjectSchema'.propertyDependencies]", path);
    }
    return res;
}
