...
static INLINE bool _jm_obj_10(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "not a bool [.'$schema#ObjectSchema'.dependencies.''.'|'.0]", (path ? &lpath_9 : NULL));
        }
        if (! res)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $ObjectSchema [.'$schema#ObjectSchema'.dependencies.''.'|'.1]", (path ? &lpath_9 : NULL));
            }
            if (! res)
            {
                ...
                if (! res)
                {
                    if (rep) jm_report_add_entry(rep, "unexpected $stringArray [.'$schema#ObjectSchema'.dependencies.''.'|'.2]", (path ? &lpath_9 : NULL));
                }
            }
        }
        if (res)
