...
def _jm_f_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$objectKeywords'.patternProperties]", path))
    return res
...
def _jm_f_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$objectKeywords'.properties]", path))
    return res
...
def _jm_f_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$metas'.'$vocabulary']", path))
    return res
...
def _jm_f_37(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$String'.'$vocabulary']", path))
    return res
...
def _jm_f_57(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Array'.'$vocabulary']", path))
    return res
...
def _jm_f_80(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Object'.'$vocabulary']", path))
    return res
...
def _jm_f_104(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Integer'.'$vocabulary']", path))
    return res
...
def _jm_f_122(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Number'.'$vocabulary']", path))
    return res
...
def _jm_f_140(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Bool'.'$vocabulary']", path))
    return res
...
def _jm_f_156(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Null'.'$vocabulary']", path))
    return res
...
def _jm_f_172(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$AllOf'.'$vocabulary']", path))
    return res
...
def _jm_f_188(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$AnyOf'.'$vocabulary']", path))
    return res
...
def _jm_f_204(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$OneOf'.'$vocabulary']", path))
    return res
...
def _jm_f_220(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Enum'.'$vocabulary']", path))
    return res
...
def _jm_f_236(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Const'.'$vocabulary']", path))
    return res
...
def _jm_f_252(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Ref'.'$vocabulary']", path))
    return res
...
def _jm_f_264(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$DynRef'.'$defs']", path))
    return res
...
def _jm_f_268(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$DynRef'.'$vocabulary']", path))
    return res
...
def _jm_f_270(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$DynRef'.definitions]", path))
    return res
...
def json_model_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$DynRef']", path))
    return res
