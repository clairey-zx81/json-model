                                                ...
                                                if not res:
                                                    ...
                                                    if not res:
                                                        ...
                                                        if not res:
                                                            ...
                                                            if not res:
                                                                rep is None or rep.append(("unexpected $DynRef [.'$arrayKeywords'.items.'|'.14]", path))
                                                            if not res:
                                                                # .'$arrayKeywords'.items.'|'.15
                                                                res = json_model_9(val, path, rep)
                                                                if not res:
                                                                    rep is None or rep.append(("unexpected $metas [.'$arrayKeywords'.items.'|'.15]", path))
                                                                if not res:
                                                                    # .'$arrayKeywords'.items.'|'.16
                                                                    res = json_model_4(val, path, rep)
                                                                    if not res:
                                                                        rep is None or rep.append(("unexpected $schemaArray [.'$arrayKeywords'.items.'|'.16]", path))
    if res:
        rep is None or rep.clear()
    else:
                                                ...
                                                if not res:
                                                    ...
                                                    if not res:
                                                        ...
                                                        if not res:
                                                            ...
                                                            res = json_model_23(val, path, rep)
                                                            if not res:
                                                                rep is None or rep.append(("unexpected $DynRef [.'$Array'.items.'|'.14]", path))
                                                            if not res:
                                                                # .'$Array'.items.'|'.15
                                                                res = json_model_9(val, path, rep)
                                                                if not res:
                                                                    rep is None or rep.append(("unexpected $metas [.'$Array'.items.'|'.15]", path))
                                                                if not res:
                                                                    # .'$Array'.items.'|'.16
                                                                    res = json_model_4(val, path, rep)
                                                                    if not res:
                                                                        rep is None or rep.append(("unexpected $schemaArray [.'$Array'.items.'|'.16]", path))
    if res:
        rep is None or rep.clear()
    else:
                                                ...
                                                if not res:
                                                    ...
                                                    if not res:
                                                        ...
                                                        if not res:
                                                            ...
                                                            res = json_model_23(val, path, rep)
                                                            if not res:
                                                                rep is None or rep.append(("unexpected $DynRef [.'$Schema'.'|'.14]", path))
                                                            if not res:
                                                                # .'$Schema'.'|'.15
                                                                res = json_model_9(val, path, rep)
                                                                if not res:
                                                                    rep is None or rep.append(("unexpected $metas [.'$Schema'.'|'.15]", path))
    if res:
        rep is None or rep.clear()
    else:
