...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "$schema":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#RootSchema'.'&'.0.'$schema']", lpath_0 if path is not None else None))
                return False
        else:
...
def json_model_27(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if not res:
            rep is None or rep.append(("not an expected object [.'$tight#RootSchema'.'&'.0]", path))
        if res:
            # .'$tight#RootSchema'.'&'.1
...
def _jm_f_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#metas'.'$defs']", path))
    return res
...
def _jm_obj_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_3 if path is not None else None, rep)
        if not res:
...
def _jm_f_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#metas'.definitions]", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_1_map.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_1 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#metas']", lpath_1 if path is not None else None))
                return False
        else:
...
def json_model_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#metas']", path))
    return res
...
def _jm_f_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#String'.'$defs']", path))
    return res
...
def _jm_obj_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_6 if path is not None else None, rep)
        if not res:
...
def _jm_f_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#String'.definitions]", path))
    return res
...
def _jm_obj_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#String'.type]", lpath_4 if path is not None else None))
                return False
        elif pfun := _jm_obj_4_map.get(prop):
            # handle 14 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_4 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#String']", lpath_4 if path is not None else None))
                return False
        else:
...
def json_model_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#String']", path))
    return res
...
def _jm_f_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Array'.'$defs']", path))
    return res
...
def _jm_obj_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_9 if path is not None else None, rep)
        if not res:
...
def _jm_f_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Array'.definitions]", path))
    return res
...
def _jm_obj_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#Array'.type]", lpath_7 if path is not None else None))
                return False
        elif pfun := _jm_obj_7_map.get(prop):
            # handle 16 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_7 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#Array']", lpath_7 if path is not None else None))
                return False
        else:
...
def json_model_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Array']", path))
    return res
...
def _jm_f_41(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Object'.'$defs']", path))
    return res
...
def _jm_f_46(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Object'.definitions]", path))
    return res
...
def _jm_f_50(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Object'.patternProperties]", path))
    return res
...
def _jm_f_51(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Object'.properties]", path))
    return res
...
def _jm_obj_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#Object'.type]", lpath_10 if path is not None else None))
                return False
        elif pfun := _jm_obj_10_map.get(prop):
            # handle 14 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_10 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#Object']", lpath_10 if path is not None else None))
                return False
        else:
...
def json_model_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Object']", path))
    return res
...
def _jm_f_55(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Integer'.'$defs']", path))
    return res
...
def _jm_f_59(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Integer'.definitions]", path))
    return res
...
def _jm_obj_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#Integer'.type]", lpath_15 if path is not None else None))
                return False
        elif pfun := _jm_obj_15_map.get(prop):
            # handle 12 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_15 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#Integer']", lpath_15 if path is not None else None))
                return False
        else:
...
def json_model_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Integer']", path))
    return res
...
def _jm_f_67(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Number'.'$defs']", path))
    return res
...
def _jm_f_71(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Number'.definitions]", path))
    return res
...
def _jm_obj_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#Number'.type]", lpath_18 if path is not None else None))
                return False
        elif pfun := _jm_obj_18_map.get(prop):
            # handle 12 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_18 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#Number']", lpath_18 if path is not None else None))
                return False
        else:
...
def json_model_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Number']", path))
    return res
...
def _jm_f_79(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Bool'.'$defs']", path))
    return res
...
def _jm_f_83(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Bool'.definitions]", path))
    return res
...
def _jm_obj_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#Bool'.type]", lpath_21 if path is not None else None))
                return False
        elif pfun := _jm_obj_21_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_21 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#Bool']", lpath_21 if path is not None else None))
                return False
        else:
...
def json_model_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Bool']", path))
    return res
...
def _jm_f_89(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Null'.'$defs']", path))
    return res
...
def _jm_f_93(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Null'.definitions]", path))
    return res
...
def _jm_obj_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#Null'.type]", lpath_24 if path is not None else None))
                return False
        elif pfun := _jm_obj_24_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_24 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#Null']", lpath_24 if path is not None else None))
                return False
        else:
...
def json_model_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Null']", path))
    return res
...
def _jm_f_99(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#AllOf'.'$defs']", path))
    return res
...
def _jm_f_103(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#AllOf'.definitions]", path))
    return res
...
def _jm_obj_27(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "allOf":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#AllOf'.allOf]", lpath_27 if path is not None else None))
                return False
        elif pfun := _jm_obj_27_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_27 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#AllOf']", lpath_27 if path is not None else None))
                return False
        else:
...
def json_model_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#AllOf']", path))
    return res
...
def _jm_f_109(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#AnyOf'.'$defs']", path))
    return res
...
def _jm_f_113(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#AnyOf'.definitions]", path))
    return res
...
def _jm_obj_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "anyOf":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#AnyOf'.anyOf]", lpath_30 if path is not None else None))
                return False
        elif pfun := _jm_obj_30_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_30 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#AnyOf']", lpath_30 if path is not None else None))
                return False
        else:
...
def json_model_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#AnyOf']", path))
    return res
...
def _jm_f_119(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#OneOf'.'$defs']", path))
    return res
...
def _jm_f_123(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#OneOf'.definitions]", path))
    return res
...
def _jm_obj_33(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "oneOf":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#OneOf'.oneOf]", lpath_33 if path is not None else None))
                return False
        elif pfun := _jm_obj_33_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_33 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#OneOf']", lpath_33 if path is not None else None))
                return False
        else:
...
def json_model_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#OneOf']", path))
    return res
...
def _jm_f_129(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Enum'.'$defs']", path))
    return res
...
def _jm_f_133(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Enum'.definitions]", path))
    return res
...
def _jm_obj_36(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "enum":
            ...
            must_count += 1
            # .'$tight#Enum'.enum
            res = json_model_5(pval, lpath_36 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected $enum [.'$tight#Enum'.enum]", lpath_36 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#Enum'.enum]", lpath_36 if path is not None else None))
                return False
        elif pfun := _jm_obj_36_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_36 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#Enum']", lpath_36 if path is not None else None))
                return False
        else:
...
def json_model_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Enum']", path))
    return res
...
def _jm_f_139(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Const'.'$defs']", path))
    return res
...
def _jm_obj_41(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_41 if path is not None else None, rep)
        if not res:
...
def _jm_f_143(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Const'.definitions]", path))
    return res
...
def _jm_obj_39(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#Const'.const]", lpath_39 if path is not None else None))
                return False
        elif pfun := _jm_obj_39_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_39 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#Const']", lpath_39 if path is not None else None))
                return False
        else:
...
def json_model_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Const']", path))
    return res
...
def _jm_f_149(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Ref'.'$defs']", path))
    return res
...
def _jm_obj_44(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_44 if path is not None else None, rep)
        if not res:
...
def _jm_f_153(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Ref'.definitions]", path))
    return res
...
def _jm_obj_42(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "$ref":
            ...
            must_count += 1
            # .'$tight#Ref'.'$ref'
            res = is_valid_url(pval, lpath_42 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected $URL [.'$tight#Ref'.'$ref']", lpath_42 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#Ref'.'$ref']", lpath_42 if path is not None else None))
                return False
        elif pfun := _jm_obj_42_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_42 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#Ref']", lpath_42 if path is not None else None))
                return False
        else:
...
def json_model_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#Ref']", path))
    return res
...
def _jm_f_159(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#EnumString'.'$defs']", path))
    return res
...
def _jm_obj_47(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_47 if path is not None else None, rep)
        if not res:
...
def _jm_f_163(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#EnumString'.definitions]", path))
    return res
...
def _jm_obj_45(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "enum":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#EnumString'.enum]", lpath_45 if path is not None else None))
                return False
        elif prop == "type":
            # handle must type property
            must_count += 1
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#EnumString'.type]", lpath_45 if path is not None else None))
                return False
        elif pfun := _jm_obj_45_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_45 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#EnumString']", lpath_45 if path is not None else None))
                return False
        else:
...
def json_model_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#EnumString']", path))
    return res
...
def _jm_f_169(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#EnumNum'.'$defs']", path))
    return res
...
def _jm_obj_50(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_50 if path is not None else None, rep)
        if not res:
...
def _jm_f_173(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#EnumNum'.definitions]", path))
    return res
...
def _jm_obj_48(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "enum":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#EnumNum'.enum]", lpath_48 if path is not None else None))
                return False
        elif prop == "type":
            # handle must type property
            must_count += 1
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#EnumNum'.type]", lpath_48 if path is not None else None))
                return False
        elif pfun := _jm_obj_48_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_48 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#EnumNum']", lpath_48 if path is not None else None))
                return False
        else:
...
def json_model_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#EnumNum']", path))
    return res
...
def _jm_f_179(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#EnumInt'.'$defs']", path))
    return res
...
def _jm_obj_53(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_53 if path is not None else None, rep)
        if not res:
...
def _jm_f_183(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#EnumInt'.definitions]", path))
    return res
...
def _jm_obj_51(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "enum":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#EnumInt'.enum]", lpath_51 if path is not None else None))
                return False
        elif prop == "type":
            # handle must type property
            must_count += 1
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#EnumInt'.type]", lpath_51 if path is not None else None))
                return False
        elif pfun := _jm_obj_51_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_51 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#EnumInt']", lpath_51 if path is not None else None))
                return False
        else:
...
def json_model_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#EnumInt']", path))
    return res
...
def _jm_f_189(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstString'.'$defs']", path))
    return res
...
def _jm_obj_56(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_56 if path is not None else None, rep)
        if not res:
...
def _jm_f_193(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstString'.definitions]", path))
    return res
...
def _jm_obj_54(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#ConstString'.const]", lpath_54 if path is not None else None))
                return False
        elif prop == "type":
            # handle must type property
            must_count += 1
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#ConstString'.type]", lpath_54 if path is not None else None))
                return False
        elif pfun := _jm_obj_54_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_54 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#ConstString']", lpath_54 if path is not None else None))
                return False
        else:
...
def json_model_31(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstString']", path))
    return res
...
def _jm_f_199(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstNum'.'$defs']", path))
    return res
...
def _jm_obj_59(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_59 if path is not None else None, rep)
        if not res:
...
def _jm_f_203(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstNum'.definitions]", path))
    return res
...
def _jm_obj_57(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#ConstNum'.const]", lpath_57 if path is not None else None))
                return False
        elif prop == "type":
            # handle must type property
            must_count += 1
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#ConstNum'.type]", lpath_57 if path is not None else None))
                return False
        elif pfun := _jm_obj_57_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_57 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#ConstNum']", lpath_57 if path is not None else None))
                return False
        else:
...
def json_model_32(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstNum']", path))
    return res
...
def _jm_f_209(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstInt'.'$defs']", path))
    return res
...
def _jm_obj_62(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_62 if path is not None else None, rep)
        if not res:
...
def _jm_f_213(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstInt'.definitions]", path))
    return res
...
def _jm_obj_60(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#ConstInt'.const]", lpath_60 if path is not None else None))
                return False
        elif prop == "type":
            # handle must type property
            must_count += 1
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#ConstInt'.type]", lpath_60 if path is not None else None))
                return False
        elif pfun := _jm_obj_60_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_60 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#ConstInt']", lpath_60 if path is not None else None))
                return False
        else:
...
def json_model_33(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstInt']", path))
    return res
...
def _jm_f_219(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstBool'.'$defs']", path))
    return res
...
def _jm_obj_65(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_26(pval, lpath_65 if path is not None else None, rep)
        if not res:
...
def _jm_f_223(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstBool'.definitions]", path))
    return res
...
def _jm_obj_63(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#ConstBool'.const]", lpath_63 if path is not None else None))
                return False
        elif prop == "type":
            # handle must type property
            must_count += 1
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$tight#ConstBool'.type]", lpath_63 if path is not None else None))
                return False
        elif pfun := _jm_obj_63_map.get(prop):
            # handle 10 may props
            if pfun != UNDEFINED and not pfun(pval, lpath_63 if path is not None else None, rep):
                rep is None or rep.append(("invalid optional prop value [.'$tight#ConstBool']", lpath_63 if path is not None else None))
                return False
        else:
...
def json_model_34(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object [.'$tight#ConstBool']", path))
    return res
