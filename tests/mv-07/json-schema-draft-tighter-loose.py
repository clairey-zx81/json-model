...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$RootSchema\" [.'$tight']", path))
    return res
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = json_model_27(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$tight#RootSchema\" [.]", path))
    return res
...
def json_model_27(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if res:
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$ObjectSchema\" [.'$tight#RootSchema'.'&'.1]", path))
        else:
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#metas'.'$defs'.'']", lpath_1 if path is not None else None))
            return False
    return True
...
def _jm_obj_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#metas'.definitions.'']", lpath_2 if path is not None else None))
            return False
    return True
...
def json_model_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "$schema":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#metas'.'$schema']", lpath_0 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#metas'.'$id']", lpath_0 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#metas'.'$comment']", lpath_0 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#metas'.title]", lpath_0 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#metas'.description]", lpath_0 if path is not None else None))
...
def _jm_f_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#String'.'$comment']", path))
    return res
...
def _jm_f_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#String'.'$defs'.'']", lpath_4 if path is not None else None))
            return False
    return True
...
def _jm_f_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#String'.'$id']", path))
    return res
...
def _jm_f_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#String'.'$schema']", path))
    return res
...
def _jm_f_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#String'.definitions.'']", lpath_5 if path is not None else None))
            return False
    return True
...
def _jm_f_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#String'.description]", path))
    return res
...
def _jm_f_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$REGEX\" [.'$tight#String'.pattern]", path))
    return res
...
def _jm_f_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#String'.title]", path))
    return res
...
def json_model_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"string\" [.'$tight#String'.type]", lpath_3 if path is not None else None))
...
def _jm_f_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Array'.'$comment']", path))
    return res
...
def _jm_f_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Array'.'$defs'.'']", lpath_7 if path is not None else None))
            return False
    return True
...
def _jm_f_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Array'.'$id']", path))
    return res
...
def _jm_f_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Array'.'$schema']", path))
    return res
...
def _jm_f_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Array'.definitions.'']", lpath_8 if path is not None else None))
            return False
    return True
...
def _jm_f_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Array'.description]", path))
    return res
...
def _jm_f_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Array'.items.'|'.0]", path))
        # .'$tight#Array'.items.'|'.1
        res = json_model_6(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$schemaArray\" [.'$tight#Array'.items.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def _jm_f_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Array'.title]", path))
    return res
...
def json_model_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"array\" [.'$tight#Array'.type]", lpath_6 if path is not None else None))
...
def json_model_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_0_idx, arr_0_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#schemaArray'.0]", arr_0_lpath if path is not None else None))
                break
    if not res:
...
def _jm_f_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Object'.'$comment']", path))
    return res
...
def _jm_f_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Object'.'$defs'.'']", lpath_10 if path is not None else None))
            return False
    return True
...
def _jm_f_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Object'.'$id']", path))
    return res
...
def _jm_f_31(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Object'.'$schema']", path))
    return res
...
def _jm_f_33(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Object'.definitions.'']", lpath_11 if path is not None else None))
            return False
    return True
...
def _jm_f_34(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Object'.description]", path))
    return res
...
def _jm_f_37(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_12 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Object'.patternProperties.'$REGEX']", lpath_12 if path is not None else None))
                return False
        else:
...
def _jm_f_38(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Object'.properties.'']", lpath_13 if path is not None else None))
            return False
    return True
...
def _jm_f_39(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_1_idx, arr_1_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Object'.required.0]", arr_1_lpath if path is not None else None))
                break
    if not res:
...
def _jm_f_40(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Object'.title]", path))
    return res
...
def json_model_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"object\" [.'$tight#Object'.type]", lpath_9 if path is not None else None))
...
def _jm_f_41(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Integer'.'$comment']", path))
    return res
...
def _jm_f_42(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Integer'.'$defs'.'']", lpath_15 if path is not None else None))
            return False
    return True
...
def _jm_f_43(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Integer'.'$id']", path))
    return res
...
def _jm_f_44(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Integer'.'$schema']", path))
    return res
...
def _jm_f_46(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Integer'.definitions.'']", lpath_16 if path is not None else None))
            return False
    return True
...
def _jm_f_47(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Integer'.description]", path))
    return res
...
def _jm_f_52(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Integer'.title]", path))
    return res
...
def json_model_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"integer\" [.'$tight#Integer'.type]", lpath_14 if path is not None else None))
...
def _jm_f_53(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Number'.'$comment']", path))
    return res
...
def _jm_f_54(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Number'.'$defs'.'']", lpath_18 if path is not None else None))
            return False
    return True
...
def _jm_f_55(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Number'.'$id']", path))
    return res
...
def _jm_f_56(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Number'.'$schema']", path))
    return res
...
def _jm_f_58(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Number'.definitions.'']", lpath_19 if path is not None else None))
            return False
    return True
...
def _jm_f_59(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Number'.description]", path))
    return res
...
def _jm_f_64(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Number'.title]", path))
    return res
...
def json_model_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"number\" [.'$tight#Number'.type]", lpath_17 if path is not None else None))
...
def _jm_obj_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Bool'.'$defs'.'']", lpath_21 if path is not None else None))
            return False
    return True
...
def _jm_obj_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Bool'.definitions.'']", lpath_22 if path is not None else None))
            return False
    return True
...
def json_model_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"boolean\" [.'$tight#Bool'.type]", lpath_20 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Bool'.'$schema']", lpath_20 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Bool'.'$id']", lpath_20 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Bool'.'$comment']", lpath_20 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Bool'.title]", lpath_20 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Bool'.description]", lpath_20 if path is not None else None))
...
def _jm_obj_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Null'.'$defs'.'']", lpath_24 if path is not None else None))
            return False
    return True
...
def _jm_obj_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Null'.definitions.'']", lpath_25 if path is not None else None))
            return False
    return True
...
def json_model_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"null\" [.'$tight#Null'.type]", lpath_23 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Null'.'$schema']", lpath_23 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Null'.'$id']", lpath_23 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Null'.'$comment']", lpath_23 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Null'.title]", lpath_23 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Null'.description]", lpath_23 if path is not None else None))
...
def _jm_obj_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#AllOf'.'$defs'.'']", lpath_27 if path is not None else None))
            return False
    return True
...
def _jm_obj_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#AllOf'.definitions.'']", lpath_28 if path is not None else None))
            return False
    return True
...
def json_model_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "allOf":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$schemaArray\" [.'$tight#AllOf'.allOf]", lpath_26 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#AllOf'.'$schema']", lpath_26 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#AllOf'.'$id']", lpath_26 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#AllOf'.'$comment']", lpath_26 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#AllOf'.title]", lpath_26 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#AllOf'.description]", lpath_26 if path is not None else None))
...
def _jm_obj_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#AnyOf'.'$defs'.'']", lpath_30 if path is not None else None))
            return False
    return True
...
def _jm_obj_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#AnyOf'.definitions.'']", lpath_31 if path is not None else None))
            return False
    return True
...
def json_model_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "anyOf":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$schemaArray\" [.'$tight#AnyOf'.anyOf]", lpath_29 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#AnyOf'.'$schema']", lpath_29 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#AnyOf'.'$id']", lpath_29 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#AnyOf'.'$comment']", lpath_29 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#AnyOf'.title]", lpath_29 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#AnyOf'.description]", lpath_29 if path is not None else None))
...
def _jm_obj_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#OneOf'.'$defs'.'']", lpath_33 if path is not None else None))
            return False
    return True
...
def _jm_obj_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#OneOf'.definitions.'']", lpath_34 if path is not None else None))
            return False
    return True
...
def json_model_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "oneOf":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$schemaArray\" [.'$tight#OneOf'.oneOf]", lpath_32 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#OneOf'.'$schema']", lpath_32 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#OneOf'.'$id']", lpath_32 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#OneOf'.'$comment']", lpath_32 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#OneOf'.title]", lpath_32 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#OneOf'.description]", lpath_32 if path is not None else None))
...
def _jm_obj_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Enum'.'$defs'.'']", lpath_36 if path is not None else None))
            return False
    return True
...
def _jm_obj_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Enum'.definitions.'']", lpath_37 if path is not None else None))
            return False
    return True
...
def json_model_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "enum":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$enum\" [.'$tight#Enum'.enum]", lpath_35 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Enum'.'$schema']", lpath_35 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Enum'.'$id']", lpath_35 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Enum'.'$comment']", lpath_35 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Enum'.title]", lpath_35 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Enum'.description]", lpath_35 if path is not None else None))
...
def json_model_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        for arr_5_idx, arr_5_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#enum'.'|'.0.0]", arr_5_lpath if path is not None else None))
                break
        if not res:
            ...
            for arr_4_idx, arr_4_item in enumerate(val):
                ...
                # .'$tight#enum'.'|'.1.0
                res = isinstance(arr_4_item, int) and not isinstance(arr_4_item, bool)
                if not res:
                    rep is None or rep.append(("not a -1 strict int [.'$tight#enum'.'|'.1.0]", arr_4_lpath if path is not None else None))
                    break
            if not res:
                ...
                for arr_3_idx, arr_3_item in enumerate(val):
                    ...
                    if not res:
                        rep is None or rep.append(("not a bool [.'$tight#enum'.'|'.2.0]", arr_3_lpath if path is not None else None))
                        break
                if not res:
                    ...
                    for arr_2_idx, arr_2_item in enumerate(val):
                        ...
                        # .'$tight#enum'.'|'.3.0
                        res = isinstance(arr_2_item, float)
                        if not res:
                            rep is None or rep.append(("not a -1.0 strict float [.'$tight#enum'.'|'.3.0]", arr_2_lpath if path is not None else None))
                            break
                    if not res:
                        rep is None or rep.append(("not array or unexpected array [.'$tight#enum'.'|'.3]", path))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Const'.'$defs'.'']", lpath_39 if path is not None else None))
            return False
    return True
...
def _jm_obj_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Const'.definitions.'']", lpath_40 if path is not None else None))
            return False
    return True
...
def json_model_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$const\" [.'$tight#Const'.const]", lpath_38 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Const'.'$schema']", lpath_38 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Const'.'$id']", lpath_38 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Const'.'$comment']", lpath_38 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Const'.title]", lpath_38 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Const'.description]", lpath_38 if path is not None else None))
...
def _jm_obj_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Ref'.'$defs'.'']", lpath_42 if path is not None else None))
            return False
    return True
...
def _jm_obj_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#Ref'.definitions.'']", lpath_43 if path is not None else None))
            return False
    return True
...
def json_model_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "$ref":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$tight#Ref'.'$ref']", lpath_41 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Ref'.'$schema']", lpath_41 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Ref'.'$id']", lpath_41 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Ref'.'$comment']", lpath_41 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Ref'.title]", lpath_41 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#Ref'.description]", lpath_41 if path is not None else None))
...
def json_model_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        ...
        res = json_model_25(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$ObjectSchema\" [.'$tight#Schema'.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def _jm_obj_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#EnumString'.'$defs'.'']", lpath_45 if path is not None else None))
            return False
    return True
...
def _jm_obj_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#EnumString'.definitions.'']", lpath_46 if path is not None else None))
            return False
    return True
...
def json_model_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "enum":
            ...
            if res:
                for arr_6_idx, arr_6_item in enumerate(pval):
                    arr_6_lpath: Path = ((lpath_44 if path is not None else None) + [ arr_6_idx ]) if (lpath_44 if path is not None else None) is not None else None
                    # .'$tight#EnumString'.enum.0
                    res = isinstance(arr_6_item, str)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumString'.enum.0]", arr_6_lpath if (lpath_44 if path is not None else None) is not None else None))
                        break
            if not res:
            ...
            res = isinstance(pval, str) and pval == "string"
            if not res:
                rep is None or rep.append(("unexpected value for model \"string\" [.'$tight#EnumString'.type]", lpath_44 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumString'.'$schema']", lpath_44 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumString'.'$id']", lpath_44 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumString'.'$comment']", lpath_44 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumString'.title]", lpath_44 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumString'.description]", lpath_44 if path is not None else None))
...
def _jm_obj_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#EnumNum'.'$defs'.'']", lpath_48 if path is not None else None))
            return False
    return True
...
def _jm_obj_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#EnumNum'.definitions.'']", lpath_49 if path is not None else None))
            return False
    return True
...
def json_model_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "enum":
            ...
            if res:
                for arr_7_idx, arr_7_item in enumerate(pval):
                    arr_7_lpath: Path = ((lpath_47 if path is not None else None) + [ arr_7_idx ]) if (lpath_47 if path is not None else None) is not None else None
                    # .'$tight#EnumNum'.enum.0
                    res = isinstance(arr_7_item, float)
                    if not res:
                        rep is None or rep.append(("not a -1.0 strict float [.'$tight#EnumNum'.enum.0]", arr_7_lpath if (lpath_47 if path is not None else None) is not None else None))
                        break
            if not res:
            ...
            res = isinstance(pval, str) and pval == "number"
            if not res:
                rep is None or rep.append(("unexpected value for model \"number\" [.'$tight#EnumNum'.type]", lpath_47 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumNum'.'$schema']", lpath_47 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumNum'.'$id']", lpath_47 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumNum'.'$comment']", lpath_47 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumNum'.title]", lpath_47 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumNum'.description]", lpath_47 if path is not None else None))
...
def _jm_obj_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#EnumInt'.'$defs'.'']", lpath_51 if path is not None else None))
            return False
    return True
...
def _jm_obj_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#EnumInt'.definitions.'']", lpath_52 if path is not None else None))
            return False
    return True
...
def json_model_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "enum":
            ...
            if res:
                for arr_8_idx, arr_8_item in enumerate(pval):
                    arr_8_lpath: Path = ((lpath_50 if path is not None else None) + [ arr_8_idx ]) if (lpath_50 if path is not None else None) is not None else None
                    # .'$tight#EnumInt'.enum.0
                    res = isinstance(arr_8_item, int) and not isinstance(arr_8_item, bool)
                    if not res:
                        rep is None or rep.append(("not a -1 strict int [.'$tight#EnumInt'.enum.0]", arr_8_lpath if (lpath_50 if path is not None else None) is not None else None))
                        break
            if not res:
            ...
            res = isinstance(pval, str) and pval == "integer"
            if not res:
                rep is None or rep.append(("unexpected value for model \"integer\" [.'$tight#EnumInt'.type]", lpath_50 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumInt'.'$schema']", lpath_50 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumInt'.'$id']", lpath_50 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumInt'.'$comment']", lpath_50 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumInt'.title]", lpath_50 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#EnumInt'.description]", lpath_50 if path is not None else None))
...
def _jm_obj_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#ConstString'.'$defs'.'']", lpath_54 if path is not None else None))
            return False
    return True
...
def _jm_obj_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#ConstString'.definitions.'']", lpath_55 if path is not None else None))
            return False
    return True
...
def json_model_31(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstString'.const]", lpath_53 if path is not None else None))
            ...
            res = isinstance(pval, str) and pval == "string"
            if not res:
                rep is None or rep.append(("unexpected value for model \"string\" [.'$tight#ConstString'.type]", lpath_53 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstString'.'$schema']", lpath_53 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstString'.'$id']", lpath_53 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstString'.'$comment']", lpath_53 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstString'.title]", lpath_53 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstString'.description]", lpath_53 if path is not None else None))
...
def _jm_obj_27(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#ConstNum'.'$defs'.'']", lpath_57 if path is not None else None))
            return False
    return True
...
def _jm_obj_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#ConstNum'.definitions.'']", lpath_58 if path is not None else None))
            return False
    return True
...
def json_model_32(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            res = isinstance(pval, str) and pval == "number"
            if not res:
                rep is None or rep.append(("unexpected value for model \"number\" [.'$tight#ConstNum'.type]", lpath_56 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstNum'.'$schema']", lpath_56 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstNum'.'$id']", lpath_56 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstNum'.'$comment']", lpath_56 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstNum'.title]", lpath_56 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstNum'.description]", lpath_56 if path is not None else None))
...
def _jm_obj_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#ConstInt'.'$defs'.'']", lpath_60 if path is not None else None))
            return False
    return True
...
def _jm_obj_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#ConstInt'.definitions.'']", lpath_61 if path is not None else None))
            return False
    return True
...
def json_model_33(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            res = isinstance(pval, str) and pval == "integer"
            if not res:
                rep is None or rep.append(("unexpected value for model \"integer\" [.'$tight#ConstInt'.type]", lpath_59 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstInt'.'$schema']", lpath_59 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstInt'.'$id']", lpath_59 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstInt'.'$comment']", lpath_59 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstInt'.title]", lpath_59 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstInt'.description]", lpath_59 if path is not None else None))
...
def _jm_obj_31(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#ConstBool'.'$defs'.'']", lpath_63 if path is not None else None))
            return False
    return True
...
def _jm_obj_32(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$tight#ConstBool'.definitions.'']", lpath_64 if path is not None else None))
            return False
    return True
...
def json_model_34(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            res = isinstance(pval, str) and pval == "boolean"
            if not res:
                rep is None or rep.append(("unexpected value for model \"boolean\" [.'$tight#ConstBool'.type]", lpath_62 if path is not None else None))
        ...
        if prop == "$schema":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstBool'.'$schema']", lpath_62 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstBool'.'$id']", lpath_62 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstBool'.'$comment']", lpath_62 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstBool'.title]", lpath_62 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$tight#ConstBool'.description]", lpath_62 if path is not None else None))
