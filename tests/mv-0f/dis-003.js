...
function _jm_obj_0(val, path, rep)
{
    ...
    for(const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "d")
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["unexpected string [.'|'.2.d]", (path ? lpath_0 : null)])
            }
            if (! res)
            {
                rep !== null && rep.push(["invalid mandatory prop value [.'|'.2.d]", (path ? lpath_0 : null)])
                return false;
            }
        }
        else
...
function _jm_obj_1(val, path, rep)
{
    ...
    for(const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "c")
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["not a -1 strict int [.'|'.1.c]", (path ? lpath_1 : null)])
            }
            if (! res)
            {
                rep !== null && rep.push(["invalid mandatory prop value [.'|'.1.c]", (path ? lpath_1 : null)])
                return false;
            }
        }
        else
...
function _jm_obj_2(val, path, rep)
{
    ...
    for(const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "b")
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["not a 1 strict int [.'|'.0.b]", (path ? lpath_2 : null)])
            }
            if (! res)
            {
                rep !== null && rep.push(["invalid mandatory prop value [.'|'.0.b]", (path ? lpath_2 : null)])
                return false;
            }
        }
        else
