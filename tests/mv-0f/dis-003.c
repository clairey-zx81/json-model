...
static bool _jm_obj_0(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (strcmp(prop, "a") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid must property value [$.'|'.2.a]", (path ? &lpath_0 : NULL));
                return false;
            }
        }
        else if (strcmp(prop, "d") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid must property value [$.'|'.2.d]", (path ? &lpath_0 : NULL));
                return false;
            }
        }
        else
...
static bool _jm_obj_1(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (strcmp(prop, "a") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid must property value [$.'|'.1.a]", (path ? &lpath_1 : NULL));
                return false;
            }
        }
        else if (strcmp(prop, "c") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid must property value [$.'|'.1.c]", (path ? &lpath_1 : NULL));
                return false;
            }
        }
        else
...
static bool _jm_obj_2(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (strcmp(prop, "b") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid must property value [$.'|'.0.b]", (path ? &lpath_2 : NULL));
                return false;
            }
        }
        else
