...
function _jm_obj_0(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (prop == "a")
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["not a 0 strict int [.'|'.1.a]", (path ? lpath_0 : null)])
            }
            if (! res)
            {
                rep !== null && rep.push(["invalid mandatory prop value [.'|'.1.a]", (path ? lpath_0 : null)])
                return false;
            }
        }
        else if (prop == "c")
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["not a -1 strict int [.'|'.1.c]", (path ? lpath_0 : null)])
            }
            if (! res)
            {
                rep !== null && rep.push(["invalid mandatory prop value [.'|'.1.c]", (path ? lpath_0 : null)])
                return false;
            }
        }
        else
...
function _jm_obj_1(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "b")
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["not a 1 strict int [.'|'.0.b]", (path ? lpath_1 : null)])
            }
            if (! res)
            {
        ...
        {
            rep !== null && rep.push(["unexpected prop [.'|'.0]", (path ? lpath_1 : null)])
            return false;
        }
    }
    if (must_count != 2)
