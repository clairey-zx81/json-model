...
public class dis_001 extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> dis_001_map_pmap;
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            dis_001_map_pmap = new HashMap<String, Checker>();
            dis_001_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        ...
        {
            super.free();
            dis_001_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return dis_001_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return dis_001_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new dis_001();
        Main.main("dis_001", checker, VERSION, args);
    }
}
