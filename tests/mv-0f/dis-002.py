...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "a":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'|'.1.a]", lpath_0 if path is not None else None))
                return False
        elif prop == "c":
            ...
            if not res:
                rep is None or rep.append(("not a -1 strict int [.'|'.1.c]", lpath_0 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'|'.1.c]", lpath_0 if path is not None else None))
                return False
        else:
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "a":
            ...
            if not res:
                rep is None or rep.append(("not a 1 strict int [.'|'.0.b]", lpath_1 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'|'.0.b]", lpath_1 if path is not None else None))
                return False
        else:
