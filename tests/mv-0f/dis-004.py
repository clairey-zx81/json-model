...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not a 1 strict int [.'$Aa'.'|'.1.b]", lpath if path is not None else None))
...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Aa\" [.'$Bb'.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Bb\" [.]", path))
    return res
