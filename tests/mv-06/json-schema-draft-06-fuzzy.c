...
static INLINE bool _jm_obj_0(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (unlikely(! res))
        {
            if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Schema\" [.'$schema#ObjectSchema'.dependencies.''.'|'.0]", (path ? &lpath_1 : NULL));
            // .'$schema#ObjectSchema'.dependencies.''.'|'.1
            res = json_model_8(pval, (path ? &lpath_1 : NULL), rep);
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"$stringArray\" [.'$schema#ObjectSchema'.dependencies.''.'|'.1]", (path ? &lpath_1 : NULL));
            }
        }
        if (likely(res))
        {
                ...
                else
                {
                    ...
                    else if (jm_str_eq_5(prop, 0x0000000065707974LL))
                    {
                        ...
                        if (unlikely(! res))
                        {
                            ...
                            if (unlikely(! res))
                            {
                                if (rep) jm_report_add_entry(rep, "unexpected value for model \"$typeArray\" [.'$schema#ObjectSchema'.type.'|'.1]", (path ? &lpath_0 : NULL));
                            }
                        }
                        if (likely(res))
                        {
...
static bool json_model_5(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (likely(res))
    {
        ...
        json_array_foreach(val, arr_0_idx, arr_0_item)
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Schema\" [.'$schema#schemaArray'.'@'.0]", (path ? &arr_0_lpath : NULL));
                break;
            }
        }
    }
...
static bool json_model_8(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (likely(res))
    {
        ...
        json_array_foreach(val, arr_2_idx, arr_2_item)
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"\" [.'$schema#stringArray'.0]", (path ? &arr_2_lpath : NULL));
                break;
            }
        }
    }
