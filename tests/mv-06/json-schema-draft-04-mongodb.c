...
static bool json_model_5(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    bool res;
    // .'$schema#simpleTypes'
    res = json_is_string(val) && jm_search_cst(&(jm_constant_t) { cst_is_string, { .s = json_string_value(val) } }, _jm_cst_0, 6);;
    if (! res)
    {
...
static bool json_model_9(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    // .'$schema#bsonType'
    res = json_is_string(val) && jm_search_cst(&(jm_constant_t) { cst_is_string, { .s = json_string_value(val) } }, _jm_cst_1, 17);;
    if (! res)
    {
...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        json_model_3_map_tab[0] = (jm_propmap_t) { "additionalItems", _jm_f_0 };
        json_model_3_map_tab[1] = (jm_propmap_t) { "additionalProperties", _jm_f_1 };
        json_model_3_map_tab[2] = (jm_propmap_t) { "allOf", json_model_4 };
        json_model_3_map_tab[3] = (jm_propmap_t) { "anyOf", json_model_4 };
        json_model_3_map_tab[4] = (jm_propmap_t) { "bsonType", _jm_f_2 };
        json_model_3_map_tab[5] = (jm_propmap_t) { "dependencies", _jm_f_3 };
        json_model_3_map_tab[6] = (jm_propmap_t) { "description", _jm_f_4 };
        json_model_3_map_tab[7] = (jm_propmap_t) { "enum", _jm_f_5 };
        json_model_3_map_tab[8] = (jm_propmap_t) { "exclusiveMaximum", _jm_f_6 };
        json_model_3_map_tab[9] = (jm_propmap_t) { "exclusiveMinimum", _jm_f_7 };
        json_model_3_map_tab[10] = (jm_propmap_t) { "items", _jm_f_8 };
        json_model_3_map_tab[11] = (jm_propmap_t) { "maxItems", _jm_f_9 };
        json_model_3_map_tab[12] = (jm_propmap_t) { "maxLength", _jm_f_10 };
        json_model_3_map_tab[13] = (jm_propmap_t) { "maxProperties", _jm_f_11 };
        json_model_3_map_tab[14] = (jm_propmap_t) { "maximum", _jm_f_12 };
        json_model_3_map_tab[15] = (jm_propmap_t) { "minItems", _jm_f_13 };
        json_model_3_map_tab[16] = (jm_propmap_t) { "minLength", _jm_f_14 };
        json_model_3_map_tab[17] = (jm_propmap_t) { "minProperties", _jm_f_15 };
        json_model_3_map_tab[18] = (jm_propmap_t) { "minimum", _jm_f_16 };
        json_model_3_map_tab[19] = (jm_propmap_t) { "multipleOf", _jm_f_17 };
        json_model_3_map_tab[20] = (jm_propmap_t) { "not", json_model_3 };
        json_model_3_map_tab[21] = (jm_propmap_t) { "oneOf", json_model_4 };
        json_model_3_map_tab[22] = (jm_propmap_t) { "pattern", _jm_f_18 };
        json_model_3_map_tab[23] = (jm_propmap_t) { "patternProperties", _jm_f_19 };
        json_model_3_map_tab[24] = (jm_propmap_t) { "properties", _jm_f_20 };
        json_model_3_map_tab[25] = (jm_propmap_t) { "required", json_model_6 };
        json_model_3_map_tab[26] = (jm_propmap_t) { "title", _jm_f_21 };
        json_model_3_map_tab[27] = (jm_propmap_t) { "type", _jm_f_22 };
        json_model_3_map_tab[28] = (jm_propmap_t) { "uniqueItems", _jm_f_23 };
