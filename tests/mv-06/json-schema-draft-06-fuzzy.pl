...
sub json_model_3($$$)
{
    ...
    # .'$schema'
    # .'$schema'.'@'
    return json_model_10($val, undef, undef);
}
...
sub json_model_10($$$)
{
    ...
    # .'$schema#Schema'.'|'.0
    # .'$schema#Schema'.'|'.1
    return jm_is_boolean($val) || json_model_9($val, undef, undef);
}
...
sub _jm_obj_2($$$)
{
    ...
    while (my ($prop, $pval) = each %$val)
    {
        ...
        $res = json_model_10($pval, undef, undef) || json_model_8($pval, undef, undef);
        if (! $res)
        {
            return 0;
        }
...
sub json_model_9($$$)
{
    ...
    if (exists $$val{'items'})
    {
        ...
        $res = json_model_10($pval, undef, undef) || json_model_5($pval, undef, undef);
        if (! $res)
        {
            return 0;
        }
