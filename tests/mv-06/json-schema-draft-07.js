...
function json_model_5(val, path, rep)
{
    ...
    if (res)
    {
        for (let arr_1_idx = 0; arr_1_idx < val.length; arr_1_idx++)
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["unexpected value for model \"$simpleTypes\" [.'$arrayTypes'.'@'.0]", (path ? arr_1_lpath : null)])
                break
            }
        }
    }
...
function _jm_f_6(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected value for model \"$Schema\" [.'$ObjectSchema'.definitions.'']", (path ? lpath_1 : null)])
            return false
        }
    }
    return true
...
function _jm_f_7(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected value for model \"$Schema\" [.'$ObjectSchema'.dependencies.''.'|'.0]", (path ? lpath_2 : null)])
            ...
            if (res)
            {
                for (let arr_2_idx = 0; arr_2_idx < pval.length; arr_2_idx++)
                {
                    ...
                    if (! res)
                    {
                        rep !== null && rep.push(["unexpected value for model \"\" [.'$ObjectSchema'.dependencies.''.'|'.1.0]", ((path ? lpath_2 : null) ? arr_2_lpath : null)])
                        break
                    }
                }
            }
...
function _jm_f_14(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["unexpected value for model \"$Schema\" [.'$ObjectSchema'.items.'|'.0]", path])
...
function _jm_f_25(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (runtime.jm_is_valid_regex(prop, false))
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["unexpected value for model \"$Schema\" [.'$ObjectSchema'.patternProperties.'$REGEX']", (path ? lpath_3 : null)])
                return false
            }
        }
        else
...
function _jm_f_26(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected value for model \"$Schema\" [.'$ObjectSchema'.properties.'']", (path ? lpath_4 : null)])
            return false
        }
    }
    return true
...
function _jm_f_28(val, path, rep)
{
    ...
    if (res)
    {
        for (let arr_3_idx = 0; arr_3_idx < val.length; arr_3_idx++)
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["unexpected value for model \"\" [.'$ObjectSchema'.required.0]", (path ? arr_3_lpath : null)])
                break
            }
        }
    }
...
function _jm_f_30(val, path, rep)
{
    ...
    if (! res)
    {
        ...
        if (! res)
            rep !== null && rep.push(["unexpected value for model \"$arrayTypes\" [.'$ObjectSchema'.type.'|'.1]", path])
    }
    if (res)
    {
        if (rep !== null) rep.length = 0
...
export function check_model_init()
{
    if (! initialized)
    {
        ...
        json_model_6_map.set("$id", json_model_2)
        json_model_6_map.set("$ref", json_model_2)
        json_model_6_map.set("$schema", _jm_f_1)
        json_model_6_map.set("additionalItems", json_model_7)
        json_model_6_map.set("additionalProperties", json_model_7)
        json_model_6_map.set("allOf", json_model_3)
        json_model_6_map.set("anyOf", json_model_3)
        json_model_6_map.set("const", _jm_f_2)
        json_model_6_map.set("contains", json_model_7)
        json_model_6_map.set("contentEncoding", _jm_f_3)
        json_model_6_map.set("contentMediaType", _jm_f_4)
        json_model_6_map.set("default", _jm_f_5)
        json_model_6_map.set("definitions", _jm_f_6)
        json_model_6_map.set("dependencies", _jm_f_7)
        json_model_6_map.set("description", _jm_f_8)
        json_model_6_map.set("else", json_model_7)
        json_model_6_map.set("enum", _jm_f_9)
        json_model_6_map.set("examples", _jm_f_10)
        json_model_6_map.set("exclusiveMaximum", _jm_f_11)
        json_model_6_map.set("exclusiveMinimum", _jm_f_12)
        json_model_6_map.set("format", _jm_f_13)
        json_model_6_map.set("if", json_model_7)
        json_model_6_map.set("items", _jm_f_14)
        json_model_6_map.set("maxItems", _jm_f_15)
        json_model_6_map.set("maxLength", _jm_f_16)
        json_model_6_map.set("maxProperties", _jm_f_17)
        json_model_6_map.set("maximum", _jm_f_18)
        json_model_6_map.set("minItems", _jm_f_19)
        json_model_6_map.set("minLength", _jm_f_20)
        json_model_6_map.set("minProperties", _jm_f_21)
        json_model_6_map.set("minimum", _jm_f_22)
        json_model_6_map.set("multipleOf", _jm_f_23)
        json_model_6_map.set("not", json_model_7)
        json_model_6_map.set("oneOf", json_model_3)
        json_model_6_map.set("pattern", _jm_f_24)
        json_model_6_map.set("patternProperties", _jm_f_25)
        json_model_6_map.set("properties", _jm_f_26)
        json_model_6_map.set("propertyNames", json_model_7)
        json_model_6_map.set("readOnly", _jm_f_27)
        json_model_6_map.set("required", _jm_f_28)
        json_model_6_map.set("then", json_model_7)
        json_model_6_map.set("title", _jm_f_29)
        json_model_6_map.set("type", _jm_f_30)
        json_model_6_map.set("uniqueItems", _jm_f_31)
        json_model_6_map.set("writeOnly", _jm_f_32)
