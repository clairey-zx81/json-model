...
export function check_model_init()
{
    if (! initialized)
    {
        ...
        _jm_obj_0_map.set("additionalItems", _jm_f_3)
        _jm_obj_0_map.set("additionalProperties", _jm_f_4)
        _jm_obj_0_map.set("allOf", _jm_f_5)
        _jm_obj_0_map.set("anyOf", _jm_f_6)
        _jm_obj_0_map.set("const", _jm_f_7)
        _jm_obj_0_map.set("contains", _jm_f_8)
        _jm_obj_0_map.set("default", _jm_f_9)
        _jm_obj_0_map.set("definitions", _jm_f_10)
        _jm_obj_0_map.set("dependencies", _jm_f_11)
        _jm_obj_0_map.set("description", _jm_f_12)
        _jm_obj_0_map.set("enum", _jm_f_13)
        _jm_obj_0_map.set("examples", _jm_f_14)
        _jm_obj_0_map.set("exclusiveMaximum", _jm_f_15)
        _jm_obj_0_map.set("exclusiveMinimum", _jm_f_16)
        _jm_obj_0_map.set("format", _jm_f_17)
        _jm_obj_0_map.set("items", _jm_f_18)
        _jm_obj_0_map.set("maxItems", _jm_f_19)
        _jm_obj_0_map.set("maxLength", _jm_f_20)
        _jm_obj_0_map.set("maxProperties", _jm_f_21)
        _jm_obj_0_map.set("maximum", _jm_f_22)
        _jm_obj_0_map.set("minItems", _jm_f_23)
        _jm_obj_0_map.set("minLength", _jm_f_24)
        _jm_obj_0_map.set("minProperties", _jm_f_25)
        _jm_obj_0_map.set("minimum", _jm_f_26)
        _jm_obj_0_map.set("multipleOf", _jm_f_27)
        _jm_obj_0_map.set("not", _jm_f_28)
        _jm_obj_0_map.set("oneOf", _jm_f_29)
        _jm_obj_0_map.set("pattern", _jm_f_30)
        _jm_obj_0_map.set("patternProperties", _jm_f_31)
        _jm_obj_0_map.set("properties", _jm_f_32)
        _jm_obj_0_map.set("propertyNames", _jm_f_33)
        _jm_obj_0_map.set("required", _jm_f_34)
        _jm_obj_0_map.set("title", _jm_f_35)
        _jm_obj_0_map.set("type", _jm_f_36)
        _jm_obj_0_map.set("uniqueItems", _jm_f_37)
        _jm_cst_0.add("null")
