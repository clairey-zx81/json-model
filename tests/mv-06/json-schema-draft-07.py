...
def json_model_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_1_idx, arr_1_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$simpleTypes\" [.'$arrayTypes'.'@'.0]", arr_1_lpath if path is not None else None))
                break
    if res:
        ival_1: int = len(val)
...
def _jm_f_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.definitions.'']", lpath_1 if path is not None else None))
            return False
    return True
...
def _jm_f_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.dependencies.''.'|'.0]", lpath_2 if path is not None else None))
            ...
            if res:
                for arr_2_idx, arr_2_item in enumerate(pval):
                    ...
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"\" [.'$ObjectSchema'.dependencies.''.'|'.1.0]", arr_2_lpath if (lpath_2 if path is not None else None) is not None else None))
                        break
            if not res:
...
def _jm_f_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_3 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.patternProperties.'$REGEX']", lpath_3 if path is not None else None))
                return False
        else:
...
def _jm_f_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.properties.'']", lpath_4 if path is not None else None))
            return False
    return True
...
def _jm_f_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_3_idx, arr_3_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$ObjectSchema'.required.0]", arr_3_lpath if path is not None else None))
                break
    if not res:
...
def _jm_f_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$arrayTypes\" [.'$ObjectSchema'.type.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
