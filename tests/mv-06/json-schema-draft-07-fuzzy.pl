...
sub json_model_9($$$)
{
    ...
    # .'$schema#Schema'.'|'.0
    # .'$schema#Schema'.'|'.1
    return jm_is_boolean($val) || json_model_8($val, $path, $rep);
}
...
sub _jm_f_14($$$)
{
    ...
    return json_model_9($val, $path, $rep) || json_model_5($val, $path, $rep);
}
...
sub _jm_f_30($$$)
{
    ...
    return json_model_6($val, $path, $rep) || json_model_7($val, $path, $rep);
}
