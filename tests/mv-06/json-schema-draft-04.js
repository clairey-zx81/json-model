...
function _jm_f_7(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.definitions]", path])
    }
    return res;
}
...
function _jm_f_8(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.dependencies]", path])
    }
    return res;
}
...
function _jm_f_28(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.patternProperties]", path])
    }
    return res;
}
