...
def _jm_obj_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$String'.type]", lpath_9 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$String']", lpath_9 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
...
def _jm_obj_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$Array'.type]", lpath_12 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$Array']", lpath_12 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
...
def _jm_obj_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_18 if path is not None else None, rep):
            ...
            rep is None or rep.append(("no other prop expected [.'$Object'.patternProperties]", lpath_18 if path is not None else None))
            return False
    return True
...
def _jm_obj_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$Object'.type]", lpath_15 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$Object']", lpath_15 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
...
def _jm_obj_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$Integer'.type]", lpath_20 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$Integer']", lpath_20 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
...
def _jm_obj_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$Number'.type]", lpath_23 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$Number']", lpath_23 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
...
def _jm_obj_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$Bool'.type]", lpath_26 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$Bool']", lpath_26 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
...
def _jm_obj_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$Null'.type]", lpath_29 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$Null']", lpath_29 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
...
def _jm_obj_32(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "allOf":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$AllOf'.allOf]", lpath_32 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$AllOf']", lpath_32 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "allOf" in val:
...
def _jm_obj_35(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "anyOf":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$AnyOf'.anyOf]", lpath_35 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$AnyOf']", lpath_35 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "anyOf" in val:
...
def _jm_obj_38(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "oneOf":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$OneOf'.oneOf]", lpath_38 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$OneOf']", lpath_38 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "oneOf" in val:
...
def _jm_obj_41(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "enum":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$Enum'.enum]", lpath_41 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$Enum']", lpath_41 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "enum" in val:
...
def _jm_obj_44(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "const":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$Const'.const]", lpath_44 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$Const']", lpath_44 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "const" in val:
...
def _jm_obj_47(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "$ref":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$Ref'.$ref]", lpath_47 if path is not None else None))
                return False
            ...
            rep is None or rep.append(("no other prop expected [.'$Ref']", lpath_47 if path is not None else None))
            return False
    if must_count != 1:
        if rep is not None:
            if not "$ref" in val:
...
def _jm_obj_50(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "$schema":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory property value [.'$RootSchema'.'&'.0.$schema]", lpath_50 if path is not None else None))
                return False
        else:
...
def check_model_init():
    ...
    if not initialized:
        ...
        _jm_obj_2_map = {
            "additionalProperties": _jm_f_10,
            "patternProperties": _jm_f_11,
            "properties": _jm_f_12,
            "required": _jm_f_13,
        }
        ...
        _jm_obj_15_map = {
            ...
            "$id": _jm_f_56,
            "$schema": _jm_f_57,
            "additionalProperties": _jm_f_58,
            "default": _jm_f_59,
            "definitions": _jm_f_60,
            "description": _jm_f_61,
            "examples": _jm_f_62,
            "id": _jm_f_63,
            "patternProperties": _jm_f_64,
            "properties": _jm_f_65,
            "required": _jm_f_66,
            "title": _jm_f_67,
        }
