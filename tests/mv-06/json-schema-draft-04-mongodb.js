...
function _jm_f_4(val, path, rep)
{
    ...
    if (! res)
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected type [.'$schema'.bsonType.'|']", path])
        }
        if (res)
        {
            // .'$schema'.bsonType.'|'.0
            for (let arr_0_idx = 0; arr_0_idx < val.length; arr_0_idx++)
            {
                ...
                if (! res)
                {
                    rep !== null && rep.push(["unexpected $bsonType [.'$schema'.bsonType.'|'.0.0]", (path ? arr_0_lpath : null)])
                }
                if (! res)
                {
                    break;
            ...
            if (! res)
            {
                rep !== null && rep.push(["not array or unexpected array [.'$schema'.bsonType.'|'.0]", path])
            }
            if (res)
            {
                if (rep !== null) rep.length = 0
...
export function check_model_init()
{
    if (! initialized)
    {
        ...
        _jm_cst_0.add("binData")
        _jm_cst_0.add("objectId")
        _jm_cst_0.add("date")
        _jm_cst_0.add("regex")
        _jm_cst_0.add("javascript")
        _jm_cst_0.add("timestamp")
        _jm_cst_0.add("minKey")
        _jm_cst_0.add("maxKey")
        _jm_cst_1.add("null")
        ...
        _jm_obj_0_map.set("additionalItems", _jm_f_0)
        _jm_obj_0_map.set("additionalProperties", _jm_f_1)
        _jm_obj_0_map.set("allOf", _jm_f_2)
        _jm_obj_0_map.set("anyOf", _jm_f_3)
        _jm_obj_0_map.set("bsonType", _jm_f_4)
        _jm_obj_0_map.set("dependencies", _jm_f_5)
        _jm_obj_0_map.set("description", _jm_f_6)
        _jm_obj_0_map.set("enum", _jm_f_7)
        _jm_obj_0_map.set("exclusiveMaximum", _jm_f_8)
        _jm_obj_0_map.set("exclusiveMinimum", _jm_f_9)
        _jm_obj_0_map.set("items", _jm_f_10)
        _jm_obj_0_map.set("maxItems", _jm_f_11)
        _jm_obj_0_map.set("maxLength", _jm_f_12)
        _jm_obj_0_map.set("maxProperties", _jm_f_13)
        _jm_obj_0_map.set("maximum", _jm_f_14)
        _jm_obj_0_map.set("minItems", _jm_f_15)
        _jm_obj_0_map.set("minLength", _jm_f_16)
        _jm_obj_0_map.set("minProperties", _jm_f_17)
        _jm_obj_0_map.set("minimum", _jm_f_18)
        _jm_obj_0_map.set("multipleOf", _jm_f_19)
        _jm_obj_0_map.set("not", _jm_f_20)
        _jm_obj_0_map.set("oneOf", _jm_f_21)
        ...
        _jm_cst_3.add("int")
        _jm_cst_3.add("long")
        _jm_cst_3.add("decimal")
        _jm_cst_3.add("binData")
        _jm_cst_3.add("objectId")
        _jm_cst_3.add("date")
        _jm_cst_3.add("regex")
        _jm_cst_3.add("javascript")
        _jm_cst_3.add("timestamp")
        _jm_cst_3.add("minKey")
        _jm_cst_3.add("maxKey")
