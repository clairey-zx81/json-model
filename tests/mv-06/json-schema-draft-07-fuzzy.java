...
public class json_schema_draft_07_fuzzy extends ModelChecker
{
    ...
    public boolean _jm_obj_3(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (! res)
            {
                if (rep != null) rep.addEntry("not a bool [.'$schema#ObjectSchema'.dependencies.''.'|'.0]", (path != null ? lpath_2 : null));
            }
            if (! res)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected $ObjectSchema [.'$schema#ObjectSchema'.dependencies.''.'|'.1]", (path != null ? lpath_2 : null));
                }
                if (! res)
                {
                    ...
                    if (res)
                    {
                        ...
                        while (arr_1_item_loop.hasNext())
                        {
                            ...
                            if (! res)
                            {
                                if (rep != null) rep.addEntry("unexpected string [.'$schema#ObjectSchema'.dependencies.''.'|'.2.0]", ((path != null ? lpath_2 : null) != null ? arr_1_lpath : null));
                            }
                            if (! res)
                            {
                                break;
                    ...
                    if (! res)
                    {
                        if (rep != null) rep.addEntry("not array or unexpected array [.'$schema#ObjectSchema'.dependencies.''.'|'.2]", (path != null ? lpath_2 : null));
                    }
                }
            }
            if (res)
    ...
    public boolean _jm_obj_0(Object val, Path path, Report rep)
    {
        ...
        if (json.objectHasProp(val, "type"))
        {
            ...
            if (! res)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected $arrayTypes [.'$schema#ObjectSchema'.type.'|'.0]", path);
                }
                if (res)
                {
                    if (rep != null) rep.clearEntries();
