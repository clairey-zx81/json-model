...
export function check_model_init()
{
    if (! initialized)
    {
        ...
        json_model_8_map.set("const", _jm_f_2)
        json_model_8_map.set("contains", json_model_9)
        json_model_8_map.set("contentEncoding", _jm_f_3)
        json_model_8_map.set("contentMediaType", _jm_f_4)
        json_model_8_map.set("default", _jm_f_5)
        json_model_8_map.set("definitions", _jm_f_6)
        json_model_8_map.set("dependencies", _jm_f_7)
        json_model_8_map.set("description", _jm_f_8)
        json_model_8_map.set("else", json_model_9)
        json_model_8_map.set("enum", _jm_f_9)
        json_model_8_map.set("examples", _jm_f_10)
        json_model_8_map.set("exclusiveMaximum", _jm_f_11)
        json_model_8_map.set("exclusiveMinimum", _jm_f_12)
        json_model_8_map.set("format", _jm_f_13)
        json_model_8_map.set("if", json_model_9)
        json_model_8_map.set("items", _jm_f_14)
        json_model_8_map.set("maxItems", _jm_f_15)
        json_model_8_map.set("maxLength", _jm_f_16)
        json_model_8_map.set("maxProperties", _jm_f_17)
        json_model_8_map.set("maximum", _jm_f_18)
        json_model_8_map.set("minItems", _jm_f_19)
        json_model_8_map.set("minLength", _jm_f_20)
        json_model_8_map.set("minProperties", _jm_f_21)
        json_model_8_map.set("minimum", _jm_f_22)
        json_model_8_map.set("multipleOf", _jm_f_23)
        json_model_8_map.set("not", json_model_9)
        json_model_8_map.set("oneOf", json_model_5)
        json_model_8_map.set("pattern", _jm_f_24)
        json_model_8_map.set("patternProperties", _jm_f_25)
        json_model_8_map.set("properties", _jm_f_26)
        json_model_8_map.set("propertyNames", json_model_9)
        json_model_8_map.set("readOnly", _jm_f_27)
        json_model_8_map.set("required", _jm_f_28)
        json_model_8_map.set("then", json_model_9)
        json_model_8_map.set("title", _jm_f_29)
        json_model_8_map.set("type", _jm_f_30)
        json_model_8_map.set("uniqueItems", _jm_f_31)
        json_model_8_map.set("writeOnly", _jm_f_32)
        _jm_cst_0.add("null")
