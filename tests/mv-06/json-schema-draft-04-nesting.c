...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        json_model_3_map_tab[4] = (jm_propmap_t) { "allOf", _jm_f_4 };
        json_model_3_map_tab[5] = (jm_propmap_t) { "anyOf", _jm_f_5 };
        json_model_3_map_tab[6] = (jm_propmap_t) { "default", _jm_f_6 };
        json_model_3_map_tab[7] = (jm_propmap_t) { "definitions", _jm_f_7 };
        json_model_3_map_tab[8] = (jm_propmap_t) { "dependencies", _jm_f_8 };
        json_model_3_map_tab[9] = (jm_propmap_t) { "description", _jm_f_9 };
        json_model_3_map_tab[10] = (jm_propmap_t) { "enum", _jm_f_10 };
        json_model_3_map_tab[11] = (jm_propmap_t) { "exclusiveMaximum", _jm_f_11 };
        json_model_3_map_tab[12] = (jm_propmap_t) { "exclusiveMinimum", _jm_f_12 };
        ...
        json_model_3_map_tab[18] = (jm_propmap_t) { "maxProperties", _jm_f_18 };
        json_model_3_map_tab[19] = (jm_propmap_t) { "maximum", _jm_f_19 };
        json_model_3_map_tab[20] = (jm_propmap_t) { "minItems", _jm_f_20 };
        json_model_3_map_tab[21] = (jm_propmap_t) { "minLength", _jm_f_21 };
        json_model_3_map_tab[22] = (jm_propmap_t) { "minProperties", _jm_f_22 };
        json_model_3_map_tab[23] = (jm_propmap_t) { "minimum", _jm_f_23 };
        json_model_3_map_tab[24] = (jm_propmap_t) { "multipleOf", _jm_f_24 };
        json_model_3_map_tab[25] = (jm_propmap_t) { "not", _jm_f_25 };
        json_model_3_map_tab[26] = (jm_propmap_t) { "oneOf", _jm_f_26 };
        json_model_3_map_tab[27] = (jm_propmap_t) { "pattern", _jm_f_27 };
        json_model_3_map_tab[28] = (jm_propmap_t) { "patternProperties", _jm_f_28 };
        json_model_3_map_tab[29] = (jm_propmap_t) { "properties", _jm_f_29 };
        json_model_3_map_tab[30] = (jm_propmap_t) { "required", _jm_f_30 };
        json_model_3_map_tab[31] = (jm_propmap_t) { "title", _jm_f_31 };
        json_model_3_map_tab[32] = (jm_propmap_t) { "type", _jm_f_32 };
        json_model_3_map_tab[33] = (jm_propmap_t) { "uniqueItems", _jm_f_33 };
