        ...
        if (! res)
        {
            ...
            if (res)
            {
                ...
                json_array_foreach(pval, arr_1_idx, arr_1_item)
                {
                    ...
                    if (unlikely(! res))
                    {
                        if (rep) jm_report_add_entry(rep, "unexpected string [.'$schema#ObjectSchema'.dependencies.''.'|'.1.0]", ((path ? &lpath_3 : NULL) ? &arr_1_lpath : NULL));
                        break;
                    }
                }
            }
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "not array or unexpected array [.'$schema#ObjectSchema'.dependencies.''.'|'.1]", (path ? &lpath_3 : NULL));
            }
        }
        if (likely(res))
        {
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_str_eq_5(prop, 0x0000000065707974LL)))
        {
            ...
            if (! res)
            {
                ...
                if (unlikely(! res))
                {
                    if (rep) jm_report_add_entry(rep, "unexpected $arrayTypes [.'$schema#ObjectSchema'.type.'|'.1]", (path ? &lpath_0 : NULL));
                }
            }
            if (likely(res))
            {
        ...
        else if (unlikely(jm_str_eq_8(prop, 0x6465726975716572LL) && jm_str_eq_0(prop + 8)))
        {
            ...
            if (res)
            {
                ...
                json_array_foreach(pval, arr_0_idx, arr_0_item)
                {
                    ...
                    if (unlikely(! res))
                    {
                        if (rep) jm_report_add_entry(rep, "unexpected string [.'$schema#ObjectSchema'.required.0]", ((path ? &lpath_0 : NULL) ? &arr_0_lpath : NULL));
                        break;
                    }
                }
            }
