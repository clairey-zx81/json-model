...
public class base_000 extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> base_000_map_pmap;
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            base_000_map_pmap = new HashMap<String, Checker>();
            base_000_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        ...
        {
            super.free();
            base_000_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return base_000_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return base_000_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new base_000();
        Main.main("base_000", checker, VERSION, args);
    }
}
