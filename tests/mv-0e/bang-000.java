...
public class bang_000 extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> bang_000_map_pmap;
    ...
    public boolean _jm_obj_0(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            else if (prop.compareTo("_") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not a bool [._]", (path != null ? lpath_0 : null));
                }
                if (! res)
                {
            ...
            else if (prop.compareTo("b") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not null [.b]", (path != null ? lpath_0 : null));
                }
                if (! res)
                {
        ...
        if (must_count != 5)
        {
            if (rep != null)
            {
                ...
                if (! json.objectHasProp(val, "_"))
                {
                    if (rep != null) rep.addEntry("missing mandatory prop <_> [.]", path);
                }
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            bang_000_map_pmap = new HashMap<String, Checker>();
            bang_000_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    static public void main(String[] args) throws Exception
    {
        ...
        Main.main("bang_000", checker, VERSION, args);
    }
}
