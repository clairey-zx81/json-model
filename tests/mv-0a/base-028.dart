...
bool json_model_1(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    for (var entry in val.entries)
    {
        ...
        if (prop.compareTo("country") == 0)
        {
            ...
            // .country
            res = (pval is String) && pval.compareTo("South Africa") == 0;
            if (! res)
            {
                rep?.add(["unexpected _South Africa [.country]", (path != null ? lpath_0 : null)]);
                rep?.add(["invalid optional prop value [.country]", (path != null ? lpath_0 : null)]);
                return false;
            }
            continue;
        }
