...
public class ppp_002 extends ModelChecker
{
    ...
    public boolean json_model_1(Object val, Path path, Report rep)
    {
        ...
        if (! res)
        {
            if (rep != null) rep.addEntry("not a -1 strict int [.c]", (path != null ? lpath : null));
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            ppp_002_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
