...
def json_model_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.'$t']", path))
    return res
...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.'$x'.a]", lpath if path is not None else None))
    ...
    res = isinstance(pval, str) and pval == "cst_01"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.'$x'.b]", lpath if path is not None else None))
...
def json_model_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(pval, str) and pval == "cst_01"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.'$y'.c]", lpath if path is not None else None))
    ...
    res = isinstance(pval, str) and pval == "cst_01"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.'$y'.d]", lpath if path is not None else None))
