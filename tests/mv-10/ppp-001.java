...
public class ppp_001 extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> ppp_001_map_pmap;
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            ppp_001_map_pmap = new HashMap<String, Checker>();
            ppp_001_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        ...
        {
            super.free();
            ppp_001_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return ppp_001_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return ppp_001_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new ppp_001();
        Main.main("ppp_001", checker, VERSION, args);
    }
}
