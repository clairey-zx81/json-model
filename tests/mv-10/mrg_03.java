...
public class mrg_03 extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> mrg_03_map_pmap;
    ...
    public boolean _jm_obj_0(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            else if (prop.compareTo("b") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected string [.b]", (path != null ? lpath_0 : null));
                }
                if (! res)
                {
            ...
            else if (prop.compareTo("c") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not a 1.0 strict float [.c]", (path != null ? lpath_0 : null));
                }
                if (! res)
                {
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            mrg_03_map_pmap = new HashMap<String, Checker>();
            mrg_03_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        ...
        {
            super.free();
            mrg_03_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return mrg_03_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return mrg_03_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new mrg_03();
        Main.main("mrg_03", checker, VERSION, args);
    }
}
