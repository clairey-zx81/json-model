...
def json_model_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_02\" [.'$t']", path))
    return res
...
def json_model_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(pval, str) and pval == "cst_01"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.'$r'.b]", lpath if path is not None else None))
    ...
    res = isinstance(pval, str) and pval == "cst_01"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.'$r'.c]", lpath if path is not None else None))
    ...
    res = isinstance(pval, str) and pval == "cst_01"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.'$r'.d]", lpath if path is not None else None))
...
def json_model_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(pval, str) and pval == "cst_02"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_02\" [.'$z'.f]", lpath if path is not None else None))
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(pval, str) and pval == "cst_01"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.b]", lpath if path is not None else None))
    ...
    res = isinstance(pval, str) and pval == "cst_02"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_02\" [.e]", lpath if path is not None else None))
    ...
    res = isinstance(pval, str) and pval == "cst_02"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_02\" [.f]", lpath if path is not None else None))
    ...
    res = isinstance(pval, str) and pval == "cst_01"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.c]", lpath if path is not None else None))
    ...
    res = isinstance(pval, str) and pval == "cst_01"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_cst_01\" [.d]", lpath if path is not None else None))
