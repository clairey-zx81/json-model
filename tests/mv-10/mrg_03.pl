...
sub json_model_1($$$)
{
    ...
    unless ($res)
    {
        push @$rep, ["not a 1 strict int [.a]", defined $path ? $lpath : undef] if defined $rep;
    ...
    unless ($res)
    {
        push @$rep, ["unexpected value for model \"\" [.b]", defined $path ? $lpath : undef] if defined $rep;
    ...
    unless ($res)
    {
        push @$rep, ["not a 1.0 strict float [.c]", defined $path ? $lpath : undef] if defined $rep;
