...
char *CHECK_init(void)
{
    if (!initialized)
    {
        ...
        _jm_map_0_tab[0] = (jm_constmap_t) { (jm_constant_t) { cst_is_integer, { .i = 18 } }, _jm_obj_0 };
        _jm_map_0_tab[1] = (jm_constmap_t) { (jm_constant_t) { cst_is_integer, { .i = 42 } }, _jm_obj_1 };
        _jm_map_0_tab[2] = (jm_constmap_t) { (jm_constant_t) { cst_is_integer, { .i = 1024 } }, _jm_obj_2 };
