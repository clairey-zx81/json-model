...
sub _jm_obj_0($$$)
{
    ...
    unless ($res)
    {
        push @$rep, ["unexpected value for model \"=3.1415927\" [.'|'.0.t]", defined $path ? $lpath : undef] if defined $rep;
        push @$rep, ["unexpected value for mandatory prop <t> [.'|'.0]", defined $path ? $lpath : undef] if defined $rep;
        return 0;
    }
    unless (exists $$val{"pi"})
    {
        push @$rep, ["missing mandatory prop <pi> [.'|'.0]", $path] if defined $rep;
        return 0;
    }
    $lpath = defined $path ? [@{$path}, "pi"] : undef;
    $pval = $$val{"pi"};
    # .'|'.0.pi
    $res = jm_is_string($pval);
    unless ($res)
    {
        push @$rep, ["unexpected value for model \"\" [.'|'.0.pi]", defined $path ? $lpath : undef] if defined $rep;
        push @$rep, ["unexpected value for mandatory prop <pi> [.'|'.0]", defined $path ? $lpath : undef] if defined $rep;
        return 0;
    }
    return 1;
}
...
sub _jm_obj_1($$$)
{
    ...
    unless ($res)
    {
        push @$rep, ["unexpected value for model \"=1.0\" [.'|'.1.t]", defined $path ? $lpath : undef] if defined $rep;
        push @$rep, ["unexpected value for mandatory prop <t> [.'|'.1]", defined $path ? $lpath : undef] if defined $rep;
        return 0;
    }
    unless (exists $$val{"one"})
    {
        push @$rep, ["missing mandatory prop <one> [.'|'.1]", $path] if defined $rep;
        return 0;
    }
    $lpath = defined $path ? [@{$path}, "one"] : undef;
    $pval = $$val{"one"};
    # .'|'.1.one
    $res = jm_is_string($pval);
    unless ($res)
    {
        push @$rep, ["unexpected value for model \"\" [.'|'.1.one]", defined $path ? $lpath : undef] if defined $rep;
        push @$rep, ["unexpected value for mandatory prop <one> [.'|'.1]", defined $path ? $lpath : undef] if defined $rep;
        return 0;
    }
    return 1;
}
...
sub _jm_obj_2($$$)
{
    ...
    unless ($res)
    {
        push @$rep, ["unexpected value for model \"=0.5\" [.'|'.2.t]", defined $path ? $lpath : undef] if defined $rep;
        push @$rep, ["unexpected value for mandatory prop <t> [.'|'.2]", defined $path ? $lpath : undef] if defined $rep;
        return 0;
    }
    unless (exists $$val{"half"})
    {
        push @$rep, ["missing mandatory prop <half> [.'|'.2]", $path] if defined $rep;
        return 0;
    }
    $lpath = defined $path ? [@{$path}, "half"] : undef;
    $pval = $$val{"half"};
    # .'|'.2.half
    $res = jm_is_string($pval);
    unless ($res)
    {
        push @$rep, ["unexpected value for model \"\" [.'|'.2.half]", defined $path ? $lpath : undef] if defined $rep;
        push @$rep, ["unexpected value for mandatory prop <half> [.'|'.2]", defined $path ? $lpath : undef] if defined $rep;
        return 0;
    }
    return 1;
}
