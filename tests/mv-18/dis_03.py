...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'|'.0.x]", lpath if path is not None else None))
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(pval, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'|'.1.y]", lpath if path is not None else None))
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        tag_0: Jsonable
        if (tag_0 := val.get("discriminator", UNDEFINED)) != UNDEFINED:
