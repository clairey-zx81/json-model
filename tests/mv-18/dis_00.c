...
static INLINE bool _jm_obj_0(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (likely(jm_str_eq_4(prop, 0x00676174)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"a\" [.'|'.0.tag]", (path ? &lpath_0 : NULL));
...
static INLINE bool _jm_obj_1(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (likely(jm_str_eq_4(prop, 0x00676174)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"b\" [.'|'.1.tag]", (path ? &lpath_1 : NULL));
...
static INLINE bool _jm_obj_2(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (likely(jm_str_eq_4(prop, 0x00676174)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"c\" [.'|'.2.tag]", (path ? &lpath_2 : NULL));
...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_map_0_tab[2] = (jm_constmap_t) { (jm_constant_t) { 2, { .s = "c" } }, _jm_obj_2 };
