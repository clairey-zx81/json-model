...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "Model":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_$https://json-model.org/models/json-model\" [.'$'.Model]", lpath_1 if path is not None else None))
        ...
        if prop == "":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$'.'']", lpath_1 if path is not None else None))
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop.startswith("#"):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'%'.'/^#/']", lpath_2 if path is not None else None))
                return False
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop.startswith("#"):
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'/^#/']", lpath_0 if path is not None else None))
                return False
        else:
