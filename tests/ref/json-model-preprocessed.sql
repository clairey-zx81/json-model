      ...
      IF NOT res THEN
        ...
        IF res THEN
          FOR arr_6_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
            ...
            -- .'$Model#Root'.'|'.3.'%'.'<'.'|'.1.0
            res := json_model_10(arr_6_item, NULL, NULL);
            IF NOT res THEN
              EXIT;
            END IF;
          END LOOP;
    ...
    IF prop = '^' THEN
      ...
      IF res THEN
        FOR arr_5_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
          ...
          -- .'$Model#Root'.'|'.3.'^'.0
          res := json_model_21(arr_5_item, NULL, NULL);
          IF NOT res THEN
            EXIT;
          END IF;
        END LOOP;
      ...
      IF NOT res THEN
        ...
        IF res THEN
          FOR arr_8_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
            ...
            -- .'$Model#Root'.'|'.2.'%'.'<'.'|'.1.0
            res := json_model_10(arr_8_item, NULL, NULL);
            IF NOT res THEN
              EXIT;
            END IF;
          END LOOP;
    ...
    IF prop = '&' THEN
      ...
      IF res THEN
        FOR arr_7_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
          ...
          -- .'$Model#Root'.'|'.2.'&'.0
          res := json_model_21(arr_7_item, NULL, NULL);
          IF NOT res THEN
            EXIT;
          END IF;
        END LOOP;
      ...
      IF NOT res THEN
        ...
        IF res THEN
          FOR arr_10_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
            ...
            -- .'$Model#Root'.'|'.1.'%'.'<'.'|'.1.0
            res := json_model_10(arr_10_item, NULL, NULL);
            IF NOT res THEN
              EXIT;
            END IF;
          END LOOP;
    ...
    IF prop = '|' THEN
      ...
      IF res THEN
        FOR arr_9_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
          ...
          -- .'$Model#Root'.'|'.1.'|'.0
          res := json_model_21(arr_9_item, NULL, NULL);
          IF NOT res THEN
            EXIT;
          END IF;
        END LOOP;
...
BEGIN
  ...
  -- .'$Model#Root'.'|'.3
  -- .'$Model#Root'.'|'.4
  RETURN JSONB_TYPEOF(val) = 'object' AND (_jm_obj_17(val, NULL, NULL) OR _jm_obj_14(val, NULL, NULL) OR _jm_obj_11(val, NULL, NULL) OR _jm_obj_8(val, NULL, NULL) OR _jm_obj_5(val, NULL, NULL));
END;
$$ LANGUAGE PLpgSQL;
