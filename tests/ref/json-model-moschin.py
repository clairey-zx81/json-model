...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.5.'#']", lpath_0 if path is not None else None))
                return False
        elif prop == ".schema":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.5.'.schema']", lpath_0 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.5.'.schema']", lpath_0 if path is not None else None))
                return False
...
def _jm_obj_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "+":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$Model#Elem'.'|'.4.'+']", lpath_1 if path is not None else None))
                return False
        elif prop == "#":
            # handle may # property
            # .'$Model#Elem'.'|'.4.'#'
            ...
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.4.'#']", lpath_1 if path is not None else None))
                return False
        elif prop == ".schema":
            # handle may .schema property
            # .'$Model#Elem'.'|'.4.'.schema'
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.4.'.schema']", lpath_1 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.4.'.schema']", lpath_1 if path is not None else None))
                return False
        else:
    ...
    if must_count != 1:
        if rep is not None:
            if not "+" in val:
                rep is None or rep.append(("missing mandatory prop <+> [.'$Model#Elem'.'|'.4]", path))
        return False
    return True
...
def _jm_obj_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "^":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$Model#Elem'.'|'.3.'^']", lpath_2 if path is not None else None))
                return False
        elif prop == "#":
            # handle may # property
            # .'$Model#Elem'.'|'.3.'#'
            ...
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.3.'#']", lpath_2 if path is not None else None))
                return False
        elif prop == ".schema":
            # handle may .schema property
            # .'$Model#Elem'.'|'.3.'.schema'
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.3.'.schema']", lpath_2 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.3.'.schema']", lpath_2 if path is not None else None))
                return False
        else:
...
def _jm_obj_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "&":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$Model#Elem'.'|'.2.'&']", lpath_3 if path is not None else None))
                return False
        elif prop == "#":
            # handle may # property
            # .'$Model#Elem'.'|'.2.'#'
            ...
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.2.'#']", lpath_3 if path is not None else None))
                return False
        elif prop == ".schema":
            # handle may .schema property
            # .'$Model#Elem'.'|'.2.'.schema'
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.2.'.schema']", lpath_3 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.2.'.schema']", lpath_3 if path is not None else None))
                return False
        else:
...
def _jm_obj_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "|":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$Model#Elem'.'|'.1.'|']", lpath_4 if path is not None else None))
                return False
        elif prop == "#":
            # handle may # property
            # .'$Model#Elem'.'|'.1.'#'
            ...
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.1.'#']", lpath_4 if path is not None else None))
                return False
        elif prop == ".schema":
            # handle may .schema property
            # .'$Model#Elem'.'|'.1.'.schema'
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.1.'.schema']", lpath_4 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.1.'.schema']", lpath_4 if path is not None else None))
                return False
        else:
...
def _jm_obj_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "@":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$Model#Elem'.'|'.0.'@']", lpath_5 if path is not None else None))
                return False
        elif prop == "#":
            # handle may # property
            # .'$Model#Elem'.'|'.0.'#'
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected string [.'$Model#Elem'.'|'.0.'#']", lpath_5 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.0.'#']", lpath_5 if path is not None else None))
                return False
        elif prop == ".schema":
            # handle may .schema property
            # .'$Model#Elem'.'|'.0.'.schema'
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.0.'.schema']", lpath_5 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.0.'.schema']", lpath_5 if path is not None else None))
                return False
        elif prop == "!":
            # handle may ! property
            # .'$Model#Elem'.'|'.0.'!'
            ...
            if not res:
                rep is None or rep.append(("not a bool [.'$Model#Elem'.'|'.0.'!']", lpath_5 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.0.'!']", lpath_5 if path is not None else None))
                return False
        elif prop == ".mo":
            ...
            if not res:
                rep is None or rep.append(("not a 1 strict int [.'$Model#Elem'.'|'.0.'.mo']", lpath_5 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.0.'.mo']", lpath_5 if path is not None else None))
                return False
        elif prop == ".in":
            ...
            res = json_model_19(pval, lpath_5 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected $Model [.'$Model#Elem'.'|'.0.'.in']", lpath_5 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Elem'.'|'.0.'.in']", lpath_5 if path is not None else None))
                return False
...
def json_model_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if not res:
            rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.0]", path))
        if not res:
            # .'$Model#Elem'.'|'.1
            res = _jm_obj_8(val, path, rep)
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.1]", path))
            if not res:
                # .'$Model#Elem'.'|'.2
                res = _jm_obj_6(val, path, rep)
                if not res:
                    rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.2]", path))
                if not res:
                    # .'$Model#Elem'.'|'.3
                    res = _jm_obj_4(val, path, rep)
                    if not res:
                        rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.3]", path))
                    if not res:
                        # .'$Model#Elem'.'|'.4
                        res = _jm_obj_2(val, path, rep)
                        if not res:
                            rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.4]", path))
                        if not res:
                            # .'$Model#Elem'.'|'.5
                            res = _jm_obj_0(val, path, rep)
                            if not res:
                                rep is None or rep.append(("unexpected object [.'$Model#Elem'.'|'.5]", path))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.5.'$'.'.schema']", lpath_7 if path is not None else None))
            if not res:
...
def _jm_obj_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.5.'%'.'.schema']", lpath_8 if path is not None else None))
            if not res:
            ...
            # .'$Model#Root'.'|'.5.'%'.'/^\\..+$/'
            # "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = isinstance(pval, str) and _jm_re_5(pval, lpath_8 if path is not None else None, rep)
            if not res:
...
def _jm_obj_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "~":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.5.'$']", lpath_6 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Root'.'|'.5.'$']", lpath_6 if path is not None else None))
                return False
        elif prop == "%":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.5.'.schema']", lpath_6 if path is not None else None))
            if not res:
...
def _jm_obj_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.4.'$'.'.schema']", lpath_10 if path is not None else None))
            if not res:
...
def _jm_obj_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.4.'%'.'.schema']", lpath_11 if path is not None else None))
            if not res:
            ...
            # .'$Model#Root'.'|'.4.'%'.'/^\\..+$/'
            # "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = isinstance(pval, str) and _jm_re_5(pval, lpath_11 if path is not None else None, rep)
            if not res:
...
def _jm_obj_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "+":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.4.'$']", lpath_9 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Root'.'|'.4.'$']", lpath_9 if path is not None else None))
                return False
        elif prop == "%":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.4.'.schema']", lpath_9 if path is not None else None))
            if not res:
...
def _jm_obj_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.3.'$'.'.schema']", lpath_13 if path is not None else None))
            if not res:
...
def _jm_obj_27(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.3.'%'.'.schema']", lpath_14 if path is not None else None))
            if not res:
            ...
            # .'$Model#Root'.'|'.3.'%'.'/^\\..+$/'
            # "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = isinstance(pval, str) and _jm_re_5(pval, lpath_14 if path is not None else None, rep)
            if not res:
...
def _jm_obj_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "^":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.3.'$']", lpath_12 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Root'.'|'.3.'$']", lpath_12 if path is not None else None))
                return False
        elif prop == "%":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.3.'.schema']", lpath_12 if path is not None else None))
            if not res:
...
def _jm_obj_31(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.2.'$'.'.schema']", lpath_16 if path is not None else None))
            if not res:
...
def _jm_obj_33(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.2.'%'.'.schema']", lpath_17 if path is not None else None))
            if not res:
            ...
            # .'$Model#Root'.'|'.2.'%'.'/^\\..+$/'
            # "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = isinstance(pval, str) and _jm_re_5(pval, lpath_17 if path is not None else None, rep)
            if not res:
...
def _jm_obj_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "&":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.2.'$']", lpath_15 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Root'.'|'.2.'$']", lpath_15 if path is not None else None))
                return False
        elif prop == "%":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.2.'.schema']", lpath_15 if path is not None else None))
            if not res:
...
def _jm_obj_37(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.1.'$'.'.schema']", lpath_19 if path is not None else None))
            if not res:
...
def _jm_obj_39(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.1.'%'.'.schema']", lpath_20 if path is not None else None))
            if not res:
            ...
            # .'$Model#Root'.'|'.1.'%'.'/^\\..+$/'
            # "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = isinstance(pval, str) and _jm_re_5(pval, lpath_20 if path is not None else None, rep)
            if not res:
...
def _jm_obj_36(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "|":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.1.'$']", lpath_18 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Root'.'|'.1.'$']", lpath_18 if path is not None else None))
                return False
        elif prop == "%":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.1.'.schema']", lpath_18 if path is not None else None))
            if not res:
...
def _jm_obj_43(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.0.'$'.'.schema']", lpath_22 if path is not None else None))
            if not res:
...
def _jm_f_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.0.'$']", path))
    return res
...
def _jm_obj_45(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.0.'%'.'.schema']", lpath_23 if path is not None else None))
            if not res:
            ...
            # .'$Model#Root'.'|'.0.'%'.'/^\\..+$/'
            # "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = isinstance(pval, str) and _jm_re_5(pval, lpath_23 if path is not None else None, rep)
            if not res:
...
def _jm_f_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.0.'.schema']", path))
    return res
...
def json_model_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if not res:
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.1]", path))
            if not res:
                # .'$Model#Root'.'|'.2
                res = _jm_obj_30(val, path, rep)
                if not res:
                    rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.2]", path))
                if not res:
                    # .'$Model#Root'.'|'.3
                    res = _jm_obj_24(val, path, rep)
                    if not res:
                        rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.3]", path))
                    if not res:
                        # .'$Model#Root'.'|'.4
                        res = _jm_obj_18(val, path, rep)
                        if not res:
                            rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.4]", path))
                        if not res:
                            # .'$Model#Root'.'|'.5
                            res = _jm_obj_12(val, path, rep)
                            if not res:
                                rep is None or rep.append(("unexpected object [.'$Model#Root'.'|'.5]", path))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_48(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "*":
            ...
            if not res:
                ...
                if not res:
                    rep is None or rep.append(("unexpected object [.'$Model#Trafo'.'|'.2.'*'.'|'.1]", lpath_24 if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
                rep is None or rep.append(("no model matched [.'$Model#Trafo'.'|'.2.'*'.'|']", lpath_24 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$Model#Trafo'.'|'.2.'*']", lpath_24 if path is not None else None))
                return False
        elif prop == "#":
            # handle may # property
            # .'$Model#Trafo'.'|'.2.'#'
            ...
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Trafo'.'|'.2.'#']", lpath_24 if path is not None else None))
                return False
        elif prop == ".schema":
            # handle may .schema property
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Trafo'.'|'.2.'.schema']", lpath_24 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Trafo'.'|'.2.'.schema']", lpath_24 if path is not None else None))
                return False
        elif prop == "/":
            # handle may / property
            # .'$Model#Trafo'.'|'.2.'/'
    ...
    if must_count != 1:
        if rep is not None:
            if not "*" in val:
                rep is None or rep.append(("missing mandatory prop <*> [.'$Model#Trafo'.'|'.2]", path))
        return False
    return True
...
def _jm_obj_51(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "/":
            ...
            if not res:
                rep is None or rep.append(("invalid mandatory prop value [.'$Model#Trafo'.'|'.1.'/']", lpath_26 if path is not None else None))
                return False
        elif prop == "#":
            # handle may # property
            # .'$Model#Trafo'.'|'.1.'#'
            ...
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Trafo'.'|'.1.'#']", lpath_26 if path is not None else None))
                return False
        elif prop == ".schema":
            # handle may .schema property
            ...
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Trafo'.'|'.1.'.schema']", lpath_26 if path is not None else None))
            if not res:
                rep is None or rep.append(("invalid optional prop value [.'$Model#Trafo'.'|'.1.'.schema']", lpath_26 if path is not None else None))
                return False
        elif prop == "*":
            # handle may * property
            # .'$Model#Trafo'.'|'.1.'*'
            ...
            if not res:
                ...
                if not res:
                    rep is None or rep.append(("unexpected object [.'$Model#Trafo'.'|'.1.'*'.'|'.1]", lpath_26 if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
    ...
    if must_count != 1:
        if rep is not None:
            if not "/" in val:
                rep is None or rep.append(("missing mandatory prop </> [.'$Model#Trafo'.'|'.1]", path))
        return False
    return True
...
def json_model_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        ...
        if not res:
            rep is None or rep.append(("unexpected object [.'$Model#Trafo'.'|'.1]", path))
        if not res:
            # .'$Model#Trafo'.'|'.2
            res = _jm_obj_48(val, path, rep)
            if not res:
                rep is None or rep.append(("unexpected object [.'$Model#Trafo'.'|'.2]", path))
    if res:
        rep is None or rep.clear()
    else:
