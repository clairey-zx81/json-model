...
public class json_model_moschin extends ModelChecker
{
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            json_model_moschin_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_43(o, p, r);} });
            json_model_moschin_map_pmap.put("Model", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_43(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
