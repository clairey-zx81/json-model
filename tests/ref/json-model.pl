...
sub json_model_16($$$)
{
    ...
    if ($res)
    {
        for my $arr_0_idx (0 .. $#$val)
        {
            ...
            # .'$Array'.0
            $res = json_model_29($arr_0_item, undef, $rep);
            if (! $res)
            {
                last;
            }
        ...
        if ($prop eq '|')
        {
            ...
            if ($res)
            {
                for my $arr_1_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Or'.'|'.0
                    $res = json_model_29($arr_1_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
        ...
        if ($prop eq '^')
        {
            ...
            if ($res)
            {
                for my $arr_3_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Xor'.'^'.0
                    $res = json_model_29($arr_3_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
        ...
        if ($prop eq '+')
        {
            ...
            if ($res)
            {
                for my $arr_4_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Add'.'+'.0
                    $res = json_model_29($arr_4_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
...
sub _jm_obj_6($$$)
{
    ...
    while (my ($prop, $pval) = each %$val)
    {
        if (json_model_22($prop, undef, $rep))
        {
            # handle 1 key props
            # .'$Obj'.'$Prop'
            $res = json_model_29($pval, undef, $rep);
...
sub _jm_obj_7($$$)
{
    ...
    while (my ($prop, $pval) = each %$val)
    {
        ...
        elsif (json_model_22($prop, undef, $rep))
        {
            # handle 1 key props
            # .'$Element'.'|'.5.'$Prop'
            $res = json_model_29($pval, undef, $rep);
        ...
        if ($prop eq '+')
        {
            ...
            if ($res)
            {
                for my $arr_5_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Element'.'|'.4.'+'.0
                    $res = json_model_29($arr_5_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
        ...
        if ($prop eq '^')
        {
            ...
            if ($res)
            {
                for my $arr_6_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Element'.'|'.3.'^'.0
                    $res = json_model_29($arr_6_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
        ...
        if ($prop eq '&')
        {
            ...
            if ($res)
            {
                for my $arr_7_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Element'.'|'.2.'&'.0
                    $res = json_model_29($arr_7_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
        ...
        if ($prop eq '|')
        {
            ...
            if ($res)
            {
                for my $arr_8_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Element'.'|'.1.'|'.0
                    $res = json_model_29($arr_8_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
...
sub _jm_obj_18($$$)
{
    ...
    while (my ($prop, $pval) = each %$val)
    {
        if (json_model_8($prop, undef, $rep))
        {
            # handle 1 key props
            # .'$Rename'.'$Name'
            # "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
...
sub _jm_obj_23($$$)
{
    ...
    while (my ($prop, $pval) = each %$val)
    {
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_10_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$RootOnly'.'%'.'<'.'|'.1.0
                        $res = json_model_4($arr_10_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        elsif (json_model_8($prop, undef, $rep))
        {
            # handle 1 key props
            # .'$RootOnly'.'%'.'$Name'
            # "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_11_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Root'.'|'.5.'%'.'<'.'|'.1.0
                        $res = json_model_4($arr_11_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_13_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Root'.'|'.4.'%'.'<'.'|'.1.0
                        $res = json_model_4($arr_13_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        if ($prop eq '+')
        {
            ...
            if ($res)
            {
                for my $arr_12_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Root'.'|'.4.'+'.0
                    $res = json_model_29($arr_12_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_15_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Root'.'|'.3.'%'.'<'.'|'.1.0
                        $res = json_model_4($arr_15_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        if ($prop eq '^')
        {
            ...
            if ($res)
            {
                for my $arr_14_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Root'.'|'.3.'^'.0
                    $res = json_model_29($arr_14_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_17_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Root'.'|'.2.'%'.'<'.'|'.1.0
                        $res = json_model_4($arr_17_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        if ($prop eq '&')
        {
            ...
            if ($res)
            {
                for my $arr_16_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Root'.'|'.2.'&'.0
                    $res = json_model_29($arr_16_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_19_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Root'.'|'.1.'%'.'<'.'|'.1.0
                        $res = json_model_4($arr_19_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        if ($prop eq '|')
        {
            ...
            if ($res)
            {
                for my $arr_18_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Root'.'|'.1.'|'.0
                    $res = json_model_29($arr_18_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
