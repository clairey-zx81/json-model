...
static bool _jm_obj_10(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (strcmp(prop, ".schema") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Elem'.'|'.0.'.schema']", (path ? &lpath_5 : NULL));
            }
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Elem'.'|'.0.'.schema']", (path ? &lpath_5 : NULL));
                return false;
            }
        }
        else if (strcmp(prop, "!") == 0)
        ...
        else if (strcmp(prop, ".mo") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "not a 1 strict int [.'$Model#Elem'.'|'.0.'.mo']", (path ? &lpath_5 : NULL));
            }
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Elem'.'|'.0.'.mo']", (path ? &lpath_5 : NULL));
                return false;
            }
        }
        else if (strcmp(prop, ".in") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Model [.'$Model#Elem'.'|'.0.'.in']", (path ? &lpath_5 : NULL));
            }
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Elem'.'|'.0.'.in']", (path ? &lpath_5 : NULL));
                return false;
            }
        }
...
static bool _jm_obj_12(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (strcmp(prop, "$") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Root'.'|'.5.'$']", (path ? &lpath_6 : NULL));
            }
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Root'.'|'.5.'$']", (path ? &lpath_6 : NULL));
        ...
        else if (strcmp(prop, ".schema") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Root'.'|'.5.'.schema']", (path ? &lpath_6 : NULL));
            }
            if (! res)
            {
...
static bool _jm_obj_18(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (strcmp(prop, "$") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Root'.'|'.4.'$']", (path ? &lpath_9 : NULL));
            }
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Root'.'|'.4.'$']", (path ? &lpath_9 : NULL));
        ...
        else if (strcmp(prop, ".schema") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Root'.'|'.4.'.schema']", (path ? &lpath_9 : NULL));
            }
            if (! res)
            {
...
static bool _jm_obj_24(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (strcmp(prop, "$") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Root'.'|'.3.'$']", (path ? &lpath_12 : NULL));
            }
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Root'.'|'.3.'$']", (path ? &lpath_12 : NULL));
        ...
        else if (strcmp(prop, ".schema") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Root'.'|'.3.'.schema']", (path ? &lpath_12 : NULL));
            }
            if (! res)
            {
...
static bool _jm_obj_30(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (strcmp(prop, "$") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Root'.'|'.2.'$']", (path ? &lpath_15 : NULL));
            }
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Root'.'|'.2.'$']", (path ? &lpath_15 : NULL));
        ...
        else if (strcmp(prop, ".schema") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Root'.'|'.2.'.schema']", (path ? &lpath_15 : NULL));
            }
            if (! res)
            {
...
static bool _jm_obj_36(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (strcmp(prop, "$") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Root'.'|'.1.'$']", (path ? &lpath_18 : NULL));
            }
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Root'.'|'.1.'$']", (path ? &lpath_18 : NULL));
        ...
        else if (strcmp(prop, ".schema") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected object [.'$Model#Root'.'|'.1.'.schema']", (path ? &lpath_18 : NULL));
            }
            if (! res)
            {
