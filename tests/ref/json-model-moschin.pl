...
sub json_model_18($$$)
{
    ...
    if ($res)
    {
        for my $arr_0_idx (0 .. $#$val)
        {
            ...
            # .'$Model#Array'.0
            $res = json_model_31($arr_0_item, undef, $rep);
            if (! $res)
            {
                last;
            }
...
sub _jm_obj_0($$$)
{
    ...
    while (my ($prop, $pval) = each %$val)
    {
        ...
        elsif (json_model_24($prop, undef, $rep))
        {
            # handle 1 key props
        ...
        if ($prop eq '+')
        {
            ...
            if ($res)
            {
                for my $arr_1_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Element'.'|'.4.'+'.0
                    $res = json_model_31($arr_1_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
        ...
        if ($prop eq '&')
        {
            ...
            if ($res)
            {
                for my $arr_3_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Element'.'|'.2.'&'.0
                    $res = json_model_31($arr_3_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
        ...
        if ($prop eq '|')
        {
            ...
            if ($res)
            {
                for my $arr_4_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Element'.'|'.1.'|'.0
                    $res = json_model_31($arr_4_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
...
sub _jm_obj_15($$$)
{
    ...
    while (my ($prop, $pval) = each %$val)
    {
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_5_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Model#Root'.'|'.5.'%'.'<'.'|'.1.0
                        $res = json_model_6($arr_5_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        elsif (json_model_10($prop, undef, $rep))
        {
            # handle 1 key props
            # .'$Model#Root'.'|'.5.'%'.'$Name'
            # "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_7_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Model#Root'.'|'.4.'%'.'<'.'|'.1.0
                        $res = json_model_6($arr_7_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        if ($prop eq '+')
        {
            ...
            if ($res)
            {
                for my $arr_6_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Root'.'|'.4.'+'.0
                    $res = json_model_31($arr_6_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_9_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Model#Root'.'|'.3.'%'.'<'.'|'.1.0
                        $res = json_model_6($arr_9_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        if ($prop eq '^')
        {
            ...
            if ($res)
            {
                for my $arr_8_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Root'.'|'.3.'^'.0
                    $res = json_model_31($arr_8_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_11_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Model#Root'.'|'.2.'%'.'<'.'|'.1.0
                        $res = json_model_6($arr_11_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        if ($prop eq '&')
        {
            ...
            if ($res)
            {
                for my $arr_10_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Root'.'|'.2.'&'.0
                    $res = json_model_31($arr_10_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_13_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Model#Root'.'|'.1.'%'.'<'.'|'.1.0
                        $res = json_model_6($arr_13_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        if ($prop eq '|')
        {
            ...
            if ($res)
            {
                for my $arr_12_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Root'.'|'.1.'|'.0
                    $res = json_model_31($arr_12_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
