...
sub json_model_31($$$)
{
    ...
    # .'$Model#Element'.'|'.3
    # .'$Model#Element'.'|'.4
    return jm_is_object($val) && (_jm_obj_4($val, $path, $rep) || _jm_obj_3($val, $path, $rep) || _jm_obj_2($val, $path, $rep) || _jm_obj_1($val, $path, $rep) || _jm_obj_0($val, $path, $rep));
}
        ...
        if ($prop eq '^')
        {
            ...
            if ($res)
            {
                for my $arr_5_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Root'.'|'.3.'^'.0
                    $res = json_model_20($arr_5_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
        ...
        if ($prop eq '&')
        {
            ...
            if ($res)
            {
                for my $arr_7_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Root'.'|'.2.'&'.0
                    $res = json_model_20($arr_7_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
        ...
        if ($prop eq '|')
        {
            ...
            if ($res)
            {
                for my $arr_9_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Root'.'|'.1.'|'.0
                    $res = json_model_20($arr_9_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
...
sub json_model_41($$$)
{
    ...
    # .'$Model#Root'.'|'.3
    # .'$Model#Root'.'|'.4
    return jm_is_object($val) && (_jm_obj_17($val, $path, $rep) || _jm_obj_14($val, $path, $rep) || _jm_obj_11($val, $path, $rep) || _jm_obj_8($val, $path, $rep) || _jm_obj_5($val, $path, $rep));
}
...
sub json_model_6($$$)
{
    ...
    # .'$Model#Identifier'.'&'.1
    # "/[^A-Z0-9]/"
    return jm_is_string($val) && _jm_re_10($val, $path, $rep) && _jm_re_9($val, $path, $rep);
}
