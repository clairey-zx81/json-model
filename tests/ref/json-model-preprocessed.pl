            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_4_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Model#Root'.'|'.4.'%'.'<'.'|'.1.0
                        $res = json_model_6($arr_4_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_6_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Model#Root'.'|'.3.'%'.'<'.'|'.1.0
                        $res = json_model_6($arr_6_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        if ($prop eq '^')
        {
            ...
            if ($res)
            {
                for my $arr_5_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Root'.'|'.3.'^'.0
                    $res = json_model_31($arr_5_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
        ...
        if ($prop eq '&')
        {
            ...
            if ($res)
            {
                for my $arr_7_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Root'.'|'.2.'&'.0
                    $res = json_model_31($arr_7_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
            ...
            if (! $res)
            {
                ...
                if ($res)
                {
                    for my $arr_10_idx (0 .. $#$pval)
                    {
                        ...
                        # .'$Model#Root'.'|'.1.'%'.'<'.'|'.1.0
                        $res = json_model_6($arr_10_item, undef, $rep);
                        if (! $res)
                        {
                            last;
                        }
        ...
        if ($prop eq '|')
        {
            ...
            if ($res)
            {
                for my $arr_9_idx (0 .. $#$pval)
                {
                    ...
                    # .'$Model#Root'.'|'.1.'|'.0
                    $res = json_model_31($arr_9_item, undef, $rep);
                    if (! $res)
                    {
                        last;
                    }
