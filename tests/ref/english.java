...
public class english extends ModelChecker
{
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            english_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_42(o, p, r);} });
            english_map_pmap.put("Model", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_42(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
