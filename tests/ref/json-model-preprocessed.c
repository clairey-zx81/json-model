...
static bool json_model_9(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (unlikely(! res))
    {
        if (rep) jm_report_add_entry(rep, "unexpected value for model \"/^\\\\$./\" [.'$Model#Ref']", path);
    }
    return res;
}
...
static INLINE bool _jm_obj_4(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_str_eq_4(prop, 0x006e692e)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Model\" [.'$Model#Element'.'|'.0.'.in']", (path ? &lpath_4 : NULL));
                if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Element'.'|'.0.'.in']", (path ? &lpath_4 : NULL));
                return false;
            }
            continue;
        }
        else if (unlikely(jm_str_eq_4(prop, 0x006f6d2e)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "not a 1 strict int [.'$Model#Element'.'|'.0.'.mo'.'|'.0]", (path ? &lpath_4 : NULL));
                // .'$Model#Element'.'|'.0.'.mo'.'|'.1
                res = json_is_real(pval) && json_real_value(pval) > 0.0;
                if (unlikely(! res))
                {
                    if (rep) jm_report_add_entry(rep, "not a 1.0 strict float [.'$Model#Element'.'|'.0.'.mo'.'|'.1]", (path ? &lpath_4 : NULL));
                }
            }
            if (likely(res))
            {
            ...
            {
                if (rep) jm_report_add_entry(rep, "no model matched [.'$Model#Element'.'|'.0.'.mo'.'|']", (path ? &lpath_4 : NULL));
                if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Element'.'|'.0.'.mo']", (path ? &lpath_4 : NULL));
                return false;
            }
            continue;
        }
    ...
    if (unlikely(! res))
    {
        ...
        if (unlikely(! res))
        {
            ...
            if (unlikely(! res))
            {
                ...
                if (unlikely(! res))
                {
                    if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Ref\" [.'$Model#Prop'.'|'.3]", path);
                    // .'$Model#Prop'.'|'.4
                    res = json_model_13(val, path, rep);
                    if (unlikely(! res))
                    {
                        if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Name\" [.'$Model#Prop'.'|'.4]", path);
                        // .'$Model#Prop'.'|'.5
                        res = json_is_string(val) && jm_str_eq_0(json_string_value(val));
                        if (unlikely(! res))
                        {
                            if (rep) jm_report_add_entry(rep, "unexpected value for model \"_\" [.'$Model#Prop'.'|'.5]", path);
                        }
                    }
                }
            }
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else
        {
            ...
            else if (jm_str_eq_4(prop, 0x006e692e))
            {
                ...
                if (unlikely(! res))
                {
                    if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Model\" [.'$Model#Root'.'|'.0.'.in']", (path ? &lpath_17 : NULL));
                    if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Root'.'|'.0.'.in']", (path ? &lpath_17 : NULL));
                    return false;
                }
                continue;
            }
            else if (jm_str_eq_4(prop, 0x006f6d2e))
            {
                ...
                if (unlikely(! res))
                {
                    if (rep) jm_report_add_entry(rep, "not a 1 strict int [.'$Model#Root'.'|'.0.'.mo'.'|'.0]", (path ? &lpath_17 : NULL));
                    // .'$Model#Root'.'|'.0.'.mo'.'|'.1
                    res = json_is_real(pval) && json_real_value(pval) > 0.0;
                    if (unlikely(! res))
                    {
                        if (rep) jm_report_add_entry(rep, "not a 1.0 strict float [.'$Model#Root'.'|'.0.'.mo'.'|'.1]", (path ? &lpath_17 : NULL));
                    }
                }
                if (likely(res))
                {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "no model matched [.'$Model#Root'.'|'.0.'.mo'.'|']", (path ? &lpath_17 : NULL));
                    if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'$Model#Root'.'|'.0.'.mo']", (path ? &lpath_17 : NULL));
                    return false;
                }
                continue;
            }
