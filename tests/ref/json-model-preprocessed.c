...
static jm_constant_t _jm_cst_1[29];
...
{
    // .'$Model#PreDef'
    bool res = json_is_string(val) && jm_search_cst(&(jm_constant_t) { cst_is_string, { .s = json_string_value(val) } }, _jm_cst_1, 29);;
    if (unlikely(! res))
    {
...
static INLINE bool _jm_obj_0(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_28, prop, (path ? &lpath_0 : NULL), rep)))
        {
            // handle 1 key props
...
static INLINE bool _jm_obj_4(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_str_eq_2(prop, 0x00000021)))
        {
            ...
            // .'$Model#Element'.'|'.0.'/^#/'
            res = true;
        else if (unlikely(_jm_re_3(prop, path, rep)))
        {
            // handle 3 re props
            // .'$Model#Element'.'|'.0.'/^(<=|>=|<|>)$/'
...
static INLINE bool _jm_obj_6(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_6, prop, (path ? &lpath_6 : NULL), rep)))
        {
            // handle 1 key props
...
static INLINE bool _jm_obj_7(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_13, prop, (path ? &lpath_7 : NULL), rep)))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.4.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
...
static INLINE bool _jm_obj_5(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_28, prop, (path ? &lpath_5 : NULL), rep)))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.4.'$Prop'
...
static INLINE bool _jm_obj_9(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_6, prop, (path ? &lpath_9 : NULL), rep)))
        {
            // handle 1 key props
...
static INLINE bool _jm_obj_10(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_13, prop, (path ? &lpath_10 : NULL), rep)))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.3.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
...
static INLINE bool _jm_obj_12(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_6, prop, (path ? &lpath_12 : NULL), rep)))
        {
            // handle 1 key props
...
static INLINE bool _jm_obj_13(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_13, prop, (path ? &lpath_13 : NULL), rep)))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.2.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
...
static INLINE bool _jm_obj_15(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_6, prop, (path ? &lpath_15 : NULL), rep)))
        {
            // handle 1 key props
...
static INLINE bool _jm_obj_16(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_13, prop, (path ? &lpath_16 : NULL), rep)))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.1.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
...
static INLINE bool _jm_obj_18(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_6, prop, (path ? &lpath_18 : NULL), rep)))
        {
            // handle 1 key props
...
static INLINE bool _jm_obj_19(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (unlikely(jm_check_fun_string(json_model_13, prop, (path ? &lpath_19 : NULL), rep)))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.0.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_cst_1[12] = (jm_constant_t) { cst_is_string, { .s = "$F16" } };
        _jm_cst_1[13] = (jm_constant_t) { cst_is_string, { .s = "$F32" } };
        _jm_cst_1[14] = (jm_constant_t) { cst_is_string, { .s = "$F64" } };
        _jm_cst_1[15] = (jm_constant_t) { cst_is_string, { .s = "$NUMBER" } };
        _jm_cst_1[16] = (jm_constant_t) { cst_is_string, { .s = "$INT" } };
        _jm_cst_1[17] = (jm_constant_t) { cst_is_string, { .s = "$INTEGER" } };
        _jm_cst_1[18] = (jm_constant_t) { cst_is_string, { .s = "$I8" } };
        _jm_cst_1[19] = (jm_constant_t) { cst_is_string, { .s = "$I16" } };
        _jm_cst_1[20] = (jm_constant_t) { cst_is_string, { .s = "$I32" } };
        _jm_cst_1[21] = (jm_constant_t) { cst_is_string, { .s = "$I64" } };
        _jm_cst_1[22] = (jm_constant_t) { cst_is_string, { .s = "$U8" } };
        _jm_cst_1[23] = (jm_constant_t) { cst_is_string, { .s = "$U16" } };
        _jm_cst_1[24] = (jm_constant_t) { cst_is_string, { .s = "$U32" } };
        _jm_cst_1[25] = (jm_constant_t) { cst_is_string, { .s = "$U64" } };
        _jm_cst_1[26] = (jm_constant_t) { cst_is_string, { .s = "$STRING" } };
        _jm_cst_1[27] = (jm_constant_t) { cst_is_string, { .s = "$NONE" } };
        _jm_cst_1[28] = (jm_constant_t) { cst_is_string, { .s = "$ANY" } };
        jm_sort_cst(_jm_cst_1, 29);
