...
static bool _jm_obj_7(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (jm_check_fun_string(json_model_13, prop, (path ? &lpath_7 : NULL), rep))
        {
            ...
            // .'$Model#Root'.'|'.4.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = json_is_string(pval) && _jm_re_8(json_string_value(pval), (path ? &lpath_7 : NULL), rep);
            if (! res)
            {
...
static bool _jm_obj_10(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (jm_check_fun_string(json_model_13, prop, (path ? &lpath_10 : NULL), rep))
        {
            ...
            // .'$Model#Root'.'|'.3.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = json_is_string(pval) && _jm_re_8(json_string_value(pval), (path ? &lpath_10 : NULL), rep);
            if (! res)
            {
...
static bool _jm_obj_13(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (jm_check_fun_string(json_model_13, prop, (path ? &lpath_13 : NULL), rep))
        {
            ...
            // .'$Model#Root'.'|'.2.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = json_is_string(pval) && _jm_re_8(json_string_value(pval), (path ? &lpath_13 : NULL), rep);
            if (! res)
            {
...
static bool _jm_obj_16(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (jm_check_fun_string(json_model_13, prop, (path ? &lpath_16 : NULL), rep))
        {
            ...
            // .'$Model#Root'.'|'.1.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = json_is_string(pval) && _jm_re_8(json_string_value(pval), (path ? &lpath_16 : NULL), rep);
            if (! res)
            {
...
static bool _jm_obj_19(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if (jm_check_fun_string(json_model_13, prop, (path ? &lpath_19 : NULL), rep))
        {
            ...
            // .'$Model#Root'.'|'.0.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = json_is_string(pval) && _jm_re_8(json_string_value(pval), (path ? &lpath_19 : NULL), rep);
            if (! res)
            {
...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_re_11_re2 = cre2_new("^\\w+$", strlen("^\\w+$"), NULL);
