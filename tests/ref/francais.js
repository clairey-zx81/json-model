        ...
        if (prop == "|")
        {
            ...
            if (res)
            {
                for (let arr_4_idx = 0; arr_4_idx < pval.length; arr_4_idx++)
                {
                    ...
                    // .'$Model#Element'.'|'.1.'|'.0
                    res = json_model_31(arr_4_item, ((path ? lpath_4 : null) ? arr_4_lpath : null), rep);
                    if (! res)
                    {
...
function _jm_obj_7(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        else if (_jm_re_7(prop, path, rep))
        {
            // handle 1 re props
            // .'$Model#Root'.'|'.5.'$'.'/./'
            res = json_model_31(pval, (path ? lpath_7 : null), rep);
            if (! res)
            {
...
function _jm_obj_8(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "<")
        {
            ...
            // .'$Model#Root'.'|'.5.'%'.'<'
            // .'$Model#Root'.'|'.5.'%'.'<'.'|'.0
            res = json_model_6(pval, (path ? lpath_8 : null), rep);
            if (! res)
            {
            ...
            if (! res)
            {
                ...
                if (res)
                {
                    for (let arr_5_idx = 0; arr_5_idx < pval.length; arr_5_idx++)
                    {
                        ...
                        // .'$Model#Root'.'|'.5.'%'.'<'.'|'.1.0
                        res = json_model_6(arr_5_item, ((path ? lpath_8 : null) ? arr_5_lpath : null), rep);
                        if (! res)
                        {
        ...
        else if (json_model_10(prop, (path ? lpath_8 : null), rep))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.5.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
        ...
        else if (_jm_re_9(prop, path, rep))
        {
            // handle 1 re props
            // .'$Model#Root'.'|'.5.'%'.'/^\\$.*$/'
            res = json_model_29(pval, (path ? lpath_8 : null), rep);
            if (! res)
            {
...
function _jm_obj_6(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        else if (json_model_24(prop, (path ? lpath_6 : null), rep))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.5.'$Prop'
...
function _jm_obj_11(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "<")
        {
            ...
            // .'$Model#Root'.'|'.4.'%'.'<'
            // .'$Model#Root'.'|'.4.'%'.'<'.'|'.0
            res = json_model_6(pval, (path ? lpath_11 : null), rep);
            if (! res)
            {
            ...
            if (! res)
            {
                ...
                if (res)
                {
                    for (let arr_7_idx = 0; arr_7_idx < pval.length; arr_7_idx++)
                    {
                        ...
                        // .'$Model#Root'.'|'.4.'%'.'<'.'|'.1.0
                        res = json_model_6(arr_7_item, ((path ? lpath_11 : null) ? arr_7_lpath : null), rep);
                        if (! res)
                        {
        ...
        else if (json_model_10(prop, (path ? lpath_11 : null), rep))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.4.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
        ...
        else if (_jm_re_9(prop, path, rep))
        {
            // handle 1 re props
            // .'$Model#Root'.'|'.4.'%'.'/^\\$.*$/'
            res = json_model_29(pval, (path ? lpath_11 : null), rep);
            if (! res)
            {
        ...
        if (prop == "+")
        {
            ...
            if (res)
            {
                for (let arr_6_idx = 0; arr_6_idx < pval.length; arr_6_idx++)
                {
                    ...
                    // .'$Model#Root'.'|'.4.'+'.0
                    res = json_model_31(arr_6_item, ((path ? lpath_9 : null) ? arr_6_lpath : null), rep);
                    if (! res)
                    {
...
function _jm_obj_14(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "<")
        {
            ...
            // .'$Model#Root'.'|'.3.'%'.'<'
            // .'$Model#Root'.'|'.3.'%'.'<'.'|'.0
            res = json_model_6(pval, (path ? lpath_14 : null), rep);
            if (! res)
            {
            ...
            if (! res)
            {
                ...
                if (res)
                {
                    for (let arr_9_idx = 0; arr_9_idx < pval.length; arr_9_idx++)
                    {
                        ...
                        // .'$Model#Root'.'|'.3.'%'.'<'.'|'.1.0
                        res = json_model_6(arr_9_item, ((path ? lpath_14 : null) ? arr_9_lpath : null), rep);
                        if (! res)
                        {
        ...
        else if (json_model_10(prop, (path ? lpath_14 : null), rep))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.3.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
        ...
        if (prop == "^")
        {
            ...
            if (res)
            {
                for (let arr_8_idx = 0; arr_8_idx < pval.length; arr_8_idx++)
                {
                    ...
                    // .'$Model#Root'.'|'.3.'^'.0
                    res = json_model_31(arr_8_item, ((path ? lpath_12 : null) ? arr_8_lpath : null), rep);
                    if (! res)
                    {
...
function _jm_obj_17(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
            ...
            if (! res)
            {
                ...
                if (res)
                {
                    for (let arr_11_idx = 0; arr_11_idx < pval.length; arr_11_idx++)
                    {
                        ...
                        // .'$Model#Root'.'|'.2.'%'.'<'.'|'.1.0
                        res = json_model_6(arr_11_item, ((path ? lpath_17 : null) ? arr_11_lpath : null), rep);
                        if (! res)
                        {
        ...
        else if (json_model_10(prop, (path ? lpath_17 : null), rep))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.2.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
        ...
        if (prop == "&")
        {
            ...
            if (res)
            {
                for (let arr_10_idx = 0; arr_10_idx < pval.length; arr_10_idx++)
                {
                    ...
                    // .'$Model#Root'.'|'.2.'&'.0
                    res = json_model_31(arr_10_item, ((path ? lpath_15 : null) ? arr_10_lpath : null), rep);
                    if (! res)
                    {
...
function _jm_obj_20(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "<")
        {
            ...
            // .'$Model#Root'.'|'.1.'%'.'<'
            // .'$Model#Root'.'|'.1.'%'.'<'.'|'.0
            res = json_model_6(pval, (path ? lpath_20 : null), rep);
            if (! res)
            {
            ...
            if (! res)
            {
                ...
                if (res)
                {
                    for (let arr_13_idx = 0; arr_13_idx < pval.length; arr_13_idx++)
                    {
                        ...
                        // .'$Model#Root'.'|'.1.'%'.'<'.'|'.1.0
                        res = json_model_6(arr_13_item, ((path ? lpath_20 : null) ? arr_13_lpath : null), rep);
                        if (! res)
                        {
        ...
        else if (json_model_10(prop, (path ? lpath_20 : null), rep))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.1.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
        ...
        else if (_jm_re_9(prop, path, rep))
        {
            // handle 1 re props
            // .'$Model#Root'.'|'.1.'%'.'/^\\$.*$/'
            res = json_model_29(pval, (path ? lpath_20 : null), rep);
            if (! res)
            {
        ...
        if (prop == "|")
        {
            ...
            if (res)
            {
                for (let arr_12_idx = 0; arr_12_idx < pval.length; arr_12_idx++)
                {
                    ...
                    // .'$Model#Root'.'|'.1.'|'.0
                    res = json_model_31(arr_12_item, ((path ? lpath_18 : null) ? arr_12_lpath : null), rep);
                    if (! res)
                    {
...
function _jm_obj_23(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "<")
        {
            ...
            // .'$Model#Root'.'|'.0.'%'.'<'
            // .'$Model#Root'.'|'.0.'%'.'<'.'|'.0
            res = json_model_6(pval, (path ? lpath_23 : null), rep);
            if (! res)
            {
            ...
            if (! res)
            {
                ...
                if (res)
                {
                    for (let arr_14_idx = 0; arr_14_idx < pval.length; arr_14_idx++)
                    {
                        ...
                        // .'$Model#Root'.'|'.0.'%'.'<'.'|'.1.0
                        res = json_model_6(arr_14_item, ((path ? lpath_23 : null) ? arr_14_lpath : null), rep);
                        if (! res)
                        {
        ...
        else if (json_model_10(prop, (path ? lpath_23 : null), rep))
        {
            // handle 1 key props
            // .'$Model#Root'.'|'.0.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
        ...
        else if (_jm_re_9(prop, path, rep))
        {
            // handle 1 re props
            // .'$Model#Root'.'|'.0.'%'.'/^\\$.*$/'
            res = json_model_29(pval, (path ? lpath_23 : null), rep);
            if (! res)
            {
...
function _jm_obj_21(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (prop == "@")
        {
            ...
            must_count += 1;
            // .'$Model#Root'.'|'.0.'@'
            res = json_model_31(pval, (path ? lpath_21 : null), rep);
            if (! res)
            {
