...
function _jm_obj_8(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (json_model_13(prop, (path ? lpath_8 : null), rep))
        {
            ...
            // .'$Model#Root'.'|'.5.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = typeof pval == 'string' && _jm_re_7(pval, (path ? lpath_8 : null), rep)
            if (! res)
            {
...
function _jm_obj_11(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (json_model_13(prop, (path ? lpath_11 : null), rep))
        {
            ...
            // .'$Model#Root'.'|'.4.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = typeof pval == 'string' && _jm_re_7(pval, (path ? lpath_11 : null), rep)
            if (! res)
            {
...
function _jm_obj_14(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (json_model_13(prop, (path ? lpath_14 : null), rep))
        {
            ...
            // .'$Model#Root'.'|'.3.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = typeof pval == 'string' && _jm_re_7(pval, (path ? lpath_14 : null), rep)
            if (! res)
            {
...
function _jm_obj_17(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (json_model_13(prop, (path ? lpath_17 : null), rep))
        {
            ...
            // .'$Model#Root'.'|'.2.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = typeof pval == 'string' && _jm_re_7(pval, (path ? lpath_17 : null), rep)
            if (! res)
            {
...
function _jm_obj_20(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (json_model_13(prop, (path ? lpath_20 : null), rep))
        {
            ...
            // .'$Model#Root'.'|'.1.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = typeof pval == 'string' && _jm_re_7(pval, (path ? lpath_20 : null), rep)
            if (! res)
            {
...
function _jm_obj_23(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (json_model_13(prop, (path ? lpath_23 : null), rep))
        {
            ...
            // .'$Model#Root'.'|'.0.'%'.'$Name'
            // "/^([#|&^+/*@~=$%]|[<>!]=?)$/"
            res = typeof pval == 'string' && _jm_re_7(pval, (path ? lpath_23 : null), rep)
            if (! res)
            {
