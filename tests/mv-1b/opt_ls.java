...
public class opt_ls extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> opt_ls_map_pmap;
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            opt_ls_map_pmap = new HashMap<String, Checker>();
            opt_ls_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        ...
        {
            super.free();
            opt_ls_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return opt_ls_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return opt_ls_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new opt_ls();
        Main.main("opt_ls", checker, VERSION, args);
    }
}
