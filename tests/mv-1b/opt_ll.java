...
public class opt_ll extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> opt_ll_map_pmap;
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            opt_ll_map_pmap = new HashMap<String, Checker>();
            opt_ll_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_0(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        ...
        {
            super.free();
            opt_ll_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return opt_ll_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return opt_ll_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new opt_ll();
        Main.main("opt_ll", checker, VERSION, args);
    }
}
