...
public class opt_ll extends ModelChecker
{
    ...
    public boolean _jm_obj_0(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("i") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not a -1 loose int [.i]", (path != null ? lpath_0 : null));
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            opt_ll_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
