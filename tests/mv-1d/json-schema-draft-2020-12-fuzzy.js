...
export function check_model_init()
{
    if (! initialized)
    {
        ...
        _jm_obj_13_map.set("$recursiveAnchor", _jm_f_57)
        _jm_obj_13_map.set("$recursiveRef", _jm_f_58)
        _jm_obj_13_map.set("$ref", _jm_f_59)
        _jm_obj_13_map.set("$schema", _jm_f_60)
        _jm_obj_13_map.set("$vocabulary", _jm_f_61)
        _jm_obj_13_map.set("additionalProperties", _jm_f_62)
        _jm_obj_13_map.set("allOf", _jm_f_63)
        _jm_obj_13_map.set("anyOf", _jm_f_64)
        _jm_obj_13_map.set("const", _jm_f_65)
        _jm_obj_13_map.set("contains", _jm_f_66)
        _jm_obj_13_map.set("contentEncoding", _jm_f_67)
        _jm_obj_13_map.set("contentMediaType", _jm_f_68)
        _jm_obj_13_map.set("contentSchema", _jm_f_69)
        _jm_obj_13_map.set("default", _jm_f_70)
        _jm_obj_13_map.set("definitions", _jm_f_71)
        _jm_obj_13_map.set("dependencies", _jm_f_72)
        _jm_obj_13_map.set("dependentRequired", _jm_f_73)
        _jm_obj_13_map.set("dependentSchemas", _jm_f_74)
        _jm_obj_13_map.set("deprecated", _jm_f_75)
        _jm_obj_13_map.set("description", _jm_f_76)
        _jm_obj_13_map.set("else", _jm_f_77)
        _jm_obj_13_map.set("enum", _jm_f_78)
        _jm_obj_13_map.set("examples", _jm_f_79)
        _jm_obj_13_map.set("exclusiveMaximum", _jm_f_80)
        _jm_obj_13_map.set("exclusiveMinimum", _jm_f_81)
        _jm_obj_13_map.set("format", _jm_f_82)
        _jm_obj_13_map.set("if", _jm_f_83)
        _jm_obj_13_map.set("items", _jm_f_84)
        _jm_obj_13_map.set("maxContains", _jm_f_85)
        _jm_obj_13_map.set("maxItems", _jm_f_86)
        _jm_obj_13_map.set("maxLength", _jm_f_87)
        _jm_obj_13_map.set("maxProperties", _jm_f_88)
        _jm_obj_13_map.set("maximum", _jm_f_89)
        _jm_obj_13_map.set("minContains", _jm_f_90)
        _jm_obj_13_map.set("minItems", _jm_f_91)
        _jm_obj_13_map.set("minLength", _jm_f_92)
        _jm_obj_13_map.set("minProperties", _jm_f_93)
        _jm_obj_13_map.set("minimum", _jm_f_94)
        _jm_obj_13_map.set("multipleOf", _jm_f_95)
        _jm_obj_13_map.set("not", _jm_f_96)
        _jm_obj_13_map.set("oneOf", _jm_f_97)
        _jm_obj_13_map.set("pattern", _jm_f_98)
        _jm_obj_13_map.set("patternProperties", _jm_f_99)
        _jm_obj_13_map.set("prefixItems", _jm_f_100)
        _jm_obj_13_map.set("properties", _jm_f_101)
        _jm_obj_13_map.set("propertyNames", _jm_f_102)
        _jm_obj_13_map.set("readOnly", _jm_f_103)
        _jm_obj_13_map.set("required", _jm_f_104)
        _jm_obj_13_map.set("then", _jm_f_105)
        _jm_obj_13_map.set("title", _jm_f_106)
        _jm_obj_13_map.set("type", _jm_f_107)
        _jm_obj_13_map.set("unevaluatedItems", _jm_f_108)
        _jm_obj_13_map.set("unevaluatedProperties", _jm_f_109)
        _jm_obj_13_map.set("uniqueItems", _jm_f_110)
        _jm_obj_13_map.set("writeOnly", _jm_f_111)
