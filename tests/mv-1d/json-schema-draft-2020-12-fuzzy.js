...
export function check_model_init()
{
    if (! initialized)
    {
        ...
        json_model_4_map.set("$anchor", json_model_3)
        json_model_4_map.set("$comment", _jm_f_0)
        json_model_4_map.set("$defs", _jm_f_1)
        json_model_4_map.set("$dynamicAnchor", json_model_3)
        json_model_4_map.set("$dynamicRef", json_model_3)
        json_model_4_map.set("$id", json_model_3)
        json_model_4_map.set("$ref", json_model_3)
        json_model_4_map.set("$schema", _jm_f_2)
        json_model_4_map.set("$vocabulary", _jm_f_3)
        json_model_5_map.set("default", _jm_f_4)
        json_model_5_map.set("deprecated", _jm_f_5)
        json_model_5_map.set("description", _jm_f_6)
        json_model_5_map.set("examples", _jm_f_7)
        json_model_5_map.set("readOnly", _jm_f_8)
        json_model_5_map.set("title", _jm_f_9)
        json_model_5_map.set("writeOnly", _jm_f_10)
        _jm_cst_0.add("array")
        ...
        json_model_13_map.set("const", _jm_f_11)
        json_model_13_map.set("dependentRequired", _jm_f_12)
        json_model_13_map.set("enum", _jm_f_13)
        json_model_13_map.set("exclusiveMaximum", _jm_f_14)
        json_model_13_map.set("exclusiveMinimum", _jm_f_15)
        json_model_13_map.set("maxContains", json_model_12)
        json_model_13_map.set("maxItems", json_model_12)
        json_model_13_map.set("maxLength", json_model_12)
        json_model_13_map.set("maxProperties", json_model_12)
        json_model_13_map.set("maximum", _jm_f_16)
        json_model_13_map.set("minContains", json_model_12)
        json_model_13_map.set("minItems", json_model_12)
        json_model_13_map.set("minLength", json_model_12)
        json_model_13_map.set("minProperties", json_model_12)
        json_model_13_map.set("minimum", _jm_f_17)
        json_model_13_map.set("multipleOf", _jm_f_18)
        json_model_13_map.set("pattern", _jm_f_19)
        json_model_13_map.set("required", json_model_11)
        json_model_13_map.set("type", _jm_f_20)
        json_model_13_map.set("uniqueItems", _jm_f_21)
        json_model_15_map.set("additionalProperties", json_model_17)
        json_model_15_map.set("allOf", json_model_14)
        json_model_15_map.set("anyOf", json_model_14)
        json_model_15_map.set("contains", json_model_17)
        json_model_15_map.set("dependentSchemas", _jm_f_22)
        json_model_15_map.set("else", json_model_17)
        json_model_15_map.set("if", json_model_17)
        json_model_15_map.set("items", json_model_17)
        json_model_15_map.set("not", json_model_17)
        json_model_15_map.set("oneOf", json_model_14)
        json_model_15_map.set("patternProperties", _jm_f_23)
        json_model_15_map.set("prefixItems", json_model_14)
        json_model_15_map.set("properties", _jm_f_24)
        json_model_15_map.set("propertyNames", json_model_17)
        json_model_15_map.set("then", json_model_17)
        json_model_16_map.set("$anchor", json_model_3)
        json_model_16_map.set("$comment", _jm_f_25)
        json_model_16_map.set("$defs", _jm_f_26)
        ...
        json_model_16_map.set("$recursiveAnchor", _jm_f_27)
        json_model_16_map.set("$recursiveRef", _jm_f_28)
        json_model_16_map.set("$ref", json_model_3)
        json_model_16_map.set("$schema", _jm_f_29)
        json_model_16_map.set("$vocabulary", _jm_f_30)
        ...
        json_model_16_map.set("const", _jm_f_31)
        json_model_16_map.set("contains", json_model_17)
        json_model_16_map.set("contentEncoding", _jm_f_32)
        json_model_16_map.set("contentMediaType", _jm_f_33)
        json_model_16_map.set("contentSchema", json_model_17)
        json_model_16_map.set("default", _jm_f_34)
        json_model_16_map.set("definitions", _jm_f_35)
        json_model_16_map.set("dependencies", _jm_f_36)
        json_model_16_map.set("dependentRequired", _jm_f_37)
        json_model_16_map.set("dependentSchemas", _jm_f_38)
        json_model_16_map.set("deprecated", _jm_f_39)
        json_model_16_map.set("description", _jm_f_40)
        json_model_16_map.set("else", json_model_17)
        json_model_16_map.set("enum", _jm_f_41)
        json_model_16_map.set("examples", _jm_f_42)
        json_model_16_map.set("exclusiveMaximum", _jm_f_43)
        json_model_16_map.set("exclusiveMinimum", _jm_f_44)
        json_model_16_map.set("format", _jm_f_45)
        ...
        json_model_16_map.set("maximum", _jm_f_46)
        ...
        json_model_16_map.set("minimum", _jm_f_47)
        json_model_16_map.set("multipleOf", _jm_f_48)
        json_model_16_map.set("not", json_model_17)
        json_model_16_map.set("oneOf", json_model_14)
        json_model_16_map.set("pattern", _jm_f_49)
        json_model_16_map.set("patternProperties", _jm_f_50)
        json_model_16_map.set("prefixItems", json_model_14)
        json_model_16_map.set("properties", _jm_f_51)
        json_model_16_map.set("propertyNames", json_model_17)
        json_model_16_map.set("readOnly", _jm_f_52)
        json_model_16_map.set("required", json_model_11)
        json_model_16_map.set("then", json_model_17)
        json_model_16_map.set("title", _jm_f_53)
        json_model_16_map.set("type", _jm_f_54)
        json_model_16_map.set("unevaluatedItems", json_model_17)
        json_model_16_map.set("unevaluatedProperties", json_model_17)
        json_model_16_map.set("uniqueItems", _jm_f_55)
        json_model_16_map.set("writeOnly", _jm_f_56)
