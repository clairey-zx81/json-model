...
BEGIN
  ...
  END IF;
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    IF _jm_obj_41_map(prop) IS NOT NULL THEN
      -- handle 25 may props
...
RETURNS TEXT STRICT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  map JSONB := JSONB '{"":"json_model_16","URI-REFERENCE":"json_model_2","core":"_jm_obj_0","meta":"_jm_obj_3","Null":"_jm_obj_4","Boolean":"_jm_obj_5","Number":"_jm_obj_6","Integer":"_jm_obj_7","String":"_jm_obj_8","stringArray":"json_model_10","schemaArray":"json_model_11","Array":"_jm_obj_9","Object":"_jm_obj_10","Misc":"_jm_obj_15","TightSchema":"json_model_15","Schema":"json_model_16"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
...
INSERT INTO jm_constant_maps(mapname, tagval, value) VALUES
  ('_jm_map_0', JSONB '"null"', '_jm_obj_16'),
  ('_jm_map_0', JSONB '"boolean"', '_jm_obj_19'),
  ('_jm_map_0', JSONB '"number"', '_jm_obj_22'),
  ('_jm_map_0', JSONB '"integer"', '_jm_obj_25'),
  ('_jm_map_0', JSONB '"string"', '_jm_obj_28'),
  ('_jm_map_0', JSONB '"array"', '_jm_obj_31'),
  ('_jm_map_0', JSONB '"object"', '_jm_obj_34')
;
