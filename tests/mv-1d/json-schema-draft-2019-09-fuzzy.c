...
static INLINE bool _jm_obj_8(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "not a bool [.'$schema#ObjectSchema'.dependencies.''.'|'.0]", (path ? &lpath_7 : NULL));
        }
        if (! res)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $ObjectSchema [.'$schema#ObjectSchema'.dependencies.''.'|'.1]", (path ? &lpath_7 : NULL));
            }
            if (! res)
            {
                ...
                if (! res)
                {
                    if (rep) jm_report_add_entry(rep, "unexpected $stringArray [.'$schema#ObjectSchema'.dependencies.''.'|'.2]", (path ? &lpath_7 : NULL));
                }
            }
        }
        if (res)
...
static INLINE bool _jm_obj_0(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (json_object_get(val, "$recursiveRef") != NULL)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "unexpected value for optional prop <$recursiveRef> [.'$schema#ObjectSchema']", path);
            return false;
        }
    }
    if (json_object_get(val, "$recursiveAnchor") != NULL)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "unexpected value for optional prop <$recursiveAnchor> [.'$schema#ObjectSchema']", path);
            return false;
        }
    }
