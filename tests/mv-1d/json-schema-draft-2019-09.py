...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$URI-REFERENCE\" [.'$id']", path))
    return res
...
def json_model_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "$id":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$id\" [.'$core'.'$id']", lpath_0 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_https://json-schema.org/draft/2019-09/schema\" [.'$core'.'$schema']", lpath_0 if path is not None else None))
            ...
            res = json_model_2(pval, lpath_0 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URI-REFERENCE\" [.'$core'.'$recursiveRef']", lpath_0 if path is not None else None))
...
def json_model_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "format":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$format'.format]", lpath_5 if path is not None else None))
...
def _jm_f_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$stringArray\" [.'$validation'.dependentRequired.'']", lpath_7 if path is not None else None))
            return False
    return True
...
def _jm_f_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$applicator'.dependentSchemas.'']", lpath_9 if path is not None else None))
            return False
    return True
...
def _jm_f_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$applicator'.items.'|'.0]", path))
        # .'$applicator'.items.'|'.1
        res = json_model_13(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$schemaArray\" [.'$applicator'.items.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def _jm_f_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_10 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$applicator'.patternProperties.'$REGEX']", lpath_10 if path is not None else None))
                return False
        else:
...
def _jm_f_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$applicator'.properties.'']", lpath_11 if path is not None else None))
            return False
    return True
...
def _jm_f_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.'$defs'.'']", lpath_13 if path is not None else None))
            return False
    return True
...
def _jm_f_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"_https://json-schema.org/draft/2019-09/schema\" [.'$ObjectSchema'.'$schema']", path))
    return res
...
def _jm_f_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$stringArray\" [.'$ObjectSchema'.dependentRequired.'']", lpath_15 if path is not None else None))
            return False
    return True
...
def _jm_f_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.dependentSchemas.'']", lpath_16 if path is not None else None))
            return False
    return True
...
def _jm_f_33(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = json_model_16(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.items.'|'.0]", path))
        # .'$ObjectSchema'.items.'|'.1
        res = json_model_13(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$schemaArray\" [.'$ObjectSchema'.items.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def _jm_f_38(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_17 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.patternProperties.'$REGEX']", lpath_17 if path is not None else None))
                return False
        else:
...
def _jm_f_39(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.properties.'']", lpath_18 if path is not None else None))
            return False
    return True
