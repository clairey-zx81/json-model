...
static bool json_model_7(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (unlikely(jm_str_eq_8(prop, 0x656c7069746c756dLL) && jm_str_eq_3(prop + 8, 0x0000664f)))
        {
...
static bool json_model_10(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (likely(res))
    {
        ...
        if (likely(size_0 >= 1))
        {
            ...
            if (likely(res))
            {
                for (int64_t scan_0_idx = 1; scan_0_idx < size_0; scan_0_idx++)
                {
                    ...
                    if (unlikely(! res))
                    {
                        ...
                        if (rep) jm_report_add_entry(rep, "unexpected array item type [.'$stringArray'.'@'.1]", (path ? &scan_0_lpath : NULL));
                        break;
                    }
                }
            }
            ...
            {
                if (rep) jm_report_add_entry(rep, "unexpected array item type [.'$stringArray'.'@'.1]", path);
            }
            // optional remaining items
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "unexpected array size [.'$stringArray']", path);
            res = false;
        }
    }
    else
    {
        if (rep) jm_report_add_entry(rep, "expecting an array [.'$stringArray'.@]", path);
        res = false;
    }
    return res;
}
...
static bool json_model_11(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (likely(res))
    {
        ...
        json_array_foreach(val, arr_0_idx, arr_0_item)
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Schema\" [.'$schemaArray'.'@'.0]", (path ? &arr_0_lpath : NULL));
                break;
            }
        }
    }
...
static bool json_model_12(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        {
            if (jm_str_eq_8(prop, 0x7449657571696e75LL) && jm_str_eq_4(prop + 8, 0x00736d65))
            {
...
static INLINE bool _jm_obj_2(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (unlikely(! res))
        {
            if (rep) jm_report_add_entry(rep, "unexpected value for model \"$stringArray\" [.'$Object'.dependentRequired.'']", (path ? &lpath_11 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_3(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (unlikely(! res))
        {
            if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Schema\" [.'$Object'.dependentSchemas.'']", (path ? &lpath_12 : NULL));
            return false;
        }
    }
    return true;
...
static bool json_model_13(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (hash_4 <= 0x69646461)
        {
            if (jm_str_eq_8(prop, 0x6e6f697469646461LL) && jm_str_eq_8(prop + 8, 0x7265706f72506c61LL) && jm_str_eq_5(prop + 16, 0x0000000073656974LL))
            {
...
static INLINE bool _jm_obj_13(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (likely(jm_is_valid_url(prop, (path ? &lpath_23 : NULL), rep)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "not a bool [.'$TightSchema'.'|'.2.'$vocabulary'.'$URI']", (path ? &lpath_23 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "unexpected prop [.'$TightSchema'.'|'.2.'$vocabulary']", (path ? &lpath_23 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_14(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (unlikely(! res))
        {
            if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Schema\" [.'$TightSchema'.'|'.2.'$defs'.'']", (path ? &lpath_24 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_12(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (hash_8 <= 0x6c637865)
        {
            if (hash_8 <= 0x66657224)
            {
                if (jm_str_eq_4(prop, 0x00646924))
                {
                    // handle may $id property
        ...
        else
        {
            ...
            {
                if (jm_str_eq_8(prop, 0x7461636572706564LL) && jm_str_eq_3(prop + 8, 0x00006465))
                {
                    // handle may deprecated property
...
static INLINE bool _jm_obj_16(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (likely(jm_is_valid_url(prop, (path ? &lpath_26 : NULL), rep)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "not a bool [.'$TightSchema'.'|'.3.'$vocabulary'.'$URI']", (path ? &lpath_26 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "unexpected prop [.'$TightSchema'.'|'.3.'$vocabulary']", (path ? &lpath_26 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_17(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (unlikely(! res))
        {
            if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Schema\" [.'$TightSchema'.'|'.3.'$defs'.'']", (path ? &lpath_27 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_15(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (hash_9 <= 0x6c637865)
        {
            if (hash_9 <= 0x66657224)
            {
                if (jm_str_eq_4(prop, 0x00646924))
                {
                    // handle may $id property
...
static INLINE bool _jm_obj_19(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (likely(jm_is_valid_url(prop, (path ? &lpath_29 : NULL), rep)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "not a bool [.'$TightSchema'.'|'.4.'$vocabulary'.'$URI']", (path ? &lpath_29 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "unexpected prop [.'$TightSchema'.'|'.4.'$vocabulary']", (path ? &lpath_29 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_22(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (likely(jm_is_valid_url(prop, (path ? &lpath_32 : NULL), rep)))
        {
            // handle 1 key props
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "not a bool [.'$TightSchema'.'|'.5.'$vocabulary'.'$URI']", (path ? &lpath_32 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "unexpected prop [.'$TightSchema'.'|'.5.'$vocabulary']", (path ? &lpath_32 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_21(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        uint32_t hash_11 = *((uint32_t *) (prop));
        if (hash_11 <= 0x6d617865)
        {
            if (hash_11 <= 0x636f7624)
            {
                if (jm_str_eq_4(prop, 0x00646924))
                {
                    // handle may $id property
...
static INLINE bool _jm_obj_26(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (unlikely(! res))
        {
            if (rep) jm_report_add_entry(rep, "unexpected value for model \"$stringArray\" [.'$TightSchema'.'|'.6.dependentRequired.'']", (path ? &lpath_36 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_27(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (unlikely(! res))
        {
            if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Schema\" [.'$TightSchema'.'|'.6.dependentSchemas.'']", (path ? &lpath_37 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_28(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (likely(jm_is_valid_url(prop, (path ? &lpath_38 : NULL), rep)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "not a bool [.'$TightSchema'.'|'.6.'$vocabulary'.'$URI']", (path ? &lpath_38 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "unexpected prop [.'$TightSchema'.'|'.6.'$vocabulary']", (path ? &lpath_38 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_30(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (likely(jm_is_valid_regex(prop, false, (path ? &lpath_40 : NULL), rep)))
        {
            // handle 1 key props
        ...
        {
            if (rep) jm_report_add_entry(rep, "unexpected prop [.'$TightSchema'.'|'.6.patternProperties]", (path ? &lpath_40 : NULL));
            return false;
        }
    }
    return true;
...
static INLINE bool _jm_obj_24(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        uint32_t hash_12 = *((uint32_t *) (prop));
        if (hash_12 <= 0x6d6f6324)
        {
            if (hash_12 <= 0x64616572)
            {
                if (jm_str_eq_4(prop, 0x00646924))
                {
                    // handle may $id property
...
static INLINE bool _jm_obj_32(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (likely(jm_is_valid_url(prop, (path ? &lpath_42 : NULL), rep)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "not a bool [.'$TightSchema'.'|'.7.'$vocabulary'.'$URI']", (path ? &lpath_42 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "unexpected prop [.'$TightSchema'.'|'.7.'$vocabulary']", (path ? &lpath_42 : NULL));
            return false;
        }
    }
    return true;
...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_map_0_tab[0] = (jm_constmap_t) { (jm_constant_t) { 5, { .s = "null" } }, _jm_obj_6 };
        _jm_map_0_tab[1] = (jm_constmap_t) { (jm_constant_t) { 8, { .s = "boolean" } }, _jm_obj_9 };
        _jm_map_0_tab[2] = (jm_constmap_t) { (jm_constant_t) { 7, { .s = "number" } }, _jm_obj_12 };
        _jm_map_0_tab[3] = (jm_constmap_t) { (jm_constant_t) { 8, { .s = "integer" } }, _jm_obj_15 };
        _jm_map_0_tab[4] = (jm_constmap_t) { (jm_constant_t) { 7, { .s = "string" } }, _jm_obj_18 };
        _jm_map_0_tab[5] = (jm_constmap_t) { (jm_constant_t) { 6, { .s = "array" } }, _jm_obj_21 };
        _jm_map_0_tab[6] = (jm_constmap_t) { (jm_constant_t) { 7, { .s = "object" } }, _jm_obj_24 };
