...
BEGIN
  -- .'$core'.'$schema'
  res := JSONB_TYPEOF(val) = 'string' AND JSON_VALUE(val, '$' RETURNING TEXT) = 'https://json-schema.org/draft/2019-09/schema';
  RETURN res;
END;
$$ LANGUAGE PLpgSQL;
...
DECLARE
  map JSONB := JSONB '{"$anchor":"_jm_f_0","$comment":"_jm_f_1","$defs":"_jm_f_2","$id":"_jm_f_3","$recursiveAnchor":"_jm_f_4","$recursiveRef":"_jm_f_5","$ref":"_jm_f_6","$schema":"_jm_f_7","$vocabulary":"_jm_f_8"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
...
RETURNS TEXT STRICT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  map JSONB := JSONB '{"additionalItems":"_jm_f_36","additionalProperties":"_jm_f_37","allOf":"_jm_f_38","anyOf":"_jm_f_39","contains":"_jm_f_40","dependentSchemas":"_jm_f_41","else":"_jm_f_42","if":"_jm_f_43","items":"_jm_f_44","not":"_jm_f_45","oneOf":"_jm_f_46","patternProperties":"_jm_f_47","properties":"_jm_f_48","propertyNames":"_jm_f_49","then":"_jm_f_50","unevaluatedItems":"_jm_f_51","unevaluatedProperties":"_jm_f_52"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
...
RETURNS TEXT STRICT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  map JSONB := JSONB '{"$anchor":"_jm_f_53","$comment":"_jm_f_54","$defs":"_jm_f_55","$id":"_jm_f_56","$recursiveAnchor":"_jm_f_57","$recursiveRef":"_jm_f_58","$ref":"_jm_f_59","$schema":"_jm_f_60","$vocabulary":"_jm_f_61","additionalItems":"_jm_f_62","additionalProperties":"_jm_f_63","allOf":"_jm_f_64","anyOf":"_jm_f_65","const":"_jm_f_66","contains":"_jm_f_67","contentEncoding":"_jm_f_68","contentMediaType":"_jm_f_69","contentSchema":"_jm_f_70","default":"_jm_f_71","dependentRequired":"_jm_f_72","dependentSchemas":"_jm_f_73","deprecated":"_jm_f_74","description":"_jm_f_75","else":"_jm_f_76","enum":"_jm_f_77","examples":"_jm_f_78","exclusiveMaximum":"_jm_f_79","exclusiveMinimum":"_jm_f_80","format":"_jm_f_81","if":"_jm_f_82","items":"_jm_f_83","maxContains":"_jm_f_84","maxItems":"_jm_f_85","maxLength":"_jm_f_86","maxProperties":"_jm_f_87","maximum":"_jm_f_88","minContains":"_jm_f_89","minItems":"_jm_f_90","minLength":"_jm_f_91","minProperties":"_jm_f_92","minimum":"_jm_f_93","multipleOf":"_jm_f_94","not":"_jm_f_95","oneOf":"_jm_f_96","pattern":"_jm_f_97","patternProperties":"_jm_f_98","properties":"_jm_f_99","propertyNames":"_jm_f_100","readOnly":"_jm_f_101","required":"_jm_f_102","then":"_jm_f_103","title":"_jm_f_104","type":"_jm_f_105","unevaluatedItems":"_jm_f_106","unevaluatedProperties":"_jm_f_107","uniqueItems":"_jm_f_108","writeOnly":"_jm_f_109"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
...
RETURNS TEXT STRICT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  map JSONB := JSONB '{"":"json_model_1","URI-REFERENCE":"json_model_2","id":"json_model_2","core":"_jm_obj_0","meta":"_jm_obj_3","content":"_jm_obj_4","format":"_jm_obj_5","simpleTypes":"json_model_8","simpleTypesArray":"json_model_9","stringArray":"json_model_10","nonNegativeInteger":"json_model_11","validation":"_jm_obj_6","schemaArray":"json_model_13","applicator":"_jm_obj_8","ObjectSchema":"_jm_obj_12","Schema":"json_model_16"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
