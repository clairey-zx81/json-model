...
export function check_model_init()
{
    if (! initialized)
    {
        ...
        json_model_17_map.set("const", _jm_f_5)
        json_model_17_map.set("contains", json_model_18)
        json_model_17_map.set("contentEncoding", _jm_f_6)
        json_model_17_map.set("contentMediaType", _jm_f_7)
        json_model_17_map.set("contentSchema", json_model_18)
        json_model_17_map.set("default", _jm_f_8)
        json_model_17_map.set("definitions", _jm_f_9)
        json_model_17_map.set("dependencies", _jm_f_10)
        json_model_17_map.set("dependentRequired", _jm_f_11)
        json_model_17_map.set("dependentSchemas", _jm_f_12)
        json_model_17_map.set("deprecated", _jm_f_13)
        json_model_17_map.set("description", _jm_f_14)
        json_model_17_map.set("else", json_model_18)
        json_model_17_map.set("enum", _jm_f_15)
        json_model_17_map.set("examples", _jm_f_16)
        json_model_17_map.set("exclusiveMaximum", _jm_f_17)
        json_model_17_map.set("exclusiveMinimum", _jm_f_18)
        json_model_17_map.set("format", _jm_f_19)
        json_model_17_map.set("if", json_model_18)
        json_model_17_map.set("items", _jm_f_20)
        ...
        json_model_17_map.set("maximum", _jm_f_21)
        ...
        json_model_17_map.set("minimum", _jm_f_22)
        json_model_17_map.set("multipleOf", _jm_f_23)
        json_model_17_map.set("not", json_model_18)
        json_model_17_map.set("oneOf", json_model_15)
        json_model_17_map.set("pattern", _jm_f_24)
        json_model_17_map.set("patternProperties", _jm_f_25)
        json_model_17_map.set("properties", _jm_f_26)
        json_model_17_map.set("propertyNames", json_model_18)
        json_model_17_map.set("readOnly", _jm_f_27)
        json_model_17_map.set("required", json_model_12)
        json_model_17_map.set("then", json_model_18)
        json_model_17_map.set("title", _jm_f_28)
        json_model_17_map.set("type", _jm_f_29)
        json_model_17_map.set("unevaluatedItems", json_model_18)
        json_model_17_map.set("unevaluatedProperties", json_model_18)
        json_model_17_map.set("uniqueItems", _jm_f_30)
        json_model_17_map.set("writeOnly", _jm_f_31)
        _jm_cst_0.add("array")
