...
def _jm_obj_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
                rep is None or rep.append(("missing must prop <type> [.'$Boolean']", path))
        return False
    return True
...
def _jm_obj_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
                rep is None or rep.append(("missing must prop <type> [.'$TightSchema'.'|'.6]", path))
        return False
    return True
...
def _jm_obj_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
                rep is None or rep.append(("missing must prop <type> [.'$TightSchema'.'|'.5]", path))
        return False
    return True
...
def _jm_obj_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
                rep is None or rep.append(("missing must prop <type> [.'$TightSchema'.'|'.4]", path))
        return False
    return True
...
def _jm_obj_32(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
                rep is None or rep.append(("missing must prop <type> [.'$TightSchema'.'|'.3]", path))
        return False
    return True
...
def _jm_obj_35(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
                rep is None or rep.append(("missing must prop <type> [.'$TightSchema'.'|'.2]", path))
        return False
    return True
...
def _jm_obj_38(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
                rep is None or rep.append(("missing must prop <type> [.'$TightSchema'.'|'.1]", path))
        return False
    return True
...
def _jm_obj_41(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if must_count != 1:
        if rep is not None:
            if not "type" in val:
                rep is None or rep.append(("missing must prop <type> [.'$TightSchema'.'|'.0]", path))
        return False
    return True
