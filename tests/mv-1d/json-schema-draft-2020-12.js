...
function json_model_3(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "$schema")
        {
            ...
            // .'$core'.'$schema'
            res = typeof pval == 'string' && pval == "https://json-schema.org/draft/2020-12/schema"
            if (! res)
            {
...
function _jm_f_8(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected value for model \"$stringArray\" [.'$ObjectSchema'.dependentRequired.'']", (path ? lpath_16 : null)])
            return false
        }
    }
    return true
...
function _jm_f_9(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected value for model \"$Schema\" [.'$ObjectSchema'.dependentSchemas.'']", (path ? lpath_17 : null)])
            return false
        }
    }
    return true
...
function _jm_f_21(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (runtime.jm_is_valid_regex(prop, false))
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["unexpected value for model \"$Schema\" [.'$ObjectSchema'.patternProperties.'$REGEX']", (path ? lpath_18 : null)])
                return false
            }
        }
        else
...
function _jm_f_22(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected value for model \"$Schema\" [.'$ObjectSchema'.properties.'']", (path ? lpath_19 : null)])
            return false
        }
    }
    return true
