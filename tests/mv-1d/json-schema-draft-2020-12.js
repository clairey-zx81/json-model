...
function _jm_obj_21(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected $Schema [.'$Schema'.'|'.1.'$defs'.'']", (path ? lpath_21 : null)])
        }
        if (! res)
        {
            return false;
...
function _jm_f_115(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["unexpected _https://json-schema.org/draft/2020-12/schema [.'$Schema'.'|'.1.'$schema']", path])
    }
    return res;
}
...
function _jm_obj_22(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (runtime.jm_is_valid_url(prop))
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["not a bool [.'$Schema'.'|'.1.'$vocabulary'.'$URI']", (path ? lpath_22 : null)])
            }
            if (! res)
            {
                return false;
        ...
        {
            rep !== null && rep.push(["unexpected prop [.'$Schema'.'|'.1.'$vocabulary']", (path ? lpath_22 : null)])
            return false;
        }
    }
    return true;
...
function _jm_obj_23(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected $stringArray [.'$Schema'.'|'.1.dependentRequired.'']", (path ? lpath_23 : null)])
        }
        if (! res)
        {
            return false;
...
function _jm_obj_24(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected $Schema [.'$Schema'.'|'.1.dependentSchemas.'']", (path ? lpath_24 : null)])
        }
        if (! res)
        {
            return false;
...
function _jm_obj_25(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (runtime.jm_is_valid_regex(prop, false))
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["unexpected $Schema [.'$Schema'.'|'.1.patternProperties.'$REGEX']", (path ? lpath_25 : null)])
            }
            if (! res)
            {
                return false;
        ...
        {
            rep !== null && rep.push(["unexpected prop [.'$Schema'.'|'.1.patternProperties]", (path ? lpath_25 : null)])
            return false;
        }
    }
    return true;
...
function _jm_obj_26(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected $Schema [.'$Schema'.'|'.1.properties.'']", (path ? lpath_26 : null)])
        }
        if (! res)
        {
            return false;
...
function _jm_obj_20(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if ((pfun = _jm_obj_20_map.get(prop)))
        {
            ...
            {
                rep !== null && rep.push(["invalid optional prop value [.'$Schema'.'|'.1]", (path ? lpath_20 : null)])
                return false;
            }
        }
        else
        {
            rep !== null && rep.push(["unexpected prop [.'$Schema'.'|'.1]", (path ? lpath_20 : null)])
            return false;
        }
    }
    return true;
...
export function check_model_init()
{
    if (! initialized)
    {
        ...
        _jm_obj_20_map.set("$anchor", _jm_f_108)
        _jm_obj_20_map.set("$comment", _jm_f_109)
        _jm_obj_20_map.set("$defs", _jm_f_110)
        _jm_obj_20_map.set("$dynamicAnchor", _jm_f_111)
        _jm_obj_20_map.set("$dynamicRef", _jm_f_112)
        _jm_obj_20_map.set("$id", _jm_f_113)
        _jm_obj_20_map.set("$ref", _jm_f_114)
        _jm_obj_20_map.set("$schema", _jm_f_115)
        _jm_obj_20_map.set("$vocabulary", _jm_f_116)
        _jm_obj_20_map.set("additionalProperties", _jm_f_117)
        _jm_obj_20_map.set("allOf", _jm_f_118)
        _jm_obj_20_map.set("anyOf", _jm_f_119)
        _jm_obj_20_map.set("const", _jm_f_120)
        _jm_obj_20_map.set("contains", _jm_f_121)
        _jm_obj_20_map.set("contentEncoding", _jm_f_122)
        _jm_obj_20_map.set("contentMediaType", _jm_f_123)
        _jm_obj_20_map.set("contentSchema", _jm_f_124)
        _jm_obj_20_map.set("default", _jm_f_125)
        _jm_obj_20_map.set("dependentRequired", _jm_f_126)
        _jm_obj_20_map.set("dependentSchemas", _jm_f_127)
        _jm_obj_20_map.set("deprecated", _jm_f_128)
        _jm_obj_20_map.set("description", _jm_f_129)
        _jm_obj_20_map.set("else", _jm_f_130)
        _jm_obj_20_map.set("enum", _jm_f_131)
        _jm_obj_20_map.set("examples", _jm_f_132)
        _jm_obj_20_map.set("exclusiveMaximum", _jm_f_133)
        _jm_obj_20_map.set("exclusiveMinimum", _jm_f_134)
        _jm_obj_20_map.set("format", _jm_f_135)
        _jm_obj_20_map.set("if", _jm_f_136)
        _jm_obj_20_map.set("items", _jm_f_137)
        _jm_obj_20_map.set("maxContains", _jm_f_138)
        _jm_obj_20_map.set("maxItems", _jm_f_139)
        _jm_obj_20_map.set("maxLength", _jm_f_140)
        _jm_obj_20_map.set("maxProperties", _jm_f_141)
        _jm_obj_20_map.set("maximum", _jm_f_142)
        _jm_obj_20_map.set("minContains", _jm_f_143)
        _jm_obj_20_map.set("minItems", _jm_f_144)
        _jm_obj_20_map.set("minLength", _jm_f_145)
        _jm_obj_20_map.set("minProperties", _jm_f_146)
        _jm_obj_20_map.set("minimum", _jm_f_147)
        _jm_obj_20_map.set("multipleOf", _jm_f_148)
        _jm_obj_20_map.set("not", _jm_f_149)
        _jm_obj_20_map.set("oneOf", _jm_f_150)
        _jm_obj_20_map.set("pattern", _jm_f_151)
        _jm_obj_20_map.set("patternProperties", _jm_f_152)
        _jm_obj_20_map.set("prefixItems", _jm_f_153)
        _jm_obj_20_map.set("properties", _jm_f_154)
        _jm_obj_20_map.set("propertyNames", _jm_f_155)
        _jm_obj_20_map.set("readOnly", _jm_f_156)
        _jm_obj_20_map.set("required", _jm_f_157)
        _jm_obj_20_map.set("then", _jm_f_158)
        _jm_obj_20_map.set("title", _jm_f_159)
        _jm_obj_20_map.set("type", _jm_f_160)
        _jm_obj_20_map.set("unevaluatedItems", _jm_f_161)
        _jm_obj_20_map.set("unevaluatedProperties", _jm_f_162)
        _jm_obj_20_map.set("uniqueItems", _jm_f_163)
        _jm_obj_20_map.set("writeOnly", _jm_f_164)
