...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "$id":
            ...
            # .'$core'.'$schema'
            res = isinstance(pval, str) and (pval == "https://json-schema.org/draft/2020-12/schema")
            if not res:
                rep is None or rep.append(("unexpected value for model \"_https://json-schema.org/draft/2020-12/schema\" [.'$core'.'$schema']", lpath_0 if path is not None else None))
...
def _jm_f_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"_https://json-schema.org/draft/2020-12/schema\" [.'$ObjectSchema'.'$schema']", path))
    return res
...
def _jm_f_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$stringArray\" [.'$ObjectSchema'.dependentRequired.'']", lpath_16 if path is not None else None))
            return False
    return True
...
def _jm_f_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.dependentSchemas.'']", lpath_17 if path is not None else None))
            return False
    return True
...
def _jm_f_35(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_18 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.patternProperties.'$REGEX']", lpath_18 if path is not None else None))
                return False
        else:
            rep is None or rep.append(("unexpected prop [.'$ObjectSchema'.patternProperties]", lpath_18 if path is not None else None))
            return False
    return True
...
def _jm_f_36(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$ObjectSchema'.properties.'']", lpath_19 if path is not None else None))
            return False
    return True
    ...
    for prop, pval in val.items():
        ...
        if pfun := json_model_15_map.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_13 if path is not None else None, rep):
                ...
                return False
            continue
        rep is None or rep.append(("unexpected prop [.'$ObjectSchema']", lpath_13 if path is not None else None))
        return False
    return True
...
def check_model_init():
    ...
    if not initialized:
        ...
        json_model_15_map = {
            ...
            "const": _jm_f_18,
            "contains": json_model_16,
            "contentEncoding": _jm_f_19,
            "contentMediaType": _jm_f_20,
