...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "ma1":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.ma2]", lpath_0 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$DATE\" [.ma3]", lpath_0 if path is not None else None))
