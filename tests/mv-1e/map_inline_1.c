...
static bool json_model_1(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (unlikely(jm_str_eq_4(prop, 0x0031616d)))
        {
        ...
        else if (jm_str_eq_4(prop, 0x0032616d))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"\" [.ma2]", (path ? &lpath_0 : NULL));
        ...
        else if (likely(jm_str_eq_4(prop, 0x0033616d)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"$DATE\" [.ma3]", (path ? &lpath_0 : NULL));
