...
sub json_model_1($$$)
{
    ...
    unless ($res)
    {
        push @$rep, ["not a 0 strict int [.b]", defined $path ? $lpath : undef] if defined $rep;
    ...
    unless ($res)
    {
        push @$rep, ["not a 0 strict int [.c]", defined $path ? $lpath : undef] if defined $rep;
    ...
    unless ($res)
    {
        push @$rep, ["not a 0 strict int [.d]", defined $path ? $lpath : undef] if defined $rep;
    ...
    unless ($res)
    {
        push @$rep, ["not a 0 strict int [.e]", defined $path ? $lpath : undef] if defined $rep;
