...
public class musts extends ModelChecker
{
    ...
    public boolean _jm_obj_0(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            else if (prop.compareTo("b") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not a 0 strict int [.b]", (path != null ? lpath_0 : null));
                }
                if (! res)
                {
            ...
            else if (prop.compareTo("c") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not a 0 strict int [.c]", (path != null ? lpath_0 : null));
                }
                if (! res)
                {
            ...
            else if (prop.compareTo("d") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not a 0 strict int [.d]", (path != null ? lpath_0 : null));
                }
                if (! res)
                {
            ...
            else if (prop.compareTo("e") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not a 0 strict int [.e]", (path != null ? lpath_0 : null));
                }
                if (! res)
                {
                    if (rep != null) rep.addEntry("invalid mandatory prop value [.e]", (path != null ? lpath_0 : null));
                    return false;
                }
            }
            else
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            musts_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
