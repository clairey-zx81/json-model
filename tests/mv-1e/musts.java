...
public class musts extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> musts_map_pmap;
    ...
    public boolean _jm_obj_0(Object val, Path path, Report rep)
    {
        ...
        if (! res)
        {
            if (rep != null) rep.addEntry("not a 0 strict int [.b]", path);
        ...
        if (! res)
        {
            if (rep != null) rep.addEntry("not a 0 strict int [.c]", path);
        ...
        if (! res)
        {
            if (rep != null) rep.addEntry("not a 0 strict int [.d]", path);
        ...
        if (! res)
        {
            if (rep != null) rep.addEntry("not a 0 strict int [.e]", path);
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            musts_map_pmap = new HashMap<String, Checker>();
            musts_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_0(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    {
        return musts_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return musts_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new musts();
        Main.main("musts", checker, VERSION, args);
    }
}
