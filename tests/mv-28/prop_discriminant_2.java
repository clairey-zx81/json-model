...
public class prop_discriminant_2 extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> prop_discriminant_2_map_pmap;
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            prop_discriminant_2_map_pmap = new HashMap<String, Checker>();
            prop_discriminant_2_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        ...
        {
            super.free();
            prop_discriminant_2_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return prop_discriminant_2_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return prop_discriminant_2_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new prop_discriminant_2();
        Main.main("prop_discriminant_2", checker, VERSION, args);
    }
}
