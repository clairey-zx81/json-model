...
static bool json_model_1(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (res)
    {
        if (unlikely(json_object_get(val, "b") != NULL))
            ...
            res = json_object_get(val, "c") != NULL && _jm_obj_3(val, NULL, NULL) || json_object_get(val, "d") != NULL && _jm_obj_2(val, NULL, NULL) || json_object_get(val, "e") != NULL && _jm_obj_1(val, NULL, NULL) || json_object_get(val, "c") != NULL && _jm_obj_0(val, NULL, NULL);
    }
    return res;
}
