...
function json_model_1(val, path, rep)
{
    ...
    if (res)
    {
        ...
        {
            res = val.hasOwnProperty("c") && _jm_obj_3(val, null, null) || val.hasOwnProperty("d") && _jm_obj_2(val, null, null) || val.hasOwnProperty("e") && _jm_obj_1(val, null, null) || val.hasOwnProperty("c") && _jm_obj_0(val, null, null);
        }
    }
    return res;
}
