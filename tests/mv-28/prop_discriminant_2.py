...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        if "b" in val:
            # .'|'.0
            res = _jm_obj_4(val, None, None)
        else:
            res = "c" in val and _jm_obj_3(val, None, None) or "d" in val and _jm_obj_2(val, None, None) or "e" in val and _jm_obj_1(val, None, None) or "c" in val and _jm_obj_0(val, None, None)
    return res
