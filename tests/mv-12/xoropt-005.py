...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "b":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'|'.1.b]", lpath_0 if path is not None else None))
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "a":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'|'.0.a]", lpath_1 if path is not None else None))
