...
bool _jm_obj_0(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    for (var entry in val.entries)
    {
        ...
        if (prop.compareTo("a") == 0)
        {
            ...
            if (! res)
            {
                rep?.add(["not a 0 strict int [.'^'.0.a]", (path != null ? lpath_0 : null)]);
        ...
        if (prop.compareTo("b") == 0)
        {
            ...
            if (! res)
            {
                rep?.add(["not a 0 strict int [.'^'.0.b]", (path != null ? lpath_0 : null)]);
                rep?.add(["invalid optional prop value [.'^'.0.b]", (path != null ? lpath_0 : null)]);
                return false;
            }
            continue;
        }
...
bool _jm_obj_1(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    for (var entry in val.entries)
    {
        ...
        if (prop.compareTo("b") == 0)
        {
            ...
            if (! res)
            {
                rep?.add(["not a 0 strict int [.'^'.1.b]", (path != null ? lpath_1 : null)]);
