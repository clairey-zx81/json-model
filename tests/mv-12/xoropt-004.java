...
public class xoropt_004 extends ModelChecker
{
    static public final String VERSION = "2";

    public Pattern _jm_re_0_pat = null;
    public Map<String, Checker> xoropt_004_map_pmap;
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            xoropt_004_map_pmap = new HashMap<String, Checker>();
            xoropt_004_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        if (initialized)
        {
            super.free();
            _jm_re_0_pat = null;
            xoropt_004_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return xoropt_004_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return xoropt_004_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new xoropt_004();
        Main.main("xoropt_004", checker, VERSION, args);
    }
}
