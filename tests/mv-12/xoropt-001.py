...
def json_model_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Ss']", path))
    return res
...
def json_model_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_0_idx, arr_0_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Any\" [.'$Aa'.0]", arr_0_lpath if path is not None else None))
                break
    if not res:
...
def json_model_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Any\" [.'$Oo'.'']", lpath_0 if path is not None else None))
            return False
    return True
...
def json_model_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Bb\" [.'$Any'.'|'.1]", path))
            # .'$Any'.'|'.2
            res = json_model_4(val, path, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Ii\" [.'$Any'.'|'.2]", path))
                # .'$Any'.'|'.3
                res = json_model_5(val, path, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Ff\" [.'$Any'.'|'.3]", path))
                    # .'$Any'.'|'.4
                    res = json_model_6(val, path, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$Ss\" [.'$Any'.'|'.4]", path))
                        # .'$Any'.'|'.5
                        res = json_model_7(val, path, rep)
                        if not res:
                            rep is None or rep.append(("unexpected value for model \"$Aa\" [.'$Any'.'|'.5]", path))
                            # .'$Any'.'|'.6
                            res = json_model_8(val, path, rep)
                            if not res:
                                rep is None or rep.append(("unexpected value for model \"$Oo\" [.'$Any'.'|'.6]", path))
    if res:
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Any\" [.]", path))
    return res
