            ...
            if (prop.compareTo("a") == 0)
            {
                ...
                if (res)
                {
                    ...
                    while (arr_0_item_loop.hasNext())
                    {
                        ...
                        if (! res)
                        {
                            if (rep != null) rep.addEntry("not a 0 strict int [.'|'.2.a.0]", ((path != null ? lpath_0 : null) != null ? arr_0_lpath : null));
                        }
                        if (! res)
                        {
                            break;
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not array or unexpected array [.'|'.2.a]", (path != null ? lpath_0 : null));
                }
                if (! res)
                {
    ...
    public boolean _jm_obj_1(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("a") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected string [.'|'.1.a]", (path != null ? lpath_1 : null));
                }
                if (! res)
                {
    ...
    public boolean _jm_obj_2(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("a") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not a bool [.'|'.0.a]", (path != null ? lpath_2 : null));
                }
                if (! res)
                {
