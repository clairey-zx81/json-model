...
public class xoropt_005 extends ModelChecker
{
    static public final String VERSION = "2";

    public Map<String, Checker> xoropt_005_map_pmap;
    ...
    public boolean _jm_obj_0(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("b") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected value for model \"\" [.'|'.1.b]", (path != null ? lpath_0 : null));
    ...
    public boolean _jm_obj_1(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("a") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected value for model \"\" [.'|'.0.a]", (path != null ? lpath_1 : null));
            ...
            if (! res)
            {
                if (rep != null) rep.addEntry("not a 0 strict int [.'|'.0.'']", (path != null ? lpath_1 : null));
                return false;
            }
        }
        if (must_count != 1)
    ...
    public void init(JSON json)
    {
        ...
        {
            try {
            xoropt_005_map_pmap = new HashMap<String, Checker>();
            xoropt_005_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    public void free()
    {
        ...
        {
            super.free();
            xoropt_005_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return xoropt_005_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return xoropt_005_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new xoropt_005();
        Main.main("xoropt_005", checker, VERSION, args);
    }
}
