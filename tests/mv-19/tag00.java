...
public class tag00 extends ModelChecker
{
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            tag00_map_pmap.put("Aa", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_0(o, p, r);} });
            tag00_map_pmap.put("Bb", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
