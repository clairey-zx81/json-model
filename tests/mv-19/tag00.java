...
public class tag00 extends ModelChecker
{
    ...
    public boolean _jm_obj_2(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("t") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected =1 [.'|'.0.t]", (path != null ? lpath_2 : null));
                }
                if (! res)
                {
    ...
    public boolean _jm_obj_3(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("t") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected =2 [.'|'.1.t]", (path != null ? lpath_3 : null));
                }
                if (! res)
                {
            ...
            else if (prop.compareTo("b") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("not a 0 strict int [.'|'.1.b]", (path != null ? lpath_3 : null));
                }
                if (! res)
                {
                    if (rep != null) rep.addEntry("invalid mandatory prop value [.'|'.1.b]", (path != null ? lpath_3 : null));
                    return false;
                }
            }
            else
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            _jm_map_0_cmap.put(json.safeJSON("2"), new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_3(o, p, r);} });
