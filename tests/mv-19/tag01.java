...
public class tag01 extends ModelChecker
{
    ...
    public boolean _jm_obj_0(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("t") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected =true [.'$A'.t]", (path != null ? lpath_0 : null));
                }
                if (! res)
                {
    ...
    public boolean _jm_obj_1(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("t") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected =false [.'$B'.t]", (path != null ? lpath_1 : null));
                }
                if (! res)
                {
    ...
    public boolean _jm_obj_2(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("t") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected =true [.'|'.0.t]", (path != null ? lpath_2 : null));
                }
                if (! res)
                {
    ...
    public boolean _jm_obj_3(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (prop.compareTo("t") == 0)
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected =false [.'|'.1.t]", (path != null ? lpath_3 : null));
                }
                if (! res)
                {
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            _jm_map_0_cmap.put(json.safeJSON("true"), new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_2(o, p, r);} });
            _jm_map_0_cmap.put(json.safeJSON("false"), new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_3(o, p, r);} });
            ...
            tag01_map_pmap.put("A", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_2(o, p, r);} });
            tag01_map_pmap.put("B", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_3(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
