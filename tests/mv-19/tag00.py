...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "t":
            ...
            if not res:
                rep is None or rep.append(("unexpected =1 [.'$A'.t]", lpath_0 if path is not None else None))
            if not res:
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "t":
            ...
            if not res:
                rep is None or rep.append(("unexpected =2 [.'$B'.t]", lpath_1 if path is not None else None))
            if not res:
...
def _jm_obj_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "t":
            ...
            res = isinstance(pval, int) and not isinstance(pval, bool) and pval == 1
            if not res:
                rep is None or rep.append(("unexpected =1 [.'|'.0.t]", lpath_2 if path is not None else None))
            if not res:
...
def _jm_obj_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "t":
            ...
            res = isinstance(pval, int) and not isinstance(pval, bool) and pval == 2
            if not res:
                rep is None or rep.append(("unexpected =2 [.'|'.1.t]", lpath_3 if path is not None else None))
            if not res:
