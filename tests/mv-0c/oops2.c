...
static INLINE bool _jm_obj_0(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    {
        if (rep) jm_report_add_entry(rep, "not an object [.'$Ax'.'^'.0]", path);
        return false;
    }
    ...
    if (unlikely(must_count != 1))
    {
        if (likely(rep != NULL))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "missing mandatory prop <a> [.'$Ax'.'^'.0.'']", path);
            }
        }
        return false;
    }
...
static INLINE bool _jm_obj_1(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    if (unlikely(! json_is_object(val)))
    {
        if (rep) jm_report_add_entry(rep, "not an object [.'$Ax'.'^'.1]", path);
        return false;
    }
    int64_t must_count = 0;
    const char *prop;
    ...
    if (unlikely(must_count != 1))
    {
        if (likely(rep != NULL))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "missing mandatory prop <b> [.'$Ax'.'^'.1.'']", path);
            }
        }
        return false;
    }
...
static bool json_model_2(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    {
        if (rep) jm_report_add_entry(rep, "unexpected element [.'$Ax'.'^'.0]", path);
    }
    // .'$Ax'.'^'.1
    ...
    {
        if (rep) jm_report_add_entry(rep, "unexpected element [.'$Ax'.'^'.1]", path);
    }
    bool res = xc_0 == 1;
    if (likely(res))
    {
    ...
    {
        if (rep) jm_report_add_entry(rep, "not one model match [.'$Ax'.'^']", path);
    }
    return res;
}
...
static bool json_model_3(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (unlikely(! res))
    {
        if (rep) jm_report_add_entry(rep, "not null [.'$Bx'.'|'.0]", path);
        // .'$Bx'.'|'.1
    ...
    {
        if (rep) jm_report_add_entry(rep, "no model matched [.'$Bx'.'|']", path);
    }
    return res;
}
...
static bool json_model_1(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (unlikely(! res))
    {
        if (rep) jm_report_add_entry(rep, "unexpected value for model \"$Ax\" [.]", path);
    }
    return res;
}
...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        check_model_map_tab[1] = (jm_propmap_t) { "Ax", json_model_2 };
        check_model_map_tab[2] = (jm_propmap_t) { "Bx", json_model_3 };
