...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_0_idx, arr_0_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.0.'|'.0]", arr_0_lpath if path is not None else None))
                # .0.'|'.1
                    ...
                    if res:
                        ...
                        if res:
                            ...
                            if res:
                                ...
                                rep is None or rep.append(("unexpected value for model \"\" [.0.'|'.2.1]", lpath_0 if (arr_0_lpath if path is not None else None) is not None else None))
                        else:
