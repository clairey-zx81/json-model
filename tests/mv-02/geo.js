...
function json_model_5(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$Point']", path])
    }
    return res;
}
...
function json_model_6(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$MultiPoint']", path])
    }
    return res;
}
...
function json_model_7(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$LineString']", path])
    }
    return res;
}
...
function json_model_8(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$MultiLineString']", path])
    }
    return res;
}
...
function json_model_9(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$Polygon']", path])
    }
    return res;
}
...
function json_model_10(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$MultiPolygon']", path])
    }
    return res;
}
...
function json_model_12(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$GeometryCollection']", path])
    }
    return res;
}
    ...
    for(const [prop, pval] of Object.entries(val))
    {
        ...
        else if (prop == "properties")
        {
            ...
            if (! res)
            {
                ...
                if (! res)
                {
                    rep !== null && rep.push(["not an expected object [.'$Feature'.properties.'|'.1]", (path ? lpath_7 : null)])
                }
            }
            if (res)
            {
...
function json_model_13(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$Feature']", path])
    }
    return res;
}
...
function json_model_14(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not an expected object [.'$FeatureCollection']", path])
    }
    return res;
}
