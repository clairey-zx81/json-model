...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Schema'.metadata.name]", lpath_1 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Schema'.metadata.previous]", lpath_1 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Schema'.metadata.date]", lpath_1 if path is not None else None))
            ...
            if res:
                for arr_1_idx, arr_1_item in enumerate(pval):
                    ...
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"\" [.'$Schema'.metadata.authors.0]", arr_1_lpath if (lpath_1 if path is not None else None) is not None else None))
                        break
            if not res:
        ...
        if prop == "types":
            ...
            if res:
                for arr_0_idx, arr_0_item in enumerate(pval):
                    ...
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$Type\" [.'$Schema'.types.0]", arr_0_lpath if (lpath_0 if path is not None else None) is not None else None))
                        break
            if not res:
...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        tag_0: Jsonable
        if (tag_0 := val.get("kind", UNDEFINED)) != UNDEFINED:
...
def _jm_f_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_2_idx, arr_2_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$atomic\" [.'$Atomic'.enumeration.0]", arr_2_lpath if path is not None else None))
                break
    if not res:
...
def _jm_f_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Atomic'.name]", path))
    return res
...
def _jm_f_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Atomic'.pattern]", path))
    return res
...
def json_model_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "kind":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"atomic\" [.'$Atomic'.kind]", lpath_2 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$atomic-types\" [.'$Atomic'.baseType]", lpath_2 if path is not None else None))
...
def json_model_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "kind":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"object\" [.'$Object'.kind]", lpath_3 if path is not None else None))
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Object'.name]", lpath_3 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Object'.baseType]", lpath_3 if path is not None else None))
            ...
            if res:
                for arr_3_idx, arr_3_item in enumerate(pval):
                    ...
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$Fields\" [.'$Object'.content.0]", arr_3_lpath if (lpath_3 if path is not None else None) is not None else None))
                        break
            if not res:
...
def json_model_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Fields'.name]", lpath_4 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$type-or-ref\" [.'$Fields'.type]", lpath_4 if path is not None else None))
...
def json_model_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "kind":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"array\" [.'$Array'.kind]", lpath_5 if path is not None else None))
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Array'.name]", lpath_5 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Array'.baseType]", lpath_5 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$type-or-ref\" [.'$Array'.content]", lpath_5 if path is not None else None))
...
def json_model_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Union'.name]", lpath_6 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"union\" [.'$Union'.kind]", lpath_6 if path is not None else None))
            ...
            if res:
                for arr_4_idx, arr_4_item in enumerate(pval):
                    ...
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$type-or-ref\" [.'$Union'.content.0]", arr_4_lpath if (lpath_6 if path is not None else None) is not None else None))
                        break
            if not res:
        ...
        if prop == "baseType":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$Union'.baseType]", lpath_6 if path is not None else None))
...
def json_model_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$type-or-ref'.'|'.0]", path))
        # .'$type-or-ref'.'|'.1
        res = json_model_3(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Type\" [.'$type-or-ref'.'|'.1]", path))
    if res:
