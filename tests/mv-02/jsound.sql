...
RETURNS TEXT STRICT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  map JSONB := JSONB '{"":"json_model_1","Schema":"json_model_2","Type":"json_model_3","atomic-types":"json_model_4","atomic":"json_model_5","Atomic":"json_model_6","Object":"json_model_7","Fields":"json_model_8","Array":"json_model_9","Union":"json_model_10","type-or-ref":"json_model_11"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
