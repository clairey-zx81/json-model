#! /bin/env python
#
# Model: ./json-schema-draft-2019-09-fuzzy.model.json
#
...
def _jm_f_0(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    result = json_model_110(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $id at {path} [$.'$schema#ObjectSchema'.'$id']")
    return result
...
def _jm_f_1(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if not result:
        rep is None or rep.append(f"not an expected _https://json-schema.org/draft/2019-09/schema at {path} [$.'$schema#ObjectSchema'.'$schema']")
    return result
...
def _jm_f_2(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    result = json_model_109(value, path, rep)
    if not result:
...
# define "json_model_122_may_$recursiveRef" ($.'$schema#ObjectSchema'.'$recursiveRef')
def _jm_f_4(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$schema#ObjectSchema'.'$recursiveRef'
    result = json_model_109(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $URI-REFERENCE at {path} [$.'$schema#ObjectSchema'.'$recursiveRef']")
    return result

# define "json_model_122_may_$recursiveAnchor" ($.'$schema#ObjectSchema'.'$recursiveAnchor')
def _jm_f_5(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$schema#ObjectSchema'.'$recursiveAnchor'
    result = isinstance(value, bool)
    if not result:
        rep is None or rep.append(f"not a bool at {path} [$.'$schema#ObjectSchema'.'$recursiveAnchor']")
    return result
...
# define "json_model_122_may_additionalItems" ($.'$schema#ObjectSchema'.additionalItems)
...
def json_model_109(value: Jsonable, path: str, rep: Report = None) -> bool:
...
# define "$schema#id" ($.'$schema#id')
def json_model_110(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$schema#id'
    result = json_model_109(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $URI-REFERENCE at {path} [$.'$schema#id']")
    return result
...
json_model_122_may = {
    ...
    "maxContains": _jm_f_40,
    "minContains": _jm_f_41,
    "maxProperties": _jm_f_42,
    "minProperties": _jm_f_43,
    "required": _jm_f_44,
    "dependentRequired": _jm_f_45,
    "title": _jm_f_46,
    ...
    "examples": _jm_f_52,
    "format": _jm_f_53,
    "contentEncoding": _jm_f_54,
    "contentMediaType": _jm_f_55,
    "contentSchema": _jm_f_56,
}
