# Generated for model: ./json-schema-draft-2019-09-fuzzy.model.json
#
...
# define "json_model_40_may_additionalItems" ($.'$#schema#ObjectSchema'.additionalItems)
...
def json_model_1(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if not result:
        rep is None or rep.append(f"not an expected $https://json-model.org/models/json-schema-draft-2019-09 at {path} [$.'$schema']")
    return result
