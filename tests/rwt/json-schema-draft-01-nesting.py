...
# define "json_model_25_may_maxDecimal" ($.'$#schema'.maxDecimal)
...
def json_model_1(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    result = json_model_25(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $https://json-model.org/models/json-schema-draft-01 at {path} [$.'$schema']")
    return result
