#! /bin/env python
#
# Model: ./json-schema-draft-01-nesting.model.json
#
...
# define "json_model_6_may_type" ($.'$schema'.type)
...
# define "json_model_6_may_items" ($.'$schema'.items)
    ...
    if not result:
        ...
        if result:
            for array_1_idx, array_1_item in enumerate(value):
                ...
                # $.'$schema'.items.'|'.1.0
                result = json_model_6(array_1_item, path, rep)
                if not result:
...
# define "json_model_6_may_optional" ($.'$schema'.optional)
...
# define "json_model_6_may_additionalProperties" ($.'$schema'.additionalProperties)
...
# define "json_model_6_may_requires" ($.'$schema'.requires)
...
# define "json_model_6_may_minimum" ($.'$schema'.minimum)
...
# define "json_model_6_may_maximum" ($.'$schema'.maximum)
...
# define "json_model_6_may_minimumCanEqual" ($.'$schema'.minimumCanEqual)
...
# define "json_model_6_may_maximumCanEqual" ($.'$schema'.maximumCanEqual)
...
# define "json_model_6_may_minItems" ($.'$schema'.minItems)
...
# define "json_model_6_may_maxItems" ($.'$schema'.maxItems)
...
# define "json_model_6_may_pattern" ($.'$schema'.pattern)
...
# define "json_model_6_may_minLength" ($.'$schema'.minLength)
...
# define "json_model_6_may_maxLength" ($.'$schema'.maxLength)
...
# define "json_model_6_may_enum" ($.'$schema'.enum)
...
# define "json_model_6_may_title" ($.'$schema'.title)
...
# define "json_model_6_may_description" ($.'$schema'.description)
...
# define "json_model_6_may_format" ($.'$schema'.format)
...
# define "json_model_6_may_contentEncoding" ($.'$schema'.contentEncoding)
...
# define "json_model_6_may_default" ($.'$schema'.default)
...
# define "json_model_6_may_maxDecimal" ($.'$schema'.maxDecimal)
def _jm_f_21(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$schema'.maxDecimal
    result = isinstance(value, int) and not isinstance(value, bool) and value >= 0
    if not result:
        rep is None or rep.append(f"not a 0 int at {path} [$.'$schema'.maxDecimal]")
    return result

# define "json_model_6_may_disallow" ($.'$schema'.disallow)
    ...
    if not result:
        ...
        if result:
            for array_3_idx, array_3_item in enumerate(value):
                ...
                if not result:
                    rep is None or rep.append(f"not an expected string at {lpath} [$.'$schema'.disallow.'|'.1.0]")
                if not result:
                    break
        if not result:
            rep is None or rep.append(f"not array or unexpected array at {path} [$.'$schema'.disallow.'|'.1]")
    if not result:
        rep is None or rep.append(f"not any model match at {path} [$.'$schema'.disallow.'|']")
    return result

# define "json_model_6_may_extends" ($.'$schema'.extends)
    ...
    if not result:
        ...
        if result:
            for array_4_idx, array_4_item in enumerate(value):
                ...
                # $.'$schema'.extends.'|'.1.0
                result = json_model_6(array_4_item, path, rep)
                if not result:
...
# define "json_model_6_may_id" ($.'$schema'.id)
...
# define "json_model_6_may_$schema" ($.'$schema'.'$schema')
