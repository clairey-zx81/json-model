...
static propmap_t _jm_obj_0_may_tab[2];
...
static propmap_t _jm_obj_2_may_tab[2];
...
static propmap_t _jm_obj_4_may_tab[2];
...
static propmap_t _jm_obj_10_may_tab[5];
...
static propmap_t _jm_obj_13_may_tab[3];
...
static propmap_t _jm_obj_12_may_tab[5];
...
static propmap_t _jm_obj_19_may_tab[3];
...
static propmap_t _jm_obj_18_may_tab[5];
...
static propmap_t _jm_obj_25_may_tab[3];
...
static propmap_t _jm_obj_24_may_tab[5];
...
static propmap_t _jm_obj_30_may_tab[5];
...
static propmap_t _jm_obj_37_may_tab[3];
...
static propmap_t _jm_obj_43_may_tab[3];
...
static propmap_t _jm_obj_45_may_tab[2];
...
static propmap_t _jm_obj_42_may_tab[8];
...
static propmap_t _jm_obj_48_may_tab[3];
static bool _jm_f_92(const json_t* val, Path* path, Report* rep);
static propmap_t _jm_obj_51_must_tab[1];
...
static propmap_t _jm_obj_51_may_tab[3];
...
static bool _jm_f_0(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected string [$.'$Model#Elem'.'|'.5.'#']", path);
    }
    return res;
}
...
static bool _jm_obj_1(const json_t* val, Path* path, Report* rep)
{
    ...
    {
        if (rep) jm_report_add_entry(rep, "not an object [$.'$Model#Elem'.'|'.5.'.schema']", path);
        return false;
    }
    // accept any object
    return true;
...
static bool _jm_f_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Elem'.'|'.5.'.schema']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_0_may_tab, 2);
}
...
static bool _jm_obj_0(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_0_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Elem'.'|'.5]", (path ? &lpath_0 : NULL));
                return false;
            }
        }
...
static bool _jm_f_2(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        json_array_foreach(val, arr_1_idx, arr_1_item)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Elem'.'|'.4.'+'.0]", (path ? &arr_1_lpath : NULL));
            }
            if (! res)
            {
                break;
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not array or unexpected array [$.'$Model#Elem'.'|'.4.'+']", path);
    }
    return res;
}
...
static bool _jm_f_3(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected string [$.'$Model#Elem'.'|'.4.'#']", path);
    }
    return res;
}
...
static bool _jm_obj_3(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) jm_report_add_entry(rep, "not an object [$.'$Model#Elem'.'|'.4.'.schema']", path);
        return false;
    }
    // accept any object
    return true;
...
static bool _jm_f_4(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Elem'.'|'.4.'.schema']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_2_may_tab, 2);
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_2_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Elem'.'|'.4]", (path ? &lpath_1 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_2_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Elem'.'|'.4]", (path ? &lpath_1 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Elem'.'|'.4]", (path ? &lpath_1 : NULL));
            return false;
        }
    }
    if (must_count != 1)
    {
        if (rep) jm_report_add_entry(rep, "missing must prop [$.'$Model#Elem'.'|'.4]", path);
        return false;
    }
    return true;
}
...
static bool _jm_f_5(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        json_array_foreach(val, arr_2_idx, arr_2_item)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Elem'.'|'.3.'^'.0]", (path ? &arr_2_lpath : NULL));
            }
            if (! res)
            {
                break;
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not array or unexpected array [$.'$Model#Elem'.'|'.3.'^']", path);
    }
    return res;
}
...
static bool _jm_f_6(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected string [$.'$Model#Elem'.'|'.3.'#']", path);
    }
    return res;
}
...
static bool _jm_obj_5(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) jm_report_add_entry(rep, "not an object [$.'$Model#Elem'.'|'.3.'.schema']", path);
        return false;
    }
    // accept any object
    return true;
...
static bool _jm_f_7(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Elem'.'|'.3.'.schema']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_4_may_tab, 2);
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_4_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Elem'.'|'.3]", (path ? &lpath_2 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_4_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Elem'.'|'.3]", (path ? &lpath_2 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Elem'.'|'.3]", (path ? &lpath_2 : NULL));
            return false;
        }
    }
    if (must_count != 1)
...
static bool _jm_f_8(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        json_array_foreach(val, arr_3_idx, arr_3_item)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Elem'.'|'.2.'&'.0]", (path ? &arr_3_lpath : NULL));
            }
            if (! res)
            {
                break;
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not array or unexpected array [$.'$Model#Elem'.'|'.2.'&']", path);
    }
    return res;
}
...
static bool _jm_f_9(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected string [$.'$Model#Elem'.'|'.2.'#']", path);
    }
    return res;
}
...
static bool _jm_obj_7(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) jm_report_add_entry(rep, "not an object [$.'$Model#Elem'.'|'.2.'.schema']", path);
        return false;
    }
    // accept any object
    return true;
...
static bool _jm_f_10(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Elem'.'|'.2.'.schema']", path);
    }
    return res;
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_6_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Elem'.'|'.2]", (path ? &lpath_3 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_6_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Elem'.'|'.2]", (path ? &lpath_3 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Elem'.'|'.2]", (path ? &lpath_3 : NULL));
            return false;
        }
    }
    if (must_count != 1)
...
static bool _jm_f_11(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        json_array_foreach(val, arr_4_idx, arr_4_item)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Elem'.'|'.1.'|'.0]", (path ? &arr_4_lpath : NULL));
            }
            if (! res)
            {
                break;
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not array or unexpected array [$.'$Model#Elem'.'|'.1.'|']", path);
    }
    return res;
}
...
static bool _jm_f_12(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected string [$.'$Model#Elem'.'|'.1.'#']", path);
    }
    return res;
}
...
static bool _jm_obj_9(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) jm_report_add_entry(rep, "not an object [$.'$Model#Elem'.'|'.1.'.schema']", path);
        return false;
    }
    // accept any object
    return true;
...
static bool _jm_f_13(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Elem'.'|'.1.'.schema']", path);
    }
    return res;
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_8_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Elem'.'|'.1]", (path ? &lpath_4 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_8_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Elem'.'|'.1]", (path ? &lpath_4 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Elem'.'|'.1]", (path ? &lpath_4 : NULL));
            return false;
        }
    }
    if (must_count != 1)
...
static bool _jm_f_14(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Elem'.'|'.0.'@']", path);
    }
    return res;
}
...
static bool _jm_f_15(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not a bool [$.'$Model#Elem'.'|'.0.'!']", path);
    }
    return res;
}
...
static bool _jm_f_16(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected string [$.'$Model#Elem'.'|'.0.'#']", path);
    }
    return res;
}
...
static bool _jm_f_17(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Elem'.'|'.0.'.in']", path);
    }
    return res;
}
...
static bool _jm_f_18(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not a 1 strict int [$.'$Model#Elem'.'|'.0.'.mo']", path);
    }
    return res;
}
...
static bool _jm_obj_11(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) jm_report_add_entry(rep, "not an object [$.'$Model#Elem'.'|'.0.'.schema']", path);
        return false;
    }
    // accept any object
    return true;
...
static bool _jm_f_19(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Elem'.'|'.0.'.schema']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_10_may_tab, 5);
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_10_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Elem'.'|'.0]", (path ? &lpath_5 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_10_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Elem'.'|'.0]", (path ? &lpath_5 : NULL));
                return false;
            }
        }
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Elem'.'|'.0]", (path ? &lpath_5 : NULL));
            return false;
        }
    }
    if (must_count != 1)
                ...
                if (! res)
                {
                    ...
                    if (! res)
                    {
                        ...
                        if (! res)
                        {
                            ...
                            if (! res)
                            {
                                if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Elem'.'|'.5]", path);
                            }
                        }
                    }
                }
...
static bool _jm_f_24(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Root'.'|'.5.'$'.'.schema']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_13_may_tab, 3);
}
...
static bool _jm_obj_13(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_13_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.5.'$']", (path ? &lpath_7 : NULL));
                return false;
            }
        }
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.5.'$']", (path ? &lpath_7 : NULL));
            return false;
        }
    }
    return true;
...
static bool _jm_f_21(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Root'.'|'.5.'$']", path);
    }
    return res;
}
...
static bool _jm_obj_15(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_15_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.5.'%']", (path ? &lpath_8 : NULL));
                return false;
            }
        }
        else if (_jm_re_4(prop))
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected REGEX [$.'$Model#Root'.'|'.5.'%'.'/^\\\\..+$/']", (path ? &lpath_8 : NULL));
            }
            if (! res)
            {
                return false;
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.5.'%']", (path ? &lpath_8 : NULL));
            return false;
        }
    }
    return true;
...
{
    return jm_search_propmap(pname, _jm_obj_12_may_tab, 5);
}
...
static bool _jm_obj_12(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_12_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.5]", (path ? &lpath_6 : NULL));
                return false;
            }
        }
        else if (_jm_re_0(prop))
...
static bool _jm_f_30(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        json_array_foreach(val, arr_5_idx, arr_5_item)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Root'.'|'.4.'+'.0]", (path ? &arr_5_lpath : NULL));
            }
            if (! res)
            {
                break;
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not array or unexpected array [$.'$Model#Root'.'|'.4.'+']", path);
    }
    return res;
}
...
static bool _jm_f_35(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Root'.'|'.4.'$'.'.schema']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_19_may_tab, 3);
}
...
static bool _jm_obj_19(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_19_may(prop)))
        {
            // handle {len(may)} may props
            if (pfun != NULL && ! pfun(pval, (path ? &lpath_10 : NULL), rep))
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.4.'$']", (path ? &lpath_10 : NULL));
                return false;
            }
        }
        else if (_jm_re_3(prop))
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.4.'$']", (path ? &lpath_10 : NULL));
            return false;
        }
    }
    return true;
...
static bool _jm_obj_21(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_21_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.4.'%']", (path ? &lpath_11 : NULL));
                return false;
            }
        }
        else if (_jm_re_4(prop))
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected REGEX [$.'$Model#Root'.'|'.4.'%'.'/^\\\\..+$/']", (path ? &lpath_11 : NULL));
            }
            if (! res)
            {
                return false;
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.4.'%']", (path ? &lpath_11 : NULL));
            return false;
        }
    }
    return true;
...
{
    return jm_search_propmap(pname, _jm_obj_18_may_tab, 5);
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_18_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Root'.'|'.4]", (path ? &lpath_9 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_18_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.4]", (path ? &lpath_9 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.4]", (path ? &lpath_9 : NULL));
            return false;
        }
    }
    if (must_count != 1)
    {
        if (rep) jm_report_add_entry(rep, "missing must prop [$.'$Model#Root'.'|'.4]", path);
        return false;
    }
    return true;
}
...
static bool _jm_f_41(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        json_array_foreach(val, arr_6_idx, arr_6_item)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Root'.'|'.3.'^'.0]", (path ? &arr_6_lpath : NULL));
            }
            if (! res)
            {
                break;
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not array or unexpected array [$.'$Model#Root'.'|'.3.'^']", path);
    }
    return res;
}
...
static bool _jm_f_46(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Root'.'|'.3.'$'.'.schema']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_25_may_tab, 3);
}
...
static bool _jm_obj_25(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_25_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.3.'$']", (path ? &lpath_13 : NULL));
                return false;
            }
        }
        else if (_jm_re_3(prop))
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.3.'$']", (path ? &lpath_13 : NULL));
            return false;
        }
    }
    return true;
...
static bool _jm_obj_27(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_27_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.3.'%']", (path ? &lpath_14 : NULL));
                return false;
            }
        }
        else if (_jm_re_4(prop))
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected REGEX [$.'$Model#Root'.'|'.3.'%'.'/^\\\\..+$/']", (path ? &lpath_14 : NULL));
            }
            if (! res)
            {
                return false;
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.3.'%']", (path ? &lpath_14 : NULL));
            return false;
        }
    }
    return true;
...
{
    return jm_search_propmap(pname, _jm_obj_24_may_tab, 5);
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_24_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Root'.'|'.3]", (path ? &lpath_12 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_24_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.3]", (path ? &lpath_12 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.3]", (path ? &lpath_12 : NULL));
            return false;
        }
    }
    if (must_count != 1)
...
static bool _jm_f_52(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        json_array_foreach(val, arr_7_idx, arr_7_item)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Root'.'|'.2.'&'.0]", (path ? &arr_7_lpath : NULL));
            }
            if (! res)
            {
                break;
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not array or unexpected array [$.'$Model#Root'.'|'.2.'&']", path);
    }
    return res;
}
...
static bool _jm_f_57(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Root'.'|'.2.'$'.'.schema']", path);
    }
    return res;
}
...
static bool _jm_obj_31(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_31_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.2.'$']", (path ? &lpath_16 : NULL));
                return false;
            }
        }
        else if (_jm_re_3(prop))
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.2.'$']", (path ? &lpath_16 : NULL));
            return false;
        }
    }
    return true;
...
static bool _jm_obj_33(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_33_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.2.'%']", (path ? &lpath_17 : NULL));
                return false;
            }
        }
        else if (_jm_re_4(prop))
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected REGEX [$.'$Model#Root'.'|'.2.'%'.'/^\\\\..+$/']", (path ? &lpath_17 : NULL));
            }
            if (! res)
            {
                return false;
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.2.'%']", (path ? &lpath_17 : NULL));
            return false;
        }
    }
    return true;
...
{
    return jm_search_propmap(pname, _jm_obj_30_may_tab, 5);
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_30_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Root'.'|'.2]", (path ? &lpath_15 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_30_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.2]", (path ? &lpath_15 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.2]", (path ? &lpath_15 : NULL));
            return false;
        }
    }
    if (must_count != 1)
...
static bool _jm_f_63(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        json_array_foreach(val, arr_8_idx, arr_8_item)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Root'.'|'.1.'|'.0]", (path ? &arr_8_lpath : NULL));
            }
            if (! res)
            {
                break;
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not array or unexpected array [$.'$Model#Root'.'|'.1.'|']", path);
    }
    return res;
}
...
static bool _jm_f_68(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Root'.'|'.1.'$'.'.schema']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_37_may_tab, 3);
}
...
static bool _jm_obj_37(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_37_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.1.'$']", (path ? &lpath_19 : NULL));
                return false;
            }
        }
        else if (_jm_re_3(prop))
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.1.'$']", (path ? &lpath_19 : NULL));
            return false;
        }
    }
    return true;
...
static bool _jm_obj_39(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_39_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.1.'%']", (path ? &lpath_20 : NULL));
                return false;
            }
        }
        else if (_jm_re_4(prop))
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected REGEX [$.'$Model#Root'.'|'.1.'%'.'/^\\\\..+$/']", (path ? &lpath_20 : NULL));
            }
            if (! res)
            {
                return false;
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.1.'%']", (path ? &lpath_20 : NULL));
            return false;
        }
    }
    return true;
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_36_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Root'.'|'.1]", (path ? &lpath_18 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_36_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.1]", (path ? &lpath_18 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.1]", (path ? &lpath_18 : NULL));
            return false;
        }
    }
    if (must_count != 1)
...
static bool _jm_f_74(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected $Model [$.'$Model#Root'.'|'.0.'@']", path);
    }
    return res;
}
...
static bool _jm_f_80(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Root'.'|'.0.'$'.'.schema']", path);
    }
    return res;
}

static check_fun_t _jm_obj_43_may(const char *pname)
{
    return jm_search_propmap(pname, _jm_obj_43_may_tab, 3);
}
...
static bool _jm_obj_43(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_43_may(prop)))
        {
            // handle {len(may)} may props
            if (pfun != NULL && ! pfun(pval, (path ? &lpath_22 : NULL), rep))
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.0.'$']", (path ? &lpath_22 : NULL));
                return false;
            }
        }
        else if (_jm_re_3(prop))
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.0.'$']", (path ? &lpath_22 : NULL));
            return false;
        }
    }
    return true;
...
{
    return jm_search_propmap(pname, _jm_obj_45_may_tab, 2);
}
...
static bool _jm_obj_45(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_45_may(prop)))
        {
            // handle {len(may)} may props
            if (pfun != NULL && ! pfun(pval, (path ? &lpath_23 : NULL), rep))
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.0.'%']", (path ? &lpath_23 : NULL));
                return false;
            }
        }
        else if (_jm_re_4(prop))
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "unexpected REGEX [$.'$Model#Root'.'|'.0.'%'.'/^\\\\..+$/']", (path ? &lpath_23 : NULL));
            }
            if (! res)
            {
                return false;
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.0.'%']", (path ? &lpath_23 : NULL));
            return false;
        }
    }
    return true;
...
{
    return jm_search_propmap(pname, _jm_obj_42_may_tab, 8);
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_42_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Root'.'|'.0]", (path ? &lpath_21 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_42_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Root'.'|'.0]", (path ? &lpath_21 : NULL));
                return false;
            }
        }
        else if (_jm_re_1(prop))
        ...
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Root'.'|'.0]", (path ? &lpath_21 : NULL));
            return false;
        }
    }
    if (must_count != 1)
...
static bool json_model_4(const json_t* val, Path* path, Report* rep)
{
    ...
    // $.'$Model#Url'
    // "/^((file|https?)://.+|\\./.*|\\.\\./.*)$/"
    res = json_is_string(val) && _jm_re_7(json_string_value(val));
    if (! res)
    {
...
static bool _jm_f_88(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not array or unexpected array [$.'$Model#Trafo'.'|'.2.'*'.'|'.0]", path);
    }
    if (! res)
    {
        // $.'$Model#Trafo'.'|'.2.'*'.'|'.1
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Trafo'.'|'.2.'*'.'|'.1]", path);
        }
    }
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "no model matched [$.'$Model#Trafo'.'|'.2.'*'.'|']", path);
    }
    return res;
}
...
static bool _jm_f_89(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected string [$.'$Model#Trafo'.'|'.2.'#']", path);
    }
    return res;
}
...
static bool _jm_obj_50(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) jm_report_add_entry(rep, "not an object [$.'$Model#Trafo'.'|'.2.'.schema']", path);
        return false;
    }
    // accept any object
    return true;
...
static bool _jm_f_90(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Trafo'.'|'.2.'.schema']", path);
    }
    return res;
}
...
static bool _jm_f_91(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected $ANY [$.'$Model#Trafo'.'|'.2.'/']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_48_may_tab, 3);
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_48_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Trafo'.'|'.2]", (path ? &lpath_24 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_48_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Trafo'.'|'.2]", (path ? &lpath_24 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Trafo'.'|'.2]", (path ? &lpath_24 : NULL));
            return false;
        }
    }
    if (must_count != 1)
    {
        if (rep) jm_report_add_entry(rep, "missing must prop [$.'$Model#Trafo'.'|'.2]", path);
        return false;
    }
    return true;
}
...
static bool _jm_f_92(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected $ANY [$.'$Model#Trafo'.'|'.1.'/']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_51_must_tab, 1);
}
...
static bool _jm_f_93(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected string [$.'$Model#Trafo'.'|'.1.'#']", path);
    }
    return res;
}
...
static bool _jm_f_94(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not array or unexpected array [$.'$Model#Trafo'.'|'.1.'*'.'|'.0]", path);
    }
    if (! res)
    {
        // $.'$Model#Trafo'.'|'.1.'*'.'|'.1
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Trafo'.'|'.1.'*'.'|'.1]", path);
        }
    }
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "no model matched [$.'$Model#Trafo'.'|'.1.'*'.'|']", path);
    }
    return res;
}
...
static bool _jm_obj_53(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) jm_report_add_entry(rep, "not an object [$.'$Model#Trafo'.'|'.1.'.schema']", path);
        return false;
    }
    // accept any object
    return true;
...
static bool _jm_f_95(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Trafo'.'|'.1.'.schema']", path);
    }
    return res;
}
...
{
    return jm_search_propmap(pname, _jm_obj_51_may_tab, 3);
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_51_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "invalid must property value [$.'$Model#Trafo'.'|'.1]", (path ? &lpath_26 : NULL));
                    return false;
                }
            }
        }
        else if ((pfun = _jm_obj_51_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'$Model#Trafo'.'|'.1]", (path ? &lpath_26 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "no other prop expected [$.'$Model#Trafo'.'|'.1]", (path ? &lpath_26 : NULL));
            return false;
        }
    }
    if (must_count != 1)
    {
        if (rep) jm_report_add_entry(rep, "missing must prop [$.'$Model#Trafo'.'|'.1]", path);
        return false;
    }
    return true;
}
...
static bool json_model_17(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        ...
        if (! res)
        {
            if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Trafo'.'|'.1]", path);
        }
        if (! res)
        {
            // $.'$Model#Trafo'.'|'.2
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "not an expected object at [$.'$Model#Trafo'.'|'.2]", path);
            }
        }
    }
    if (! res)
...
char *CHECK_init(void)
{
    if (!initialized)
    {
        ...
        jm_sort_propmap(_jm_obj_0_may_tab, 2);
        int err_code;
        ...
        _jm_obj_2_must_tab[0] = (propmap_t) { "+", _jm_f_2 };
        jm_sort_propmap(_jm_obj_2_must_tab, 1);
        _jm_obj_2_may_tab[0] = (propmap_t) { "#", _jm_f_3 };
        _jm_obj_2_may_tab[1] = (propmap_t) { ".schema", _jm_f_4 };
        jm_sort_propmap(_jm_obj_2_may_tab, 2);
        _jm_obj_4_must_tab[0] = (propmap_t) { "^", _jm_f_5 };
        jm_sort_propmap(_jm_obj_4_must_tab, 1);
        _jm_obj_4_may_tab[0] = (propmap_t) { "#", _jm_f_6 };
        _jm_obj_4_may_tab[1] = (propmap_t) { ".schema", _jm_f_7 };
        jm_sort_propmap(_jm_obj_4_may_tab, 2);
        _jm_obj_6_must_tab[0] = (propmap_t) { "&", _jm_f_8 };
        jm_sort_propmap(_jm_obj_6_must_tab, 1);
        _jm_obj_6_may_tab[0] = (propmap_t) { "#", _jm_f_9 };
        _jm_obj_6_may_tab[1] = (propmap_t) { ".schema", _jm_f_10 };
        jm_sort_propmap(_jm_obj_6_may_tab, 2);
        _jm_obj_8_must_tab[0] = (propmap_t) { "|", _jm_f_11 };
        jm_sort_propmap(_jm_obj_8_must_tab, 1);
        _jm_obj_8_may_tab[0] = (propmap_t) { "#", _jm_f_12 };
        _jm_obj_8_may_tab[1] = (propmap_t) { ".schema", _jm_f_13 };
        jm_sort_propmap(_jm_obj_8_may_tab, 2);
        _jm_obj_10_must_tab[0] = (propmap_t) { "@", _jm_f_14 };
        jm_sort_propmap(_jm_obj_10_must_tab, 1);
        _jm_obj_10_may_tab[0] = (propmap_t) { "!", _jm_f_15 };
        _jm_obj_10_may_tab[1] = (propmap_t) { "#", _jm_f_16 };
        _jm_obj_10_may_tab[2] = (propmap_t) { ".in", _jm_f_17 };
        _jm_obj_10_may_tab[3] = (propmap_t) { ".mo", _jm_f_18 };
        _jm_obj_10_may_tab[4] = (propmap_t) { ".schema", _jm_f_19 };
        jm_sort_propmap(_jm_obj_10_may_tab, 5);
        ...
        _jm_obj_13_may_tab[0] = (propmap_t) { "", _jm_f_22 };
        _jm_obj_13_may_tab[1] = (propmap_t) { "#", _jm_f_23 };
        _jm_obj_13_may_tab[2] = (propmap_t) { ".schema", _jm_f_24 };
        jm_sort_propmap(_jm_obj_13_may_tab, 3);
        ...
        _jm_obj_15_may_tab[0] = (propmap_t) { "#", _jm_f_26 };
        _jm_obj_15_may_tab[1] = (propmap_t) { ".schema", _jm_f_27 };
        ...
        _jm_obj_12_may_tab[0] = (propmap_t) { "#", _jm_f_20 };
        _jm_obj_12_may_tab[1] = (propmap_t) { "$", _jm_f_21 };
        _jm_obj_12_may_tab[2] = (propmap_t) { "%", _jm_f_25 };
        _jm_obj_12_may_tab[3] = (propmap_t) { ".schema", _jm_f_28 };
        _jm_obj_12_may_tab[4] = (propmap_t) { "~", _jm_f_29 };
        jm_sort_propmap(_jm_obj_12_may_tab, 5);
        _jm_obj_18_must_tab[0] = (propmap_t) { "+", _jm_f_30 };
        jm_sort_propmap(_jm_obj_18_must_tab, 1);
        _jm_obj_19_may_tab[0] = (propmap_t) { "", _jm_f_33 };
        _jm_obj_19_may_tab[1] = (propmap_t) { "#", _jm_f_34 };
        _jm_obj_19_may_tab[2] = (propmap_t) { ".schema", _jm_f_35 };
        jm_sort_propmap(_jm_obj_19_may_tab, 3);
        _jm_obj_21_may_tab[0] = (propmap_t) { "#", _jm_f_37 };
        _jm_obj_21_may_tab[1] = (propmap_t) { ".schema", _jm_f_38 };
        jm_sort_propmap(_jm_obj_21_may_tab, 2);
        _jm_obj_18_may_tab[0] = (propmap_t) { "#", _jm_f_31 };
        _jm_obj_18_may_tab[1] = (propmap_t) { "$", _jm_f_32 };
        _jm_obj_18_may_tab[2] = (propmap_t) { "%", _jm_f_36 };
        _jm_obj_18_may_tab[3] = (propmap_t) { ".schema", _jm_f_39 };
        _jm_obj_18_may_tab[4] = (propmap_t) { "~", _jm_f_40 };
        jm_sort_propmap(_jm_obj_18_may_tab, 5);
        _jm_obj_24_must_tab[0] = (propmap_t) { "^", _jm_f_41 };
        jm_sort_propmap(_jm_obj_24_must_tab, 1);
        _jm_obj_25_may_tab[0] = (propmap_t) { "", _jm_f_44 };
        _jm_obj_25_may_tab[1] = (propmap_t) { "#", _jm_f_45 };
        _jm_obj_25_may_tab[2] = (propmap_t) { ".schema", _jm_f_46 };
        jm_sort_propmap(_jm_obj_25_may_tab, 3);
        _jm_obj_27_may_tab[0] = (propmap_t) { "#", _jm_f_48 };
        _jm_obj_27_may_tab[1] = (propmap_t) { ".schema", _jm_f_49 };
        jm_sort_propmap(_jm_obj_27_may_tab, 2);
        _jm_obj_24_may_tab[0] = (propmap_t) { "#", _jm_f_42 };
        _jm_obj_24_may_tab[1] = (propmap_t) { "$", _jm_f_43 };
        _jm_obj_24_may_tab[2] = (propmap_t) { "%", _jm_f_47 };
        _jm_obj_24_may_tab[3] = (propmap_t) { ".schema", _jm_f_50 };
        _jm_obj_24_may_tab[4] = (propmap_t) { "~", _jm_f_51 };
        jm_sort_propmap(_jm_obj_24_may_tab, 5);
        _jm_obj_30_must_tab[0] = (propmap_t) { "&", _jm_f_52 };
        jm_sort_propmap(_jm_obj_30_must_tab, 1);
        _jm_obj_31_may_tab[0] = (propmap_t) { "", _jm_f_55 };
        _jm_obj_31_may_tab[1] = (propmap_t) { "#", _jm_f_56 };
        _jm_obj_31_may_tab[2] = (propmap_t) { ".schema", _jm_f_57 };
        jm_sort_propmap(_jm_obj_31_may_tab, 3);
        _jm_obj_33_may_tab[0] = (propmap_t) { "#", _jm_f_59 };
        _jm_obj_33_may_tab[1] = (propmap_t) { ".schema", _jm_f_60 };
        jm_sort_propmap(_jm_obj_33_may_tab, 2);
        _jm_obj_30_may_tab[0] = (propmap_t) { "#", _jm_f_53 };
        _jm_obj_30_may_tab[1] = (propmap_t) { "$", _jm_f_54 };
        _jm_obj_30_may_tab[2] = (propmap_t) { "%", _jm_f_58 };
        _jm_obj_30_may_tab[3] = (propmap_t) { ".schema", _jm_f_61 };
        _jm_obj_30_may_tab[4] = (propmap_t) { "~", _jm_f_62 };
        jm_sort_propmap(_jm_obj_30_may_tab, 5);
        _jm_obj_36_must_tab[0] = (propmap_t) { "|", _jm_f_63 };
        jm_sort_propmap(_jm_obj_36_must_tab, 1);
        _jm_obj_37_may_tab[0] = (propmap_t) { "", _jm_f_66 };
        _jm_obj_37_may_tab[1] = (propmap_t) { "#", _jm_f_67 };
        _jm_obj_37_may_tab[2] = (propmap_t) { ".schema", _jm_f_68 };
        jm_sort_propmap(_jm_obj_37_may_tab, 3);
        _jm_obj_39_may_tab[0] = (propmap_t) { "#", _jm_f_70 };
        _jm_obj_39_may_tab[1] = (propmap_t) { ".schema", _jm_f_71 };
        jm_sort_propmap(_jm_obj_39_may_tab, 2);
        _jm_obj_36_may_tab[0] = (propmap_t) { "#", _jm_f_64 };
        _jm_obj_36_may_tab[1] = (propmap_t) { "$", _jm_f_65 };
        _jm_obj_36_may_tab[2] = (propmap_t) { "%", _jm_f_69 };
        _jm_obj_36_may_tab[3] = (propmap_t) { ".schema", _jm_f_72 };
        _jm_obj_36_may_tab[4] = (propmap_t) { "~", _jm_f_73 };
        jm_sort_propmap(_jm_obj_36_may_tab, 5);
        _jm_obj_42_must_tab[0] = (propmap_t) { "@", _jm_f_74 };
        jm_sort_propmap(_jm_obj_42_must_tab, 1);
        _jm_obj_43_may_tab[0] = (propmap_t) { "", _jm_f_78 };
        _jm_obj_43_may_tab[1] = (propmap_t) { "#", _jm_f_79 };
        _jm_obj_43_may_tab[2] = (propmap_t) { ".schema", _jm_f_80 };
        jm_sort_propmap(_jm_obj_43_may_tab, 3);
        _jm_obj_45_may_tab[0] = (propmap_t) { "#", _jm_f_82 };
        _jm_obj_45_may_tab[1] = (propmap_t) { ".schema", _jm_f_83 };
        jm_sort_propmap(_jm_obj_45_may_tab, 2);
        _jm_obj_42_may_tab[0] = (propmap_t) { "!", _jm_f_75 };
        _jm_obj_42_may_tab[1] = (propmap_t) { "#", _jm_f_76 };
        _jm_obj_42_may_tab[2] = (propmap_t) { "$", _jm_f_77 };
        _jm_obj_42_may_tab[3] = (propmap_t) { "%", _jm_f_81 };
        _jm_obj_42_may_tab[4] = (propmap_t) { ".in", _jm_f_84 };
        _jm_obj_42_may_tab[5] = (propmap_t) { ".mo", _jm_f_85 };
        _jm_obj_42_may_tab[6] = (propmap_t) { ".schema", _jm_f_86 };
        _jm_obj_42_may_tab[7] = (propmap_t) { "~", _jm_f_87 };
        jm_sort_propmap(_jm_obj_42_may_tab, 8);
        _jm_re_7_code = pcre2_compile((PCRE2_SPTR) "^((file|https?)://.+|\\./.*|\\.\\./.*)$", PCRE2_ZERO_TERMINATED, PCRE2_UCP|PCRE2_UTF, &err_code, &err_offset, NULL);
        ...
        _jm_obj_48_must_tab[0] = (propmap_t) { "*", _jm_f_88 };
        jm_sort_propmap(_jm_obj_48_must_tab, 1);
        _jm_obj_48_may_tab[0] = (propmap_t) { "#", _jm_f_89 };
        _jm_obj_48_may_tab[1] = (propmap_t) { ".schema", _jm_f_90 };
        _jm_obj_48_may_tab[2] = (propmap_t) { "/", _jm_f_91 };
        jm_sort_propmap(_jm_obj_48_may_tab, 3);
        _jm_obj_51_must_tab[0] = (propmap_t) { "/", _jm_f_92 };
        jm_sort_propmap(_jm_obj_51_must_tab, 1);
        _jm_obj_51_may_tab[0] = (propmap_t) { "#", _jm_f_93 };
        _jm_obj_51_may_tab[1] = (propmap_t) { "*", _jm_f_94 };
        _jm_obj_51_may_tab[2] = (propmap_t) { ".schema", _jm_f_95 };
        jm_sort_propmap(_jm_obj_51_may_tab, 3);
