# Generated for model: ./json-schema-draft-02-nesting.model.json
#
...
# define "json_model_25_may_optional" ($.'$#schema'.optional)
...
# define "json_model_25_may_requires" ($.'$#schema'.requires)
...
# define "json_model_25_may_minimumCanEqual" ($.'$#schema'.minimumCanEqual)
...
# define "json_model_25_may_maximumCanEqual" ($.'$#schema'.maximumCanEqual)
...
# define "json_model_25_may_contentEncoding" ($.'$#schema'.contentEncoding)
    ...
    if not result:
        ...
        if result:
            for array_3_idx, array_3_item in enumerate(value):
                ...
                # $.'$#schema'.extends.'|'.1.0
                result = json_model_25(array_3_item, path, rep)
                if not result:
...
def json_model_1(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    result = json_model_25(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $https://json-model.org/models/json-schema-draft-02 at {path} [$.'$schema']")
    return result
