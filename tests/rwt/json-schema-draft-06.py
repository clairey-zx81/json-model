#! /bin/env python
#
# Model: ./json-schema-draft-06.model.json
#
...
# define "json_model_8_may_$id" ($.'$ObjectSchema'.'$id')
...
# define "json_model_8_may_$schema" ($.'$ObjectSchema'.'$schema')
...
# define "json_model_8_may_title" ($.'$ObjectSchema'.title)
...
# define "json_model_8_may_description" ($.'$ObjectSchema'.description)
...
# define "json_model_8_may_default" ($.'$ObjectSchema'.default)
...
# define "json_model_8_may_examples" ($.'$ObjectSchema'.examples)
...
# define "json_model_8_may_multipleOf" ($.'$ObjectSchema'.multipleOf)
...
# define "json_model_8_may_maximum" ($.'$ObjectSchema'.maximum)
...
# define "json_model_8_may_exclusiveMaximum" ($.'$ObjectSchema'.exclusiveMaximum)
...
# define "json_model_8_may_minimum" ($.'$ObjectSchema'.minimum)
...
# define "json_model_8_may_exclusiveMinimum" ($.'$ObjectSchema'.exclusiveMinimum)
...
# define "json_model_8_may_maxLength" ($.'$ObjectSchema'.maxLength)
...
# define "json_model_8_may_minLength" ($.'$ObjectSchema'.minLength)
...
# define "json_model_8_may_pattern" ($.'$ObjectSchema'.pattern)
...
# define "json_model_8_may_additionalItems" ($.'$ObjectSchema'.additionalItems)
...
# define "json_model_8_may_items" ($.'$ObjectSchema'.items)
...
# define "json_model_8_may_maxItems" ($.'$ObjectSchema'.maxItems)
...
# define "json_model_8_may_minItems" ($.'$ObjectSchema'.minItems)
...
# define "json_model_8_may_uniqueItems" ($.'$ObjectSchema'.uniqueItems)
...
# define "json_model_8_may_contains" ($.'$ObjectSchema'.contains)
...
# define "json_model_8_may_maxProperties" ($.'$ObjectSchema'.maxProperties)
...
# define "json_model_8_may_minProperties" ($.'$ObjectSchema'.minProperties)
...
# define "json_model_8_may_required" ($.'$ObjectSchema'.required)
...
# define "json_model_8_may_additionalProperties" ($.'$ObjectSchema'.additionalProperties)
...
# define "json_model_8_may_propertyNames" ($.'$ObjectSchema'.propertyNames)
...
# define "json_model_8_may_enum" ($.'$ObjectSchema'.enum)
...
# define "json_model_8_may_const" ($.'$ObjectSchema'.const)
...
# define "json_model_8_may_type" ($.'$ObjectSchema'.type)
def jm_f_31(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if not result:
        ...
        if not result:
            rep is None or rep.append(f"not an expected $typeArray at {path} [$.'$ObjectSchema'.type.'|'.1]")
    if not result:
        rep is None or rep.append(f"not any model match at {path} [$.'$ObjectSchema'.type.'|']")
    return result

# define "json_model_8_may_format" ($.'$ObjectSchema'.format)
...
# define "json_model_8_may_allOf" ($.'$ObjectSchema'.allOf)
...
# define "json_model_8_may_anyOf" ($.'$ObjectSchema'.anyOf)
...
# define "json_model_8_may_oneOf" ($.'$ObjectSchema'.oneOf)
...
# define "json_model_8_may_not" ($.'$ObjectSchema'.not)
...
# define "json_model_8_may_$ref" ($.'$ObjectSchema'.'$ref')
...
def json_model_4(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if result:
        for array_0_idx, array_0_item in enumerate(value):
            ...
            # $.'$schemaArray'.'@'.0
            result = json_model_9(array_0_item, path, rep)
            if not result:
...
def jm_f_24(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        result = json_model_9(val, path, rep)
        if not result:
...
def jm_f_28(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        if not result:
            ...
            if not result:
                rep is None or rep.append(f"not an expected $stringArray at {lpath} [$.'$ObjectSchema'.dependencies.''.'|'.1]")
        if not result:
