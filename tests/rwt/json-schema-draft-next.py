#! /bin/env python
#
# Model: ./json-schema-draft-next.model.json
#
...
# define "json_model_7_may_unevaluatedItems" ($.'$unevaluated'.unevaluatedItems)
...
# define "json_model_7_may_unevaluatedProperties" ($.'$unevaluated'.unevaluatedProperties)
...
# define "json_model_15_may_prefixItems" ($.'$applicator'.prefixItems)
...
# define "json_model_16_may_$dynamicRef" ($.'$ObjectSchema'.'$dynamicRef')
...
# define "json_model_16_may_$dynamicAnchor" ($.'$ObjectSchema'.'$dynamicAnchor')
...
# define "json_model_16_may_prefixItems" ($.'$ObjectSchema'.prefixItems)
...
def _jm_f_74(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        lpath = path + "." + prop
        # $.'$ObjectSchema'.propertyDependencies.''
        result = _jm_obj_1(val, lpath, rep)
        if not result:
...
json_model_13_may = {
    ...
    "maxContains": _jm_f_36,
    "minContains": _jm_f_37,
    "maxProperties": _jm_f_38,
    "minProperties": _jm_f_39,
    "required": _jm_f_40,
    "dependentRequired": _jm_f_41,
}
json_model_15_may = {
    "prefixItems": _jm_f_42,
    "items": _jm_f_43,
    "contains": _jm_f_44,
    "additionalProperties": _jm_f_45,
    "properties": _jm_f_46,
    "patternProperties": _jm_f_47,
    "dependentSchemas": _jm_f_48,
...
json_model_16_may = {
    ...
    "$anchor": _jm_f_61,
    "$dynamicRef": _jm_f_62,
    "$dynamicAnchor": _jm_f_63,
    "$vocabulary": _jm_f_64,
    "$comment": _jm_f_65,
    "$defs": _jm_f_66,
    "prefixItems": _jm_f_67,
    "items": _jm_f_68,
    "contains": _jm_f_69,
    "additionalProperties": _jm_f_70,
    "properties": _jm_f_71,
    "patternProperties": _jm_f_72,
    "dependentSchemas": _jm_f_73,
    "propertyDependencies": _jm_f_74,
    "propertyNames": _jm_f_75,
    "if": _jm_f_76,
    "then": _jm_f_77,
    "else": _jm_f_78,
    "not": _jm_f_79,
    ...
    "anyOf": _jm_f_81,
    "oneOf": _jm_f_82,
    "unevaluatedItems": _jm_f_83,
    "unevaluatedProperties": _jm_f_84,
    "type": _jm_f_85,
    "const": _jm_f_86,
    "enum": _jm_f_87,
    "multipleOf": _jm_f_88,
    "maximum": _jm_f_89,
    "exclusiveMaximum": _jm_f_90,
    "minimum": _jm_f_91,
    "exclusiveMinimum": _jm_f_92,
    "maxLength": _jm_f_93,
    "minLength": _jm_f_94,
    "pattern": _jm_f_95,
    "maxItems": _jm_f_96,
    "minItems": _jm_f_97,
    "uniqueItems": _jm_f_98,
    "maxContains": _jm_f_99,
    "minContains": _jm_f_100,
    "maxProperties": _jm_f_101,
    "minProperties": _jm_f_102,
    "required": _jm_f_103,
    "dependentRequired": _jm_f_104,
    "title": _jm_f_105,
    ...
    "examples": _jm_f_111,
    "format": _jm_f_112,
    "contentEncoding": _jm_f_113,
    "contentMediaType": _jm_f_114,
    "contentSchema": _jm_f_115,
}
