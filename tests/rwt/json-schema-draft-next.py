# Generated for model: ./json-schema-draft-next.model.json
#
...
# define "json_model_5_may_contentEncoding" ($.'$content'.contentEncoding)
...
# define "json_model_5_may_contentMediaType" ($.'$content'.contentMediaType)
...
# define "json_model_5_may_contentSchema" ($.'$content'.contentSchema)
...
# define "json_model_6_may_unevaluatedItems" ($.'$unevaluated'.unevaluatedItems)
def jm_f_19(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$unevaluated'.unevaluatedItems
    result = json_model_16(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $Schema at {path} [$.'$unevaluated'.unevaluatedItems]")
    return result

# define "json_model_6_may_unevaluatedProperties" ($.'$unevaluated'.unevaluatedProperties)
def jm_f_20(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$unevaluated'.unevaluatedProperties
    result = json_model_16(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $Schema at {path} [$.'$unevaluated'.unevaluatedProperties]")
    return result
...
# define "json_model_14_may_prefixItems" ($.'$applicator'.prefixItems)
def jm_f_42(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$applicator'.prefixItems
    result = json_model_13(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $schemaArray at {path} [$.'$applicator'.prefixItems]")
    return result
...
def jm_f_43(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    result = json_model_16(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $Schema at {path} [$.'$applicator'.items]")
    return result
...
# define "json_model_15_may_$dynamicRef" ($.'$ObjectSchema'.'$dynamicRef')
def jm_f_62(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$ObjectSchema'.'$dynamicRef'
    result = json_model_2(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $URI-REFERENCE at {path} [$.'$ObjectSchema'.'$dynamicRef']")
    return result

# define "json_model_15_may_$dynamicAnchor" ($.'$ObjectSchema'.'$dynamicAnchor')
def jm_f_63(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$ObjectSchema'.'$dynamicAnchor'
    result = json_model_2(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $URI-REFERENCE at {path} [$.'$ObjectSchema'.'$dynamicAnchor']")
    return result
...
# define "json_model_15_may_prefixItems" ($.'$ObjectSchema'.prefixItems)
def jm_f_67(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$ObjectSchema'.prefixItems
    result = json_model_13(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $schemaArray at {path} [$.'$ObjectSchema'.prefixItems]")
    return result
...
def jm_f_68(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    result = json_model_16(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $Schema at {path} [$.'$ObjectSchema'.items]")
    return result
...
def json_model_6(value: Jsonable, path: str, rep: Report = None) -> bool:
    if not isinstance(value, dict):
        rep is None or rep.append(f"not an object at {path} [$.'$unevaluated']")
        return False
    for prop, val in value.items():
        assert isinstance(prop, str)
        lpath = path + "." + prop
        if prop in json_model_6_may:  # may
            if not json_model_6_may[prop](val, lpath, rep):
                rep is None or rep.append(f"invalid may prop value at {lpath} [$.'$unevaluated'.{prop}]")
                return False
        else:  # no catch all
            rep is None or rep.append(f"no other prop expected at {path} [$.'$unevaluated']")
            return False
    return True
...
def json_model_13(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if result:
        for array_4_idx, array_4_item in enumerate(value):
            ...
            # $.'$schemaArray'.'@'.0
            result = json_model_16(array_4_item, path, rep)
            if not result:
...
def jm_obj_0(value: Jsonable, path: str, rep: Report = None) -> bool:
    if not isinstance(value, dict):
        rep is None or rep.append(f"not an object at {path} [$.'$applicator'.propertyDependencies.'']")
        return False
    for prop, val in value.items():
        assert isinstance(prop, str)
        lpath = path + "." + prop
        ...
        result = json_model_16(val, path, rep)
        if not result:
            rep is None or rep.append(f"not an expected $Schema at {lpath} [$.'$applicator'.propertyDependencies.''.'']")
        if not result:
            rep is None or rep.append(f"unexpected other value at {lpath} [$.'$applicator'.propertyDependencies.''.'']")
            return False
    return True
...
def jm_f_49(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        if not result:
            rep is None or rep.append(f"not an expected object at {lpath} [$.'$applicator'.propertyDependencies.'']")
        if not result:
            rep is None or rep.append(f"unexpected other value at {lpath} [$.'$applicator'.propertyDependencies.'']")
            return False
    return True
...
def jm_obj_1(value: Jsonable, path: str, rep: Report = None) -> bool:
    if not isinstance(value, dict):
        rep is None or rep.append(f"not an object at {path} [$.'$ObjectSchema'.propertyDependencies.'']")
        return False
    for prop, val in value.items():
        assert isinstance(prop, str)
        lpath = path + "." + prop
        ...
        result = json_model_16(val, path, rep)
        if not result:
            rep is None or rep.append(f"not an expected $Schema at {lpath} [$.'$ObjectSchema'.propertyDependencies.''.'']")
        if not result:
            rep is None or rep.append(f"unexpected other value at {lpath} [$.'$ObjectSchema'.propertyDependencies.''.'']")
            return False
    return True
...
def jm_f_74(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        lpath = path + "." + prop
        # $.'$ObjectSchema'.propertyDependencies.''
        result = jm_obj_1(val, lpath, rep)
        if not result:
            rep is None or rep.append(f"not an expected object at {lpath} [$.'$ObjectSchema'.propertyDependencies.'']")
        if not result:
            rep is None or rep.append(f"unexpected other value at {lpath} [$.'$ObjectSchema'.propertyDependencies.'']")
            return False
    return True
...
json_model_6_may = {
    "unevaluatedItems": jm_f_19,
    "unevaluatedProperties": jm_f_20,
}
json_model_7_may = {
    "format": jm_f_21,
}
json_model_12_may = {
    ...
    "maxContains": jm_f_36,
    "minContains": jm_f_37,
    "maxProperties": jm_f_38,
    "minProperties": jm_f_39,
    "required": jm_f_40,
    "dependentRequired": jm_f_41,
}
json_model_14_may = {
    "prefixItems": jm_f_42,
    "items": jm_f_43,
    "contains": jm_f_44,
    "additionalProperties": jm_f_45,
    "properties": jm_f_46,
    "patternProperties": jm_f_47,
    "dependentSchemas": jm_f_48,
    "propertyDependencies": jm_f_49,
    "propertyNames": jm_f_50,
    "if": jm_f_51,
    "then": jm_f_52,
    "else": jm_f_53,
    "not": jm_f_54,
...
json_model_15_may = {
    ...
    "items": jm_f_68,
    "contains": jm_f_69,
    "additionalProperties": jm_f_70,
    "properties": jm_f_71,
    "patternProperties": jm_f_72,
    "dependentSchemas": jm_f_73,
    "propertyDependencies": jm_f_74,
    "propertyNames": jm_f_75,
    "if": jm_f_76,
    "then": jm_f_77,
    "else": jm_f_78,
    "not": jm_f_79,
    ...
    "anyOf": jm_f_81,
    "oneOf": jm_f_82,
    "unevaluatedItems": jm_f_83,
    "unevaluatedProperties": jm_f_84,
    "type": jm_f_85,
    "const": jm_f_86,
    "enum": jm_f_87,
    "multipleOf": jm_f_88,
    "maximum": jm_f_89,
    "exclusiveMaximum": jm_f_90,
    "minimum": jm_f_91,
    "exclusiveMinimum": jm_f_92,
    "maxLength": jm_f_93,
    "minLength": jm_f_94,
    "pattern": jm_f_95,
    "maxItems": jm_f_96,
    ...
    "uniqueItems": jm_f_98,
    "maxContains": jm_f_99,
    "minContains": jm_f_100,
    "maxProperties": jm_f_101,
    "minProperties": jm_f_102,
    "required": jm_f_103,
    "dependentRequired": jm_f_104,
    "title": jm_f_105,
    "description": jm_f_106,
    "default": jm_f_107,
    "deprecated": jm_f_108,
    "readOnly": jm_f_109,
    "writeOnly": jm_f_110,
    "examples": jm_f_111,
    "format": jm_f_112,
    "contentEncoding": jm_f_113,
    "contentMediaType": jm_f_114,
    "contentSchema": jm_f_115,
}
