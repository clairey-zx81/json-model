...
def _jm_f_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected _https://json-schema.org/draft/2020-12/schema [$.'$core'.'$schema']", path))
    return res
...
def _jm_f_64(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, str) and val == "https://json-schema.org/draft/2020-12/schema"
    if not res:
        rep is None or rep.append(("unexpected _https://json-schema.org/draft/2020-12/schema [$.'$ObjectSchema'.'$schema']", path))
    return res
...
def _jm_obj_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_url(prop, lpath_15 if path is not None else None, rep):
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [$.'$ObjectSchema'.'$vocabulary'.'$URL']", lpath_15 if path is not None else None))
            if not res:
                return False
        else:
            rep is None or rep.append(("no other prop expected [$.'$ObjectSchema'.'$vocabulary']", lpath_15 if path is not None else None))
            return False
    return True
...
def _jm_obj_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_11(pval, path, rep)
        if not res:
            rep is None or rep.append(("unexpected $stringArray [$.'$ObjectSchema'.dependentRequired.'']", lpath_16 if path is not None else None))
        if not res:
            return False
    return True
...
def _jm_obj_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_regex(prop, lpath_18 if path is not None else None, rep):
            ...
            res = json_model_17(pval, path, rep)
            if not res:
                rep is None or rep.append(("unexpected $Schema [$.'$ObjectSchema'.patternProperties.'$REGEX']", lpath_18 if path is not None else None))
            if not res:
                return False
        else:
            rep is None or rep.append(("no other prop expected [$.'$ObjectSchema'.patternProperties]", lpath_18 if path is not None else None))
            return False
    return True
...
def _jm_obj_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_17(pval, path, rep)
        if not res:
            rep is None or rep.append(("unexpected $Schema [$.'$ObjectSchema'.properties.'']", lpath_19 if path is not None else None))
        if not res:
            return False
    return True
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_13_may.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_13 if path is not None else None, rep):
                rep is None or rep.append(("invalid may property value [$.'$ObjectSchema']", lpath_13 if path is not None else None))
                return False
        else:
            rep is None or rep.append(("no other prop expected [$.'$ObjectSchema']", lpath_13 if path is not None else None))
            return False
    return True
