...
def jm_f_3(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if result:
        for array_0_idx, array_0_item in enumerate(value):
            ...
            # $.'$OpenAPI'.servers.0
            result = json_model_5(array_0_item, path, rep)
            if not result:
...
def jm_f_8(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if result:
        for array_1_idx, array_1_item in enumerate(value):
            ...
            # $.'$OpenAPI'.tags.0
            result = json_model_24(array_1_item, path, rep)
            if not result:
...
def jm_f_62(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if result:
        for array_4_idx, array_4_item in enumerate(value):
            ...
            result = json_model_33(array_4_item, path, rep)
            if not result:
...
def jm_f_63(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if result:
        for array_5_idx, array_5_item in enumerate(value):
            ...
            # $.'$Operation'.servers.0
            result = json_model_5(array_5_item, path, rep)
            if not result:
...
def jm_f_127(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$Schema'.'$id'
    result = json_model_59(value, path, rep)
    if not result:
...
def jm_f_161(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$Schema'.maxLength
    result = json_model_69(value, path, rep)
    if not result:
...
def jm_f_171(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$Schema'.required
    result = json_model_68(value, path, rep)
    if not result:
...
def jm_f_32(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        result = json_model_13(val, path, rep)
        if not result:
...
def jm_f_36(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        result = json_model_30(val, path, rep)
        if not result:
...
def jm_f_37(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        # $.'$Components'.links.''
        # $.'$Components'.links.''.'|'.0
        result = json_model_22(val, path, rep)
        if not result:
...
def json_model_19(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        assert isinstance(prop, str)
        lpath = path + "." + prop
        if json_model_21(prop, path, rep) or _rep(f"prop {prop} does not match $Expression at {path}", rep):  # $Expression
            # $.'$Callback'.'$Expression'
...
def jm_f_135(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        lpath = path + "." + prop
        # $.'$Schema'.'$defs'.''
        result = json_model_74(val, path, rep)
        if not result:
...
def jm_f_172(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        result = json_model_68(val, path, rep)
        if not result:
...
def json_model_28(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        if prop in json_model_28_must:  # must
            must_count += 1
            if not json_model_28_must[prop](val, lpath, rep):
...
def json_model_32(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        if prop in json_model_32_must:  # must
            must_count += 1
            if not json_model_32_must[prop](val, lpath, rep):
...
def json_model_58(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    result = json_model_74(value, path, rep)
    if not result:
        rep is None or rep.append(f"not an expected $Schema at {path} [$.'$https://json-model.org/models/json-schema-draft-2020-12'.'@']")
    if not result:
        rep is None or rep.append(f"invalid type or constraints at {path} [$.'$https://json-model.org/models/json-schema-draft-2020-12']")
    return result

# define "$#schema#URI-REFERENCE" ($.'$#schema#URI-REFERENCE')
def json_model_59(value: Jsonable, path: str, rep: Report = None) -> bool:
...
def json_model_66(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$#schema#simpleTypes'
...
def json_model_67(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if result:
        for array_9_idx, array_9_item in enumerate(value):
            ...
            result = json_model_66(array_9_item, path, rep)
            if not result:
...
def json_model_68(value: Jsonable, path: str, rep: Report = None) -> bool:
    # $.'$#schema#stringArray'
    # $.'$#schema#stringArray'.'@'
    result = isinstance(value, list)
    if result:
...
def json_model_69(value: Jsonable, path: str, rep: Report = None) -> bool:
...
def json_model_71(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if result:
        for array_11_idx, array_11_item in enumerate(value):
            ...
            result = json_model_74(array_11_item, path, rep)
            if not result:
