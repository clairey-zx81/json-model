# Generated for model: ./json-schema-draft-06-fuzzy.model.json
#
...
# define "json_model_32_may_$id" ($.'$#schema#ObjectSchema'.'$id')
...
# define "json_model_32_may_$schema" ($.'$#schema#ObjectSchema'.'$schema')
...
# define "json_model_32_may_title" ($.'$#schema#ObjectSchema'.title)
...
# define "json_model_32_may_description" ($.'$#schema#ObjectSchema'.description)
...
# define "json_model_32_may_default" ($.'$#schema#ObjectSchema'.default)
...
# define "json_model_32_may_examples" ($.'$#schema#ObjectSchema'.examples)
...
# define "json_model_32_may_multipleOf" ($.'$#schema#ObjectSchema'.multipleOf)
...
# define "json_model_32_may_maximum" ($.'$#schema#ObjectSchema'.maximum)
...
# define "json_model_32_may_exclusiveMaximum" ($.'$#schema#ObjectSchema'.exclusiveMaximum)
...
# define "json_model_32_may_minimum" ($.'$#schema#ObjectSchema'.minimum)
...
# define "json_model_32_may_exclusiveMinimum" ($.'$#schema#ObjectSchema'.exclusiveMinimum)
...
# define "json_model_32_may_maxLength" ($.'$#schema#ObjectSchema'.maxLength)
...
# define "json_model_32_may_minLength" ($.'$#schema#ObjectSchema'.minLength)
...
# define "json_model_32_may_additionalItems" ($.'$#schema#ObjectSchema'.additionalItems)
...
# define "json_model_32_may_items" ($.'$#schema#ObjectSchema'.items)
...
# define "json_model_32_may_maxItems" ($.'$#schema#ObjectSchema'.maxItems)
...
# define "json_model_32_may_minItems" ($.'$#schema#ObjectSchema'.minItems)
...
# define "json_model_32_may_uniqueItems" ($.'$#schema#ObjectSchema'.uniqueItems)
...
# define "json_model_32_may_contains" ($.'$#schema#ObjectSchema'.contains)
...
# define "json_model_32_may_maxProperties" ($.'$#schema#ObjectSchema'.maxProperties)
...
# define "json_model_32_may_minProperties" ($.'$#schema#ObjectSchema'.minProperties)
...
# define "json_model_32_may_required" ($.'$#schema#ObjectSchema'.required)
...
# define "json_model_32_may_additionalProperties" ($.'$#schema#ObjectSchema'.additionalProperties)
...
# define "json_model_32_may_propertyNames" ($.'$#schema#ObjectSchema'.propertyNames)
...
# define "json_model_32_may_enum" ($.'$#schema#ObjectSchema'.enum)
...
# define "json_model_32_may_const" ($.'$#schema#ObjectSchema'.const)
...
# define "json_model_32_may_type" ($.'$#schema#ObjectSchema'.type)
...
# define "json_model_32_may_format" ($.'$#schema#ObjectSchema'.format)
...
# define "json_model_32_may_allOf" ($.'$#schema#ObjectSchema'.allOf)
...
# define "json_model_32_may_anyOf" ($.'$#schema#ObjectSchema'.anyOf)
...
# define "json_model_32_may_oneOf" ($.'$#schema#ObjectSchema'.oneOf)
...
# define "json_model_32_may_not" ($.'$#schema#ObjectSchema'.not)
...
# define "json_model_32_may_$ref" ($.'$#schema#ObjectSchema'.'$ref')
...
# define "json_model_32_may_pattern" ($.'$#schema#ObjectSchema'.pattern)
...
def json_model_1(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if not result:
        rep is None or rep.append(f"not an expected $https://json-model.org/models/json-schema-draft-06 at {path} [$.'$schema']")
    return result
...
def jm_f_23(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    for prop, val in value.items():
        ...
        result = json_model_33(val, path, rep)
        if not result:
...
def json_model_30(value: Jsonable, path: str, rep: Report = None) -> bool:
    ...
    if result:
        for array_3_idx, array_3_item in enumerate(value):
            ...
            # $.'$#schema#typeArray'.'@'.0
            result = json_model_29(array_3_item, path, rep)
            if not result:
...
json_model_32_may = {
    ...
    "uniqueItems": jm_f_17,
    "contains": jm_f_18,
    "maxProperties": jm_f_19,
    "minProperties": jm_f_20,
    "required": jm_f_21,
    "additionalProperties": jm_f_22,
    "definitions": jm_f_23,
    "properties": jm_f_24,
    "propertyNames": jm_f_25,
    "dependencies": jm_f_26,
    "enum": jm_f_27,
    "const": jm_f_28,
    "type": jm_f_29,
    "format": jm_f_30,
