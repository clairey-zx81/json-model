...
def _jm_f_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = json_model_17(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected $Schema [$.'$unevaluated'.unevaluatedItems]", path))
    return res
...
def _jm_f_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = json_model_17(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected $Schema [$.'$unevaluated'.unevaluatedProperties]", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_5_may.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_5 if path is not None else None, rep):
                rep is None or rep.append(("invalid may property value [$.'$unevaluated']", lpath_5 if path is not None else None))
                return False
        else:
...
def json_model_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object at [$.'$unevaluated']", path))
    return res
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_6_may.get(prop):
            ...
            if pfun != UNDEFINED and not pfun(pval, lpath_6 if path is not None else None, rep):
                rep is None or rep.append(("invalid may property value [$.'$format']", lpath_6 if path is not None else None))
                return False
        else:
...
def _jm_obj_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("not an expected object at [$.'$applicator'.propertyDependencies.'']", lpath_13 if path is not None else None))
        if not res:
            return False
    return True
...
def _jm_f_55(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object at [$.'$applicator'.propertyDependencies]", path))
    return res
...
def _jm_obj_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if is_valid_url(prop, lpath_17 if path is not None else None, rep):
            ...
            res = isinstance(pval, bool)
            if not res:
                rep is None or rep.append(("not a bool [$.'$ObjectSchema'.'$vocabulary'.'$URL']", lpath_17 if path is not None else None))
            if not res:
                return False
        else:
...
def _jm_obj_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("not an expected object at [$.'$ObjectSchema'.propertyDependencies.'']", lpath_22 if path is not None else None))
        if not res:
            return False
    return True
...
def _jm_f_105(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not an expected object at [$.'$ObjectSchema'.propertyDependencies]", path))
    return res
...
def check_model_init():
    ...
    if not initialized:
        ...
        _jm_obj_5_may = {
            "unevaluatedItems": _jm_f_19,
            "unevaluatedProperties": _jm_f_20,
        }
        ...
        _jm_obj_7_may = {
            ...
            "maxContains": _jm_f_27,
            "maxItems": _jm_f_28,
            "maxLength": _jm_f_29,
            "maxProperties": _jm_f_30,
            "maximum": _jm_f_31,
            "minContains": _jm_f_32,
            "minItems": _jm_f_33,
            "minLength": _jm_f_34,
            "minProperties": _jm_f_35,
            "minimum": _jm_f_36,
            "multipleOf": _jm_f_37,
            "pattern": _jm_f_38,
            "required": _jm_f_39,
        ...
        _jm_obj_9_may = {
            ...
            "not": _jm_f_50,
            "oneOf": _jm_f_51,
            "patternProperties": _jm_f_52,
            "prefixItems": _jm_f_53,
            "properties": _jm_f_54,
            "propertyDependencies": _jm_f_55,
        ...
        _jm_obj_15_may = {
            ...
            "prefixItems": _jm_f_103,
            "properties": _jm_f_104,
            "propertyDependencies": _jm_f_105,
            ...
            "title": _jm_f_110,
            "type": _jm_f_111,
            "unevaluatedItems": _jm_f_112,
            "unevaluatedProperties": _jm_f_113,
            "uniqueItems": _jm_f_114,
            "writeOnly": _jm_f_115,
        }
