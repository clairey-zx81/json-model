...
_jm_obj_20_must: PropMap
_jm_obj_20_may: PropMap
_jm_obj_23_must: PropMap
        ...
        if pfun := _jm_obj_9_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_9 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$String']", lpath_9 if path is not None else None))
                    return False
        ...
        if pfun := _jm_obj_12_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_12 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Array']", lpath_12 if path is not None else None))
                    return False
        ...
        if pfun := _jm_obj_15_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_15 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Object']", lpath_15 if path is not None else None))
                    return False
...
def _jm_obj_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_20_must.get(prop):
            # handle 1 must props
            if pfun != UNDEFINED:
                must_count += 1
                if not pfun(pval, lpath_20 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Integer']", lpath_20 if path is not None else None))
                    return False
        elif pfun := _jm_obj_20_may.get(prop):
            # handle {len(may)} may props
...
def _jm_obj_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_23_must.get(prop):
            # handle 1 must props
            if pfun != UNDEFINED:
                must_count += 1
                if not pfun(pval, lpath_23 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Number']", lpath_23 if path is not None else None))
                    return False
        elif pfun := _jm_obj_23_may.get(prop):
            # handle {len(may)} may props
        ...
        if pfun := _jm_obj_26_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_26 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Bool']", lpath_26 if path is not None else None))
                    return False
        ...
        if pfun := _jm_obj_29_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_29 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Null']", lpath_29 if path is not None else None))
                    return False
        ...
        if pfun := _jm_obj_32_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_32 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$AllOf']", lpath_32 if path is not None else None))
                    return False
        ...
        if pfun := _jm_obj_35_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_35 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$AnyOf']", lpath_35 if path is not None else None))
                    return False
        ...
        if pfun := _jm_obj_38_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_38 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$OneOf']", lpath_38 if path is not None else None))
                    return False
        ...
        if pfun := _jm_obj_41_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_41 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Enum']", lpath_41 if path is not None else None))
                    return False
        ...
        if pfun := _jm_obj_44_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_44 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Const']", lpath_44 if path is not None else None))
                    return False
...
def _jm_f_176(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected $URL [$.'$Ref'.'$ref']", path))
    return res
...
def _jm_obj_47(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_47_must.get(prop):
            ...
            if pfun != UNDEFINED:
                must_count += 1
                if not pfun(pval, lpath_47 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Ref']", lpath_47 if path is not None else None))
                    return False
        ...
        if pfun := _jm_obj_50_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_50 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$RootSchema'.'&'.0]", lpath_50 if path is not None else None))
                    return False
        else:
...
def check_model_init():
    ...
    if not initialized:
        ...
        _jm_obj_12_may = {
            ...
            "$id": _jm_f_44,
            "$schema": _jm_f_45,
            "additionalItems": _jm_f_46,
            "default": _jm_f_47,
            "definitions": _jm_f_48,
        ...
        _jm_obj_15_may = {
            ...
            "examples": _jm_f_67,
            "id": _jm_f_68,
            "patternProperties": _jm_f_69,
            "properties": _jm_f_70,
            "required": _jm_f_71,
            "title": _jm_f_72,
        }
        global _jm_obj_20_must
        _jm_obj_20_must = {
            "type": _jm_f_73,
        }
        ...
        _jm_obj_47_may = {
            ...
            "$schema": _jm_f_180,
            "default": _jm_f_181,
            "definitions": _jm_f_182,
            "description": _jm_f_183,
            "examples": _jm_f_184,
            "id": _jm_f_185,
            "title": _jm_f_186,
        }
