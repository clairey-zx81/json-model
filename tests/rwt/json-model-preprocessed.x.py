...
def _jm_f_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_1_idx, arr_1_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected $Model [$.'$Model#Elem'.'|'.3.'^'.0]", arr_1_lpath if path is not None else None))
            if not res:
                break
    if not res:
        ...
        if pfun := _jm_obj_1_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_1 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Model#Elem'.'|'.3]", lpath_1 if path is not None else None))
                    return False
...
def _jm_f_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_2_idx, arr_2_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected $Model [$.'$Model#Elem'.'|'.2.'&'.0]", arr_2_lpath if path is not None else None))
            if not res:
                break
    if not res:
        ...
        if pfun := _jm_obj_2_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_2 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Model#Elem'.'|'.2]", lpath_2 if path is not None else None))
                    return False
...
def _jm_f_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_3_idx, arr_3_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected $Model [$.'$Model#Elem'.'|'.1.'|'.0]", arr_3_lpath if path is not None else None))
            if not res:
                break
    if not res:
        ...
        if pfun := _jm_obj_3_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_3 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Model#Elem'.'|'.1]", lpath_3 if path is not None else None))
                    return False
        ...
        if pfun := _jm_obj_4_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_4 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Model#Elem'.'|'.0]", lpath_4 if path is not None else None))
                    return False
...
def _jm_f_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_4_idx, arr_4_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected $Model [$.'$Model#Root'.'|'.3.'^'.0]", arr_4_lpath if path is not None else None))
            if not res:
                break
    if not res:
...
def _jm_obj_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_10_may.get(prop):
            # handle {len(may)} may props
        ...
        if pfun := _jm_obj_8_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_8 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Model#Root'.'|'.3]", lpath_8 if path is not None else None))
                    return False
...
def _jm_f_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_5_idx, arr_5_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected $Model [$.'$Model#Root'.'|'.2.'&'.0]", arr_5_lpath if path is not None else None))
            if not res:
                break
    if not res:
        ...
        if pfun := _jm_obj_11_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_11 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Model#Root'.'|'.2]", lpath_11 if path is not None else None))
                    return False
...
def _jm_f_33(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_6_idx, arr_6_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected $Model [$.'$Model#Root'.'|'.1.'|'.0]", arr_6_lpath if path is not None else None))
            if not res:
                break
    if not res:
        ...
        if pfun := _jm_obj_14_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_14 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Model#Root'.'|'.1]", lpath_14 if path is not None else None))
                    return False
...
def _jm_obj_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_18_may.get(prop):
            # handle {len(may)} may props
...
def _jm_obj_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if pfun := _jm_obj_17_must.get(prop):
            # handle 1 must props
            if pfun != UNDEFINED:
                must_count += 1
                if not pfun(pval, lpath_17 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$Model#Root'.'|'.0]", lpath_17 if path is not None else None))
                    return False
        elif pfun := _jm_obj_17_may.get(prop):
            # handle {len(may)} may props
...
def check_model_init():
    ...
    if not initialized:
        ...
        _jm_re_6_search = re.compile("^((file|https?)://.+|\\./.*|\\.\\./.*)$").search
