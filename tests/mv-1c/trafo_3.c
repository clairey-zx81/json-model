...
static bool _jm_obj_0(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (strcmp(prop, "ua") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid mandatory property value [.'$D#U#un'.ua]", (path ? &lpath_0 : NULL));
                return false;
            }
        }
        else if (strcmp(prop, "ub") == 0)
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "invalid mandatory property value [.'$D#U#un'.ub]", (path ? &lpath_0 : NULL));
                return false;
            }
        }
        else
        {
            if (rep) jm_report_add_entry(rep, "unexpected prop [.'$D#U#un']", (path ? &lpath_0 : NULL));
            return false;
        }
    }
    if (must_count != 2)
    {
        if (rep != NULL)
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "missing mandatory prop <ua> [.'$D#U#un']", path);
            }
            if (! (json_object_get(val, "ub") != NULL))
            {
                if (rep) jm_report_add_entry(rep, "missing mandatory prop <ub> [.'$D#U#un']", path);
            }
        }
        return false;
    }
...
static bool json_model_12(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not an expected object [.'$D#U#un']", path);
    }
    return res;
}
...
char *CHECK_init(void)
{
    if (!initialized)
    {
        ...
        check_model_map_tab[1] = (jm_propmap_t) { "D", json_model_3 };
