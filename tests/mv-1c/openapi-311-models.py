...
_jm_re_11: RegexFun
_jm_xre_2_re_reco: object
_jm_xre_2_re: RegexFun
_jm_xre_2: RegexFun
_jm_xre_3_re_reco: object
_jm_xre_3_re: RegexFun
_jm_xre_3: RegexFun
_jm_re_12_reco: object
_jm_re_12: RegexFun
_jm_cst_5: set[str]
_jm_re_13_reco: object
_jm_re_13: RegexFun
...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$OpenAPI\" [.'$openapi']", path))
    return res
...
def _jm_obj_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$PathItem\" [.'$openapi#OpenAPI'.webhooks.'']", lpath_1 if path is not None else None))
            return False
    return True
...
def json_model_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "openapi":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"/^3\\\\.1\\\\.\\\\d+(-.+)?$/\" [.'$openapi#OpenAPI'.openapi]", lpath_0 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Info\" [.'$openapi#OpenAPI'.info]", lpath_0 if path is not None else None))
        ...
        if prop == "servers":
            ...
            if res:
                for arr_0_idx, arr_0_item in enumerate(pval):
                    ...
                    res = json_model_8(arr_0_item, arr_0_lpath if (lpath_0 if path is not None else None) is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$Server\" [.'$openapi#OpenAPI'.servers.0]", arr_0_lpath if (lpath_0 if path is not None else None) is not None else None))
                        break
            if not res:
            ...
            res = json_model_11(pval, lpath_0 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Paths\" [.'$openapi#OpenAPI'.paths]", lpath_0 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Components\" [.'$openapi#OpenAPI'.components]", lpath_0 if path is not None else None))
            ...
            if res:
                for arr_1_idx, arr_1_item in enumerate(pval):
                    ...
                    res = json_model_45(arr_1_item, arr_1_lpath if (lpath_0 if path is not None else None) is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$SecurityRequirement\" [.'$openapi#OpenAPI'.security.0]", arr_1_lpath if (lpath_0 if path is not None else None) is not None else None))
                        break
            if not res:
            ...
            if res:
                for arr_2_idx, arr_2_item in enumerate(pval):
                    ...
                    res = json_model_31(arr_2_item, arr_2_lpath if (lpath_0 if path is not None else None) is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$Tag\" [.'$openapi#OpenAPI'.tags.0]", arr_2_lpath if (lpath_0 if path is not None else None) is not None else None))
                        break
            if not res:
            ...
            res = json_model_14(pval, lpath_0 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$ExternalDocumentation\" [.'$openapi#OpenAPI'.externalDocs]", lpath_0 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$openapi#OpenAPI'.jsonModelVersion]", lpath_0 if path is not None else None))
...
def json_model_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "title":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Info'.title]", lpath_2 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Info'.version]", lpath_2 if path is not None else None))
        ...
        if prop == "summary":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Info'.summary]", lpath_2 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Info'.description]", lpath_2 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Info'.termsOfService]", lpath_2 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Contact\" [.'$openapi#Info'.contact]", lpath_2 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$License\" [.'$openapi#Info'.license]", lpath_2 if path is not None else None))
...
def json_model_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Contact'.name]", lpath_3 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$openapi#Contact'.url]", lpath_3 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Contact'.email]", lpath_3 if path is not None else None))
...
def _jm_obj_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#License'.'|'.1.name]", lpath_4 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$openapi#License'.'|'.1.url]", lpath_4 if path is not None else None))
...
def _jm_obj_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#License'.'|'.0.name]", lpath_5 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#License'.'|'.0.identifier]", lpath_5 if path is not None else None))
...
def _jm_obj_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$ServerVariable\" [.'$openapi#Server'.variables.'']", lpath_7 if path is not None else None))
            return False
    return True
...
def json_model_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "url":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$openapi#Server'.url]", lpath_6 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Server'.description]", lpath_6 if path is not None else None))
...
def json_model_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "default":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#ServerVariable'.default]", lpath_8 if path is not None else None))
        ...
        if prop == "enum":
            ...
            if res:
                for arr_3_idx, arr_3_item in enumerate(pval):
                    ...
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#ServerVariable'.enum.0]", arr_3_lpath if (lpath_8 if path is not None else None) is not None else None))
                        break
            if not res:
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#ServerVariable'.description]", lpath_8 if path is not None else None))
...
def _jm_obj_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Response\" [.'$openapi#Components'.responses.''.'|'.0]", lpath_10 if path is not None else None))
            # .'$openapi#Components'.responses.''.'|'.1
            res = json_model_32(pval, lpath_10 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Components'.responses.''.'|'.1]", lpath_10 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$openapi#Components'.responses.''.'|']", lpath_10 if path is not None else None))
            return False
    return True
...
def _jm_obj_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_20(pval, lpath_11 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Parameter\" [.'$openapi#Components'.parameters.''.'|'.0]", lpath_11 if path is not None else None))
            # .'$openapi#Components'.parameters.''.'|'.1
            res = json_model_32(pval, lpath_11 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Components'.parameters.''.'|'.1]", lpath_11 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$openapi#Components'.parameters.''.'|']", lpath_11 if path is not None else None))
            return False
    return True
...
def _jm_obj_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_27(pval, lpath_12 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Example\" [.'$openapi#Components'.examples.''.'|'.0]", lpath_12 if path is not None else None))
            # .'$openapi#Components'.examples.''.'|'.1
            res = json_model_32(pval, lpath_12 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Components'.examples.''.'|'.1]", lpath_12 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$openapi#Components'.examples.''.'|']", lpath_12 if path is not None else None))
            return False
    return True
...
def _jm_obj_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_21(pval, lpath_13 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$RequestBody\" [.'$openapi#Components'.requestBodies.''.'|'.0]", lpath_13 if path is not None else None))
            # .'$openapi#Components'.requestBodies.''.'|'.1
            res = json_model_32(pval, lpath_13 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Components'.requestBodies.''.'|'.1]", lpath_13 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$openapi#Components'.requestBodies.''.'|']", lpath_13 if path is not None else None))
            return False
    return True
...
def _jm_obj_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Header\" [.'$openapi#Components'.headers.''.'|'.0]", lpath_14 if path is not None else None))
            # .'$openapi#Components'.headers.''.'|'.1
            res = json_model_32(pval, lpath_14 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Components'.headers.''.'|'.1]", lpath_14 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$openapi#Components'.headers.''.'|']", lpath_14 if path is not None else None))
            return False
    return True
...
def _jm_obj_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_42(pval, lpath_15 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$SecurityScheme\" [.'$openapi#Components'.securitySchemes.''.'|'.0]", lpath_15 if path is not None else None))
            # .'$openapi#Components'.securitySchemes.''.'|'.1
            res = json_model_32(pval, lpath_15 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Components'.securitySchemes.''.'|'.1]", lpath_15 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$openapi#Components'.securitySchemes.''.'|']", lpath_15 if path is not None else None))
            return False
    return True
...
def _jm_obj_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_29(pval, lpath_16 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Link\" [.'$openapi#Components'.links.''.'|'.0]", lpath_16 if path is not None else None))
            # .'$openapi#Components'.links.''.'|'.1
            res = json_model_32(pval, lpath_16 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Components'.links.''.'|'.1]", lpath_16 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$openapi#Components'.links.''.'|']", lpath_16 if path is not None else None))
            return False
    return True
...
def _jm_obj_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Callback\" [.'$openapi#Components'.callbacks.''.'|'.0]", lpath_17 if path is not None else None))
            # .'$openapi#Components'.callbacks.''.'|'.1
            res = json_model_32(pval, lpath_17 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Components'.callbacks.''.'|'.1]", lpath_17 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$openapi#Components'.callbacks.''.'|']", lpath_17 if path is not None else None))
            return False
    return True
...
def _jm_obj_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$PathItem\" [.'$openapi#Components'.pathItems.''.'|'.0]", lpath_18 if path is not None else None))
            # .'$openapi#Components'.pathItems.''.'|'.1
            res = json_model_32(pval, lpath_18 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Components'.pathItems.''.'|'.1]", lpath_18 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$openapi#Components'.pathItems.''.'|']", lpath_18 if path is not None else None))
            return False
    return True
...
def _jm_obj_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = json_model_98(pval, lpath_19 if path is not None else None, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Model\" [.'$openapi#Components'.models.'']", lpath_19 if path is not None else None))
            return False
    return True
...
def json_model_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop.startswith("/"):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$PathItem\" [.'$openapi#Paths'.'/^//']", lpath_20 if path is not None else None))
                return False
...
def _jm_f_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$URI\" [.'$openapi#PathItem'.'$ref']", path))
    return res
...
def _jm_f_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#PathItem'.description]", path))
    return res
...
def _jm_f_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_4_idx, arr_4_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Parameter\" [.'$openapi#PathItem'.parameters.0.'|'.0]", arr_4_lpath if path is not None else None))
                # .'$openapi#PathItem'.parameters.0.'|'.1
                res = json_model_32(arr_4_item, arr_4_lpath if path is not None else None, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#PathItem'.parameters.0.'|'.1]", arr_4_lpath if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
...
def _jm_f_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_5_idx, arr_5_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Operation\" [.'$openapi#PathItem'.servers.0]", arr_5_lpath if path is not None else None))
                break
    if not res:
...
def _jm_f_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#PathItem'.summary]", path))
    return res
...
def _jm_f_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Callback\" [.'$openapi#Operation'.callbacks.''.'|'.0]", lpath_23 if path is not None else None))
            # .'$openapi#Operation'.callbacks.''.'|'.1
            res = json_model_32(pval, lpath_23 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Operation'.callbacks.''.'|'.1]", lpath_23 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_f_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Operation'.description]", path))
    return res
...
def _jm_f_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Operation'.operationId]", path))
    return res
...
def _jm_f_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_6_idx, arr_6_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Parameter\" [.'$openapi#Operation'.parameters.0.'|'.0]", arr_6_lpath if path is not None else None))
                # .'$openapi#Operation'.parameters.0.'|'.1
                res = json_model_32(arr_6_item, arr_6_lpath if path is not None else None, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Operation'.parameters.0.'|'.1]", arr_6_lpath if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
...
def _jm_f_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$RequestBody\" [.'$openapi#Operation'.requestBody.'|'.0]", path))
        # .'$openapi#Operation'.requestBody.'|'.1
        res = json_model_32(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Operation'.requestBody.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def _jm_f_11(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_7_idx, arr_7_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$SecurityRequirement\" [.'$openapi#Operation'.security.0]", arr_7_lpath if path is not None else None))
                break
    if not res:
...
def _jm_f_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_8_idx, arr_8_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Server\" [.'$openapi#Operation'.servers.0]", arr_8_lpath if path is not None else None))
                break
    if not res:
...
def _jm_f_13(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Operation'.summary]", path))
    return res
...
def _jm_f_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_9_idx, arr_9_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Operation'.tags.0]", arr_9_lpath if path is not None else None))
                break
    if not res:
...
def json_model_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "url":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$openapi#ExternalDocumentation'.url]", lpath_24 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#ExternalDocumentation'.description]", lpath_24 if path is not None else None))
...
def _jm_obj_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$MediaType\" [.'$openapi#Parameter'.'|'.1.content.'']", lpath_26 if path is not None else None))
            return False
    return True
...
def _jm_obj_14(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Parameter'.'|'.1.name]", lpath_25 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Parameter'.'|'.1.description]", lpath_25 if path is not None else None))
...
def _jm_obj_17(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Example\" [.'$openapi#Parameter'.'|'.0.examples.''.'|'.0]", lpath_28 if path is not None else None))
            # .'$openapi#Parameter'.'|'.0.examples.''.'|'.1
            res = json_model_32(pval, lpath_28 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Parameter'.'|'.0.examples.''.'|'.1]", lpath_28 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Parameter'.'|'.0.name]", lpath_27 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Parameter'.'|'.0.description]", lpath_27 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Style\" [.'$openapi#Parameter'.'|'.0.style]", lpath_27 if path is not None else None))
            ...
            # handle may examples property
            # .'$openapi#Parameter'.'|'.0.examples
            res = _jm_obj_17(pval, lpath_27 if path is not None else None, rep)
            if not res:
            ...
            res = json_model_98(pval, lpath_27 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Model\" [.'$openapi#Parameter'.'|'.0.model]", lpath_27 if path is not None else None))
...
def _jm_obj_18(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$MediaType\" [.'$openapi#RequestBody'.content.'']", lpath_30 if path is not None else None))
            return False
    return True
...
def json_model_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#RequestBody'.description]", lpath_29 if path is not None else None))
            ...
            # handle may content property
            # .'$openapi#RequestBody'.content
            res = _jm_obj_18(pval, lpath_29 if path is not None else None, rep)
            if not res:
...
def _jm_obj_19(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Example\" [.'$openapi#MediaType'.examples.''.'|'.0]", lpath_32 if path is not None else None))
            # .'$openapi#MediaType'.examples.''.'|'.1
            res = json_model_32(pval, lpath_32 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#MediaType'.examples.''.'|'.1]", lpath_32 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_20(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Encoding\" [.'$openapi#MediaType'.encoding.'']", lpath_33 if path is not None else None))
            return False
    return True
...
def json_model_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "example":
            ...
            # handle may examples property
            # .'$openapi#MediaType'.examples
            res = _jm_obj_19(pval, lpath_31 if path is not None else None, rep)
            if not res:
            ...
            # .'$openapi#MediaType'.encoding
            res = _jm_obj_20(pval, lpath_31 if path is not None else None, rep)
            if not res:
            ...
            res = json_model_98(pval, lpath_31 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Model\" [.'$openapi#MediaType'.model]", lpath_31 if path is not None else None))
...
def _jm_obj_21(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Header\" [.'$openapi#Encoding'.headers.''.'|'.0]", lpath_35 if path is not None else None))
            # .'$openapi#Encoding'.headers.''.'|'.1
            res = json_model_32(pval, lpath_35 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Encoding'.headers.''.'|'.1]", lpath_35 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def json_model_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "contentType":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Encoding'.contentType]", lpath_34 if path is not None else None))
            ...
            # handle may headers property
            # .'$openapi#Encoding'.headers
            res = _jm_obj_21(pval, lpath_34 if path is not None else None, rep)
            if not res:
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Style\" [.'$openapi#Encoding'.style]", lpath_34 if path is not None else None))
...
def json_model_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "default":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Response\" [.'$openapi#Responses'.default.'|'.0]", lpath_36 if path is not None else None))
                # .'$openapi#Responses'.default.'|'.1
                res = json_model_32(pval, lpath_36 if path is not None else None, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Responses'.default.'|'.1]", lpath_36 if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
        ...
        if _jm_re_2(prop, path, rep):
            ...
            res = json_model_25(pval, lpath_36 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Response\" [.'$openapi#Responses'.'/^[1-5](\\\\d\\\\d|XX)$/'.'|'.0]", lpath_36 if path is not None else None))
                # .'$openapi#Responses'.'/^[1-5](\\d\\d|XX)$/'.'|'.1
                res = json_model_32(pval, lpath_36 if path is not None else None, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Responses'.'/^[1-5](\\\\d\\\\d|XX)$/'.'|'.1]", lpath_36 if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
...
def _jm_obj_22(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Header\" [.'$openapi#Response'.headers.''.'|'.0]", lpath_38 if path is not None else None))
            # .'$openapi#Response'.headers.''.'|'.1
            res = json_model_32(pval, lpath_38 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Response'.headers.''.'|'.1]", lpath_38 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_23(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$MediaType\" [.'$openapi#Response'.content.'']", lpath_39 if path is not None else None))
            return False
    return True
...
def _jm_obj_24(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Link\" [.'$openapi#Response'.links.''.'|'.0]", lpath_40 if path is not None else None))
            # .'$openapi#Response'.links.''.'|'.1
            res = json_model_32(pval, lpath_40 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Response'.links.''.'|'.1]", lpath_40 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def json_model_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Response'.description]", lpath_37 if path is not None else None))
            ...
            # handle may content property
            # .'$openapi#Response'.content
            res = _jm_obj_23(pval, lpath_37 if path is not None else None, rep)
            if not res:
            ...
            # handle may links property
            # .'$openapi#Response'.links
            res = _jm_obj_24(pval, lpath_37 if path is not None else None, rep)
            if not res:
...
def json_model_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if json_model_28(prop, lpath_41 if path is not None else None, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$PathItem\" [.'$openapi#Callback'.'$Expression'.'|'.0]", lpath_41 if path is not None else None))
                # .'$openapi#Callback'.'$Expression'.'|'.1
                res = json_model_32(pval, lpath_41 if path is not None else None, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Callback'.'$Expression'.'|'.1]", lpath_41 if path is not None else None))
            if res:
                rep is None or rep.clear()
            else:
...
def json_model_27(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "summary":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Example'.summary]", lpath_42 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Example'.description]", lpath_42 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Example'.externalValue]", lpath_42 if path is not None else None))
...
def json_model_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Expression']", path))
    return res
...
def _jm_obj_25(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "operationId":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Link'.'|'.1.operationId]", lpath_43 if path is not None else None))
        ...
        if prop == "parameters":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Link'.'|'.1.description]", lpath_43 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Server\" [.'$openapi#Link'.'|'.1.server]", lpath_43 if path is not None else None))
...
def _jm_obj_26(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "operationRef":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Link'.'|'.0.operationRef]", lpath_44 if path is not None else None))
        ...
        if prop == "parameters":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Link'.'|'.0.description]", lpath_44 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Server\" [.'$openapi#Link'.'|'.0.server]", lpath_44 if path is not None else None))
...
def _jm_obj_28(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$MediaType\" [.'$openapi#Header'.'|'.1.content.'']", lpath_46 if path is not None else None))
            return False
    return True
...
def _jm_obj_27(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Header'.'|'.1.description]", lpath_45 if path is not None else None))
            ...
            # handle may content property
            # .'$openapi#Header'.'|'.1.content
            res = _jm_obj_28(pval, lpath_45 if path is not None else None, rep)
            if not res:
...
def _jm_obj_30(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Example\" [.'$openapi#Header'.'|'.0.examples.''.'|'.0]", lpath_48 if path is not None else None))
            # .'$openapi#Header'.'|'.0.examples.''.'|'.1
            res = json_model_32(pval, lpath_48 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Reference\" [.'$openapi#Header'.'|'.0.examples.''.'|'.1]", lpath_48 if path is not None else None))
        if res:
            rep is None or rep.clear()
        else:
...
def _jm_obj_29(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Header'.'|'.0.description]", lpath_47 if path is not None else None))
            ...
            res = json_model_17(pval, lpath_47 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Style\" [.'$openapi#Header'.'|'.0.style]", lpath_47 if path is not None else None))
            ...
            # handle may examples property
            # .'$openapi#Header'.'|'.0.examples
            res = _jm_obj_30(pval, lpath_47 if path is not None else None, rep)
            if not res:
            ...
            res = json_model_98(pval, lpath_47 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Model\" [.'$openapi#Header'.'|'.0.model]", lpath_47 if path is not None else None))
...
def json_model_31(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "name":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Tag'.name]", lpath_49 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Tag'.description]", lpath_49 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$ExternalDocumentation\" [.'$openapi#Tag'.externalDocs]", lpath_49 if path is not None else None))
...
def json_model_32(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "$ref":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Reference'.'$ref']", lpath_50 if path is not None else None))
        ...
        if prop == "summary":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Reference'.summary]", lpath_50 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#Reference'.description]", lpath_50 if path is not None else None))
...
def _jm_obj_31(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_apiKey\" [.'$openapi#SecurityScheme'.'|'.0.type]", lpath_51 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#SecurityScheme'.'|'.0.name]", lpath_51 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#SecurityScheme'.'|'.0.description]", lpath_51 if path is not None else None))
...
def _jm_obj_32(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_http\" [.'$openapi#SecurityScheme'.'|'.1.type]", lpath_52 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"/bearer/i\" [.'$openapi#SecurityScheme'.'|'.1.scheme]", lpath_52 if path is not None else None))
        ...
        if prop == "bearerFormat":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#SecurityScheme'.'|'.1.bearerFormat]", lpath_52 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#SecurityScheme'.'|'.1.description]", lpath_52 if path is not None else None))
...
def _jm_obj_33(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            res = isinstance(pval, str) and pval == "http"
            if not res:
                rep is None or rep.append(("unexpected value for model \"_http\" [.'$openapi#SecurityScheme'.'|'.2.type]", lpath_53 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#SecurityScheme'.'|'.2.scheme]", lpath_53 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#SecurityScheme'.'|'.2.description]", lpath_53 if path is not None else None))
...
def _jm_obj_34(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_oauth2\" [.'$openapi#SecurityScheme'.'|'.3.type]", lpath_54 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$OAuthFlows\" [.'$openapi#SecurityScheme'.'|'.3.flows]", lpath_54 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#SecurityScheme'.'|'.3.description]", lpath_54 if path is not None else None))
...
def _jm_obj_35(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "type":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"_openIdConnect\" [.'$openapi#SecurityScheme'.'|'.4.type]", lpath_55 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$openapi#SecurityScheme'.'|'.4.openIdConnectUrl]", lpath_55 if path is not None else None))
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#SecurityScheme'.'|'.4.description]", lpath_55 if path is not None else None))
...
def _jm_obj_36(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "description":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#SecurityScheme'.'|'.5.description]", lpath_56 if path is not None else None))
...
def json_model_43(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "implicit":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$OAuthFlow\" [.'$openapi#OAuthFlows'.implicit]", lpath_57 if path is not None else None))
            ...
            res = json_model_44(pval, lpath_57 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$OAuthFlow\" [.'$openapi#OAuthFlows'.password]", lpath_57 if path is not None else None))
            ...
            res = json_model_44(pval, lpath_57 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$OAuthFlow\" [.'$openapi#OAuthFlows'.clientCredentials]", lpath_57 if path is not None else None))
            ...
            res = json_model_44(pval, lpath_57 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$OAuthFlow\" [.'$openapi#OAuthFlows'.authorizationCode]", lpath_57 if path is not None else None))
...
def _jm_obj_37(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        res = isinstance(pval, str)
        if not res:
            rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#OAuthFlow'.scopes.'']", lpath_59 if path is not None else None))
            return False
    return True
...
def json_model_44(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "authorizationUrl":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$openapi#OAuthFlow'.authorizationUrl]", lpath_58 if path is not None else None))
            ...
            res = is_valid_url(pval, lpath_58 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$openapi#OAuthFlow'.tokenUrl]", lpath_58 if path is not None else None))
            ...
            must_count += 1
            # .'$openapi#OAuthFlow'.scopes
            res = _jm_obj_37(pval, lpath_58 if path is not None else None, rep)
            if not res:
        ...
        if prop == "refreshUrl":
            ...
            res = is_valid_url(pval, lpath_58 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$URL\" [.'$openapi#OAuthFlow'.refreshUrl]", lpath_58 if path is not None else None))
    ...
    for prop, pval in val.items():
        ...
        if res:
            for arr_10_idx, arr_10_item in enumerate(pval):
                ...
                if not res:
                    rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#SecurityRequirement'.''.0]", arr_10_lpath if (lpath_60 if path is not None else None) is not None else None))
                    break
        if not res:
...
def json_model_64(val: Jsonable, path: Path, rep: Report) -> bool:
    # .'$openapi#Model'
    res: bool = json_model_98(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$model#Model\" [.'$openapi#Model']", path))
    return res

# check $openapi#model#Model (.'$openapi#model#Model')
def json_model_98(val: Jsonable, path: Path, rep: Report) -> bool:
    # .'$openapi#model#Model'
    # .'$openapi#model#Model'.'|'.0
    res: bool = json_model_97(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$ScalarModel\" [.'$openapi#model#Model'.'|'.0]", path))
        # .'$openapi#model#Model'.'|'.1
        res = json_model_84(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Array\" [.'$openapi#model#Model'.'|'.1]", path))
            # .'$openapi#model#Model'.'|'.2
            res = json_model_94(val, path, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Element\" [.'$openapi#model#Model'.'|'.2]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def json_model_84(val: Jsonable, path: Path, rep: Report) -> bool:
    # .'$openapi#model#Array'
    res: bool = isinstance(val, list)
    if res:
        for arr_11_idx, arr_11_item in enumerate(val):
            ...
            res = json_model_83(arr_11_item, arr_11_lpath if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$CModel\" [.'$openapi#model#Array'.0]", arr_11_lpath if path is not None else None))
                break
    if not res:
...
def json_model_83(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = json_model_98(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Model\" [.'$openapi#model#CModel'.'|'.0]", path))
        # .'$openapi#model#CModel'.'|'.1
        res = json_model_70(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$ArrayComment\" [.'$openapi#model#CModel'.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def json_model_70(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"/^#/\" [.'$openapi#model#ArrayComment']", path))
    return res
...
def _jm_obj_38(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "#":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#model#Element'.'|'.5.'#']", lpath_61 if path is not None else None))
                rep is None or rep.append(("invalid optional prop value [.'$openapi#model#Element'.'|'.5.'#']", lpath_61 if path is not None else None))
                return False
            continue
        if json_model_91(prop, lpath_61 if path is not None else None, rep):
            # handle 1 key props
            # .'$openapi#model#Element'.'|'.5.'$Prop'
            res = json_model_98(pval, lpath_61 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Model\" [.'$openapi#model#Element'.'|'.5.'$Prop']", lpath_61 if path is not None else None))
                return False
...
def _jm_obj_39(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "+":
            ...
            if res:
                for arr_12_idx, arr_12_item in enumerate(pval):
                    ...
                    res = json_model_83(arr_12_item, arr_12_lpath if (lpath_62 if path is not None else None) is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$CModel\" [.'$openapi#model#Element'.'|'.4.'+'.0]", arr_12_lpath if (lpath_62 if path is not None else None) is not None else None))
                        break
            if not res:
        ...
        if prop == "#":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#model#Element'.'|'.4.'#']", lpath_62 if path is not None else None))
...
def _jm_obj_40(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "^":
            ...
            if res:
                for arr_13_idx, arr_13_item in enumerate(pval):
                    ...
                    res = json_model_83(arr_13_item, arr_13_lpath if (lpath_63 if path is not None else None) is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$CModel\" [.'$openapi#model#Element'.'|'.3.'^'.0]", arr_13_lpath if (lpath_63 if path is not None else None) is not None else None))
                        break
            if not res:
        ...
        if prop == "#":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#model#Element'.'|'.3.'#']", lpath_63 if path is not None else None))
...
def _jm_obj_41(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "&":
            ...
            if res:
                for arr_14_idx, arr_14_item in enumerate(pval):
                    ...
                    res = json_model_83(arr_14_item, arr_14_lpath if (lpath_64 if path is not None else None) is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$CModel\" [.'$openapi#model#Element'.'|'.2.'&'.0]", arr_14_lpath if (lpath_64 if path is not None else None) is not None else None))
                        break
            if not res:
        ...
        if prop == "#":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#model#Element'.'|'.2.'#']", lpath_64 if path is not None else None))
...
def _jm_obj_42(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "|":
            ...
            if res:
                for arr_15_idx, arr_15_item in enumerate(pval):
                    ...
                    res = json_model_83(arr_15_item, arr_15_lpath if (lpath_65 if path is not None else None) is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$CModel\" [.'$openapi#model#Element'.'|'.1.'|'.0]", arr_15_lpath if (lpath_65 if path is not None else None) is not None else None))
                        break
            if not res:
        ...
        if prop == "#":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#model#Element'.'|'.1.'#']", lpath_65 if path is not None else None))
...
def _jm_obj_43(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "@":
            ...
            res = json_model_98(pval, lpath_66 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Model\" [.'$openapi#model#Element'.'|'.0.'@']", lpath_66 if path is not None else None))
        ...
        if prop == "#":
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#model#Element'.'|'.0.'#']", lpath_66 if path is not None else None))
        ...
        if _jm_re_4(prop, path, rep):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$CmpValue\" [.'$openapi#model#Element'.'|'.0.'/^(<=|>=|<|>)$/']", lpath_66 if path is not None else None))
                return False
        elif _jm_re_6(prop, path, rep):
            # handle 3 re props
            # .'$openapi#model#Element'.'|'.0.'/^(=|!=)$/'
            res = json_model_78(pval, lpath_66 if path is not None else None, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$EqValue\" [.'$openapi#model#Element'.'|'.0.'/^(=|!=)$/']", lpath_66 if path is not None else None))
                return False
        else:
...
def json_model_94(val: Jsonable, path: Path, rep: Report) -> bool:
...
def json_model_77(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        ...
        if not res:
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$openapi#model#CmpValue'.'|'.2]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def json_model_78(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        ...
        if not res:
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$CmpValue\" [.'$openapi#model#EqValue'.'|'.2]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def json_model_91(val: Jsonable, path: Path, rep: Report) -> bool:
    # .'$openapi#model#Prop'
    # .'$openapi#model#Prop'.'|'.0
    # "/^[?!]/"
    res: bool = isinstance(val, str) and _jm_re_7(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"/^[?!]/\" [.'$openapi#model#Prop'.'|'.0]", path))
        # .'$openapi#model#Prop'.'|'.1
        res = json_model_74(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$StrConst\" [.'$openapi#model#Prop'.'|'.1]", path))
            # .'$openapi#model#Prop'.'|'.2
            res = json_model_75(val, path, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Regex\" [.'$openapi#model#Prop'.'|'.2]", path))
                # .'$openapi#model#Prop'.'|'.3
                res = json_model_67(val, path, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$StrPredef\" [.'$openapi#model#Prop'.'|'.3]", path))
                    # .'$openapi#model#Prop'.'|'.4
                    res = json_model_72(val, path, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$Ref\" [.'$openapi#model#Prop'.'|'.4]", path))
                        # .'$openapi#model#Prop'.'|'.5
                        res = json_model_76(val, path, rep)
                        if not res:
                            rep is None or rep.append(("unexpected value for model \"$Name\" [.'$openapi#model#Prop'.'|'.5]", path))
                            # .'$openapi#model#Prop'.'|'.6
                            res = isinstance(val, str) and val == ""
                            if not res:
                                rep is None or rep.append(("unexpected value for model \"_\" [.'$openapi#model#Prop'.'|'.6]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def json_model_67(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = ((val is None or isinstance(val, (bool, int, float, str)))) and val in _jm_cst_4
    if not res:
        rep is None or rep.append(("value not in enum [.'$openapi#model#StrPredef'.'|']", path))
    return res
...
def _jm_xre_0(val: str, path: Path, rep: Report) -> bool:
    ...
    if not json_model_66(extract, path, rep):
        return False
    return True
...
def _jm_xre_1(val: str, path: Path, rep: Report) -> bool:
    ...
    if not match:
        return False
    extract: str = match.groupdict()["s1"]
    if not json_model_69(extract, path, rep):
        return False
    return True
...
def json_model_72(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"/^\\\\$($Identifier)$/X\" [.'$openapi#model#Ref'.'|'.0]", path))
            # .'$openapi#model#Ref'.'|'.1
            # "/^\\$($Url)$/X"
            res = _jm_xre_0(val, path, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"/^\\\\$($Url)$/X\" [.'$openapi#model#Ref'.'|'.1]", path))
        if res:
            rep is None or rep.clear()
        else:
            rep is None or rep.append(("no model matched [.'$openapi#model#Ref'.'|']", path))
    else:
        rep is None or rep.append(("unexpected type [.'$openapi#model#Ref'.'|']", path))
    return res
...
def json_model_69(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if res:
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"/[^A-Z0-9]/\" [.'$openapi#model#Identifier'.'&'.1]", path))
        else:
            rep is None or rep.append(("unexpected value for model \"/^\\\\w(\\\\w|-)*$/\" [.'$openapi#model#Identifier'.'&'.0]", path))
    if res:
        rep is None or rep.clear()
    else:
        rep is None or rep.append(("not all model match [.'$openapi#model#Identifier'.'&']", path))
    return res
...
def json_model_74(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    # "/^[A-Za-z0-9_]/"
    res: bool = isinstance(val, str) and _jm_re_11(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"/^[A-Za-z0-9_]/\" [.'$openapi#model#StrConst']", path))
    return res


def _jm_xre_2(val: str, path: Path, rep: Report) -> bool:
    extract: str
    match = _jm_xre_2_re_reco.search(val)
    if not match:
        return False
    extract: str = match.groupdict()["s1"]
...
def _jm_xre_3(val: str, path: Path, rep: Report) -> bool:
    extract: str
    match = _jm_xre_3_re_reco.search(val)
    if not match:
        return False
    extract: str = match.groupdict()["s1"]
...
def json_model_75(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"/^/($EXREG)/[a-z]*X[a-z]*$/X\" [.'$openapi#model#Regex'.'|'.0]", path))
            # .'$openapi#model#Regex'.'|'.1
            # "/^/($REGEX)/[a-z]*$/X"
            res = _jm_xre_2(val, path, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"/^/($REGEX)/[a-z]*$/X\" [.'$openapi#model#Regex'.'|'.1]", path))
        if res:
            rep is None or rep.clear()
        else:
...
def json_model_76(val: Jsonable, path: Path, rep: Report) -> bool:
    # .'$openapi#model#Name'
    # "/^\\..+$/"
    res: bool = isinstance(val, str) and _jm_re_12(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"/^\\\\..+$/\" [.'$openapi#model#Name']", path))
    return res
...
def json_model_97(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = json_model_79(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$ValModel\" [.'$openapi#model#ScalarModel'.'|'.0]", path))
        # .'$openapi#model#ScalarModel'.'|'.1
        res = json_model_80(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$StrModel\" [.'$openapi#model#ScalarModel'.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def json_model_79(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"=true\" [.'$openapi#model#ValModel'.'|'.1]", path))
            # .'$openapi#model#ValModel'.'|'.2
            res = isinstance(val, int) and not isinstance(val, bool) and val == 0
            if not res:
                rep is None or rep.append(("unexpected value for model \"=0\" [.'$openapi#model#ValModel'.'|'.2]", path))
                # .'$openapi#model#ValModel'.'|'.3
                res = isinstance(val, int) and not isinstance(val, bool) and val == 1
                if not res:
                    rep is None or rep.append(("unexpected value for model \"=1\" [.'$openapi#model#ValModel'.'|'.3]", path))
                    # .'$openapi#model#ValModel'.'|'.4
                    res = isinstance(val, int) and not isinstance(val, bool) and val == -1
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"=-1\" [.'$openapi#model#ValModel'.'|'.4]", path))
                        # .'$openapi#model#ValModel'.'|'.5
                        res = isinstance(val, float) and val == 0.0
                        if not res:
                            rep is None or rep.append(("unexpected value for model \"=0.0\" [.'$openapi#model#ValModel'.'|'.5]", path))
                            # .'$openapi#model#ValModel'.'|'.6
                            res = isinstance(val, float) and val == 1.0
                            if not res:
                                rep is None or rep.append(("unexpected value for model \"=1.0\" [.'$openapi#model#ValModel'.'|'.6]", path))
                                # .'$openapi#model#ValModel'.'|'.7
                                res = isinstance(val, float) and val == -1.0
                                if not res:
                                    rep is None or rep.append(("unexpected value for model \"=-1.0\" [.'$openapi#model#ValModel'.'|'.7]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def json_model_80(val: Jsonable, path: Path, rep: Report) -> bool:
    # .'$openapi#model#StrModel'
    # .'$openapi#model#StrModel'.'|'.0
    res: bool = json_model_74(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$StrConst\" [.'$openapi#model#StrModel'.'|'.0]", path))
        # .'$openapi#model#StrModel'.'|'.1
        res = json_model_73(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$ValConst\" [.'$openapi#model#StrModel'.'|'.1]", path))
            # .'$openapi#model#StrModel'.'|'.2
            res = json_model_75(val, path, rep)
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Regex\" [.'$openapi#model#StrModel'.'|'.2]", path))
                # .'$openapi#model#StrModel'.'|'.3
                res = json_model_68(val, path, rep)
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$PreDef\" [.'$openapi#model#StrModel'.'|'.3]", path))
                    # .'$openapi#model#StrModel'.'|'.4
                    res = json_model_72(val, path, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$Ref\" [.'$openapi#model#StrModel'.'|'.4]", path))
                        # .'$openapi#model#StrModel'.'|'.5
                        res = isinstance(val, str) and val == ""
                        if not res:
                            rep is None or rep.append(("unexpected value for model \"_\" [.'$openapi#model#StrModel'.'|'.5]", path))
    if res:
        rep is None or rep.clear()
    else:
...
def json_model_68(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = ((val is None or isinstance(val, (bool, int, float, str)))) and val in _jm_cst_5
    if not res:
        ...
        if res:
            ...
            rep is None or rep.append(("unexpected value for model \"$StrPredef\" [.'$openapi#model#PreDef'.'|'.0]", path))
            rep is None or rep.append(("no model matched [.'$openapi#model#PreDef'.'|']", path))
    return res
...
def json_model_73(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str) and _jm_re_13(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"/^=(null|true|false|[-+]?\\\\d+(\\\\.\\\\d+)?([Ee][-+]?\\\\d+)?)$/\" [.'$openapi#model#ValConst']", path))
    return res
...
def check_model_init():
    ...
    if not initialized:
        ...
        _jm_map_0 = {
            ...
            "http": _jm_obj_32,
            "oauth2": _jm_obj_34,
            "openIdConnect": _jm_obj_35,
        }
        global _jm_re_4_reco, _jm_re_4
        _jm_re_4_reco = re.compile("(?s)^#.")
        ...
        _jm_re_10_reco = re.compile("^\\w(\\w|-)*$")
        _jm_re_10 = lambda s, p, r: _jm_re_10_reco.search(s) is not None
        global _jm_re_11_reco, _jm_re_11
        _jm_re_11_reco = re.compile("^[A-Za-z0-9_]")
        _jm_re_11 = lambda s, p, r: _jm_re_11_reco.search(s) is not None
        global _jm_xre_2_re_reco, _jm_xre_2_re
        _jm_xre_2_re_reco = re.compile("^/(?<s1>.*)/[a-z]*$")
        _jm_xre_2_re = lambda s, p, r: _jm_xre_2_re_reco.search(s) is not None
        global _jm_xre_3_re_reco, _jm_xre_3_re
        _jm_xre_3_re_reco = re.compile("^/(?<s1>.*)/[a-z]*X[a-z]*$")
        _jm_xre_3_re = lambda s, p, r: _jm_xre_3_re_reco.search(s) is not None
...
def check_model_free():
    ...
    if initialized:
        ...
        _jm_re_11 = None
        global _jm_xre_2_re_reco, _jm_xre_2_re
        _jm_xre_2_re_reco = None
        _jm_xre_2_re = None
        global _jm_xre_3_re_reco, _jm_xre_3_re
        _jm_xre_3_re_reco = None
        _jm_xre_3_re = None
        global _jm_re_12_reco, _jm_re_12
        _jm_re_12_reco = None
        _jm_re_12 = None
