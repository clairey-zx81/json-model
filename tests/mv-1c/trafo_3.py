...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$l\" [.'$Dd']", path))
    return res
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = json_model_6(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Dd\" [.]", path))
    return res
...
def json_model_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_0_idx, arr_0_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$u\" [.'$Dd#l'.0]", arr_0_lpath if path is not None else None))
                break
    if not res:
...
def json_model_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Uu#un\" [.'$Dd#u']", path))
    return res
