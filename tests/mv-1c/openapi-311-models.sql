    ...
    ELSEIF prop = 'security' THEN
      ...
      IF res THEN
        FOR arr_1_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
          ...
          res := json_model_45(arr_1_item, NULL, NULL);
          IF NOT res THEN
            EXIT;
          END IF;
        END LOOP;
    ...
    ELSEIF prop = 'tags' THEN
      ...
      IF res THEN
        FOR arr_2_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
          ...
          res := json_model_31(arr_2_item, NULL, NULL);
          IF NOT res THEN
            EXIT;
          END IF;
        END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_26(pval, NULL, NULL) OR json_model_32(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_27(pval, NULL, NULL) OR json_model_32(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_30(pval, NULL, NULL) OR json_model_32(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_29(pval, NULL, NULL) OR json_model_32(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    -- handle other props
    -- .'$openapi#Components'.models.''
    res := json_model_98(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_20(pval, NULL, NULL) OR json_model_32(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_12(pval, NULL, NULL) OR json_model_32(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_21(pval, NULL, NULL) OR json_model_32(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_25(pval, NULL, NULL) OR json_model_32(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_42(pval, NULL, NULL) OR json_model_32(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
DECLARE
  map JSONB := JSONB '{"callbacks":"_jm_f_0","examples":"_jm_f_1","headers":"_jm_f_2","links":"_jm_f_3","models":"_jm_f_4","parameters":"_jm_f_5","pathItems":"_jm_f_6","requestBodies":"_jm_f_7","responses":"_jm_f_8","securitySchemes":"_jm_f_9"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
  ...
  IF res THEN
    FOR arr_4_idx IN 0 .. JSONB_ARRAY_LENGTH(val) - 1 LOOP
      ...
      res := json_model_20(arr_4_item, NULL, NULL) OR json_model_32(arr_4_item, NULL, NULL);
      IF NOT res THEN
        EXIT;
      END IF;
    END LOOP;
...
BEGIN
  ...
  IF res THEN
    FOR arr_5_idx IN 0 .. JSONB_ARRAY_LENGTH(val) - 1 LOOP
      ...
      res := json_model_13(arr_5_item, NULL, NULL);
      IF NOT res THEN
        EXIT;
      END IF;
    END LOOP;
...
RETURNS TEXT STRICT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  map JSONB := JSONB '{"$ref":"_jm_f_10","delete":"json_model_13","description":"_jm_f_11","get":"json_model_13","head":"json_model_13","options":"json_model_13","parameters":"_jm_f_12","patch":"json_model_13","post":"json_model_13","put":"json_model_13","servers":"_jm_f_13","summary":"_jm_f_14","trace":"json_model_13"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
  ...
  IF res THEN
    FOR arr_6_idx IN 0 .. JSONB_ARRAY_LENGTH(val) - 1 LOOP
      ...
      res := json_model_20(arr_6_item, NULL, NULL) OR json_model_32(arr_6_item, NULL, NULL);
      IF NOT res THEN
        EXIT;
      END IF;
    END LOOP;
...
BEGIN
  ...
  RETURN json_model_21(val, NULL, NULL) OR json_model_32(val, NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  ...
  IF res THEN
    FOR arr_7_idx IN 0 .. JSONB_ARRAY_LENGTH(val) - 1 LOOP
      ...
      res := json_model_45(arr_7_item, NULL, NULL);
      IF NOT res THEN
        EXIT;
      END IF;
    END LOOP;
...
BEGIN
  ...
  IF res THEN
    FOR arr_8_idx IN 0 .. JSONB_ARRAY_LENGTH(val) - 1 LOOP
      ...
      res := json_model_8(arr_8_item, NULL, NULL);
      IF NOT res THEN
        EXIT;
      END IF;
    END LOOP;
...
RETURNS TEXT STRICT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  map JSONB := JSONB '{"callbacks":"_jm_f_15","deprecated":"_jm_f_16","description":"_jm_f_17","externalDocs":"json_model_14","operationId":"_jm_f_18","parameters":"_jm_f_19","requestBody":"_jm_f_20","responses":"json_model_24","security":"_jm_f_21","servers":"_jm_f_22","summary":"_jm_f_23","tags":"_jm_f_24"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_22(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    res := json_model_23(pval, NULL, NULL);
    IF NOT res THEN
      RETURN FALSE;
    END IF;
  END LOOP;
...
BEGIN
  ...
  -- .'$openapi#Link'.'|'.0
  -- .'$openapi#Link'.'|'.1
  RETURN JSONB_TYPEOF(val) = 'object' AND (_jm_obj_15(val, NULL, NULL) OR _jm_obj_14(val, NULL, NULL));
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  -- value known to be an object
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    IF _jm_obj_18_map(prop) IS NOT NULL THEN
      -- handle 10 may props
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    ELSEIF prop = 'flows' THEN
      ...
      res := json_model_43(pval, NULL, NULL);
      IF NOT res THEN
        RETURN FALSE;
      END IF;
      CONTINUE;
...
BEGIN
  ...
  RETURN res OR _jm_obj_24(val, NULL, NULL) OR _jm_obj_21(val, NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    IF prop = 'implicit' THEN
      ...
      res := json_model_44(pval, NULL, NULL);
      IF NOT res THEN
        RETURN FALSE;
      END IF;
      CONTINUE;
...
BEGIN
  -- .'$openapi#Model'
  RETURN json_model_98(val, NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;

-- check $openapi#model#Model (.'$openapi#model#Model')
CREATE OR REPLACE FUNCTION json_model_98(val JSONB, path TEXT[], rep jm_report_entry[])
RETURNS BOOLEAN CALLED ON NULL INPUT IMMUTABLE PARALLEL SAFE AS $$
BEGIN
  -- .'$openapi#model#Model'
  ...
  RETURN json_model_97(val, NULL, NULL) OR json_model_84(val, NULL, NULL) OR json_model_94(val, NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  ...
  IF res THEN
    FOR arr_11_idx IN 0 .. JSONB_ARRAY_LENGTH(val) - 1 LOOP
      ...
      res := json_model_83(arr_11_item, NULL, NULL);
      IF NOT res THEN
        EXIT;
      END IF;
    END LOOP;
...
BEGIN
  ...
  RETURN json_model_98(val, NULL, NULL) OR json_model_70(val, NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    IF prop = '#' THEN
      ...
      CONTINUE;
    END IF;
    IF json_model_91(TO_JSONB(prop), NULL, NULL) THEN
      -- handle 1 key props
      ...
      IF NOT res THEN
        RETURN FALSE;
      END IF;
    ELSEIF _jm_re_4(prop, NULL, NULL) THEN
      -- handle 1 re props
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    IF prop = '+' THEN
      ...
      IF res THEN
        FOR arr_12_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
          ...
          res := json_model_83(arr_12_item, NULL, NULL);
          IF NOT res THEN
            EXIT;
          END IF;
        END LOOP;
    ...
    IF prop = '#' THEN
      ...
      CONTINUE;
    END IF;
    IF _jm_re_4(prop, NULL, NULL) THEN
      -- handle 1 re props
    ...
    IF prop = '^' THEN
      ...
      IF res THEN
        FOR arr_13_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
          ...
          res := json_model_83(arr_13_item, NULL, NULL);
          IF NOT res THEN
            EXIT;
          END IF;
        END LOOP;
    ...
    IF prop = '&' THEN
      ...
      IF res THEN
        FOR arr_14_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
          ...
          res := json_model_83(arr_14_item, NULL, NULL);
          IF NOT res THEN
            EXIT;
          END IF;
        END LOOP;
    ...
    IF prop = '|' THEN
      ...
      IF res THEN
        FOR arr_15_idx IN 0 .. JSONB_ARRAY_LENGTH(pval) - 1 LOOP
          ...
          res := json_model_83(arr_15_item, NULL, NULL);
          IF NOT res THEN
            EXIT;
          END IF;
        END LOOP;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    IF _jm_re_4(prop, NULL, NULL) THEN
      ...
      res := TRUE;
    ELSEIF _jm_re_5(prop, NULL, NULL) THEN
      -- handle 3 re props
      -- .'$openapi#model#Element'.'|'.0.'/^(<=|>=|<|>)$/'
      res := json_model_77(pval, NULL, NULL);
      IF NOT res THEN
        RETURN FALSE;
      END IF;
    ELSEIF _jm_re_6(prop, NULL, NULL) THEN
      -- handle 3 re props
      -- .'$openapi#model#Element'.'|'.0.'/^(=|!=)$/'
      res := json_model_78(pval, NULL, NULL);
      IF NOT res THEN
        RETURN FALSE;
      END IF;
    ELSE
...
CREATE OR REPLACE FUNCTION json_model_94(val JSONB, path TEXT[], rep jm_report_entry[])
RETURNS BOOLEAN CALLED ON NULL INPUT IMMUTABLE PARALLEL SAFE AS $$
BEGIN
  ...
  -- .'$openapi#model#Element'.'|'.4
  -- .'$openapi#model#Element'.'|'.5
  RETURN JSONB_TYPEOF(val) = 'object' AND (_jm_obj_31(val, NULL, NULL) OR _jm_obj_30(val, NULL, NULL) OR _jm_obj_29(val, NULL, NULL) OR _jm_obj_28(val, NULL, NULL) OR _jm_obj_27(val, NULL, NULL) OR _jm_obj_26(val, NULL, NULL));
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  ...
  RETURN JSONB_TYPEOF(val) = 'null' OR JSONB_TYPEOF(val) = 'boolean' OR json_model_77(val, NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
CREATE OR REPLACE FUNCTION json_model_91(val JSONB, path TEXT[], rep jm_report_entry[])
RETURNS BOOLEAN CALLED ON NULL INPUT IMMUTABLE PARALLEL SAFE AS $$
BEGIN
  -- .'$openapi#model#Prop'
  ...
  RETURN JSONB_TYPEOF(val) = 'string' AND _jm_re_7(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL) OR json_model_74(val, NULL, NULL) OR json_model_75(val, NULL, NULL) OR json_model_67(val, NULL, NULL) OR json_model_72(val, NULL, NULL) OR json_model_76(val, NULL, NULL) OR JSONB_TYPEOF(val) = 'string' AND JSON_VALUE(val, '$' RETURNING TEXT) = '';
END;
$$ LANGUAGE PLpgSQL;
...
DECLARE
  ...
  match TEXT[];
BEGIN
  match := regexp_match(val, '^\$(.*)$', 'n');
  IF match IS NULL THEN
    RETURN FALSE;
  END IF;
  extract := match[1];
  IF NOT json_model_66(TO_JSONB(extract), NULL, NULL) THEN
    RETURN FALSE;
  END IF;
  RETURN TRUE;
END;
...
BEGIN
  ...
  END IF;
  extract := match[1];
  IF NOT json_model_69(TO_JSONB(extract), NULL, NULL) THEN
    RETURN FALSE;
  END IF;
  RETURN TRUE;
END;
...
CREATE OR REPLACE FUNCTION json_model_66(val JSONB, path TEXT[], rep jm_report_entry[])
RETURNS BOOLEAN CALLED ON NULL INPUT IMMUTABLE PARALLEL SAFE AS $$
BEGIN
  -- .'$openapi#model#Url'
  -- "/^((file|https?)://.+|\\./.*|\\.\\./.*|[^#]*#.*)$/"
...
BEGIN
  ...
  -- "/[^A-Z0-9]/"
  RETURN JSONB_TYPEOF(val) = 'string' AND _jm_re_10(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL) AND _jm_re_9(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  ...
  -- "/^[A-Za-z0-9_]/"
  RETURN JSONB_TYPEOF(val) = 'string' AND _jm_re_11(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;

-- regex=^/(.*)/[a-z]*$ opts=n
CREATE OR REPLACE FUNCTION _jm_xre_2_re(val TEXT, path TEXT[], rep jm_report_entry[])
RETURNS BOOLEAN CALLED ON NULL INPUT IMMUTABLE PARALLEL SAFE AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION _jm_xre_2(val TEXT, path TEXT[], rep jm_report_entry[])
RETURNS BOOL CALLED ON NULL INPUT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  extract TEXT;
  match TEXT[];
...
CREATE OR REPLACE FUNCTION _jm_xre_3_re(val TEXT, path TEXT[], rep jm_report_entry[])
RETURNS BOOLEAN CALLED ON NULL INPUT IMMUTABLE PARALLEL SAFE AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION _jm_xre_3(val TEXT, path TEXT[], rep jm_report_entry[])
RETURNS BOOL CALLED ON NULL INPUT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  extract TEXT;
  match TEXT[];
...
BEGIN
  ...
  -- "/^/($REGEX)/[a-z]*$/X"
  RETURN JSONB_TYPEOF(val) = 'string' AND (_jm_xre_3(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL) OR _jm_xre_2(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL));
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  -- .'$openapi#model#Name'
  -- "/^\\..+$/"
  RETURN JSONB_TYPEOF(val) = 'string' AND _jm_re_12(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  ...
  RETURN json_model_79(val, NULL, NULL) OR json_model_80(val, NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  ...
  RETURN json_model_74(val, NULL, NULL) OR json_model_73(val, NULL, NULL) OR json_model_75(val, NULL, NULL) OR json_model_68(val, NULL, NULL) OR json_model_72(val, NULL, NULL) OR JSONB_TYPEOF(val) = 'string' AND JSON_VALUE(val, '$' RETURNING TEXT) = '';
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  ...
  RETURN JSONB_TYPEOF(val) IN ('null', 'boolean', 'number', 'string') AND _jm_cst_6(val) OR json_model_67(val, NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;

-- regex=^=(null|true|false|[-+]?\d+(\.\d+)?([Ee][-+]?\d+)?)$ opts=n
CREATE OR REPLACE FUNCTION _jm_re_13(val TEXT, path TEXT[], rep jm_report_entry[])
RETURNS BOOLEAN CALLED ON NULL INPUT IMMUTABLE PARALLEL SAFE AS $$
BEGIN
...
BEGIN
  ...
  RETURN JSONB_TYPEOF(val) = 'string' AND _jm_re_13(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
INSERT INTO jm_constant_maps(mapname, tagval, value) VALUES
  ('_jm_map_0', JSONB '"apiKey"', '_jm_obj_19'),
  ('_jm_map_0', JSONB '"http"', '_jm_obj_20'),
  ('_jm_map_0', JSONB '"oauth2"', '_jm_obj_22'),
  ('_jm_map_0', JSONB '"openIdConnect"', '_jm_obj_23')
;
