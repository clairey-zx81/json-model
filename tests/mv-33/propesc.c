    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (hash_0 <= 0xc)
        {
            if (jm_str_eq_2(prop, 0x0000000a))
            {
                ...
                if (unlikely(! res))
                {
                    if (rep) jm_report_add_entry(rep, "not a 1 strict int [.'\n']", (path ? &lpath_0 : NULL));
                    if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'\n']", (path ? &lpath_0 : NULL));
                    return false;
                }
                continue;
            }
            else if (jm_str_eq_2(prop, 0x00000009))
            {
                ...
                if (unlikely(! res))
                {
                    if (rep) jm_report_add_entry(rep, "not a 1 strict int [.'\t']", (path ? &lpath_0 : NULL));
            ...
            else if (jm_str_eq_2(prop, 0x0000000c))
            {
                ...
                if (unlikely(! res))
                {
                    if (rep) jm_report_add_entry(rep, "not a 1 strict int [.'\f']", (path ? &lpath_0 : NULL));
        ...
        {
            if (jm_str_eq_2(prop, 0x0000005c))
            {
                // handle may \ property
                // .'\\'
                res = json_is_integer(pval) && json_integer_value(pval) >= 1;
            ...
            else if (jm_str_eq_2(prop, 0x00000027))
            {
                // handle may ' property
                // .'\''
                res = json_is_integer(pval) && json_integer_value(pval) >= 1;
            ...
            else if (jm_str_eq_2(prop, 0x00000022))
            {
                // handle may " property
                // .'"'
                res = json_is_integer(pval) && json_integer_value(pval) >= 1;
            ...
            else if (jm_str_eq_2(prop, 0x0000000d))
            {
                ...
                if (unlikely(! res))
                {
                    if (rep) jm_report_add_entry(rep, "not a 1 strict int [.'\r']", (path ? &lpath_0 : NULL));
                    if (rep) jm_report_add_entry(rep, "invalid optional prop value [.'\r']", (path ? &lpath_0 : NULL));
                    return false;
                }
                continue;
            }
