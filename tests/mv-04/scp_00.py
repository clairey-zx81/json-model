...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Aa']", path))
    return res
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "a":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Aa\" [.a]", lpath_0 if path is not None else None))
