...
bool json_model_2(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    if (! (val is Map))
    {
        rep?.add(["not an object [.'\$obj']", path]);
        return false;
    }
    bool res;
    for (var entry in val.entries)
    {
        ...
        if (! res)
        {
            rep?.add(["unexpected \$rec [.'\$obj'.'']", (path != null ? lpath_0 : null)]);
            return false;
        }
    }
    return true;
...
bool json_model_3(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    if (! res)
    {
        ...
        if (! res)
        {
            rep?.add(["unexpected \$obj [.'\$rec'.'|'.1]", path]);
        }
    }
    if (res)
    {
...
void check_model_init() {
  if (!GlobalState.initializer){
    GlobalState.initializer = true;
        ...
        check_model_map["obj"] = json_model_2;
        check_model_map["rec"] = json_model_3;
}
