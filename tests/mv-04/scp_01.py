...
def json_model_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"_b\" [.'$b']", path))
    return res
...
def json_model_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "a":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Aa\" [.'$Rr'.a]", lpath_0 if path is not None else None))
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "RA":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Rr\" [.RA]", lpath_1 if path is not None else None))
        ...
        if prop == "a":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Rr#Aa\" [.a]", lpath_1 if path is not None else None))
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$Bb\" [.b]", lpath_1 if path is not None else None))
...
def json_model_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Rr#Aa']", path))
    return res
