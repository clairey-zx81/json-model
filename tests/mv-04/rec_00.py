...
def json_model_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$rec\" [.'$obj'.'']", lpath_0 if path is not None else None))
            return False
    return True
...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$obj\" [.'$rec'.'|'.1]", path))
    if res:
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$rec\" [.]", path))
    return res
