...
def json_model_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"/[0-9]/\" [.'$s']", path))
    return res
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        ...
        if res:
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"$s\" [.1]", lpath_0 if path is not None else None))
        else:
            rep is None or rep.append(("unexpected value for model \"$s\" [.0]", lpath_0 if path is not None else None))
    if not res:
