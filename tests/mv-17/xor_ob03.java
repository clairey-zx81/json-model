...
public class xor_ob03 extends ModelChecker
{
    ...
    public void free()
    {
        if (initialized)
        {
            super.free();
            _jm_map_0_cmap = null;
            xor_ob03_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return xor_ob03_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return xor_ob03_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new xor_ob03();
        Main.main("xor_ob03", checker, VERSION, args);
    }
}
