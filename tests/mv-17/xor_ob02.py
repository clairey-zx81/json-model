        ...
        if pfun := _jm_obj_6_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_6 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'|'.3]", lpath_6 if path is not None else None))
                    return False
        else:
...
def _jm_f_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 0
    if not res:
        rep is None or rep.append(("not a 0 strict int [$.'|'.2.c]", path))
    return res
        ...
        if pfun := _jm_obj_7_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_7 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'|'.2]", lpath_7 if path is not None else None))
                    return False
        else:
        ...
        if pfun := _jm_obj_8_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_8 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'|'.1]", lpath_8 if path is not None else None))
                    return False
        else:
        ...
        if pfun := _jm_obj_9_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_9 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'|'.0]", lpath_9 if path is not None else None))
                    return False
        else:
