...
BEGIN
  ...
  IF res THEN
    -- .'$Cc'.'|'.0
    -- .'$Cc'.'|'.1
    res := _jm_obj_5(val, path, rep) OR _jm_obj_4(val, path, rep);
  END IF;
  RETURN res;
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  ...
  IF res THEN
    ...
    -- .'|'.2
    -- .'|'.3
    res := _jm_obj_9(val, path, rep) OR _jm_obj_8(val, path, rep) OR _jm_obj_7(val, path, rep) OR _jm_obj_6(val, path, rep);
  END IF;
  RETURN res;
END;
$$ LANGUAGE PLpgSQL;
