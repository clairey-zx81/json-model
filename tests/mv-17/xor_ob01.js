...
function _jm_obj_0(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not a 0 strict int [.'$Bb'.'|'.1.b]", path])
        rep !== null && rep.push(["unexpected value for mandatory prop <b> [.'$Bb'.'|'.1]", path])
        return false;
    }
    return true;
}
...
function _jm_obj_3(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["not a 0 strict int [.'$Cc'.'|'.0.a]", path])
        rep !== null && rep.push(["unexpected value for mandatory prop <a> [.'$Cc'.'|'.0]", path])
        return false;
    }
    return true;
}
