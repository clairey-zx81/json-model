...
static INLINE bool _jm_obj_2(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not a 0 strict int [.'$Bb'.'|'.1.d]", path);
        if (rep) jm_report_add_entry(rep, "unexpected value for mandatory prop <d> [.'$Bb'.'|'.1]", path);
        return false;
    }
    return true;
}
...
static INLINE bool _jm_obj_3(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "not a 0 strict int [.'$Bb'.'|'.0.c]", path);
        if (rep) jm_report_add_entry(rep, "unexpected value for mandatory prop <c> [.'$Bb'.'|'.0]", path);
        return false;
    }
    return true;
}
...
static INLINE bool _jm_obj_6(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        ...
        if (rep) jm_report_add_entry(rep, "unexpected value for mandatory prop <d> [.'|'.1]", path);
        return false;
    }
    return true;
}
...
static INLINE bool _jm_obj_7(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    if (! res)
    {
        ...
        if (rep) jm_report_add_entry(rep, "unexpected value for mandatory prop <c> [.'|'.0]", path);
        return false;
    }
    return true;
}
