...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "nom":
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.nom]", lpath_0 if path is not None else None))
            ...
            res = isinstance(pval, str)
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.prenom]", lpath_0 if path is not None else None))
