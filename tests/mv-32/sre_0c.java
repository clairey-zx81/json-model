...
public class sre_0c extends ModelChecker
{
    static public final String VERSION = "2";

    public Pattern _jm_re_0_pat = null;
    public Map<String, Checker> sre_0c_map_pmap;
    ...
    public void free()
    {
        if (initialized)
        {
            super.free();
            _jm_re_0_pat = null;
            sre_0c_map_pmap = null;
        }
    }

    public Checker get(String name)
    {
        return sre_0c_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return sre_0c_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new sre_0c();
        Main.main("sre_0c", checker, VERSION, args);
    }
}
