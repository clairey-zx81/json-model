...
def json_model_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Root\" [.'$root']", path))
    return res
...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not isinstance(val, dict):
        ...
        return False
    if len(val) != 1:
        rep is None or rep.append(("bad property count [.'$Foo']", path))
        return False
    lpath: Path
    pval: Jsonable
    ...
    # .'$Foo'.rt
    res: bool = json_model_5(pval, lpath if path is not None else None, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$root#Root\" [.'$Foo'.rt]", lpath if path is not None else None))
        rep is None or rep.append(("unexpected value for mandatory prop <rt> [.'$Foo']", lpath if path is not None else None))
        return False
    return True
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Foo\" [.]", path))
    return res
...
def json_model_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"=0\" [.'$root#Root'.id]", lpath if path is not None else None))
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$root#Root'.name]", lpath if path is not None else None))
