...
const _jm_re_0_re = new runtime.RX("y", "")
...
function json_model_1(val, path, rep)
{
    ...
    if (res)
    {
        for (let arr_1_idx = 0; arr_1_idx < val.length; arr_1_idx++)
        {
            ...
            res = typeof arr_1_item == 'string' && _jm_re_1(arr_1_item, null, null)
            if (! res)
                break
        }
        if (res)
        {
            for (let arr_0_idx = 0; arr_0_idx < val.length; arr_0_idx++)
            {
                ...
                res = typeof arr_0_item == 'string' && _jm_re_0(arr_0_item, null, null)
                if (! res)
                    break
            }
        }
