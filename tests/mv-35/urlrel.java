...
public class urlrel extends ModelChecker
{
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            jm_is_url_rel_pat = Pattern.compile("^(((https?|oci|s?ftp|rtsps?)://([\\w.-]+(:[^@\\s]*@)?([-\\w.]*|\\[[a-fA-F0-9:.]+\\])(:\\d+)?)?((\\.|\\.\\.)(/\\.\\.)*|[^/?#\\s]+)?(/[^/?#\\s]*)*(\\?[^#\\s]*)?(#\\S*)?|file:((\\.|\\.\\.)(/\\.\\.)*|[^/?#\\s]+)?(/[^/?#\\s]*)*(\\?[^#\\s]*)?(#\\S*)?|(ssh|telnet|mailto):([-+!#$%&'`*/=?^{}|~_a-z0-9]+)(\\.([-+!#$%&'`*/=?^{}|~_a-z0-9]+))*@([a-z0-9][-a-z0-9]{0,62})(\\.([a-z0-9][-a-z0-9]{0,62}))*|urn:[\\w.:-]+)|((\\.|\\.\\.)(/\\.\\.)*|[^/?#\\s]+)?(/[^/?#\\s]*)*(\\?[^#\\s]*)?(#\\S*)?)$");
                super.init(json);
            }
            catch (Exception e) {
