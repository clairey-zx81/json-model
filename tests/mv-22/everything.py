...
def _jm_f_43(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "m0":
            ...
            # .merge.m0
            res = _jm_obj_0(pval, lpath_8 if path is not None else None, rep)
            if not res:
            ...
            if res:
                if "b" in pval:
                    ...
                    if "c" in pval:
                        # .merge.m1.'|'.1
                        res = _jm_obj_1(pval, lpath_8 if path is not None else None, rep)
                        if not res:
...
def _jm_f_45(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    for prop, pval in val.items():
        ...
        if prop == "o0":
            ...
            # .object.o0
            res = _jm_obj_10(pval, lpath_11 if path is not None else None, rep)
            if not res:
            ...
            # .object.o1
            res = _jm_obj_11(pval, lpath_11 if path is not None else None, rep)
            if not res:
...
# check _jm_f_47_map_ETH (.predefs.ETH)
def _jm_f_55(val: Jsonable, path: Path, rep: Report) -> bool:
    # .predefs.ETH
    res: bool = isinstance(val, str) and jm_is_eth(val, path, rep)
    if not res:
        rep is None or rep.append(("unexpected value for model \"$ETH\" [.predefs.ETH]", path))
    return res
