...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    ELSEIF prop = 'm2' THEN
      ...
      -- .merge.m2.'|'.0
      -- .merge.m2.'|'.1
      res := JSONB_TYPEOF(pval) = 'object' AND (_jm_obj_4(pval, NULL, NULL) OR _jm_obj_3(pval, NULL, NULL));
      IF NOT res THEN
        RETURN FALSE;
      END IF;
      CONTINUE;
    ELSEIF prop = 'm3' THEN
      ...
      -- .merge.m3.'|'.2
      -- .merge.m3.'|'.3
      res := JSONB_TYPEOF(pval) = 'object' AND (_jm_obj_8(pval, NULL, NULL) OR _jm_obj_7(pval, NULL, NULL) OR _jm_obj_6(pval, NULL, NULL) OR _jm_obj_5(pval, NULL, NULL));
      IF NOT res THEN
        RETURN FALSE;
      END IF;
      CONTINUE;
...
BEGIN
  ...
  FOR prop, pval IN SELECT * FROM JSONB_EACH(val) LOOP
    ...
    ELSEIF prop = 'o2' THEN
      ...
      -- .or.o2.'|'.2
      -- .or.o2.'|'.3
      res := JSONB_TYPEOF(pval) = 'number' AND (pval)::INT8 = (pval)::FLOAT8 AND (pval)::INT8 >= 0 OR JSONB_TYPEOF(pval) = 'string' AND jm_is_valid_uuid(JSON_VALUE(pval, '$' RETURNING TEXT), NULL, NULL) OR JSONB_TYPEOF(pval) = 'array' OR JSONB_TYPEOF(pval) = 'object';
      IF NOT res THEN
        RETURN FALSE;
      END IF;
      CONTINUE;
...
BEGIN
  -- .predefs.ETH
  RETURN JSONB_TYPEOF(val) = 'string' AND jm_is_eth(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  -- .predefs.HOST
  RETURN JSONB_TYPEOF(val) = 'string' AND jm_is_host(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL) AND LENGTH(JSON_VALUE(val, '$' RETURNING TEXT)) <= 255;
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  -- .predefs.IP4
  RETURN JSONB_TYPEOF(val) = 'string' AND jm_is_ip4(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
BEGIN
  -- .predefs.IP6
  RETURN JSONB_TYPEOF(val) = 'string' AND jm_is_ip6(JSON_VALUE(val, '$' RETURNING TEXT), NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
RETURNS TEXT STRICT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  map JSONB := JSONB '{"ANY":"_jm_f_57","BOOL":"_jm_f_58","BOOLEAN":"_jm_f_59","DATE":"_jm_f_60","DATETIME":"_jm_f_61","DURATION":"_jm_f_62","EMAIL":"_jm_f_63","ETH":"_jm_f_64","EXREG":"_jm_f_65","F32":"_jm_f_66","F64":"_jm_f_67","FLOAT":"_jm_f_68","HOST":"_jm_f_69","I32":"_jm_f_70","I64":"_jm_f_71","INT":"_jm_f_72","INTEGER":"_jm_f_73","IP4":"_jm_f_74","IP6":"_jm_f_75","JSON":"_jm_f_76","JSONPT":"_jm_f_77","NONE":"_jm_f_78","NULL":"_jm_f_79","NUMBER":"_jm_f_80","REGEX":"_jm_f_81","STRING":"_jm_f_82","TIME":"_jm_f_83","U32":"_jm_f_84","U64":"_jm_f_85","URI":"_jm_f_86","URL":"_jm_f_87","UUID":"_jm_f_88"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
...
RETURNS TEXT STRICT IMMUTABLE PARALLEL SAFE AS $$
DECLARE
  map JSONB := JSONB '{"and":"_jm_f_0","array":"_jm_f_1","bool":"_jm_f_2","constraints":"_jm_f_3","enum":"_jm_f_29","float":"_jm_f_30","int":"_jm_f_40","merge":"_jm_f_52","null":"_jm_f_53","object":"_jm_f_54","or":"_jm_f_55","predefs":"_jm_f_56","string":"_jm_f_89","tuple":"_jm_f_90","xor":"_jm_f_91"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
