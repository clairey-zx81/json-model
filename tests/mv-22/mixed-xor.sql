...
BEGIN
  ...
  END IF;
  -- .'|'.2
  RETURN res OR JSONB_TYPEOF(val) = 'boolean' OR json_model_2(val, NULL, NULL);
END;
$$ LANGUAGE PLpgSQL;
...
DECLARE
  map JSONB := JSONB '{"":"json_model_1","cs":"json_model_2"}';
BEGIN
  RETURN map->>name;
END;
$$ LANGUAGE plpgsql;
...
INSERT INTO jm_constant_maps(mapname, tagval, value) VALUES
  ('_jm_map_0', JSONB '"c"', '_jm_obj_0'),
  ('_jm_map_0', JSONB '"s"', '_jm_obj_1')
;
INSERT INTO jm_constant_maps(mapname, tagval, value) VALUES
  ('_jm_map_1', JSONB '"m"', '_jm_obj_2'),
  ('_jm_map_1', JSONB '"h"', '_jm_obj_3')
;
