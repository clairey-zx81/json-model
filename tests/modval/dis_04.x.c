...
static bool _jm_f_0(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected t [$.'|'.5.t]", path);
    }
    return res;
}
...
static bool _jm_f_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected REGEX [$.'|'.5.v]", path);
    }
    return res;
}

static inline check_fun_t _jm_obj_0_must(const char *pname)
{
    return search_propmap(pname, _jm_obj_0_must_tab, 2);
}
...
static bool _jm_obj_0(const json_t* val, Path* path, Report* rep)
{
    ...
    {
        if (rep) report_add_entry(rep, "not an object [$.'|'.5]", path);
        return false;
    }
    check_fun_t pfun;
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_0_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) report_add_entry(rep, "invalid must property value [$.'|'.5]", (path ? &lpath_0 : NULL));
                    return false;
                }
            }
        }
        ...
        {
            if (rep) report_add_entry(rep, "no other prop expected [$.'|'.5]", (path ? &lpath_0 : NULL));
            return false;
        }
    }
    if (must_count != 2)
    {
        if (rep) report_add_entry(rep, "missing must prop [$.'|'.5]", path);
        return false;
    }
    return true;
}
...
static bool _jm_f_2(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected s [$.'|'.4.t]", path);
    }
    return res;
}
...
static bool _jm_f_3(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected string [$.'|'.4.v]", path);
    }
    return res;
}

static inline check_fun_t _jm_obj_1_must(const char *pname)
{
    return search_propmap(pname, _jm_obj_1_must_tab, 2);
}
...
static bool _jm_obj_1(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) report_add_entry(rep, "not an object [$.'|'.4]", path);
        return false;
    }
    check_fun_t pfun;
    int64_t must_count = 0;
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_1_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) report_add_entry(rep, "invalid must property value [$.'|'.4]", (path ? &lpath_1 : NULL));
                    return false;
                }
            }
        }
        ...
        {
            if (rep) report_add_entry(rep, "no other prop expected [$.'|'.4]", (path ? &lpath_1 : NULL));
            return false;
        }
    }
    if (must_count != 2)
    {
        if (rep) report_add_entry(rep, "missing must prop [$.'|'.4]", path);
        return false;
    }
    return true;
}
...
static bool _jm_f_4(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =0.0 [$.'|'.3.t]", path);
    }
    return res;
}
...
static bool _jm_f_5(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "not a 0.0 float [$.'|'.3.v]", path);
    }
    return res;
}

static inline check_fun_t _jm_obj_2_must(const char *pname)
{
    return search_propmap(pname, _jm_obj_2_must_tab, 2);
}
...
static bool _jm_obj_2(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) report_add_entry(rep, "not an object [$.'|'.3]", path);
        return false;
    }
    check_fun_t pfun;
    int64_t must_count = 0;
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_2_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) report_add_entry(rep, "invalid must property value [$.'|'.3]", (path ? &lpath_2 : NULL));
                    return false;
                }
            }
        }
        ...
        {
            if (rep) report_add_entry(rep, "no other prop expected [$.'|'.3]", (path ? &lpath_2 : NULL));
            return false;
        }
    }
    if (must_count != 2)
    {
        if (rep) report_add_entry(rep, "missing must prop [$.'|'.3]", path);
        return false;
    }
    return true;
}
...
static bool _jm_f_6(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =0 [$.'|'.2.t]", path);
    }
    return res;
}
...
static bool _jm_f_7(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "not a 0 int [$.'|'.2.v]", path);
    }
    return res;
}

static inline check_fun_t _jm_obj_3_must(const char *pname)
{
    return search_propmap(pname, _jm_obj_3_must_tab, 2);
}
...
static bool _jm_obj_3(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) report_add_entry(rep, "not an object [$.'|'.2]", path);
        return false;
    }
    check_fun_t pfun;
    int64_t must_count = 0;
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_3_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) report_add_entry(rep, "invalid must property value [$.'|'.2]", (path ? &lpath_3 : NULL));
                    return false;
                }
            }
        }
        ...
        {
            if (rep) report_add_entry(rep, "no other prop expected [$.'|'.2]", (path ? &lpath_3 : NULL));
            return false;
        }
    }
    if (must_count != 2)
    {
        if (rep) report_add_entry(rep, "missing must prop [$.'|'.2]", path);
        return false;
    }
    return true;
}
...
static bool _jm_f_8(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =true [$.'|'.1.t]", path);
    }
    return res;
}
...
static bool _jm_f_9(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "not a bool [$.'|'.1.v]", path);
    }
    return res;
}

static inline check_fun_t _jm_obj_4_must(const char *pname)
{
    return search_propmap(pname, _jm_obj_4_must_tab, 2);
}
...
static bool _jm_obj_4(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) report_add_entry(rep, "not an object [$.'|'.1]", path);
        return false;
    }
    check_fun_t pfun;
    int64_t must_count = 0;
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_4_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) report_add_entry(rep, "invalid must property value [$.'|'.1]", (path ? &lpath_4 : NULL));
                    return false;
                }
            }
        }
        ...
        {
            if (rep) report_add_entry(rep, "no other prop expected [$.'|'.1]", (path ? &lpath_4 : NULL));
            return false;
        }
    }
    if (must_count != 2)
    {
        if (rep) report_add_entry(rep, "missing must prop [$.'|'.1]", path);
        return false;
    }
    return true;
}
...
static bool _jm_f_10(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =null [$.'|'.0.t]", path);
    }
    return res;
}
...
static bool _jm_f_11(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "not null [$.'|'.0.v]", path);
    }
    return res;
}

static inline check_fun_t _jm_obj_5_must(const char *pname)
{
    return search_propmap(pname, _jm_obj_5_must_tab, 2);
}
...
static bool _jm_obj_5(const json_t* val, Path* path, Report* rep)
{
    if (! json_is_object(val))
    {
        if (rep) report_add_entry(rep, "not an object [$.'|'.0]", path);
        return false;
    }
    check_fun_t pfun;
    int64_t must_count = 0;
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_5_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) report_add_entry(rep, "invalid must property value [$.'|'.0]", (path ? &lpath_5 : NULL));
                    return false;
                }
            }
        }
        ...
        {
            if (rep) report_add_entry(rep, "no other prop expected [$.'|'.0]", (path ? &lpath_5 : NULL));
            return false;
        }
    }
    if (must_count != 2)
    {
        if (rep) report_add_entry(rep, "missing must prop [$.'|'.0]", path);
        return false;
    }
    return true;
}
...
static bool json_model_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected type at [$.'|']", path);
    }
    if (res)
    {
        // $.'|'.0
        ...
        if (! res)
        {
            if (rep) report_add_entry(rep, "not an expected object at [$.'|'.0]", path);
        }
        if (! res)
        {
            // $.'|'.1
            ...
            if (! res)
            {
                if (rep) report_add_entry(rep, "not an expected object at [$.'|'.1]", path);
            }
            if (! res)
            {
                // $.'|'.2
                ...
                if (! res)
                {
                    if (rep) report_add_entry(rep, "not an expected object at [$.'|'.2]", path);
                }
                if (! res)
                {
                    // $.'|'.3
                    ...
                    if (! res)
                    {
                        if (rep) report_add_entry(rep, "not an expected object at [$.'|'.3]", path);
                    }
                    if (! res)
                    {
                        // $.'|'.4
                        ...
                        if (! res)
                        {
                            if (rep) report_add_entry(rep, "not an expected object at [$.'|'.4]", path);
                        }
                        if (! res)
                        {
                            // $.'|'.5
                            ...
                            if (! res)
                            {
                                if (rep) report_add_entry(rep, "not an expected object at [$.'|'.5]", path);
                            }
                        }
                    }
                }
        ...
        if (! res)
        {
            if (rep) report_add_entry(rep, "no model matched [$.'|']", path);
        }
    }
    return res;
}
