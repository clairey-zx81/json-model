...
static bool _jm_f_0(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected string [$.'|'.0.pi]", path);
    }
    return res;
}

// check _jm_obj_0_must_t ($.'|'.0.t)
static bool _jm_f_1(const json_t* val, Path* path, Report* rep)
{
    bool res;
    // $.'|'.0.t
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =3.1415927 [$.'|'.0.t]", path);
    }
    return res;
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_0_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) report_add_entry(rep, "invalid must property value [$.'|'.0]", (path ? &lpath_0 : NULL));
                    return false;
                }
            }
        }
        ...
        {
            if (rep) report_add_entry(rep, "no other prop expected [$.'|'.0]", (path ? &lpath_0 : NULL));
            return false;
        }
    }
    if (must_count != 2)
...
// check _jm_obj_1_must_one ($.'|'.1.one)
static bool _jm_f_2(const json_t* val, Path* path, Report* rep)
{
    bool res;
    // $.'|'.1.one
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected string [$.'|'.1.one]", path);
    }
    return res;
}

// check _jm_obj_1_must_t ($.'|'.1.t)
static bool _jm_f_3(const json_t* val, Path* path, Report* rep)
{
    bool res;
    // $.'|'.1.t
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =1.0 [$.'|'.1.t]", path);
    }
    return res;
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_1_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) report_add_entry(rep, "invalid must property value [$.'|'.1]", (path ? &lpath_1 : NULL));
                    return false;
                }
            }
        }
        ...
        {
            if (rep) report_add_entry(rep, "no other prop expected [$.'|'.1]", (path ? &lpath_1 : NULL));
            return false;
        }
    }
    if (must_count != 2)
...
// check _jm_obj_2_must_half ($.'|'.2.half)
static bool _jm_f_4(const json_t* val, Path* path, Report* rep)
{
    bool res;
    // $.'|'.2.half
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected string [$.'|'.2.half]", path);
    }
    return res;
}

// check _jm_obj_2_must_t ($.'|'.2.t)
static bool _jm_f_5(const json_t* val, Path* path, Report* rep)
{
    bool res;
    // $.'|'.2.t
    res = json_is_real(val) && json_real_value(val) == 0.5;
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =0.5 [$.'|'.2.t]", path);
    }
    return res;
}
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_2_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) report_add_entry(rep, "invalid must property value [$.'|'.2]", (path ? &lpath_2 : NULL));
                    return false;
                }
            }
        }
        ...
        {
            if (rep) report_add_entry(rep, "no other prop expected [$.'|'.2]", (path ? &lpath_2 : NULL));
            return false;
        }
    }
    if (must_count != 2)
...
static check_fun_t _jm_map_0(json_t *val)
{
    constant_t cst;
    set_cst(&cst, val);
    return search_constmap(&cst, _jm_map_0_tab, 3);
}
...
static bool json_model_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        if (tag_0 != NULL)
        {
            ...
            {
                res = false;
                if (rep) report_add_entry(rep, "tag t value not found [$.'|']", path);
            }
        }
        else
        {
            res = false;
            if (rep) report_add_entry(rep, "tag prop t is missing [$.'|']", path);
        }
    }
    else
    {
        if (rep) report_add_entry(rep, "value is not an object [$.'|']", path);
    }
    return res;
}
...
char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_obj_0_must_tab[0] = (propmap_t) { "pi", _jm_f_0 };
        _jm_obj_0_must_tab[1] = (propmap_t) { "t", _jm_f_1 };
        sort_propmap(_jm_obj_0_must_tab, 2);
        _jm_obj_1_must_tab[0] = (propmap_t) { "one", _jm_f_2 };
        _jm_obj_1_must_tab[1] = (propmap_t) { "t", _jm_f_3 };
        sort_propmap(_jm_obj_1_must_tab, 2);
        _jm_obj_2_must_tab[0] = (propmap_t) { "half", _jm_f_4 };
        _jm_obj_2_must_tab[1] = (propmap_t) { "t", _jm_f_5 };
        sort_propmap(_jm_obj_2_must_tab, 2);
        _jm_map_0_tab[0] = (constmap_t) { (constant_t) { cst_is_float, { .f = 3.1415927 } }, _jm_obj_0 };
        _jm_map_0_tab[1] = (constmap_t) { (constant_t) { cst_is_float, { .f = 1.0 } }, _jm_obj_1 };
        _jm_map_0_tab[2] = (constmap_t) { (constant_t) { cst_is_float, { .f = 0.5 } }, _jm_obj_2 };
        sort_constmap(_jm_map_0_tab, 3);
