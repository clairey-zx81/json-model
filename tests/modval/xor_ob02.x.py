...
def _jm_f_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not a 0 strict int [$.'$A'.'|'.1.b]", path))
    return res
        ...
        if pfun := _jm_obj_0_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_0 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$A'.'|'.1]", lpath_0 if path is not None else None))
                    return False
        else:
...
def _jm_f_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 0
    if not res:
        rep is None or rep.append(("not a 0 strict int [$.'$A'.'|'.0.a]", path))
    return res
        ...
        if pfun := _jm_obj_1_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_1 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$A'.'|'.0]", lpath_1 if path is not None else None))
                    return False
        else:
...
def _jm_f_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 0
    if not res:
        rep is None or rep.append(("not a 0 strict int [$.'$B'.'|'.1.c]", path))
    return res
        ...
        if pfun := _jm_obj_2_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_2 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$B'.'|'.1]", lpath_2 if path is not None else None))
                    return False
        else:
        ...
        if pfun := _jm_obj_3_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_3 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$B'.'|'.0]", lpath_3 if path is not None else None))
                    return False
        else:
        ...
        if pfun := _jm_obj_4_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_4 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$C'.'|'.1]", lpath_4 if path is not None else None))
                    return False
        else:
...
def _jm_f_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 0
    if not res:
        rep is None or rep.append(("not a 0 strict int [$.'$C'.'|'.0.b]", path))
    return res
        ...
        if pfun := _jm_obj_5_must.get(prop):
            ...
            if pfun != UNDEFINED:
                ...
                if not pfun(pval, lpath_5 if path is not None else None, rep):
                    rep is None or rep.append(("invalid must property value [$.'$C'.'|'.0]", lpath_5 if path is not None else None))
                    return False
        else:
