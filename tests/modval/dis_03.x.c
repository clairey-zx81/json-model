...
static bool _jm_f_0(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =true [$.'|'.0.discriminator]", path);
    }
    return res;
}
...
static bool _jm_f_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected string [$.'|'.0.x]", path);
    }
    return res;
}
...
static bool _jm_f_2(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =false [$.'|'.1.discriminator]", path);
    }
    return res;
}
...
static bool _jm_f_3(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected string [$.'|'.1.y]", path);
    }
    return res;
}
...
static check_fun_t _jm_map_0(json_t *val)
{
    constant_t cst;
    set_cst(&cst, val);
    return search_constmap(&cst, _jm_map_0_tab, 2);
}
...
static bool json_model_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        if (tag_0 != NULL)
        {
            ...
            {
                res = false;
                if (rep) report_add_entry(rep, "tag discriminator value not found [$.'|']", path);
            }
        }
        else
        {
            res = false;
            if (rep) report_add_entry(rep, "tag prop discriminator is missing [$.'|']", path);
        }
    }
    else
    {
