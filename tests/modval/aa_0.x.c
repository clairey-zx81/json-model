        ...
        json_array_foreach(val, arr_0_idx, arr_0_item)
        {
            ...
            if (res)
            {
                ...
                json_array_foreach(arr_0_item, arr_1_idx, arr_1_item)
                {
                    ...
                    if (! res)
                    {
                        if (rep) report_add_entry(rep, "unexpected string [$.0.0]", ((path ? &arr_0_lpath : NULL) ? &arr_1_lpath : NULL));
                    }
                    if (! res)
                    {
                        break;
            ...
            if (! res)
            {
                if (rep) report_add_entry(rep, "not array or unexpected array [$.0]", (path ? &arr_0_lpath : NULL));
            }
            if (! res)
            {
                break;
