...
static bool _jm_f_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =18 [$.'|'.0.tag]", path);
    }
    return res;
}
...
static bool _jm_f_3(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =42 [$.'|'.1.tag]", path);
    }
    return res;
}
...
static bool _jm_f_5(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected =1024 [$.'|'.2.tag]", path);
    }
    return res;
}
