...
def _jm_f_0(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not a 1 int [$.'|'.5.a]", path))
    return res
...
def _jm_f_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("not a 0 int [$.'|'.5.c]", path))
    return res
...
def _jm_f_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 1
    if not res:
        rep is None or rep.append(("not a 1 int [$.'|'.4.a]", path))
    return res
...
def _jm_f_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 0
    if not res:
        rep is None or rep.append(("not a 0 int [$.'|'.4.c]", path))
    return res
...
def _jm_f_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 1
    if not res:
        rep is None or rep.append(("not a 1 int [$.'|'.3.a]", path))
    return res
...
def _jm_f_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 0
    if not res:
        rep is None or rep.append(("not a 0 int [$.'|'.3.c]", path))
    return res
...
def _jm_f_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 1
    if not res:
        rep is None or rep.append(("not a 1 int [$.'|'.2.a]", path))
    return res
...
def _jm_f_10(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 0
    if not res:
        rep is None or rep.append(("not a 0 int [$.'|'.2.b]", path))
    return res
...
def _jm_f_12(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 1
    if not res:
        rep is None or rep.append(("not a 1 int [$.'|'.1.a]", path))
    return res
...
def _jm_f_15(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 1
    if not res:
        rep is None or rep.append(("not a 1 int [$.'|'.0.a]", path))
    return res
...
def _jm_f_16(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res = isinstance(val, int) and not isinstance(val, bool) and val >= 0
    if not res:
        rep is None or rep.append(("not a 0 int [$.'|'.0.b]", path))
    return res
