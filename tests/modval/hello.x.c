...
static bool _jm_f_0(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "not a 0 int [$.hello]", path);
    }
    return res;
}
...
static bool _jm_f_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "not a bool [$.world]", path);
    }
    return res;
}
...
static bool _jm_obj_0(const json_t* val, Path* path, Report* rep)
{
    ...
    {
        if (rep) report_add_entry(rep, "not an object [$]", path);
        return false;
    }
    check_fun_t pfun;
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if ((pfun = _jm_obj_0_must(prop)))
        {
            ...
            if (pfun != NULL)
            {
                ...
                {
                    if (rep) report_add_entry(rep, "invalid must property value [$]", (path ? &lpath_0 : NULL));
                    return false;
                }
            }
        }
        ...
        {
            if (rep) report_add_entry(rep, "no other prop expected [$]", (path ? &lpath_0 : NULL));
            return false;
        }
    }
    if (must_count != 2)
    {
        if (rep) report_add_entry(rep, "missing must prop [$]", path);
        return false;
    }
    return true;
}
...
static bool json_model_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "not an expected object at [$]", path);
    }
    return res;
}
...
char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_obj_0_must_tab[0] = (propmap_t) { "hello", _jm_f_0 };
        _jm_obj_0_must_tab[1] = (propmap_t) { "world", _jm_f_1 };
