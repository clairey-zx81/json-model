...
static bool _jm_f_0(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected string [$.'|'.0.a]", path);
    }
    return res;
}
...
static bool _jm_f_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected a [$.'|'.0.tag]", path);
    }
    return res;
}
...
static bool _jm_f_2(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected string [$.'|'.1.b]", path);
    }
    return res;
}
...
static bool _jm_f_3(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected b [$.'|'.1.tag]", path);
    }
    return res;
}
...
static bool _jm_f_4(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected string [$.'|'.2.c]", path);
    }
    return res;
}
...
static bool _jm_f_5(const json_t* val, Path* path, Report* rep)
{
    bool res;
    // $.'|'.2.tag
    res = json_is_string(val) && strcmp(json_string_value(val), "c") == 0;
    if (! res)
    {
        if (rep) report_add_entry(rep, "unexpected c [$.'|'.2.tag]", path);
    }
    return res;
}
...
static bool json_model_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (res)
    {
        ...
        if (tag_0 != NULL)
        {
            ...
            {
                res = false;
                if (rep) report_add_entry(rep, "tag tag value not found [$.'|']", path);
            }
        }
        else
        {
            res = false;
            if (rep) report_add_entry(rep, "tag prop tag is missing [$.'|']", path);
        }
    }
    else
    {
...
char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_map_0_tab[0] = (constmap_t) { (constant_t) { cst_is_string, { .s = "a" } }, _jm_obj_0 };
        _jm_map_0_tab[1] = (constmap_t) { (constant_t) { cst_is_string, { .s = "b" } }, _jm_obj_1 };
        _jm_map_0_tab[2] = (constmap_t) { (constant_t) { cst_is_string, { .s = "c" } }, _jm_obj_2 };
