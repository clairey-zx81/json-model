# Generated for model: ./obj01.model.json
#
...
# define "json_model_0_must_foo" ($.foo)
...
# define "json_model_0_may_bla" ($.bla)
    ...
    for prop, val in value.items():
        ...
        if prop in json_model_0_must:  # must
            ...
            if not json_model_0_may[prop](val, lpath, rep):
                ...
                return False
        elif json_model_1(prop, path, rep) or _rep(f"prop {prop} does not match $XXX at {path}", rep):  # $XXX
            # $.'$XXX'
