...
static bool _jm_f_1(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected $NONE [$.'|'.1.a]", path);
    }
    return res;
}
...
static bool _jm_obj_0(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if ((pfun = _jm_obj_0_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'|'.1]", (path ? &lpath_0 : NULL));
                return false;
            }
        }
        else
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "not a 0 int [$.'|'.1.'']", (path ? &lpath_0 : NULL));
            }
            if (! res)
            {
                return false;
...
static bool _jm_f_3(const json_t* val, Path* path, Report* rep)
{
    ...
    if (! res)
    {
        if (rep) jm_report_add_entry(rep, "unexpected $NONE [$.'|'.0.b]", path);
    }
    return res;
}
...
static bool _jm_obj_1(const json_t* val, Path* path, Report* rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        else if ((pfun = _jm_obj_1_may(prop)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "invalid may property value [$.'|'.0]", (path ? &lpath_1 : NULL));
                return false;
            }
        }
        else
        {
            ...
            if (! res)
            {
                if (rep) jm_report_add_entry(rep, "not a 0 int [$.'|'.0.'']", (path ? &lpath_1 : NULL));
            }
            if (! res)
            {
                return false;
