...
public class json_schema_draft_03 extends ModelChecker
{
    ...
    public boolean json_model_3(Object val, Path path, Report rep)
    {
        ...
        if (res)
        {
            ...
            while (arr_0_item_loop.hasNext())
            {
                ...
                if (! res)
                {
                    if (rep != null) rep.addEntry("unexpected value for model \"\" [.'$distinctSchemaArray'.'@'.0.'|'.0]", (path != null ? arr_0_lpath : null));
                    // .'$distinctSchemaArray'.'@'.0.'|'.1
                    res = json_model_1(arr_0_item, (path != null ? arr_0_lpath : null), rep);
                    if (! res)
                    {
                        if (rep != null) rep.addEntry("unexpected value for model \"$Schema\" [.'$distinctSchemaArray'.'@'.0.'|'.1]", (path != null ? arr_0_lpath : null));
                    }
                }
                if (res)
                {
    ...
    public boolean _jm_f_5(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (! res)
            {
                if (rep != null) rep.addEntry("unexpected value for model \"\" [.dependencies.''.'|'.0]", (path != null ? lpath_1 : null));
                // .dependencies.''.'|'.1
                ...
                if (res)
                {
                    ...
                    while (arr_1_item_loop.hasNext())
                    {
                        ...
                        if (! res)
                        {
                            if (rep != null) rep.addEntry("unexpected value for model \"\" [.dependencies.''.'|'.1.0]", ((path != null ? lpath_1 : null) != null ? arr_1_lpath : null));
                            break;
                        }
                    }
                }
                if (! res)
                {
                    ...
                    if (! res)
                    {
                        if (rep != null) rep.addEntry("unexpected value for model \"$Schema\" [.dependencies.''.'|'.2]", (path != null ? lpath_1 : null));
                    }
                }
            }
            if (res)
    ...
    public boolean _jm_f_7(Object val, Path path, Report rep)
    {
        ...
        if (! res)
        {
            ...
            if (! res)
            {
                if (rep != null) rep.addEntry("unexpected value for model \"$distinctSchemaArray\" [.disallow.'|'.1]", path);
            }
        }
        if (res)
        {
        ...
        if (! res)
        {
            ...
            if (res)
            {
                ...
                while (arr_2_item_loop.hasNext())
                {
                    ...
                    if (! res)
                    {
                        if (rep != null) rep.addEntry("unexpected value for model \"$Schema\" [.extends.'|'.1.0]", (path != null ? arr_2_lpath : null));
                        break;
                    }
                }
            }
        ...
        if (! res)
        {
            ...
            if (res)
            {
                ...
                while (arr_3_item_loop.hasNext())
                {
                    ...
                    if (! res)
                    {
                        if (rep != null) rep.addEntry("unexpected value for model \"$Schema\" [.items.'|'.1.0]", (path != null ? arr_3_lpath : null));
                        break;
                    }
                }
            }
    ...
    public boolean _jm_f_23(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (! res)
            {
                if (rep != null) rep.addEntry("unexpected value for model \"$Schema\" [.patternProperties.'']", (path != null ? lpath_2 : null));
                return false;
            }
        }
        return true;
    ...
    public boolean _jm_f_24(Object val, Path path, Report rep)
    {
        ...
        while (prop_loop.hasNext())
        {
            ...
            if (! res)
            {
                if (rep != null) rep.addEntry("unexpected value for model \"$Schema\" [.properties.'']", (path != null ? lpath_3 : null));
                return false;
            }
        }
        return true;
        ...
        if (! res)
        {
            ...
            if (res)
            {
                ...
                while (arr_4_item_loop.hasNext())
                {
                    ...
                    if (! res)
                    {
                        if (rep != null) rep.addEntry("unexpected value for model \"\" [.type.'|'.1.0.'|'.0]", (path != null ? arr_4_lpath : null));
                        // .type.'|'.1.0.'|'.1
                        res = json_model_1(arr_4_item, (path != null ? arr_4_lpath : null), rep);
                        if (! res)
                        {
                            if (rep != null) rep.addEntry("unexpected value for model \"$Schema\" [.type.'|'.1.0.'|'.1]", (path != null ? arr_4_lpath : null));
                        }
                    }
                    if (res)
                    {
