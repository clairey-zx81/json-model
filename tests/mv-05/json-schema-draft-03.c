...
static bool _jm_f_27(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    bool res;
    // .type
    res = jm_json_is_scalar(val) && json_is_string(val) && jm_search_cst(&(jm_constant_t) { cst_is_string, { .s = json_string_value(val) } }, _jm_cst_2, 8);;
    if (! res)
    {
    ...
    if (! res)
    {
        ...
        if (res)
        {
            ...
            json_array_foreach(val, arr_4_idx, arr_4_item)
            {
                ...
                if (! res)
                {
                    if (rep) jm_report_add_entry(rep, "unexpected string [.type.'|'.0.0.'|'.0]", (path ? &arr_4_lpath : NULL));
                }
                if (! res)
                {
                    // .type.'|'.0.0.'|'.1
                    ...
                    if (! res)
                    {
                        if (rep) jm_report_add_entry(rep, "unexpected $Schema [.type.'|'.0.0.'|'.1]", (path ? &arr_4_lpath : NULL));
                    }
                }
                if (res)
                {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "no model matched [.type.'|'.0.0.'|']", (path ? &arr_4_lpath : NULL));
                }
                if (! res)
                {
                    break;
...
const char *check_model_init(void)
{
    if (!initialized)
    {
        ...
        _jm_cst_2[3] = (jm_constant_t) { cst_is_string, { .s = "number" } };
        _jm_cst_2[4] = (jm_constant_t) { cst_is_string, { .s = "string" } };
        _jm_cst_2[5] = (jm_constant_t) { cst_is_string, { .s = "array" } };
        _jm_cst_2[6] = (jm_constant_t) { cst_is_string, { .s = "object" } };
        _jm_cst_2[7] = (jm_constant_t) { cst_is_string, { .s = "any" } };
