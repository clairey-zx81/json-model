...
def _jm_f_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        ...
        if not res:
            rep is None or rep.append(("unexpected value for model \"$distinctStringArray\" [.'$schema'.disallow.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
    ...
    if not res:
        ...
        if res:
            for arr_0_idx, arr_0_item in enumerate(val):
                ...
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$schema'.extends.'|'.1.0]", arr_0_lpath if path is not None else None))
                    break
        if not res:
    ...
    if not res:
        ...
        if res:
            for arr_1_idx, arr_1_item in enumerate(val):
                ...
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$schema'.items.'|'.1.0]", arr_1_lpath if path is not None else None))
                    break
        if not res:
    ...
    if not res:
        ...
        if res:
            for arr_2_idx, arr_2_item in enumerate(val):
                ...
                if not res:
                    rep is None or rep.append(("unexpected value for model \"\" [.'$schema'.type.'|'.1.0.'|'.0]", arr_2_lpath if path is not None else None))
                    # .'$schema'.type.'|'.1.0.'|'.1
                    res = json_model_3(arr_2_item, arr_2_lpath if path is not None else None, rep)
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"$Schema\" [.'$schema'.type.'|'.1.0.'|'.1]", arr_2_lpath if path is not None else None))
                if res:
                    rep is None or rep.clear()
                else:
                    rep is None or rep.append(("no model matched [.'$schema'.type.'|'.1.0.'|']", arr_2_lpath if path is not None else None))
                    break
        if not res:
...
def json_model_5(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if res:
        for arr_3_idx, arr_3_item in enumerate(val):
            ...
            if not res:
                rep is None or rep.append(("unexpected value for model \"\" [.'$schema#distinctStringArray'.'@'.0]", arr_3_lpath if path is not None else None))
                break
    if res:
        ...
        rep is None or rep.append(("not array or unexpected array [.'$schema#distinctStringArray'.'@']", path))
    return res
