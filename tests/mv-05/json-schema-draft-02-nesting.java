...
public class json_schema_draft_02_nesting extends ModelChecker
{
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            json_schema_draft_02_nesting_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_0(o, p, r);} });
            json_schema_draft_02_nesting_map_pmap.put("schema", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_0(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
