...
public class json_schema_draft_01 extends ModelChecker
{
        ...
        if (! res)
        {
            ...
            if (res)
            {
                ...
                while (arr_0_item_loop.hasNext())
                {
                    ...
                    if (! res)
                    {
                        if (rep != null) rep.addEntry("unexpected value for model \"\" [.disallow.'|'.1.0]", (path != null ? arr_0_lpath : null));
                        break;
                    }
                }
            }
            if (! res)
            {
                if (rep != null) rep.addEntry("not array or unexpected array [.disallow.'|'.1]", path);
            }
        }
        if (res)
        {
    ...
    public boolean _jm_f_11(Object val, Path path, Report rep)
    {
        ...
        if (! res)
        {
            if (rep != null) rep.addEntry("not a 0 strict int [.maxDecimal]", path);
        }
        return res;
    }
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            json_model_1_map_pmap.put("enum", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_f_6(o, p, r);} });
            json_model_1_map_pmap.put("extends", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_f_7(o, p, r);} });
            json_model_1_map_pmap.put("format", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_f_8(o, p, r);} });
            json_model_1_map_pmap.put("id", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_f_9(o, p, r);} });
            json_model_1_map_pmap.put("items", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_f_10(o, p, r);} });
            json_model_1_map_pmap.put("maxDecimal", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_f_11(o, p, r);} });
            ...
            json_schema_draft_01_map_pmap = new HashMap<String, Checker>();
            json_schema_draft_01_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
            json_schema_draft_01_map_pmap.put("allTypes", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_2(o, p, r);} });
            json_schema_draft_01_map_pmap.put("Schema", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    {
        return json_schema_draft_01_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return json_schema_draft_01_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new json_schema_draft_01();
        Main.main("json_schema_draft_01", checker, VERSION, args);
    }
}
