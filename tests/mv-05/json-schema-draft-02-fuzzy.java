...
public class json_schema_draft_02_fuzzy extends ModelChecker
{
            ...
            if (! res)
            {
                ...
                if (res)
                {
                    ...
                    while (arr_2_item_loop.hasNext())
                    {
                        ...
                        // .'$schema'.extends.'|'.1.0
                        res = _jm_obj_0(arr_2_item, ((path != null ? lpath : null) != null ? arr_2_lpath : null), rep);
                        if (! res)
                        {
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            json_schema_draft_02_fuzzy_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_0(o, p, r);} });
            json_schema_draft_02_fuzzy_map_pmap.put("schema", new Checker() { public boolean call(Object o, Path p, Report r) { return _jm_obj_0(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
