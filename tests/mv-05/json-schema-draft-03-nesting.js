...
function _jm_obj_2(val, path, rep)
{
    ...
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (! res)
        {
            rep !== null && rep.push(["unexpected string [.'$schema'.dependencies.''.'|'.0]", (path ? lpath_3 : null)])
        }
        if (! res)
        {
            ...
            if (res)
            {
                for (let arr_2_idx = 0; arr_2_idx < pval.length; arr_2_idx++)
                {
                    ...
                    if (! res)
                    {
                        rep !== null && rep.push(["unexpected string [.'$schema'.dependencies.''.'|'.1.0]", ((path ? lpath_3 : null) ? arr_2_lpath : null)])
                        break;
                    }
                }
            }
            if (! res)
            {
                rep !== null && rep.push(["not array or unexpected array [.'$schema'.dependencies.''.'|'.1]", (path ? lpath_3 : null)])
            }
            if (! res)
            {
                ...
                if (! res)
                {
                    rep !== null && rep.push(["unexpected $Schema [.'$schema'.dependencies.''.'|'.2]", (path ? lpath_3 : null)])
                }
            }
        }
        if (res)
