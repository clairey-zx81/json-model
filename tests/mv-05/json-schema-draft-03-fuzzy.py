        ...
        if not res:
            ...
            if res:
                for arr_3_idx, arr_3_item in enumerate(pval):
                    ...
                    # .'$schema'.extends.'|'.1.0
                    res = _jm_obj_0(arr_3_item, arr_3_lpath if (lpath if path is not None else None) is not None else None, rep)
                    if not res:
    ...
    if res:
        for arr_4_idx, arr_4_item in enumerate(val):
            ...
            if not res:
                ...
                res = _jm_obj_0(arr_4_item, arr_4_lpath if path is not None else None, rep)
                if not res:
