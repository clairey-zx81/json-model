...
function json_model_3(val, path, rep)
{
    ...
    if (res)
    {
        for (let arr_0_idx = 0; arr_0_idx < val.length; arr_0_idx++)
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["unexpected value for model \"\" [.'$distinctStringArray'.'@'.0]", (path ? arr_0_lpath : null)])
                break
            }
        }
    }
...
function _jm_f_5(val, path, rep)
{
    ...
    if (! res)
    {
        ...
        if (! res)
            rep !== null && rep.push(["unexpected value for model \"$distinctStringArray\" [.disallow.'|'.1]", path])
    }
    if (res)
    {
        if (rep !== null) rep.length = 0
...
export function check_model_init()
{
    if (! initialized)
    {
        ...
        json_model_1_map.set("divisibleBy", _jm_f_6)
        json_model_1_map.set("enum", _jm_f_7)
        json_model_1_map.set("extends", _jm_f_8)
        json_model_1_map.set("format", _jm_f_9)
        json_model_1_map.set("id", _jm_f_10)
        json_model_1_map.set("items", _jm_f_11)
        ...
        json_model_1_map.set("uniqueItems", _jm_f_26)
