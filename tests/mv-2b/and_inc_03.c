...
static bool json_model_1(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        {
            res = json_is_string(pval) && _jm_re_1(json_string_value(pval), NULL, NULL) && _jm_re_0(json_string_value(pval), NULL, NULL);
            if (unlikely(! res))
                return false;
            continue;
        }
        ...
        {
            res = json_is_string(pval) && _jm_re_3(json_string_value(pval), NULL, NULL) && _jm_re_2(json_string_value(pval), NULL, NULL);
            if (unlikely(! res))
                return false;
            continue;
        }
