...
{
    // .
    bool res = json_is_string(val) && jm_str_eq_8(json_string_value(val), 0x6e61206569737553LL) && jm_str_eq_8(json_string_value(val) + 8, 0x6e69766c61432064LL) && jm_str_eq_0(json_string_value(val) + 16);
    if (unlikely(! res))
    {
