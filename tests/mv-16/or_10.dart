...
bool _jm_obj_0(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    {
        rep?.add(["missing mandatory prop <name> [.'|'.1]", path]);
        return false;
    }
    ...
    if (! res)
    {
        rep?.add(["unexpected string [.'|'.1.name]", (path != null ? lpath : null)]);
        rep?.add(["unexpected value for mandatory prop <name> [.'|'.1]", (path != null ? lpath : null)]);
        return false;
    }
    return true;
}
...
bool _jm_obj_1(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    {
        rep?.add(["expecting empty object [.'|'.0]", path]);
        return false;
    }
}
