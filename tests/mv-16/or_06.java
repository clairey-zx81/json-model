...
public class or_06 extends ModelChecker
{
    static public final String VERSION = "2";

    public Pattern _jm_re_0_pat = null;
    public Map<String, Checker> or_06_map_pmap;
    ...
    public void init(JSON json)
    {
        if (!initialized)
        {
            ...
            or_06_map_pmap = new HashMap<String, Checker>();
            or_06_map_pmap.put("", new Checker() { public boolean call(Object o, Path p, Report r) { return json_model_1(o, p, r);} });
                super.init(json);
            }
            catch (Exception e) {
    ...
    {
        return or_06_map_pmap.get(name);
    }

    public Set<String> models()
    {
        return or_06_map_pmap.keySet();
    }

    static public void main(String[] args) throws Exception
    {
        ModelChecker checker = new or_06();
        Main.main("or_06", checker, VERSION, args);
    }
}
