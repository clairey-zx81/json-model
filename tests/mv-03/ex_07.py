...
def json_model_4(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Ex05a\" [.'$ex5'.'|'.0]", path))
        # .'$ex5'.'|'.1
        res = json_model_6(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Ex05b\" [.'$ex5'.'|'.1]", path))
    if res:
...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"/[a-z]/\" [.'$Ex07']", path))
    return res
...
def json_model_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Ex05a\" [.'$__external_0'.'|'.0]", path))
        # .'$__external_0'.'|'.1
        res = json_model_9(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Ex05b\" [.'$__external_0'.'|'.1]", path))
    if res:
        rep is None or rep.clear()
    else:
    ...
    if res:
        ...
        if res:
            ...
            if res:
                ...
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Ex07\" [.2]", lpath_0 if path is not None else None))
            else:
                rep is None or rep.append(("unexpected value for model \"$__external_0#Ex05b\" [.1]", lpath_0 if path is not None else None))
        else:
            rep is None or rep.append(("unexpected value for model \"$ex5#Ex05a\" [.0]", lpath_0 if path is not None else None))
    if not res:
...
def json_model_6(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$ex5#Ex05b']", path))
    return res
...
def json_model_9(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str)
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$__external_0#Ex05b']", path))
    return res
