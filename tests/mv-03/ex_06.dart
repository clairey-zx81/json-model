...
bool json_model_1(dynamic val, List<dynamic>? path, List<dynamic>? rep)
{
    ...
    if (res)
    {
        ...
        if (res)
        {
            ...
            // .1
            res = json_model_6(val[1], (path != null ? lpath_0 : null), rep);
            if (res)
            {
                ...
                if (! res)
                {
                    rep?.add(["unexpected \$Ex06 [.2]", (path != null ? lpath_0 : null)]);
                }
            }
            else
            {
                rep?.add(["unexpected \$ex5#Ex05b [.1]", (path != null ? lpath_0 : null)]);
            }
        }
        else
        {
...
void check_model_init() {
  if (!GlobalState.initializer){
    GlobalState.initializer = true;
        ...
        check_model_map["Ex06"] = json_model_3;
}
