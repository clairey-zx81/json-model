...
def json_model_7(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str) and val == "Susie"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_Susie\" [.'$x3']", path))
    return res
...
def json_model_8(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    res: bool = isinstance(val, str) and val == "Susie"
    if not res:
        rep is None or rep.append(("unexpected value for model \"_Susie\" [.'$__external_0']", path))
    return res
        ...
        if res:
            ...
            if res:
                ...
                if res:
                    ...
                    if not res:
                        rep is None or rep.append(("unexpected value for model \"_Susie\" [.3]", lpath_0 if path is not None else None))
                else:
                    rep is None or rep.append(("unexpected value for model \"_Susie\" [.2]", lpath_0 if path is not None else None))
            else:
                rep is None or rep.append(("unexpected value for model \"_Susie\" [.1]", lpath_0 if path is not None else None))
        else:
            rep is None or rep.append(("unexpected value for model \"_Susie\" [.0]", lpath_0 if path is not None else None))
    if not res:
