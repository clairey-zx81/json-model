...
function _jm_obj_1(val, path, rep)
{
    if (! (Object.prototype.toString.call(val) === '[object Object]'))
    {
        rep !== null && rep.push(["not an object [.'$ex08#EX08'.'|'.0]", path])
        return false;
    }
    let res;
    for (const [prop, pval] of Object.entries(val))
    {
        ...
        if (runtime.jm_is_valid_url(prop))
        {
            ...
            if (! res)
            {
                rep !== null && rep.push(["unexpected $VAL [.'$ex08#EX08'.'|'.0.'$URL']", (path ? lpath_1 : null)])
            }
            if (! res)
            {
                return false;
        ...
        {
            rep !== null && rep.push(["unexpected prop [.'$ex08#EX08'.'|'.0]", (path ? lpath_1 : null)])
            return false;
        }
    }
    return true;
...
function json_model_9(val, path, rep)
{
    ...
    if (! res)
    {
        rep !== null && rep.push(["unexpected element [.'$ex08#EX08'.'|'.0]", path])
    }
    if (! res)
    {
        // .'$ex08#EX08'.'|'.1
