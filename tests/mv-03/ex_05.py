...
def json_model_3(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"\" [.'$Ex05b']", path))
    return res
...
def json_model_1(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if not res:
        rep is None or rep.append(("unexpected value for model \"$Ex05a\" [.'|'.0]", path))
        # .'|'.1
        res = json_model_3(val, path, rep)
        if not res:
            rep is None or rep.append(("unexpected value for model \"$Ex05b\" [.'|'.1]", path))
    if res:
