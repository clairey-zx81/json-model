    ...
    if res:
        ...
        if res:
            ...
            if res:
                ...
                if not res:
                    rep is None or rep.append(("unexpected value for model \"$Ex06\" [.2]", lpath_0 if path is not None else None))
            else:
                rep is None or rep.append(("unexpected value for model \"$ex5#Ex05b\" [.1]", lpath_0 if path is not None else None))
        else:
