...
{
    // .'$x1'
    let res = typeof val == 'string' && val == "Susie"
    if (! res)
...
function json_model_1(val, path, rep)
{
    ...
    if (res)
    {
        ...
        // .0
        res = typeof val[0] == 'string' && val[0] == "Susie"
        if (res)
        {
            lpath_0 = path ? path.concat([1]) : null
            // .1
            res = typeof val[1] == 'string' && val[1] == "Susie"
            if (res)
            {
                lpath_0 = path ? path.concat([2]) : null
                // .2
                res = typeof val[2] == 'string' && val[2] == "Susie"
                if (res)
                {
                    lpath_0 = path ? path.concat([3]) : null
                    // .3
                    res = typeof val[3] == 'string' && val[3] == "Susie"
                    if (! res)
