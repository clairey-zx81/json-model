...
sub json_model_1($$$)
{
    ...
    unless ($res)
    {
        push @$rep, ["unexpected value for model \"_Susie\" [.a]", defined $path ? $lpath : undef] if defined $rep;
    ...
    unless ($res)
    {
        push @$rep, ["unexpected value for model \"_Susie\" [.b]", defined $path ? $lpath : undef] if defined $rep;
