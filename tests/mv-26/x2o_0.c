...
static INLINE bool _jm_obj_0(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (likely(jm_str_eq_2(prop, 0x00000074)))
        {
            ...
            if (unlikely(! res))
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"a\" [.'|'.0.t]", (path ? &lpath_0 : NULL));
...
static INLINE bool _jm_obj_2(const json_t *val, jm_path_t *path, jm_report_t *rep)
{
    ...
    json_object_foreach((json_t *) val, prop, pval)
    {
        ...
        if (likely(jm_str_eq_2(prop, 0x00000074)))
        {
            ...
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"\" [.'|'.2.t.'^'.0]", (path ? &lpath_2 : NULL));
            }
            // .'|'.2.t.'^'.1
            ...
            {
                if (rep) jm_report_add_entry(rep, "unexpected value for model \"_a\" [.'|'.2.t.'^'.1]", (path ? &lpath_2 : NULL));
            }
            if (xc_0 <= 1)
            {
                // .'|'.2.t.'^'.2
                ...
                {
                    if (rep) jm_report_add_entry(rep, "unexpected value for model \"_b\" [.'|'.2.t.'^'.2]", (path ? &lpath_2 : NULL));
                }
            }
            if (xc_0 <= 1)
            {
                ...
                {
                    if (rep) jm_report_add_entry(rep, "unexpected value for model \"_c\" [.'|'.2.t.'^'.3]", (path ? &lpath_2 : NULL));
                }
            }
            res = xc_0 == 1;
            if (likely(res))
            ...
            {
                if (rep) jm_report_add_entry(rep, "not one model match [.'|'.2.t.'^']", (path ? &lpath_2 : NULL));
