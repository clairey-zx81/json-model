...
def _jm_obj_2(val: Jsonable, path: Path, rep: Report) -> bool:
    ...
    if xr_0:
        ...
        rep is None or rep.append(("unexpected value for model \"\" [.'|'.2.t.'^'.0]", lpath if path is not None else None))
    # .'|'.2.t.'^'.1
    xr_0 = isinstance(pval, str) and pval == "a"
    if xr_0:
        xc_0 += 1
    else:
        rep is None or rep.append(("unexpected value for model \"_a\" [.'|'.2.t.'^'.1]", lpath if path is not None else None))
    if xc_0 <= 1:
        # .'|'.2.t.'^'.2
        ...
        if xr_0:
            ...
            rep is None or rep.append(("unexpected value for model \"_b\" [.'|'.2.t.'^'.2]", lpath if path is not None else None))
    if xc_0 <= 1:
        # .'|'.2.t.'^'.3
