...
=head1 SYNOPSIS
 ...
 jmc [-h] [--version] [--debug] [--verbose] [--quiet] [--doc {pod,syn,help,man}] [--man]
     ...
     [-[-no]-optimize] [-[-no]-inline-or] [-[-no]-reporting] [-[-no]-inline]
     ...
     [--map-threshold THRESHOLD] [--map-share]
...
whether to inline objects and disjunctions in disjunctions,
which may increase code size and add more optimization opportunities.
