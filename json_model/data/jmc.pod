...
=item B<--caps> or B<--no-caps>

Reject (the default) or accept all-caps definitions.
...
=head2 JavaScript Compilation

=over 4

=item B<--js-runtime JS>

Set JavaScript runtime for generated executable, eg C<bun>.
Skip with C<none>.
Default is C<node>.

=item B<--js-direct> or B<--no-js-direct>

Use more direct operations in generated JS code.
