...
=item L<JSON Model Compiler Python Package|https://pypi.org/project/json-model-compiler/>

Ready to use JSON Model compiler for a Python environment, from I<PyPI>.

=item L<JSON Model Compiler Docker Image|https://hub.docker.com/r/zx80/jmc>

Ready to use JSON Model compiler and runtimes (Python, C, JavaScript, Perl, Java)
as a Docker image, from I<Docker Hub>.

=item L<JSON Model JavaScript Runtime|https://www.npmjs.com/package/json_model_runtime>

JS runtime for the generated code, from I<npm Registry>.

=item L<JSON Model PL/pgSQL Runtime|https://pgxn.org/dist/json_model/>

PL/pgSQL runtime for generated code, from I<PGXN>.

=item L<JSON Model Perl Runtime|https://metacpan.org/pod/JSON::JsonModel>

Perl runtime for generated code, from I<CPAN>.

=item L<JSON Model Java Runtime|https://central.sonatype.com/artifact/org.json-model/json-model>

Java runtime for generated code, from I<Maven Central>.
