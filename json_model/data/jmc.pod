...
=head1 SYNOPSIS
 ...
 jmc [-h] [--version] [--debug] [--verbose] [--quiet] [--doc {pod,syn,help,man}] [--man]
     ...
     [--may-must-open-ratio RATIO] [--may-must-open-threshold THRESHOLD]
...
=item B<--may-must-open-ratio RATIO>

consider mmo object property scheme if the ratio of optional properties
