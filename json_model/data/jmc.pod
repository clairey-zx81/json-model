...
=head1 SYNOPSIS
 ...
 jmc [-h] [--version] [--debug] [--verbose] [--quiet] [--doc {pod,syn,help,man}] [--man]
     ...
     [--javac JAVAC] [--jflags JFLAGS] [-[-no]-schema-version]
     [--name NAME] [-[-no]-report] [--none] [--true] [--false] [--test-vector]
     [--map-threshold THRESHOLD] [--map-share] [-[-no]-strcmp-optimize] [--byte-order (le|be)]
     [--unroll-may-ratio RATIO] [--unroll-may-threshold THRESHOLD]
     [--must-only-threshold THRESHOLD] [-[-no]-predef] [--short-version]
...
=item B<--unroll-may-ratio RATIO>

consider object property unrolling if the ratio of optional properties
is below the provided ratio, default is 0.5.

=item B<--unroll-may-threshold THRESHOLD>

consider object property unrolling if the number of optional properties
is below the provided threshold, default is 5.

=item B<--must-only-threshold THRESHOLD>

consider must-only object property scheme if the number of mandatory
properties is below the provided threshold, default is 5.
