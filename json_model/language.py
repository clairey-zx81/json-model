...
class Language:
    ...
    def file_header(self, exe: bool = True, mark: str|None = None) -> Block:
        ...
        if mark is not None:
            header += self.lcom(mark, force=True) + self.lcom()
        return header
    ...
    def lcom(self, text: str = "", force: bool = False) -> Block:
        ...
        if self._with_comment or force:
            if text:
    ...
    def gen_full_code(
            ...
            entry: str, package: str|None, exe: bool, mark: str|None
        ) -> Block:
        ...
        code: Block = self.gen_code(self.file_header(exe, mark), entry, package)
...
class Code:
    ...
    - `mark`: add comment at beginning of file
    """
    ...
    def __init__(self,
        ...
        self._mark = mark              # add comment to generated code
    ...
    def get_code(self) -> Block:
        ...
        return  self._lang.filter_code(
            self._lang.gen_full_code(
                ...
                self._entry, self._package, self._executable, self._mark
            )
        )
