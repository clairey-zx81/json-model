...
For instance the following JSON object describe a comic character, his birth date and
list its friends:
...
- JSON Model regular expressions are extended with option `X` (capital letter x) to allow references
